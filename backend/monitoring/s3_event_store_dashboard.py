    ...
    async def collect_publisher_checkpoint_metrics(self) -> Dict[str, Any]:
        ...
        async with self.session.client(
            ...
            try:
                ...
                logging.getLogger(__name__).warning("Exception fallback at monitoring/s3_event_store_dashboard.py:191", exc_info=True)
        ...
        if isinstance(updated_at_iso, str) and updated_at_iso:
            try:
                ...
                logging.getLogger(__name__).warning("Exception fallback at monitoring/s3_event_store_dashboard.py:215", exc_info=True)
                age_s = None
