...
OPENAPI_STRICT_REMOVED_V1_OPS="${OPENAPI_STRICT_REMOVED_V1_OPS:-true}"
...
# Production/release gates must not rely on runtime schema bootstrap.
export ALLOW_RUNTIME_DDL_BOOTSTRAP="${ALLOW_RUNTIME_DDL_BOOTSTRAP:-false}"
export OPENAPI_STRICT_REMOVED_V1_OPS
