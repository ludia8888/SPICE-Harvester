"""
Sheet import service (BFF).

Takes normalized table previews (headers + rows) and:
- applies field mappings (source_field → target_field)
- coerces values to target ontology types (best-effort, domain-neutral)
- reports row/field-level validation errors for dry-run/commit
"""
    ...
    def build_instances(
        ...
        *,
        ...
        Args:
            ...
            max_rows: Optional cap (for dry-run)
        """
