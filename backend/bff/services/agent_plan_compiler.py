...
def _build_plan_system_prompt() -> str:
    return (
        ...
        "- For Pipeline Builder workflows, include a pipelines.simulate_definition step before any pipelines.create/update/build/deploy.\n"
        "- For multi-step Pipeline Builder plans, use deterministic IDs: include pipeline_id in pipelines.create and dataset_id in pipelines.datasets.create so later steps can reference them.\n"
