...
def _parse_deploy_request_payload(*, sanitized: Dict[str, Any]) -> _DeployRequestPayload:
    return _deploy_exec.parse_deploy_request_payload(sanitized=sanitized)
...
async def _resolve_deploy_pipeline_context(
    *,
    ...
    return await _deploy_exec.resolve_deploy_pipeline_context(
...
def _resolve_deploy_definition_and_db(
    *,
    ...
    return _deploy_exec.resolve_deploy_definition_and_db(
        definition_json=definition_json,
        latest=latest,
