"""
Ontology helper utilities (BFF).

Extracted from `bff.routers.ontology_ops` to keep routers thin and to
centralize shared normalization logic behind a small service facade.
"""
