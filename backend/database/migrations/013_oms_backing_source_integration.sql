...
-- 1. Make objectify_jobs.mapping_spec_id nullable
ALTER TABLE IF EXISTS objectify_jobs ALTER COLUMN mapping_spec_id DROP NOT NULL;
ALTER TABLE IF EXISTS objectify_jobs ALTER COLUMN mapping_spec_version DROP NOT NULL;
DO $$ BEGIN
    ALTER TABLE objectify_jobs DROP CONSTRAINT IF EXISTS objectify_jobs_mapping_spec_id_fkey;
