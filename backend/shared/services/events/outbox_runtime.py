...
async def maybe_purge_with_interval(
    *,
    ...
    try:
        ...
        logging.getLogger(__name__).warning("Exception fallback at shared/services/events/outbox_runtime.py:49", exc_info=True)
    ...
    try:
        while not stop_event.is_set():
            ...
            try:
                ...
                logging.getLogger(__name__).warning("Exception fallback at shared/services/events/outbox_runtime.py:86", exc_info=True)
                warning_logger(failure_message, exc)
