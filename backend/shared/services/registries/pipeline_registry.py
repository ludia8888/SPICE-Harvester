...
from shared.services.registries.pipeline_registry_schema import ensure_pipeline_registry_schema
...
class PipelineRegistry(PostgresSchemaRegistry):
    ...
    async def _ensure_tables(self, conn: asyncpg.Connection) -> None:
        await ensure_pipeline_registry_schema(conn, schema=self._schema)
