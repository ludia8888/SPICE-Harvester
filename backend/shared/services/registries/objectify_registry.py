...
from shared.services.registries.objectify_registry_schema import ensure_objectify_registry_schema
...
class ObjectifyRegistry(PostgresSchemaRegistry):
    ...
    async def _ensure_tables(self, conn: asyncpg.Connection) -> None:  # type: ignore[override]
        await ensure_objectify_registry_schema(conn, schema=self._schema)
