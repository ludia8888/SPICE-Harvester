...
@pytest.mark.unit
def test_resolve_dataset_write_policy_default_incremental_with_pk_without_additive_signal() -> None:
    policy = resolve_dataset_write_policy(
        definition={},
...
@pytest.mark.unit
def test_resolve_dataset_write_policy_default_incremental_additive_without_pk() -> None:
    policy = resolve_dataset_write_policy(
        definition={},
        output_metadata={},
        execution_semantics="incremental",
