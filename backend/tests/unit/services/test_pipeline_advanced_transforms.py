...
@pytest.mark.unit
def test_validate_pipeline_definition_rejects_static_with_transformed_right_input() -> None:
    definition = {
        "nodes": [
            {"id": "left", "type": "input", "metadata": {"datasetName": "left_ds"}},
            {"id": "right", "type": "input", "metadata": {"datasetName": "right_ds"}},
    ...
    assert any("streamJoin strategy=static requires right input to be a direct input node" in err for err in result.errors)


@pytest.mark.unit
def test_validate_pipeline_definition_rejects_static_with_streaming_right_input() -> None:
    definition = {
        "nodes": [
            {"id": "left", "type": "input", "metadata": {"datasetName": "left_ds"}},
            {
    ...
    assert any("streamJoin strategy=static requires right input to be batch lookup source" in err for err in result.errors)


@pytest.mark.unit
def test_validate_pipeline_definition_rejects_static_non_left_join_type() -> None:
    definition = {
        "nodes": [
            {"id": "left", "type": "input", "metadata": {"datasetName": "left_ds"}},
            {"id": "right", "type": "input", "metadata": {"datasetName": "right_ds"}},
    ...
    assert any("streamJoin strategy=static requires joinType=left" in err for err in result.errors)
