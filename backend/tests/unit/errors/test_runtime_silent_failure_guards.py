...
_STRICT_RUNTIME_GLOBS = (
    ...
    "shared/services/registries/pipeline_registry.py",
    ...
    "shared/services/core/connector_ingest_service.py",
    ...
    "shared/services/storage/elasticsearch_service.py",
    "shared/utils/action_permission_profile.py",
    "bff/middleware/auth.py",
    "bff/routers/foundry_connectivity_v2.py",
