...
def build_pipeline_mcp_tool_specs() -> List[Dict[str, Any]]:
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "match_mode": {"type": "string", "enum": ["contains", "extract", "count"]},
                    "node_id": {"type": "string"},
                },
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "left_cache_expiration_seconds": {"type": "number"},
                    "right_cache_expiration_seconds": {"type": "number"},
                    "time_direction": {"type": "string", "enum": ["backward", "forward", "symmetric"]},
                    "timeDirection": {"type": "string"},
                    "leftCacheExpirationSeconds": {"type": "number"},
                    "rightCacheExpirationSeconds": {"type": "number"},
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "post_filtering_column": {"type": "string"},
                    "output_format": {
                        "type": "string",
                        "enum": ["parquet", "json", "csv", "avro", "orc"],
                    },
                    "partition_by": {"type": "array", "items": {"type": "string"}},
                    "writeMode": {"type": "string"},
                    "primaryKeyColumns": {"type": "array", "items": {"type": "string"}},
                    "postFilteringColumn": {"type": "string"},
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "session_id": {
                        "type": "string",
                        "description": "Optional stable caller session for rate-limit isolation across related tool calls.",
                    },
