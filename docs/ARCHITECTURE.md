...
- Population: files **675**, functions **6364**, classes **903**, internal cross-imports **1600**

| # | Check | Ratio | Target | Status | Metric Basis |
| --- | --- | --- | --- | --- | --- |
| 1 | 계층 간 누수 | 0/1600 (0.00%) | <= 0.50% | **PASS** | `layer_leak_imports / internal_cross_imports` |
...
| 7 | 함수 단일 책임 위반 | 326/6364 (5.12%) | <= 10.00% | **PASS** | `(cc>=25 or len>=120) / functions` |
| 8 | 연속 상속 깊이(>=3) | 15/903 (1.66%) | <= 5.00% | **PASS** | `classes_depth>=3 / classes` |
| 9 | 복잡도 과다(CC>=15) | 733/6364 (11.52%) | <= 15.00% | **PASS** | `cc>=15 / functions` |
| 10 | 롱메서드(len>=80) | 414/6364 (6.51%) | <= 8.00% | **PASS** | `len>=80 / functions` |
