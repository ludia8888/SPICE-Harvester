...
| `bff` | 221 | 167/221 (75%) | 78 | 340 | 1098 | 789 | 59872 |
...
| `data_connector` | 23 | 7/23 (30%) | 7 | 14 | 61 | 46 | 2481 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `backend/tests/test_foundry_e2e_qa.py` | 520 | 104 | 0 | 0 | 106 | 106 | 3710 |
| `backend/pipeline_worker/main.py` | 221 | 42 | 0 | 0 | 57 | 46 | 5582 |
| `backend/bff/main.py` | 208 | 39 | 0 | 0 | 41 | 28 | 818 |
| `backend/instance_worker/main.py` | 190 | 38 | 0 | 0 | 46 | 73 | 2372 |
| `backend/shared/observability/tracing.py` | 174 | 29 | 0 | 0 | 30 | 1 | 521 |
| `backend/objectify_worker/main.py` | 162 | 32 | 0 | 0 | 44 | 42 | 4194 |
...
| `backend/projection_worker/main.py` | 130 | 26 | 0 | 0 | 29 | 30 | 1866 |
...
| `backend/action_worker/main.py` | 41 | 8 | 26 | 47 | 2430 |
| `backend/agent/main.py` | 1 | 5 | 5 | 1 | 88 |
| `backend/bff/main.py` | 32 | 39 | 41 | 28 | 818 |
...
| `backend/instance_worker/main.py` | 28 | 38 | 46 | 73 | 2372 |
| `backend/message_relay/main.py` | 10 | 13 | 22 | 10 | 664 |
| `backend/objectify_worker/main.py` | 44 | 32 | 44 | 42 | 4194 |
...
| `backend/pipeline_worker/main.py` | 78 | 42 | 57 | 46 | 5582 |
| `backend/projection_worker/main.py` | 27 | 26 | 29 | 30 | 1866 |
| `backend/writeback_materializer_worker/main.py` | 8 | 4 | 6 | 4 | 298 |
...
| 3 | `backend/bff/routers/foundry_datasets_v2.py` | API contract surface, Foundry v2 compatibility, high-impact module size |
| 4 | `backend/ontology_worker/main.py` | entrypoint lifecycle, ontology model contract |
...
| 8 | `backend/instance_worker/main.py` | entrypoint lifecycle, high-impact module size |
| 9 | `backend/objectify_worker/main.py` | entrypoint lifecycle, high-impact module size |
| 10 | `backend/projection_worker/main.py` | entrypoint lifecycle, high-impact module size |
| 11 | `backend/action_worker/main.py` | entrypoint lifecycle, high-impact module size |
| 12 | `backend/oms/routers/query.py` | API contract surface, query/search behavior, high-impact module size |
| 13 | `backend/shared/services/registries/ontology_key_spec_registry.py` | domain/service orchestration, storage adapter, ontology model contract |
| 14 | `backend/oms/routers/ontology_extensions.py` | API contract surface, ontology model contract |
| 15 | `backend/bff/routers/ontology_agent.py` | API contract surface, ontology model contract |
...
| 18 | `backend/bff/routers/ontology_ops.py` | API contract surface, ontology model contract |
...
- Source footprint: total_lines=438 | code_lines=383 | risk_score=35
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=2616 | code_lines=2430 | risk_score=40
- API surface: public=2 | top-level functions=1 | classes=4 | methods=57
- Runtime signals: async_functions=41 | try=26 | raise=47 | broad_except=8 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=1/4 (25%) | methods=1/57 (1%)
- Internal imports (46): oms.services.ontology_resources; shared.config.app_config; shared.config.settings; shared.errors.enterprise_catalog; shared.errors.error_types; shared.models.commands; shared.models.event_envelope; shared.models.events (+38 more)
- External imports (9): __future__; asyncio; collections; dataclasses; json; logging; pydantic; typing (+1 more)
...
### `backend/agent/middleware/__init__.py`
...
### `backend/agent/middleware/auth.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=108 | code_lines=87 | risk_score=0
...
- External imports (4): __future__; fastapi; hmac; os
- Public API names: ensure_agent_auth_configured; install_agent_auth_middleware
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=2005 | code_lines=1818 | risk_score=35
- API surface: public=2 | top-level functions=41 | classes=2 | methods=17
- Runtime signals: async_functions=7 | try=15 | raise=18 | broad_except=7 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=5/41 (12%) | classes=0/2 (0%) | methods=0/17 (0%)
- Internal imports (8): agent.models; shared.config.settings; shared.errors.error_types; shared.foundry.rids; shared.models.event_envelope; shared.services.core.audit_log_store; shared.services.storage.event_store; shared.utils.llm_safety
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=1042 | code_lines=818 | risk_score=208
...
- Internal imports (39): bff.middleware.auth; bff.routers; bff.routers.admin_deps; bff.services.oms_client; data_connector.google_sheets.service; shared.config.settings; shared.dependencies; shared.errors.error_types (+31 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1574 | code_lines=1412 | risk_score=65
- API surface: public=3 | top-level functions=39 | classes=1 | methods=0
- Runtime signals: async_functions=18 | try=29 | raise=4 | broad_except=8 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=1/39 (2%) | classes=0/1 (0%) | methods=0/0 (n/a)
- Internal imports (11): shared.config.settings; shared.errors.error_envelope; shared.errors.error_types; shared.foundry.errors; shared.observability.request_context; shared.security.auth_utils; shared.security.user_context; shared.services.registries.agent_tool_registry (+3 more)
- External imports (13): __future__; asyncio; dataclasses; datetime; fastapi; hmac; json; logging (+5 more)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=32 | code_lines=31 | risk_score=0
- API surface: public=0 | top-level functions=0 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=94 | code_lines=73 | risk_score=0
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=0 | raise=5 | broad_except=0 | bare_except=0 | finally_return=0
...
- Public API names: require_admin; require_admin_strict
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=126 | code_lines=109 | risk_score=6
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
...
- Internal imports (13): bff.dependencies; bff.routers.objectify_job_queue_deps; bff.routers.registry_deps; bff.schemas.admin_projection_requests; bff.services; shared.dependencies.providers; shared.middleware.rate_limiter; shared.observability.tracing (+5 more)
...
- Doc coverage: module=yes | top-level functions=2/2 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (17): bff.routers.pipeline_deps; bff.routers.pipeline_plans_deps; bff.routers.pipeline_plans_ops; bff.schemas.pipeline_plans_requests; bff.services; bff.services.pipeline_agent_autonomous_loop; shared.config.settings; shared.dependencies.providers (+9 more)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=128 | code_lines=118 | risk_score=0
- API surface: public=3 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=3 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/3 (33%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=93 | code_lines=79 | risk_score=10
- API surface: public=2 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=3 | raise=6 | broad_except=2 | bare_except=0 | finally_return=0
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=237 | code_lines=180 | risk_score=0
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=113 | code_lines=100 | risk_score=15
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=190 | code_lines=159 | risk_score=5
- API surface: public=4 | top-level functions=5 | classes=2 | methods=0
- Runtime signals: async_functions=2 | try=1 | raise=5 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/2 (0%) | methods=0/0 (n/a)
- Internal imports (11): bff.dependencies; bff.routers.registry_deps; bff.services.oms_client; bff.services.pipeline_plan_tenant_service; shared.errors.error_types; shared.errors.http_error_mapper; shared.models.responses; shared.observability.tracing (+3 more)
- External imports (5): fastapi; httpx; logging; pydantic; typing
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=4258 | code_lines=3830 | risk_score=80
- API surface: public=31 | top-level functions=108 | classes=0 | methods=0
- Runtime signals: async_functions=48 | try=50 | raise=10 | broad_except=8 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/108 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (20): bff.routers.data_connector_deps; bff.services; data_connector.adapters.factory; data_connector.adapters.import_config_validators; data_connector.google_sheets.service; shared.config.settings; shared.dependencies.providers; shared.foundry.auth (+12 more)
- External imports (7): fastapi; hashlib; httpx; logging; typing; urllib; uuid
...
- Internal imports (13): bff.routers.data_connector_deps; bff.routers.pipeline_datasets_ops_lakefs; shared.foundry.auth; shared.foundry.errors; shared.foundry.rids; shared.observability.tracing; shared.security.input_sanitizer; shared.services.registries.dataset_registry (+5 more)
- External imports (7): csv; fastapi; io; logging; mimetypes; typing; uuid
- Public API names: abort_transaction_v2; commit_transaction_v2; create_branch_v2; create_dataset_v2; create_transaction_v2; delete_branch_v2; get_branch_v2; get_dataset_schema_v2; get_dataset_v2; get_file_content_v2; get_file_v2; get_schema_batch_v2 (+7 more)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=7837 | code_lines=7155 | risk_score=35
- API surface: public=60 | top-level functions=187 | classes=12 | methods=0
- Runtime signals: async_functions=71 | try=116 | raise=81 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=13/187 (6%) | classes=0/12 (0%) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=1095 | code_lines=948 | risk_score=47
- API surface: public=12 | top-level functions=33 | classes=1 | methods=0
- Runtime signals: async_functions=13 | try=21 | raise=9 | broad_except=7 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=7/33 (21%) | classes=0/1 (0%) | methods=0/0 (n/a)
- Internal imports (17): bff.dependencies; bff.routers.pipeline_deps; bff.routers.pipeline_ops; bff.services; bff.services.oms_client; shared.dependencies.providers; shared.foundry.auth; shared.foundry.errors (+9 more)
- External imports (6): dataclasses; fastapi; logging; types; typing; uuid
- Public API names: cancel_build_v2; create_build_v2; create_schedule_v2; delete_schedule_v2; deploy_build_v2; get_build_v2; get_builds_batch_v2; get_schedule_v2; list_build_jobs_v2; list_schedule_runs_v2; pause_schedule_v2; unpause_schedule_v2
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=171 | code_lines=147 | risk_score=0
...
- External imports (2): fastapi; typing
- Public API names: create_key_spec; get_key_spec; list_access_policies; list_gate_policies; list_gate_results; list_key_specs; list_schema_migration_plans; upsert_access_policy; upsert_gate_policy
...
- Module summary: Helpers for normalizing link-type resources into Foundry v2 shapes.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=195 | code_lines=154 | risk_score=0
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=309 | code_lines=261 | risk_score=0
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=114 | code_lines=98 | risk_score=5
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=210 | code_lines=182 | risk_score=15
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=3 | raise=6 | broad_except=3 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=2/2 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (10): bff.routers.objectify_deps; bff.schemas.objectify_requests; shared.errors.error_types; shared.models.objectify_job; shared.models.requests; shared.observability.tracing; shared.security.database_access; shared.security.input_sanitizer (+2 more)
- External imports (4): fastapi; logging; typing; uuid
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=58 | code_lines=49 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=47 | code_lines=40 | risk_score=0
- API surface: public=1 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=1 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/2 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (8): bff.dependencies; bff.services; bff.services.input_validation_service; bff.services.oms_client; shared.errors.error_types; shared.models.ontology; shared.observability.tracing; shared.security.database_access
- External imports (1): fastapi
- Public API names: create_ontology_compat
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=184 | code_lines=161 | risk_score=0
- API surface: public=7 | top-level functions=9 | classes=0 | methods=0
- Runtime signals: async_functions=8 | try=1 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/9 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (7): bff.dependencies; bff.schemas.ontology_extensions_requests; bff.services; bff.services.oms_client; shared.errors.error_types; shared.observability.tracing; shared.security.database_access
- External imports (2): fastapi; typing
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=36 | code_lines=25 | risk_score=0
- API surface: public=0 | top-level functions=0 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=48 | code_lines=38 | risk_score=0
- API surface: public=0 | top-level functions=0 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=265 | code_lines=235 | risk_score=35
- API surface: public=5 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=5 | try=10 | raise=19 | broad_except=7 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/5 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Public API names: create_pipeline_branch; delete_dataset; get_dataset_raw_file; list_datasets; list_pipeline_branches
...
- Module summary: Pipeline dataset tabular-analysis helpers.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=217 | code_lines=188 | risk_score=0
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=217 | code_lines=194 | risk_score=15
- API surface: public=0 | top-level functions=8 | classes=0 | methods=0
- Runtime signals: async_functions=5 | try=5 | raise=7 | broad_except=3 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/8 (12%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (7): shared.config.settings; shared.errors.error_types; shared.services.storage.lakefs_branch_utils; shared.services.storage.lakefs_client; shared.services.storage.redis_service; shared.utils.path_utils; shared.utils.s3_uri
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=137 | code_lines=125 | risk_score=12
- API surface: public=0 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=2 | raise=0 | broad_except=2 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=32 | code_lines=23 | risk_score=0
- API surface: public=0 | top-level functions=0 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=176 | code_lines=159 | risk_score=5
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=1 | raise=6 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=198 | code_lines=178 | risk_score=5
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=3 | raise=6 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (14): bff.routers.pipeline_datasets_deps; bff.routers.pipeline_datasets_ops; bff.routers.pipeline_deps; bff.services.pipeline_dataset_upload_context; bff.services.pipeline_tabular_upload_facade; shared.config.settings; shared.dependencies.providers; shared.errors.error_types (+6 more)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=120 | code_lines=108 | risk_score=15
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=3 | raise=5 | broad_except=3 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/2 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (16): bff.routers.pipeline_datasets_deps; bff.routers.pipeline_datasets_ops; bff.routers.pipeline_deps; bff.services; shared.config.app_config; shared.dependencies.providers; shared.errors.error_types; shared.models.requests (+8 more)
- External imports (5): asyncpg; fastapi; logging; typing; uuid
- Public API names: create_dataset; create_dataset_version
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=142 | code_lines=128 | risk_score=0
- API surface: public=3 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=3 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/3 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=79 | code_lines=62 | risk_score=6
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
...
- Module summary: Database access (RBAC) request schemas (BFF).
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=19 | code_lines=11 | risk_score=0
- API surface: public=2 | top-level functions=0 | classes=2 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/2 (0%) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (3): __future__; pydantic; typing
- Public API names: DatabaseAccessEntryRequest; UpsertDatabaseAccessRequest
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=82 | code_lines=63 | risk_score=0
...
- Module summary: Ontology extension request schemas (BFF re-export shim).
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.schemas.ontology_extension_requests
- External imports (0): not documented
- Public API names: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=29 | code_lines=20 | risk_score=0
- API surface: public=2 | top-level functions=0 | classes=2 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/2 (0%) | methods=0/0 (n/a)
- Internal imports (1): shared.models.type_inference
- External imports (3): __future__; pydantic; typing
- Public API names: TabularAnalysisApiResponse; TabularAnalysisData
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=954 | code_lines=847 | risk_score=31
- API surface: public=7 | top-level functions=17 | classes=4 | methods=10
- Runtime signals: async_functions=9 | try=7 | raise=6 | broad_except=6 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/17 (0%) | classes=0/4 (0%) | methods=0/10 (0%)
- Internal imports (15): bff.routers.admin_task_monitor; bff.schemas.admin_projection_requests; shared.config.search_config; shared.dependencies.providers; shared.errors.error_types; shared.models.background_task; shared.models.lineage_edge_types; shared.observability.tracing (+7 more)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=218 | code_lines=186 | risk_score=30
- API surface: public=1 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=5 | raise=0 | broad_except=5 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/2 (50%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=745 | code_lines=651 | risk_score=30
- API surface: public=4 | top-level functions=15 | classes=0 | methods=0
...
- Internal imports (20): bff.routers.data_connector_ops; bff.routers.pipeline_datasets_ops; data_connector.adapters.factory; data_connector.adapters.import_config_validators; data_connector.adapters.runtime_credentials; data_connector.google_sheets.service; shared.config.app_config; shared.errors.error_types (+12 more)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=333 | code_lines=288 | risk_score=20
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=58 | code_lines=47 | risk_score=0
- API surface: public=2 | top-level functions=1 | classes=1 | methods=1
...
- Internal imports (3): shared.errors.error_types; shared.errors.http_error_mapper; shared.security.input_sanitizer
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=576 | code_lines=502 | risk_score=60
...
- Internal imports (10): bff.services.database_error_policy; bff.services.oms_client; shared.config.settings; shared.errors.error_types; shared.errors.http_error_mapper; shared.models.requests; shared.observability.tracing; shared.security.database_access (+2 more)
...
- Module summary: In-process Funnel runtime client.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=559 | code_lines=485 | risk_score=25
- API surface: public=1 | top-level functions=0 | classes=1 | methods=18
- Runtime signals: async_functions=9 | try=6 | raise=7 | broad_except=5 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=1/1 (100%) | methods=10/18 (55%)
- Internal imports (2): bff.services.base_http_client; shared.config.settings
- External imports (6): hashlib; httpx; importlib; io; logging; typing
...
- External imports (6): dataclasses; datetime; elasticsearch; fastapi; logging; typing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=686 | code_lines=607 | risk_score=0
...
- Internal imports (15): bff.schemas.link_types_requests; bff.schemas.objectify_requests; bff.services.oms_client; shared.errors.error_types; shared.errors.external_codes; shared.observability.tracing; shared.security.auth_utils; shared.services.pipeline.pipeline_schema_utils (+7 more)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=1125 | code_lines=1037 | risk_score=45
- API surface: public=2 | top-level functions=18 | classes=0 | methods=0
- Runtime signals: async_functions=3 | try=9 | raise=42 | broad_except=9 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/18 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (19): bff.routers.objectify_job_ops; bff.schemas.object_types_requests; bff.schemas.objectify_requests; bff.services.mapping_suggestion_service; bff.services.objectify_mapping_spec_service; bff.services.oms_client; bff.services.ontology_occ_guard_service; shared.errors.error_types (+11 more)
- External imports (5): __future__; fastapi; httpx; logging; typing
- Public API names: create_object_type_contract; update_object_type_contract
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=690 | code_lines=620 | risk_score=10
...
- Internal imports (15): bff.schemas.objectify_requests; bff.services.objectify_ops_service; bff.services.oms_client; bff.utils.httpx_exceptions; shared.errors.error_types; shared.models.objectify_job; shared.models.requests; shared.observability.tracing (+7 more)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=593 | code_lines=558 | risk_score=15
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=5 | raise=39 | broad_except=3 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/1 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (16): bff.routers.objectify_deps; bff.schemas.objectify_requests; bff.services.objectify_ops_service; bff.services.oms_client; shared.errors.error_types; shared.errors.external_codes; shared.models.requests; shared.observability.tracing (+8 more)
- External imports (4): fastapi; httpx; logging; typing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=105 | code_lines=79 | risk_score=0
- API surface: public=0 | top-level functions=8 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/8 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (6): bff.services.link_types_mapping_service; shared.utils.import_type_normalization; shared.utils.objectify_outputs; shared.utils.payload_utils; shared.utils.schema_columns; shared.utils.schema_hash
- External imports (2): __future__; typing
- Public API names: not documented
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=313 | code_lines=288 | risk_score=10
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=3 | raise=29 | broad_except=2 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Module summary: OMS gRPC client used by BFF.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=736 | code_lines=680 | risk_score=5
- API surface: public=2 | top-level functions=0 | classes=2 | methods=42
- Runtime signals: async_functions=35 | try=3 | raise=4 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=1/2 (50%) | methods=0/42 (0%)
- Internal imports (4): bff.services.base_http_client; shared.config.settings; shared.generated.grpc.spice.oms.v1; shared.services.grpc.oms_gateway_client
- External imports (8): __future__; dataclasses; google; grpc; httpx; json; logging; typing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=40 | code_lines=31 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=4 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (4): bff.utils.httpx_exceptions; shared.errors.error_types; shared.errors.http_error_mapper; shared.security.input_sanitizer
- External imports (5): __future__; fastapi; httpx; logging; typing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=85 | code_lines=67 | risk_score=6
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=1 | raise=0 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/1 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (10): bff.routers.ontology_ops; bff.services.oms_client; bff.services.oms_error_policy; bff.services.ontology_class_id_service; bff.services.ontology_label_mapper_service; shared.models.ontology; shared.models.responses; shared.observability.tracing (+2 more)
- External imports (3): __future__; fastapi; logging
- Public API names: create_ontology
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=222 | code_lines=198 | risk_score=5
- API surface: public=6 | top-level functions=8 | classes=0 | methods=0
- Runtime signals: async_functions=7 | try=1 | raise=4 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/8 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- External imports (5): __future__; fastapi; httpx; logging; typing
- Public API names: create_resource; delete_resource; get_resource; list_resources; record_deployment; update_resource
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=292 | code_lines=275 | risk_score=25
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=6 | raise=13 | broad_except=5 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/2 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (13): bff.routers.pipeline_ops; bff.routers.pipeline_ops_preflight; bff.routers.pipeline_shared; bff.services.input_validation_service; shared.config.app_config; shared.errors.error_types; shared.models.requests; shared.observability.tracing (+5 more)
- External imports (4): fastapi; logging; typing; uuid
- Public API names: create_pipeline; list_pipelines
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=100 | code_lines=83 | risk_score=0
- API surface: public=0 | top-level functions=2 | classes=1 | methods=0
- Runtime signals: async_functions=1 | try=2 | raise=3 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/2 (0%) | classes=0/1 (0%) | methods=0/0 (n/a)
- Internal imports (7): bff.services.http_idempotency; shared.errors.error_types; shared.security.auth_utils; shared.security.database_access; shared.security.input_sanitizer; shared.services.registries.pipeline_registry; shared.utils.path_utils
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=335 | code_lines=311 | risk_score=5
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=316 | code_lines=298 | risk_score=10
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=3495 | code_lines=3292 | risk_score=50
- API surface: public=3 | top-level functions=80 | classes=13 | methods=0
- Runtime signals: async_functions=45 | try=17 | raise=70 | broad_except=10 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/80 (0%) | classes=0/13 (0%) | methods=0/0 (n/a)
- Internal imports (29): bff.routers.pipeline_ops; bff.routers.pipeline_shared; bff.services.input_validation_service; bff.services.oms_client; bff.services.ontology_occ_guard_service; shared.dependencies.providers; shared.errors.error_envelope; shared.errors.error_types (+21 more)
- External imports (6): dataclasses; fastapi; httpx; logging; typing; uuid
- Public API names: build_pipeline; deploy_pipeline; preview_pipeline
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=84 | code_lines=78 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=37 | code_lines=31 | risk_score=1
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=1 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): bff.dependencies; bff.main
- External imports (2): fastapi; unittest
- Public API names: test_action_submit_batch_forwards_actor_identity
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=38 | code_lines=31 | risk_score=1
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=1 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): bff.dependencies; bff.main
- External imports (2): fastapi; unittest
- Public API names: test_action_submit_batch_forwards_actor_identity_from_headers
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=62 | code_lines=49 | risk_score=0
...
- Internal imports (2): bff.routers.command_status; shared.errors.error_types
- External imports (3): fastapi; httpx; pytest
- Public API names: DummyOMSClient; ErrorOMSClient; test_command_status_maps_upstream_404_to_resource_not_found; test_command_status_proxies_to_api_v1_commands_status_path
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=3199 | code_lines=2866 | risk_score=67
- API surface: public=83 | top-level functions=85 | classes=12 | methods=28
- Runtime signals: async_functions=121 | try=75 | raise=8 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=4/85 (4%) | classes=0/12 (0%) | methods=0/28 (0%)
- Internal imports (2): bff.routers; shared.utils.foundry_page_token
- External imports (8): __future__; fastapi; httpx; json; pytest; starlette; types; typing
- Public API names: test_apply_action_batch_v2_forwards_requests_to_submit_batch; test_apply_action_batch_v2_forwards_return_edits_option; test_apply_action_batch_v2_normalizes_non_foundry_validation_error; test_apply_action_v2_emits_standardized_action_evidence_fields; test_apply_action_v2_forwards_to_oms_v2_apply_with_foundry_path; test_apply_action_v2_normalizes_non_foundry_validation_error; test_apply_action_v2_validate_only_maps_to_oms_v2_apply; test_attachment_property_v2_requires_domain_role_and_returns_payload; test_count_objects_v2_forwards_to_oms_count_path; test_create_object_type_v2_routes_to_contract_service_with_backing_sources; test_execute_query_v2_missing_required_parameter_returns_invalid_argument; test_execute_query_v2_prefers_canonical_object_type_field_over_fallback (+71 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=56 | code_lines=42 | risk_score=2
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
...
- External imports (2): fastapi; unittest
- Public API names: test_bff_health_message_localizes_by_lang_param; test_foundry_v2_error_envelope_stable_with_lang_param
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=79 | code_lines=62 | risk_score=2
- API surface: public=2 | top-level functions=4 | classes=1 | methods=4
- Runtime signals: async_functions=5 | try=2 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/1 (0%) | methods=0/4 (0%)
- Internal imports (3): bff.dependencies; bff.main; bff.routers
- External imports (2): __future__; fastapi
- Public API names: test_v2_get_object_not_found_uses_foundry_error_envelope; test_v2_list_objects_returns_foundry_shape
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=24 | code_lines=19 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): bff.main
- External imports (1): fastapi
- Public API names: test_legacy_suggest_and_import_routes_not_registered
...
- Internal imports (1): bff.services
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=126 | code_lines=111 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=1 | methods=7
- Runtime signals: async_functions=7 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/1 (0%) | methods=0/7 (0%)
- Internal imports (1): bff.services
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=189 | code_lines=170 | risk_score=0
- API surface: public=2 | top-level functions=2 | classes=1 | methods=6
- Runtime signals: async_functions=7 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/2 (0%) | classes=0/1 (0%) | methods=0/6 (0%)
- Internal imports (1): bff.services
- External imports (4): fastapi; pytest; starlette; types
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=179 | code_lines=149 | risk_score=0
...
- Internal imports (1): bff.routers.link_types_read
- External imports (1): pytest
- Public API names: test_extract_resources_unwraps_nested_data; test_invert_cardinality; test_to_foundry_incoming_link_type_filters_non_matching_target; test_to_foundry_incoming_link_type_maps_fields; test_to_foundry_incoming_link_type_no_foreign_key; test_to_foundry_incoming_link_type_one_to_many_inverts_to_one; test_to_foundry_outgoing_link_type_filters_non_matching_source; test_to_foundry_outgoing_link_type_maps_link_type_fields
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=315 | code_lines=272 | risk_score=5
- API surface: public=5 | top-level functions=6 | classes=3 | methods=11
- Runtime signals: async_functions=20 | try=5 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/6 (0%) | classes=0/3 (0%) | methods=0/11 (0%)
- Internal imports (1): bff.routers
- External imports (4): fastapi; pytest; starlette; types
- Public API names: test_object_type_accepts_backing_sources_hint; test_object_type_active_requires_backing_context; test_object_type_draft_allows_no_backing_context; test_object_type_requires_primary_key; test_object_type_requires_title_key
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=234 | code_lines=198 | risk_score=0
- API surface: public=3 | top-level functions=4 | classes=3 | methods=17
- Runtime signals: async_functions=18 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/3 (0%) | methods=0/17 (0%)
- Internal imports (1): bff.routers
- External imports (4): fastapi; pytest; starlette; types
- Public API names: test_object_type_bootstrap_seed_update_skips_migration_gate; test_object_type_migration_plan_is_recorded; test_object_type_migration_requires_approval
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=507 | code_lines=425 | risk_score=0
...
- Doc coverage: module=no | top-level functions=2/16 (12%) | classes=0/4 (0%) | methods=0/17 (0%)
- Internal imports (3): bff.dependencies; bff.main; bff.routers
- External imports (3): datetime; fastapi; types
- Public API names: test_mapping_spec_change_summary_is_recorded; test_mapping_spec_dataset_pk_target_mismatch_is_rejected; test_mapping_spec_primary_key_missing_is_rejected; test_mapping_spec_relationship_target_is_rejected; test_mapping_spec_required_missing_is_rejected; test_mapping_spec_source_missing_is_rejected; test_mapping_spec_source_type_incompatible_now_succeeds; test_mapping_spec_source_type_unsupported_now_succeeds; test_mapping_spec_target_type_mismatch_is_rejected; test_mapping_spec_target_unknown_is_rejected; test_mapping_spec_unsupported_type_is_rejected
...
- Internal imports (2): bff.routers; bff.schemas.ontology_requests
- External imports (1): __future__
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=24 | code_lines=20 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): bff.main
- External imports (1): fastapi
- Public API names: test_ontology_validate_endpoints_removed
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=167 | code_lines=132 | risk_score=0
...
- Internal imports (1): bff.services.pipeline_dataset_version_service
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=74 | code_lines=60 | risk_score=0
...
- Internal imports (1): bff.routers
- External imports (5): __future__; datetime; pytest; starlette; types
- Public API names: test_get_dataset_raw_file_includes_version_metadata
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=813 | code_lines=686 | risk_score=0
- API surface: public=11 | top-level functions=14 | classes=11 | methods=33
- Runtime signals: async_functions=43 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/14 (0%) | classes=0/11 (0%) | methods=0/33 (0%)
- Internal imports (1): bff.services.pipeline_execution_service
- External imports (5): __future__; dataclasses; fastapi; pytest; typing
- Public API names: lakefs_merge_stub; test_build_enqueues_job_and_records_run; test_build_postgres_profile_uses_branch_ref_when_head_commit_unavailable; test_preview_defaults_to_foundry_limit_and_preview_meta_flags; test_preview_enqueues_job_with_node_id_and_records_preview_and_run; test_promote_build_allows_breaking_schema_changes_with_replay_flag; test_promote_build_blocks_deploy_when_expectations_failed; test_promote_build_merges_build_branch_to_main_and_registers_version; test_promote_build_rejects_non_staged_artifact_key; test_promote_build_requires_replay_for_breaking_schema_changes; test_promote_build_surfaces_build_errors_when_build_failed
...
- Public API names: test_maybe_enqueue_objectify_job; test_pipeline_helpers_normalize_inputs
...
- Module summary: Security tests for information leakage prevention on Foundry v2 object reads.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=130 | code_lines=104 | risk_score=3
- API surface: public=4 | top-level functions=6 | classes=1 | methods=5
- Runtime signals: async_functions=5 | try=4 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/6 (0%) | classes=0/1 (0%) | methods=0/5 (0%)
- Internal imports (3): bff.dependencies; bff.main; bff.routers
- External imports (3): __future__; fastapi; httpx
- Public API names: test_v2_get_object_success_no_source_leak; test_v2_list_objects_success_no_source_leak; test_v2_not_found_error_uses_foundry_envelope_without_internal_leak; test_v2_upstream_error_does_not_leak_backend_source_details
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=477 | code_lines=414 | risk_score=20
- API surface: public=1 | top-level functions=0 | classes=1 | methods=17
- Runtime signals: async_functions=11 | try=4 | raise=7 | broad_except=4 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/1 (0%) | methods=0/17 (0%)
- Internal imports (28): data_connector.adapters.factory; data_connector.adapters.import_config_validators; data_connector.adapters.runtime_credentials; data_connector.google_sheets.service; shared.config.app_config; shared.config.settings; shared.errors.error_types; shared.errors.runtime_exception_policy (+20 more)
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=336 | code_lines=293 | risk_score=52
...
- Internal imports (14): data_connector.adapters.factory; data_connector.adapters.runtime_credentials; data_connector.google_sheets.service; shared.config.app_config; shared.config.settings; shared.observability.context_propagation; shared.observability.metrics; shared.observability.tracing (+6 more)
...
- Internal imports (0): not documented
- External imports (3): __future__; asyncio; typing
- Public API names: run_blocking_query
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=239 | code_lines=202 | risk_score=5
- API surface: public=8 | top-level functions=7 | classes=2 | methods=9
- Runtime signals: async_functions=6 | try=1 | raise=3 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/7 (0%) | classes=0/2 (0%) | methods=0/9 (0%)
...
- External imports (2): __future__; typing
- Public API names: ConnectorAdapterFactory; connection_source_type_for_kind; connector_kind_from_source_type; file_import_source_type_for_kind; import_config_key_for_source_type; resolve_connector_kind_from_connection_config; table_import_source_type_for_kind; virtual_table_source_type_for_kind
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=94 | code_lines=77 | risk_score=0
- API surface: public=5 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=9 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): data_connector.adapters.sql_query_guard; shared.models.import_modes
- External imports (2): __future__; typing
- Public API names: is_jdbc_connector_kind; normalize_import_mode; normalized_query; validate_jdbc_mode_requirements; validate_resource_import_config
...
- Internal imports (2): data_connector.adapters.factory; shared.services.registries.connector_registry
- External imports (2): __future__; typing
- Public API names: resolve_source_runtime_credentials
...
- Internal imports (0): not documented
- External imports (1): __future__
- Public API names: normalize_sql_query
...
- Internal imports (3): data_connector.adapters.base; data_connector.adapters.blocking_query; data_connector.adapters.sql_query_guard
- External imports (4): __future__; re; typing; urllib
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=308 | code_lines=271 | risk_score=29
- API surface: public=1 | top-level functions=3 | classes=1 | methods=9
- Runtime signals: async_functions=7 | try=9 | raise=5 | broad_except=5 | bare_except=0 | finally_return=0
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=263 | code_lines=228 | risk_score=6
...
- Module summary: Internal Funnel runtime app.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
- Module summary: Funnel Structure Analysis Router.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=3058 | code_lines=2642 | risk_score=144
...
- Internal imports (4): funnel.services.structure_type_hints; shared.models.common; shared.models.structure_analysis; shared.utils.blank_utils
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=112 | code_lines=95 | risk_score=0
- API surface: public=3 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=3/3 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): shared.models.common; shared.models.type_inference
- External imports (4): __future__; functools; re; typing
- Public API names: infer_column_type_hint; infer_columns_for_table; infer_single_value_type
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=254 | code_lines=220 | risk_score=19
...
- Internal imports (11): shared.config.settings; shared.errors.error_envelope; shared.errors.error_types; shared.observability.metrics; shared.observability.request_context; shared.observability.tracing; shared.security.startup_guard; shared.services.core.service_factory (+3 more)
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=2680 | code_lines=2372 | risk_score=190
...
- Internal imports (35): oms.services.event_store; shared.config.app_config; shared.config.instances_index_mapping; shared.config.search_config; shared.config.settings; shared.errors.runtime_exception_policy; shared.models.event_envelope; shared.models.lineage_edge_types (+27 more)
- External imports (11): asyncio; boto3; botocore; dataclasses; datetime; inspect; json; logging (+3 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=21 | code_lines=12 | risk_score=0
- API surface: public=3 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
...
- Module summary: Compatibility shim for legacy imports.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.services.mcp_client
- External imports (0): not documented
- Public API names: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1449 | code_lines=1245 | risk_score=72
...
- Internal imports (0): not documented
- External imports (2): __future__; typing
- Public API names: coerce_to_string_list; extract_spark_error_details; normalize_aggregates; trim_build_output; trim_preview_payload
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=652 | code_lines=595 | risk_score=18
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=4544 | code_lines=4194 | risk_score=162
- API surface: public=3 | top-level functions=4 | classes=2 | methods=67
- Runtime signals: async_functions=44 | try=44 | raise=42 | broad_except=32 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=3/4 (75%) | classes=1/2 (50%) | methods=4/67 (5%)
- Internal imports (45): objectify_worker.validation_codes; objectify_worker.write_paths; shared.config.app_config; shared.config.search_config; shared.config.settings; shared.errors.error_envelope; shared.errors.error_types; shared.errors.runtime_exception_policy (+37 more)
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=459 | code_lines=394 | risk_score=10
...
- Internal imports (5): shared.config.instances_index_mapping; shared.config.search_config; shared.models.objectify_job; shared.services.storage.elasticsearch_service; shared.utils.deterministic_ids
...
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): oms.grpc.server
- External imports (0): not documented
- Public API names: not documented

### `backend/oms/grpc/server.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=653 | code_lines=573 | risk_score=0
...
- Internal imports (2): shared.config.settings; shared.generated.grpc.spice.oms.v1
- External imports (9): __future__; fastapi; google; grpc; httpx; json; logging; os (+1 more)
- Public API names: OMSGrpcServer; OmsGatewayServicer
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=73 | code_lines=58 | risk_score=0
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=2 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/2 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): shared.config.settings; shared.security.auth_utils
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=1286 | code_lines=1143 | risk_score=5
- API surface: public=23 | top-level functions=21 | classes=18 | methods=1
- Runtime signals: async_functions=9 | try=6 | raise=24 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=2/21 (9%) | classes=2/18 (11%) | methods=0/1 (0%)
- Internal imports (28): oms.dependencies; oms.services.action_simulation_service; oms.services.action_submit_service; oms.services.ontology_deployment_registry_v2; oms.services.ontology_resources; shared.config.app_config; shared.config.settings; shared.errors.error_types (+20 more)
- External imports (6): datetime; fastapi; logging; pydantic; typing; uuid
- Public API names: ActionSimulateAssumptions; ActionSimulateObservedBaseOverrides; ActionSimulateRequest; ActionSimulateScenarioRequest; ActionSimulateStatePatch; ActionSimulateTargetAssumption; ActionSubmitBatchDependencyRequest; ActionSubmitBatchItemRequest; ActionSubmitBatchItemResponse; ActionSubmitBatchRequest; ActionSubmitBatchResponse; ActionSubmitRequest (+11 more)

### `backend/oms/routers/attachments.py`
- Module summary: Foundry v2 Attachment Property Router (OMS).
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=617 | code_lines=524 | risk_score=17
- API surface: public=5 | top-level functions=17 | classes=0 | methods=0
- Runtime signals: async_functions=7 | try=12 | raise=0 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=12/17 (70%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (6): shared.config.search_config; shared.config.settings; shared.dependencies.providers; shared.observability.tracing; shared.security.database_access; shared.security.input_sanitizer
- External imports (6): fastapi; json; logging; mimetypes; typing; uuid
- Public API names: get_attachment_by_rid; get_attachment_content; get_attachment_content_by_rid; list_property_attachments; upload_attachment
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=201 | code_lines=171 | risk_score=37
- API surface: public=1 | top-level functions=2 | classes=0 | methods=0
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=226 | code_lines=199 | risk_score=20
- API surface: public=3 | top-level functions=3 | classes=0 | methods=0
...
- Module summary: Ontology extensions router (resource CRUD + validation helpers).
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
- Internal imports (7): oms.services.ontology_resources; shared.config.search_config; shared.dependencies.providers; shared.observability.tracing; shared.security.input_sanitizer; shared.utils.foundry_page_token; shared.utils.number_utils
- External imports (10): datetime; fastapi; hashlib; json; logging; math; pydantic; re (+2 more)
- Public API names: CountObjectsResponseV2; SearchJsonQueryV2; SearchObjectsRequestV2; SearchObjectsResponseV2; aggregate_objects_v2_oms; count_objects_v2_oms; search_objects_v2_foundry
...
- Module summary: Foundry v2 Time Series Property Router (OMS).
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=544 | code_lines=459 | risk_score=7
- API surface: public=3 | top-level functions=16 | classes=0 | methods=0
- Runtime signals: async_functions=7 | try=7 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=8/16 (50%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (6): shared.config.search_config; shared.config.settings; shared.dependencies.providers; shared.observability.tracing; shared.security.database_access; shared.security.input_sanitizer
- External imports (7): datetime; fastapi; json; logging; typing; urllib; uuid
- Public API names: get_first_point; get_last_point; stream_points
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=1632 | code_lines=1515 | risk_score=40
- API surface: public=8 | top-level functions=16 | classes=4 | methods=1
- Runtime signals: async_functions=5 | try=16 | raise=69 | broad_except=8 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/16 (0%) | classes=0/4 (0%) | methods=0/1 (0%)
...
- Module summary: Application service for async action submission.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=442 | code_lines=411 | risk_score=0
- API surface: public=1 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=4 | raise=20 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/2 (50%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (24): oms.services.action_simulation_service; oms.services.ontology_deployment_registry_v2; oms.services.ontology_resources; shared.config.app_config; shared.config.settings; shared.errors.error_types; shared.models.commands; shared.models.event_envelope (+16 more)
- External imports (5): __future__; datetime; fastapi; typing; uuid
- Public API names: submit_action_request
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=1184 | code_lines=1084 | risk_score=1
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=999 | code_lines=925 | risk_score=0
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=94 | code_lines=68 | risk_score=0
- API surface: public=3 | top-level functions=4 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=3/4 (75%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (5): __future__; functools; inspect; typing; warnings
...
- Public API names: RelationshipValidationResult; RelationshipValidator; ValidationSeverity
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=1367 | code_lines=1192 | risk_score=142
...
- Internal imports (28): oms.services.event_store; oms.services.ontology_resources; shared.config.app_config; shared.config.settings; shared.models.commands; shared.models.event_envelope; shared.models.events; shared.models.lineage_edge_types (+20 more)
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=145 | code_lines=133 | risk_score=11
- API surface: public=1 | top-level functions=0 | classes=1 | methods=5
- Runtime signals: async_functions=1 | try=3 | raise=2 | broad_except=2 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/0 (n/a) | classes=0/1 (0%) | methods=0/5 (0%)
- Internal imports (0): not documented
- External imports (3): __future__; logging; typing
- Public API names: PipelineIngestDomain
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=5959 | code_lines=5582 | risk_score=221
- API surface: public=2 | top-level functions=4 | classes=4 | methods=156
- Runtime signals: async_functions=78 | try=57 | raise=46 | broad_except=42 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/4 (0%) | classes=0/4 (0%) | methods=5/156 (3%)
- Internal imports (58): data_connector.google_sheets.service; pipeline_worker.ingest_domain; pipeline_worker.output_domain; pipeline_worker.preview_sampling; pipeline_worker.run_domain; pipeline_worker.spark_schema_helpers; pipeline_worker.spark_transform_engine; pipeline_worker.validation_domain (+50 more)
- External imports (17): __future__; asyncio; base64; concurrent; confluent_kafka; dataclasses; datetime; functools (+9 more)
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=604 | code_lines=580 | risk_score=0
- API surface: public=1 | top-level functions=0 | classes=1 | methods=9
- Runtime signals: async_functions=7 | try=1 | raise=22 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/0 (n/a) | classes=0/1 (0%) | methods=0/9 (0%)
- Internal imports (5): pipeline_worker.spark_schema_helpers; shared.services.pipeline.dataset_output_semantics; shared.services.pipeline.output_plugins; shared.utils.s3_uri; shared.utils.time_utils
- External imports (8): __future__; json; logging; os; shutil; tempfile; typing; uuid
- Public API names: PipelineOutputDomain
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=137 | code_lines=124 | risk_score=0
- API surface: public=5 | top-level functions=6 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=3 | raise=10 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/6 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (2): __future__; typing
- Public API names: apply_sampling_strategy; attach_sampling_snapshot; resolve_preview_flag; resolve_preview_limit; resolve_sampling_strategy
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=400 | code_lines=375 | risk_score=17
- API surface: public=1 | top-level functions=0 | classes=1 | methods=4
- Runtime signals: async_functions=4 | try=3 | raise=1 | broad_except=3 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/0 (n/a) | classes=0/1 (0%) | methods=0/4 (0%)
- Internal imports (3): shared.errors.error_types; shared.models.pipeline_job; shared.utils.time_utils
- External imports (4): __future__; logging; shutil; typing
- Public API names: PipelineRunDomain
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=116 | code_lines=103 | risk_score=0
- API surface: public=1 | top-level functions=0 | classes=1 | methods=4
- Runtime signals: async_functions=0 | try=0 | raise=3 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/0 (n/a) | classes=0/1 (0%) | methods=0/4 (0%)
...
- External imports (2): __future__; typing
- Public API names: PipelineValidationDomain
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=2155 | code_lines=1866 | risk_score=130
...
- Internal imports (29): shared.config.app_config; shared.config.search_config; shared.config.settings; shared.models.event_envelope; shared.models.events; shared.models.lineage_edge_types; shared.observability.metrics; shared.observability.tracing (+21 more)
...
- Dependencies (doc): not documented
- Inferred role: operational or migration automation
- Source footprint: total_lines=653 | code_lines=600 | risk_score=5
- API surface: public=6 | top-level functions=15 | classes=3 | methods=1
- Runtime signals: async_functions=9 | try=6 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/15 (0%) | classes=0/3 (0%) | methods=0/1 (0%)
- Internal imports (2): shared.config.settings; shared.services.storage.lakefs_client
- External imports (10): __future__; argparse; asyncio; asyncpg; dataclasses; datetime; httpx; json (+2 more)
- Public API names: ColumnChange; LakeFSChange; MigrationAudit; main; parse_args; run
...
- Dependencies (doc): not documented
- Inferred role: operational or migration automation
- Source footprint: total_lines=90 | code_lines=69 | risk_score=0
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=2/2 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
...
- Dependencies (doc): not documented
- Inferred role: operational or migration automation
- Source footprint: total_lines=203 | code_lines=151 | risk_score=0
- API surface: public=4 | top-level functions=4 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=4/4 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
...
- Dependencies (doc): not documented
- Inferred role: operational or migration automation
- Source footprint: total_lines=216 | code_lines=162 | risk_score=13
- API surface: public=3 | top-level functions=3 | classes=0 | methods=0
...
- Dependencies (doc): not documented
- Inferred role: operational or migration automation
- Source footprint: total_lines=237 | code_lines=204 | risk_score=12
- API surface: public=1 | top-level functions=6 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=3 | raise=1 | broad_except=2 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/6 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (6): shared.config.search_config; shared.config.settings; shared.security.database_access; shared.services.core.projection_consistency; shared.services.storage.elasticsearch_service; shared.services.storage.event_store
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=365 | code_lines=253 | risk_score=1
- API surface: public=1 | top-level functions=0 | classes=2 | methods=22
- Runtime signals: async_functions=0 | try=1 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=2/2 (100%) | methods=16/22 (72%)
...
- Module summary: Shared Elasticsearch mapping contract for the instances index.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=69 | code_lines=63 | risk_score=0
- API surface: public=0 | top-level functions=0 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=491 | code_lines=385 | risk_score=0
- API surface: public=4 | top-level functions=3 | classes=2 | methods=44
- Runtime signals: async_functions=0 | try=1 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=3/3 (100%) | classes=1/2 (50%) | methods=43/44 (97%)
- Internal imports (1): shared.config.settings
- External imports (3): logging; pydantic; typing
- Public API names: ServiceConfig; get_agent_url; get_bff_url; get_oms_url
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=4491 | code_lines=3919 | risk_score=14
- API surface: public=53 | top-level functions=18 | classes=46 | methods=209
- Runtime signals: async_functions=0 | try=13 | raise=4 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=6/18 (33%) | classes=46/46 (100%) | methods=17/209 (8%)
- Internal imports (0): not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=71 | code_lines=53 | risk_score=0
- API surface: public=0 | top-level functions=0 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): .container; .providers
- External imports (0): not documented
- Public API names: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=430 | code_lines=322 | risk_score=15
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=2713 | code_lines=2613 | risk_score=3
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=533 | code_lines=476 | risk_score=14
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=138 | code_lines=108 | risk_score=0
...
- Module summary: Canonical HTTP status-code → ErrorCode mapper.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=34 | code_lines=28 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/1 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.errors.error_types
- External imports (1): __future__
- Public API names: code_for_http_status
...
- Module summary: Shared utilities for Palantir Foundry parity layers.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=56 | code_lines=44 | risk_score=0
- API surface: public=1 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=2 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/2 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): shared.foundry.errors; shared.security.user_context
- External imports (3): __future__; fastapi; typing
- Public API names: require_scopes

### `backend/shared/foundry/compute_routing.py`
- Module summary: Foundry-style compute backend routing helpers for ontology runtime paths.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=78 | code_lines=61 | risk_score=2
- API surface: public=4 | top-level functions=5 | classes=1 | methods=2
- Runtime signals: async_functions=0 | try=2 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/5 (0%) | classes=0/1 (0%) | methods=0/2 (0%)
- Internal imports (0): not documented
- External imports (3): __future__; dataclasses; typing
- Public API names: ComputeRoutingDecision; choose_search_around_backend; choose_writeback_backend; select_backend
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=44 | code_lines=35 | risk_score=0
- API surface: public=3 | top-level functions=2 | classes=1 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/2 (0%) | classes=0/1 (0%) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (6): __future__; dataclasses; fastapi; starlette; typing; uuid
- Public API names: FoundryAPIError; foundry_error; foundry_exception_handler
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=61 | code_lines=50 | risk_score=0
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=6 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/2 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (2): __future__; typing
- Public API names: build_rid; parse_rid

### `backend/shared/foundry/spark_on_demand_dispatcher.py`
- Module summary: Spark on-demand queue/dispatcher for Foundry-style compute routing.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=198 | code_lines=168 | risk_score=5
- API surface: public=6 | top-level functions=2 | classes=5 | methods=6
- Runtime signals: async_functions=5 | try=3 | raise=3 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/2 (0%) | classes=0/5 (0%) | methods=0/6 (0%)
- Internal imports (0): not documented
- External imports (7): __future__; asyncio; dataclasses; logging; time; typing; uuid
- Public API names: SparkOnDemandDispatchResult; SparkOnDemandDispatchTimeoutError; SparkOnDemandDispatcher; SparkOnDemandJobContext; get_spark_on_demand_dispatcher; reset_spark_on_demand_dispatcher_for_tests

### `backend/shared/generated/__init__.py`
- Module summary: Generated code package root.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
### `backend/shared/generated/grpc/__init__.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
### `backend/shared/generated/grpc/spice/__init__.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
### `backend/shared/generated/grpc/spice/oms/__init__.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
### `backend/shared/generated/grpc/spice/oms/v1/__init__.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
### `backend/shared/generated/grpc/spice/oms/v1/oms_gateway_pb2.py`
- Module summary: Generated protocol buffer code.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (1): google
- Public API names: not documented

### `backend/shared/generated/grpc/spice/oms/v1/oms_gateway_pb2_grpc.py`
- Module summary: Client and server classes corresponding to protobuf-defined services.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1479 | code_lines=1397 | risk_score=0
- API surface: public=4 | top-level functions=1 | classes=3 | methods=67
- Runtime signals: async_functions=0 | try=1 | raise=34 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=3/3 (100%) | methods=34/67 (50%)
- Internal imports (1): .
- External imports (2): grpc; warnings
- Public API names: OmsGatewayService; OmsGatewayServiceServicer; OmsGatewayServiceStub; add_OmsGatewayServiceServicer_to_server
...
- Module summary: Tabular type inference models.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: domain/request-response schema definitions
- Source footprint: total_lines=179 | code_lines=134 | risk_score=0
...
- Public API names: ColumnAnalysisResult; ColumnProfile; DatasetAnalysisRequest; DatasetAnalysisResponse; SchemaGenerationRequest; SchemaGenerationResponse; TabularAnalysisPayload; TabularPreviewRequest; TabularPreviewResponse; TabularRiskItem; TypeInferenceResult; TypeMappingRequest (+1 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=590 | code_lines=468 | risk_score=18
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=648 | code_lines=521 | risk_score=174
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=657 | code_lines=557 | risk_score=28
...
- Module summary: Ontology extension request schemas (shared canonical definition).
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
...
- Internal imports (0): not documented
- External imports (3): __future__; pydantic; typing
- Public API names: OntologyDeploymentRecordRequest; OntologyResourceRequest
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=134 | code_lines=108 | risk_score=0
- API surface: public=8 | top-level functions=8 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=2 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/8 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.config.settings
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=330 | code_lines=287 | risk_score=9
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=923 | code_lines=677 | risk_score=0
- API surface: public=9 | top-level functions=7 | classes=2 | methods=25
- Runtime signals: async_functions=0 | try=3 | raise=74 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=7/7 (100%) | classes=2/2 (100%) | methods=23/25 (92%)
- Internal imports (1): shared.config.settings
...
### `backend/shared/security/startup_guard.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=103 | code_lines=82 | risk_score=0
- API surface: public=1 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.config.settings
- External imports (3): __future__; logging; typing
- Public API names: ensure_startup_security
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=307 | code_lines=255 | risk_score=0
- API surface: public=4 | top-level functions=9 | classes=2 | methods=1
- Runtime signals: async_functions=2 | try=3 | raise=14 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=2/9 (22%) | classes=2/2 (100%) | methods=0/1 (0%)
- Internal imports (0): not documented
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=66 | code_lines=58 | risk_score=0
- API surface: public=2 | top-level functions=1 | classes=1 | methods=2
- Runtime signals: async_functions=1 | try=0 | raise=3 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/1 (0%) | methods=0/2 (0%)
- Internal imports (0): not documented
- External imports (3): __future__; httpx; typing
- Public API names: AgentInternalClient; build_agent_internal_headers
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=422 | code_lines=383 | risk_score=5
- API surface: public=2 | top-level functions=1 | classes=1 | methods=10
- Runtime signals: async_functions=6 | try=2 | raise=2 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/1 (0%) | methods=0/10 (0%)
...
- External imports (8): __future__; asyncpg; collections; datetime; hashlib; json; typing; uuid
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=690 | code_lines=544 | risk_score=29
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=452 | code_lines=363 | risk_score=0
- API surface: public=1 | top-level functions=0 | classes=1 | methods=13
- Runtime signals: async_functions=12 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=1/1 (100%) | methods=12/13 (92%)
- Internal imports (4): shared.config.app_config; shared.config.settings; shared.models.commands; shared.services.storage.redis_service
- External imports (3): datetime; logging; typing
- Public API names: CommandStatusService
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=440 | code_lines=389 | risk_score=0
- API surface: public=1 | top-level functions=9 | classes=1 | methods=6
- Runtime signals: async_functions=5 | try=2 | raise=3 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/9 (0%) | classes=0/1 (0%) | methods=0/6 (0%)
- Internal imports (11): shared.config.settings; shared.models.import_modes; shared.models.objectify_job; shared.services.events.objectify_job_queue; shared.services.registries.dataset_registry; shared.services.registries.objectify_registry; shared.services.registries.pipeline_registry; shared.services.storage.lakefs_client (+3 more)
...
- Internal imports (3): shared.config.instances_index_mapping; shared.config.search_config; shared.services.storage.elasticsearch_service
...
- Module summary: Build objectify link-index jobs from relationship specs.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=125 | code_lines=110 | risk_score=0
- API surface: public=2 | top-level functions=1 | classes=1 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/1 (0%) | methods=0/0 (n/a)
- Internal imports (3): shared.models.objectify_job; shared.services.registries.dataset_registry; shared.services.registries.objectify_registry
- External imports (4): __future__; dataclasses; typing; uuid
- Public API names: LinkIndexObjectifyJobBuildResult; build_link_index_objectify_job
...
### `backend/shared/services/grpc/__init__.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.services.grpc.oms_gateway_client
- External imports (0): not documented
- Public API names: not documented

### `backend/shared/services/grpc/oms_gateway_client.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=281 | code_lines=240 | risk_score=5
- API surface: public=2 | top-level functions=5 | classes=2 | methods=17
- Runtime signals: async_functions=11 | try=1 | raise=3 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=1/2 (50%) | methods=0/17 (0%)
- Internal imports (2): shared.config.settings; shared.generated.grpc.spice.oms.v1
- External imports (6): __future__; grpc; httpx; json; os; typing
- Public API names: OMSGatewayGrpcClient; OMSGrpcHttpCompatClient
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=411 | code_lines=337 | risk_score=30
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=2621 | code_lines=2365 | risk_score=20
- API surface: public=5 | top-level functions=52 | classes=5 | methods=20
- Runtime signals: async_functions=9 | try=28 | raise=45 | broad_except=4 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=3/52 (5%) | classes=0/5 (0%) | methods=0/20 (0%)
...
- External imports (15): __future__; ast; csv; dataclasses; datetime; difflib; io; json (+7 more)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=570 | code_lines=530 | risk_score=29
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=338 | code_lines=284 | risk_score=18
- API surface: public=6 | top-level functions=6 | classes=2 | methods=3
- Runtime signals: async_functions=4 | try=3 | raise=0 | broad_except=3 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=5/6 (83%) | classes=2/2 (100%) | methods=2/3 (66%)
- Internal imports (1): shared.utils.object_type_backing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=1036 | code_lines=954 | risk_score=0
- API surface: public=5 | top-level functions=1 | classes=5 | methods=23
- Runtime signals: async_functions=17 | try=0 | raise=31 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/5 (0%) | methods=1/23 (4%)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=1583 | code_lines=1509 | risk_score=5
- API surface: public=5 | top-level functions=0 | classes=5 | methods=31
- Runtime signals: async_functions=25 | try=3 | raise=33 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=1/5 (20%) | methods=5/31 (16%)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=3260 | code_lines=3071 | risk_score=10
- API surface: public=11 | top-level functions=14 | classes=11 | methods=57
- Runtime signals: async_functions=54 | try=9 | raise=104 | broad_except=2 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/14 (0%) | classes=1/11 (9%) | methods=3/57 (5%)
- Internal imports (8): shared.config.settings; shared.services.registries.postgres_schema_registry; shared.services.storage.lakefs_branch_utils; shared.services.storage.lakefs_client; shared.services.storage.lakefs_storage_service; shared.utils.json_utils; shared.utils.path_utils; shared.utils.time_utils
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=108 | code_lines=89 | risk_score=5
- API surface: public=1 | top-level functions=0 | classes=1 | methods=9
- Runtime signals: async_functions=8 | try=2 | raise=3 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/1 (0%) | methods=0/9 (0%)
- Internal imports (1): shared.config.settings
- External imports (6): __future__; abc; asyncio; asyncpg; logging; typing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=791 | code_lines=678 | risk_score=46
- API surface: public=3 | top-level functions=4 | classes=1 | methods=22
- Runtime signals: async_functions=21 | try=25 | raise=19 | broad_except=8 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=3/4 (75%) | classes=1/1 (100%) | methods=20/22 (90%)
- Internal imports (3): shared.config.settings; shared.observability.tracing; shared.services.storage.connectivity
- External imports (6): asyncio; elasticsearch; importlib; logging; typing; urllib
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=1269 | code_lines=1062 | risk_score=108
- API surface: public=2 | top-level functions=1 | classes=1 | methods=32
- Runtime signals: async_functions=21 | try=24 | raise=16 | broad_except=20 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/1 (100%) | classes=1/1 (100%) | methods=14/32 (43%)
...
- Module summary: Canonical lakeFS branch-creation helper.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=59 | code_lines=48 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=1 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/1 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (3): shared.observability.tracing; shared.services.storage.lakefs_client; shared.utils.path_utils
- External imports (2): __future__; typing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=465 | code_lines=425 | risk_score=5
- API surface: public=6 | top-level functions=2 | classes=6 | methods=12
- Runtime signals: async_functions=9 | try=1 | raise=49 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/2 (50%) | classes=1/6 (16%) | methods=3/12 (25%)
- Internal imports (2): shared.config.settings; shared.observability.tracing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=478 | code_lines=394 | risk_score=22
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=100 | code_lines=66 | risk_score=0
- API surface: public=0 | top-level functions=0 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/0 (n/a) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=395 | code_lines=310 | risk_score=17
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1280 | code_lines=1160 | risk_score=9
...
- Internal imports (0): not documented
- External imports (2): __future__; typing
- Public API names: list_backing_sources; select_primary_backing_source
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=99 | code_lines=79 | risk_score=0
- API surface: public=5 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=4/5 (80%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (3): __future__; logging; typing
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=103 | code_lines=78 | risk_score=1
- API surface: public=2 | top-level functions=6 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=1 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=3/6 (50%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.utils.repo_dotenv
- External imports (6): __future__; os; pathlib; pytest; socket; sys
- Public API names: pytest_collection_modifyitems; pytest_configure
...
- Module summary: Download Olist Brazilian E-Commerce dataset from Kaggle and extract
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=101 | code_lines=66 | risk_score=1
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=2 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (3): __future__; pathlib; sys
- Public API names: main
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1204 | code_lines=1096 | risk_score=5
- API surface: public=3 | top-level functions=27 | classes=0 | methods=0
- Runtime signals: async_functions=23 | try=7 | raise=23 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/27 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (9): shared.config.service_config; shared.config.settings; shared.services.core.link_index_job_builder; shared.services.registries.dataset_registry; shared.services.registries.objectify_registry; shared.services.storage.lakefs_storage_service; shared.utils.s3_uri; shared.utils.schema_hash (+1 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1790 | code_lines=1537 | risk_score=13
- API surface: public=3 | top-level functions=36 | classes=0 | methods=0
- Runtime signals: async_functions=29 | try=18 | raise=15 | broad_except=2 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=4/36 (11%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Public API names: test_action_batch_dependency_e2e; test_action_writeback_e2e_smoke; test_action_writeback_e2e_verification_suite
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=97 | code_lines=78 | risk_score=0
- API surface: public=2 | top-level functions=4 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/4 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1376 | code_lines=1075 | risk_score=74
- API surface: public=14 | top-level functions=4 | classes=14 | methods=49
- Runtime signals: async_functions=18 | try=25 | raise=1 | broad_except=10 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=3/4 (75%) | classes=14/14 (100%) | methods=41/49 (83%)
- Internal imports (1): shared.config.settings
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=941 | code_lines=792 | risk_score=15
- API surface: public=5 | top-level functions=15 | classes=5 | methods=14
- Runtime signals: async_functions=17 | try=7 | raise=14 | broad_except=3 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=3/15 (20%) | classes=5/5 (100%) | methods=14/14 (100%)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=706 | code_lines=641 | risk_score=0
- API surface: public=1 | top-level functions=10 | classes=0 | methods=0
- Runtime signals: async_functions=9 | try=2 | raise=10 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/10 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (3): shared.config.search_config; tests.utils.auth; tests.utils.pipelines_v2_adapter
...
- Module summary: Foundry 완전 E2E QA: 실제 Kaggle 데이터 + 실시간 API
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=4233 | code_lines=3710 | risk_score=520
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=354 | code_lines=303 | risk_score=15
- API surface: public=1 | top-level functions=7 | classes=0 | methods=0
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=3458 | code_lines=2939 | risk_score=60
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=2291 | code_lines=2087 | risk_score=10
- API surface: public=14 | top-level functions=29 | classes=0 | methods=0
- Runtime signals: async_functions=23 | try=13 | raise=14 | broad_except=2 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=15/29 (51%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (6): shared.models.pipeline_job; shared.services.pipeline.pipeline_job_queue; shared.services.storage.lakefs_client; shared.utils.path_utils; shared.utils.repo_dotenv; tests.utils.pipelines_v2_adapter
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=630 | code_lines=578 | risk_score=0
- API surface: public=1 | top-level functions=13 | classes=0 | methods=0
- Runtime signals: async_functions=11 | try=9 | raise=13 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=1/13 (7%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (5): shared.config.search_config; shared.services.registries.dataset_registry; shared.utils.repo_dotenv; shared.utils.s3_uri; tests.utils.pipelines_v2_adapter
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=432 | code_lines=390 | risk_score=0
...
- Doc coverage: module=no | top-level functions=2/9 (22%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (3): shared.services.registries.dataset_registry; shared.utils.repo_dotenv; tests.utils.pipelines_v2_adapter
- External imports (8): __future__; asyncio; httpx; os; pytest; time; typing; uuid
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=713 | code_lines=658 | risk_score=0
...
- Internal imports (3): shared.utils.repo_dotenv; shared.utils.s3_uri; tests.utils.pipelines_v2_adapter
- External imports (9): __future__; asyncio; httpx; json; os; pytest; time; typing (+1 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=284 | code_lines=252 | risk_score=0
- API surface: public=1 | top-level functions=7 | classes=0 | methods=0
- Runtime signals: async_functions=5 | try=3 | raise=5 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=1/7 (14%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): shared.utils.repo_dotenv; tests.utils.pipelines_v2_adapter
- External imports (8): __future__; asyncio; httpx; os; pytest; time; typing; uuid
...
### `backend/tests/unit/agent/test_agent_auth_middleware.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=89 | code_lines=70 | risk_score=1
- API surface: public=3 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=1 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): agent.middleware.auth
- External imports (6): __future__; contextlib; fastapi; os; pytest; typing
- Public API names: test_agent_auth_configuration_requires_token; test_agent_auth_enforced_for_run_endpoints; test_agent_health_path_remains_exempt
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=181 | code_lines=142 | risk_score=0
- API surface: public=6 | top-level functions=8 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/8 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.config.app_config
- External imports (4): __future__; ast; pathlib; pytest
- Public API names: test_app_config_reflects_current_settings; test_no_application_settings_instantiation_outside_settings_module; test_no_external_funnel_address_env_keys_reintroduced; test_no_foundry_strict_opt_out_env_keys_reintroduced; test_no_import_global_settings_symbol_outside_settings_module; test_no_os_getenv_calls_outside_settings_module
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=127 | code_lines=90 | risk_score=0
- API surface: public=13 | top-level functions=15 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/15 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (3): __future__; pathlib; re
- Public API names: test_debug_ports_overlay_does_not_expose_funnel_port; test_default_compose_does_not_publish_funnel_host_port; test_default_compose_includes_pipeline_scheduler_runtime; test_deploy_scripts_do_not_reference_external_funnel_health; test_env_templates_do_not_expose_external_funnel_toggles; test_full_compose_bff_does_not_depend_on_funnel_service; test_full_compose_does_not_enable_legacy_pull_request_surface; test_funnel_service_absent_in_compose_variants; test_gateway_does_not_expose_funnel_public_routes; test_local_start_script_does_not_start_funnel_process; test_prometheus_default_targets_do_not_assume_funnel_service; test_settings_do_not_expose_legacy_pull_request_feature_flag (+1 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=133 | code_lines=95 | risk_score=0
- API surface: public=9 | top-level functions=10 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/10 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.config.settings
- External imports (2): __future__; pytest
- Public API names: test_agent_bff_token_and_command_timeout_fallback; test_client_token_fallbacks; test_feature_flags_no_strict_compat_toggles; test_lakefs_repository_defaults; test_local_port_host_aliases; test_objectify_dataset_primary_chunk_size_clamps_lower_bound; test_objectify_dataset_primary_chunk_size_defaults; test_pipeline_publish_lock_timeout_fallback; test_service_settings_no_external_funnel_address_surface
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=28 | code_lines=18 | risk_score=0
- API surface: public=4 | top-level functions=4 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/3 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): data_connector.adapters.sql_query_guard
- External imports (2): __future__; pytest
- Public API names: test_normalize_sql_query_allows_single_statement; test_normalize_sql_query_rejects_empty; test_normalize_sql_query_rejects_multi_statement
...
- Internal imports (0): not documented
- External imports (3): __future__; pathlib; re
- Public API names: test_foundry_v2_routers_do_not_use_broad_exception_handlers
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=139 | code_lines=123 | risk_score=0
...
### `backend/tests/unit/middleware/test_bff_metrics_exempt_policy.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=69 | code_lines=55 | risk_score=1
- API surface: public=2 | top-level functions=4 | classes=0 | methods=0
- Runtime signals: async_functions=1 | try=1 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): bff.middleware.auth
- External imports (6): __future__; contextlib; fastapi; os; pytest; typing
- Public API names: test_metrics_can_stay_exempt_in_development; test_metrics_is_not_exempt_in_production_even_if_env_lists_it
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=327 | code_lines=265 | risk_score=0
- API surface: public=6 | top-level functions=8 | classes=1 | methods=1
- Runtime signals: async_functions=27 | try=0 | raise=2 | broad_except=0 | bare_except=0 | finally_return=0
...
- Public API names: action_async_app; test_simulate_returns_503_when_datasource_derived_data_access_is_unverifiable; test_simulate_use_branch_head_no_longer_requires_terminus; test_submit_batch_returns_403_for_datasource_derived_without_data_engineer_role; test_submit_batch_returns_403_when_target_class_misses_required_interface; test_submit_batch_returns_503_when_target_edit_access_is_unverifiable

### `backend/tests/unit/oms/test_attachments_router.py`
- Module summary: Tests for OMS Foundry-style Attachment Property router.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=297 | code_lines=213 | risk_score=0
- API surface: public=15 | top-level functions=15 | classes=0 | methods=0
- Runtime signals: async_functions=15 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/15 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (3): oms.routers; oms.routers.attachments; shared.dependencies.providers
- External imports (6): __future__; fastapi; httpx; json; pytest; unittest
- Public API names: mock_es; mock_storage; override_deps; test_attachments_return_permission_denied_when_actor_header_present_and_role_check_fails; test_attachments_skip_role_enforcement_without_actor_headers; test_get_attachment_by_rid_not_found; test_get_attachment_by_rid_returns_metadata; test_get_attachment_content_404_when_s3_missing; test_get_attachment_content_by_rid_returns_binary; test_get_attachment_content_returns_binary; test_list_property_attachments_404_not_found; test_list_property_attachments_multiple (+3 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=45 | code_lines=33 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=781 | code_lines=654 | risk_score=0
- API surface: public=33 | top-level functions=33 | classes=0 | methods=0
- Runtime signals: async_functions=32 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/33 (3%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (3): oms.routers.query; shared.dependencies.providers; shared.utils.foundry_page_token
- External imports (5): __future__; fastapi; httpx; pytest; unittest
- Public API names: mock_es; override_deps; test_search_objects_v2_accepts_contains_any_term_operator; test_search_objects_v2_accepts_deprecated_startswith_alias; test_search_objects_v2_accepts_foundry_branch_rid; test_search_objects_v2_accepts_non_deprecated_operator; test_search_objects_v2_accepts_scope_matched_page_token; test_search_objects_v2_allows_missing_where_with_match_all_fallback; test_search_objects_v2_collapses_duplicate_overlay_rows; test_search_objects_v2_expired_page_token_returns_foundry_error; test_search_objects_v2_hides_overlay_tombstoned_rows; test_search_objects_v2_in_operator_valid_list_accepted (+21 more)
...
- External imports (1): __future__
- Public API names: test_oms_foundry_action_routes_still_registered_runtime; test_oms_foundry_action_surface_hidden_from_openapi; test_oms_legacy_routes_removed_from_openapi
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=68 | code_lines=51 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=1/1 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): oms.main
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=238 | code_lines=169 | risk_score=0
- API surface: public=12 | top-level functions=12 | classes=0 | methods=0
- Runtime signals: async_functions=12 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/12 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (3): oms.routers; oms.routers.timeseries; shared.dependencies.providers
- External imports (6): __future__; fastapi; httpx; json; pytest; unittest
- Public API names: mock_es; mock_storage; override_deps; test_get_first_point_404_when_instance_not_found; test_get_first_point_404_when_property_not_timeseries; test_get_first_point_returns_earliest_point; test_get_last_point_returns_latest_point; test_stream_points_404_when_no_ts_data; test_stream_points_returns_all_points; test_stream_points_with_absolute_range; test_timeseries_returns_permission_denied_when_actor_header_present_and_role_check_fails; test_timeseries_skips_role_enforcement_without_actor_headers
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=60 | code_lines=46 | risk_score=0
- API surface: public=1 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/2 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (4): __future__; pathlib; pytest; re
- Public API names: test_architecture_quality_checklist_is_auto_rendered_with_ratios
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=59 | code_lines=44 | risk_score=0
- API surface: public=4 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (3): bff.routers; oms.routers; shared.routers
- External imports (2): fastapi; pytest
- Public API names: test_bff_command_status_openapi_includes_404_and_503; test_config_drift_analysis_openapi_includes_400; test_oms_command_status_openapi_includes_404_and_503; test_v2_attachments_upload_openapi_includes_400_for_bff_and_oms
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=183 | code_lines=151 | risk_score=0
- API surface: public=1 | top-level functions=6 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/6 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): bff.main
- External imports (7): __future__; fastapi; pathlib; pytest; re; typing; yaml
- Public API names: test_foundry_contract_manifest_matches_openapi_and_scopes

### `backend/tests/unit/openapi/test_foundry_datasets_v2_contract.py`
- Module summary: Contract tests for Foundry Datasets API v2 router.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1223 | code_lines=986 | risk_score=0
- API surface: public=15 | top-level functions=17 | classes=6 | methods=32
- Runtime signals: async_functions=46 | try=0 | raise=6 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=2/17 (11%) | classes=0/6 (0%) | methods=0/32 (0%)
- Internal imports (6): bff.routers; bff.routers.data_connector_deps; shared.foundry.errors; shared.security.user_context; shared.services.storage.lakefs_client; shared.utils.time_utils
- External imports (8): csv; fastapi; httpx; io; pytest; types; typing; uuid
- Public API names: test_foundry_datasets_branch_operations; test_foundry_datasets_create_and_get; test_foundry_datasets_file_operations; test_foundry_datasets_list_files_returns_503_when_lakefs_unavailable; test_foundry_datasets_read_table; test_foundry_datasets_read_table_lakefs_error_returns_unavailable; test_foundry_datasets_read_table_no_version_returns_empty; test_foundry_datasets_read_table_uses_version_artifact_key_fallback; test_foundry_datasets_read_table_with_column_selection; test_foundry_datasets_schema_get_and_update; test_foundry_datasets_transaction_commit_lakefs_failure_keeps_open; test_foundry_datasets_transaction_commit_materializes_non_source_csv_when_list_objects_fails (+3 more)
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1349 | code_lines=1116 | risk_score=0
- API surface: public=38 | top-level functions=40 | classes=0 | methods=0
- Runtime signals: async_functions=67 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=3/40 (7%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (4): bff.dependencies; bff.routers; shared.foundry.errors; shared.security.user_context
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=2196 | code_lines=1881 | risk_score=0
- API surface: public=27 | top-level functions=29 | classes=0 | methods=0
- Runtime signals: async_functions=130 | try=0 | raise=3 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/29 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (8): bff.dependencies; bff.routers; bff.routers.data_connector_deps; bff.routers.pipeline_deps; shared.dependencies.providers; shared.foundry.errors; shared.models.background_task; shared.security.user_context
- External imports (7): datetime; fastapi; httpx; pytest; types; typing; uuid
- Public API names: test_foundry_connection_create_get_list_delete; test_foundry_connection_create_jdbc_kinds; test_foundry_connection_crud_paths_exist_in_openapi; test_foundry_connection_get_not_found; test_foundry_connection_test_endpoint; test_foundry_connection_update_export_settings_v2; test_foundry_connection_update_secrets_keeps_response_non_secret; test_foundry_connection_upload_custom_jdbc_drivers_v2; test_foundry_connectivity_connection_scoped_table_import_create; test_foundry_connectivity_export_run_requires_markings_when_enforced; test_foundry_connectivity_export_runs_create_get_and_list; test_foundry_connectivity_get_list_execute_and_delete_table_import (+15 more)
...
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/3 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): bff.main; oms.main
- External imports (2): __future__; pathlib
- Public API names: test_openapi_branch_defaults_do_not_use_master; test_runtime_code_has_no_branch_master_default_literals
...
- Internal imports (1): bff.routers
- External imports (2): __future__; fastapi
- Public API names: test_ontology_resource_crud_routes_are_exposed
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=45 | code_lines=35 | risk_score=0
- API surface: public=4 | top-level functions=4 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): tests.test_openapi_contract_smoke
- External imports (2): __future__; pytest
- Public API names: test_extract_command_lifecycle_status_handles_nested_state_alias; test_extract_command_lifecycle_status_ignores_generic_envelope_status_without_data_status; test_extract_command_lifecycle_status_prefers_nested_command_status; test_extract_command_lifecycle_status_uses_top_level_when_not_generic
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=105 | code_lines=89 | risk_score=0
- API surface: public=2 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=2 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/3 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): tests.test_openapi_contract_smoke
- External imports (3): __future__; pytest; typing
- Public API names: test_openapi_smoke_preview_recipes_use_string_preview_true; test_openapi_smoke_recipes_exist_and_query_params_are_aiohttp_safe
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=1066 | code_lines=926 | risk_score=6
...
- Internal imports (1): bff.routers
- External imports (4): fastapi; pathlib; pytest; re
- Public API names: test_action_worker_direct_undo_literal_absent_from_runtime; test_agent_runtime_and_migrated_e2e_scripts_do_not_reference_v1_pipelines_prefix; test_architecture_guard_covers_legacy_action_and_funnel_path_literals; test_external_funnel_service_artifacts_deleted; test_foundry_reference_docs_use_current_urls; test_foundry_v2_openapi_parameter_surface_matches_official_docs_contract; test_funnel_runtime_does_not_call_bff_google_sheets_v1_paths; test_legacy_action_simulation_registry_module_deleted; test_legacy_actions_and_query_router_shims_deleted; test_legacy_branch_endpoint_literals_are_only_in_visibility_guard; test_legacy_data_connector_sheet_tools_router_deleted; test_legacy_instances_sample_values_router_deleted (+20 more)
...
- Dependencies (doc): not documented
- Inferred role: HTTP contract/endpoint routing
- Source footprint: total_lines=90 | code_lines=67 | risk_score=0
- API surface: public=4 | top-level functions=4 | classes=2 | methods=3
- Runtime signals: async_functions=6 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/2 (0%) | methods=0/3 (0%)
- Internal imports (1): bff.routers.audit
- External imports (4): __future__; datetime; fastapi; pytest
- Public API names: test_list_audit_logs_normalizes_status_filter; test_list_audit_logs_rejects_invalid_status_filter; test_list_audit_logs_rejects_invalid_time_window; test_list_audit_logs_treats_store_value_error_as_internal_error
...
### `backend/tests/unit/security/test_agent_internal_client.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=53 | code_lines=42 | risk_score=0
- API surface: public=3 | top-level functions=4 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.services.core.agent_internal_client
- External imports (3): __future__; pathlib; pytest
- Public API names: test_build_agent_internal_headers_requires_token; test_build_agent_internal_headers_sets_required_auth_headers; test_runtime_code_does_not_hardcode_agent_internal_endpoint

### `backend/tests/unit/security/test_compose_single_entrypoint_guard.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=84 | code_lines=69 | risk_score=0
- API surface: public=3 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (0): not documented
- External imports (3): __future__; pathlib; yaml
- Public API names: test_debug_overlay_explicitly_exposes_required_gate_ports; test_full_compose_does_not_republish_oms_port; test_secure_default_compose_hides_internal_and_data_plane_ports
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=42 | code_lines=30 | risk_score=0
- API surface: public=5 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.security.input_sanitizer
- External imports (2): __future__; pytest
- Public API names: test_sanitize_input_accepts_main_branch_value; test_sql_detector_still_matches_information_schema_keyword; test_validate_branch_name_accepts_foundry_branch_rid; test_validate_branch_name_rejects_legacy_master; test_validate_branch_name_rejects_reserved_head
...
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (3): agent.main; ingest_reconciler_worker.main; shared.services.core.service_factory
- External imports (2): __future__; fastapi
- Public API names: test_agent_service_hides_openapi_surface; test_ingest_reconciler_service_hides_openapi_surface; test_service_factory_disables_docs_when_urls_are_none
...
### `backend/tests/unit/security/test_startup_guard.py`
- Module summary: no docstring
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=53 | code_lines=44 | risk_score=1
- API surface: public=2 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=1 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/3 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.security.startup_guard
- External imports (5): __future__; contextlib; os; pytest; typing
- Public API names: test_startup_guard_allows_weak_tokens_in_development; test_startup_guard_blocks_weak_admin_token_in_production
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=246 | code_lines=201 | risk_score=0
- API surface: public=9 | top-level functions=9 | classes=0 | methods=0
...
- External imports (3): __future__; pytest; types
- Public API names: test_enforce_action_permission_allows_datasource_derived_without_policy; test_enforce_action_permission_allows_ontology_roles_model; test_enforce_action_permission_allows_when_project_policy_inheritance_matches; test_enforce_action_permission_rejects_datasource_derived_for_non_engineer_role; test_enforce_action_permission_rejects_edits_beyond_actions_without_engineer_role; test_enforce_action_permission_rejects_invalid_permission_profile; test_enforce_action_permission_rejects_policy_mismatch; test_enforce_action_permission_rejects_when_inherited_project_policy_denies; test_enforce_action_permission_rejects_when_required_project_policy_is_missing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=384 | code_lines=316 | risk_score=0
- API surface: public=8 | top-level functions=10 | classes=8 | methods=21
- Runtime signals: async_functions=22 | try=0 | raise=2 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/10 (0%) | classes=0/8 (0%) | methods=0/21 (0%)
- Internal imports (3): bff.schemas.admin_projection_requests; bff.services.admin_recompute_projection_service; shared.models.background_task
- External imports (5): __future__; datetime; fastapi; pytest; types
- Public API names: test_get_recompute_projection_result_returns_processing_for_running_task; test_load_projection_mapping_falls_back_when_file_missing_for_instances; test_load_projection_mapping_falls_back_when_file_missing_for_ontologies; test_ontologies_projection_strategy_normalizes_localized_fields_for_es; test_recompute_projection_task_blocks_instances_in_dataset_primary_mode; test_recompute_projection_task_updates_progress_for_long_running_work; test_start_recompute_projection_allows_ontologies_in_dataset_primary_mode; test_start_recompute_projection_blocks_instances_in_dataset_primary_mode
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=165 | code_lines=126 | risk_score=0
- API surface: public=5 | top-level functions=5 | classes=2 | methods=2
- Runtime signals: async_functions=5 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/5 (0%) | classes=0/2 (0%) | methods=0/2 (0%)
- Internal imports (1): bff.services.admin_reindex_instances_service
- External imports (4): __future__; pytest; typing; unittest
- Public API names: test_reindex_filters_legacy_specs_by_dataset_db_name; test_reindex_handles_missing_dataset_version; test_reindex_no_mapping_specs; test_reindex_submits_jobs; test_reindex_with_multiple_specs
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=108 | code_lines=95 | risk_score=0
- API surface: public=1 | top-level functions=1 | classes=1 | methods=3
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=346 | code_lines=302 | risk_score=0
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=126 | code_lines=106 | risk_score=0
- API surface: public=2 | top-level functions=1 | classes=1 | methods=2
- Runtime signals: async_functions=6 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/1 (0%) | methods=0/2 (0%)
- Internal imports (2): agent.models; agent.services.agent_runtime
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=78 | code_lines=67 | risk_score=0
- API surface: public=3 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/3 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=139 | code_lines=116 | risk_score=0
- API surface: public=2 | top-level functions=1 | classes=1 | methods=2
- Runtime signals: async_functions=5 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/1 (0%) | classes=0/1 (0%) | methods=0/2 (0%)
- Internal imports (2): agent.models; agent.services.agent_runtime
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=26 | code_lines=16 | risk_score=0
- API surface: public=4 | top-level functions=4 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.services.core.audit_log_store
- External imports (1): __future__
- Public API names: test_coerce_metadata_accepts_dict; test_coerce_metadata_parses_json_string; test_coerce_metadata_returns_empty_for_broken_mapping; test_coerce_metadata_returns_empty_for_invalid_string
...
- Inferred role: service/domain orchestration
- Source footprint: total_lines=102 | code_lines=80 | risk_score=0
- API surface: public=2 | top-level functions=3 | classes=1 | methods=4
- Runtime signals: async_functions=8 | try=0 | raise=2 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/3 (0%) | classes=0/1 (0%) | methods=0/4 (0%)
- Internal imports (2): shared.models.background_task; shared.services.core.background_task_manager
- External imports (4): __future__; asyncio; json; pytest
- Public API names: test_retry_attempt_clears_terminal_fields_before_reexecution; test_task_stays_terminal_failed_after_retry_exhaustion
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=325 | code_lines=274 | risk_score=0
- API surface: public=5 | top-level functions=6 | classes=3 | methods=8
- Runtime signals: async_functions=21 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/6 (0%) | classes=0/3 (0%) | methods=0/8 (0%)
- Internal imports (1): shared.services.core.connector_ingest_service
- External imports (6): __future__; csv; io; pytest; types; typing
- Public API names: test_connector_ingest_service_append_deduplicates_rows; test_connector_ingest_service_incremental_cdc_streaming_use_append_merge; test_connector_ingest_service_rejects_invalid_import_mode; test_connector_ingest_service_snapshot_creates_dataset_and_version; test_connector_ingest_service_update_upserts_by_primary_key
...
- Module summary: Tests for Elasticsearch client compatibility header behavior.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=111 | code_lines=75 | risk_score=1
- API surface: public=6 | top-level functions=6 | classes=0 | methods=0
- Runtime signals: async_functions=8 | try=1 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=0/6 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.services.storage
- External imports (4): __future__; asyncio; elasticsearch; pytest
- Public API names: test_connect_is_idempotent_under_concurrency; test_disconnect_clears_client_reference; test_resolve_compat_version_defaults_to_8_for_v9_client; test_resolve_compat_version_uses_explicit_env; test_service_injects_compat_headers_for_v9_client; test_service_patches_elasticsearch_v9_compat_template
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=157 | code_lines=113 | risk_score=0
- API surface: public=4 | top-level functions=4 | classes=3 | methods=9
- Runtime signals: async_functions=14 | try=0 | raise=2 | broad_except=0 | bare_except=0 | finally_return=0
...
- External imports (4): __future__; asyncio; pytest; typing
- Public API names: test_event_store_connect_fails_when_lineage_required_and_store_unavailable; test_event_store_connect_is_idempotent_under_concurrency; test_event_store_connect_skips_store_bootstrap_when_pre_attached; test_event_store_lineage_record_failure_propagates_when_required
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=129 | code_lines=102 | risk_score=0
- API surface: public=4 | top-level functions=5 | classes=3 | methods=6
- Runtime signals: async_functions=10 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/3 (0%) | methods=0/6 (0%)
...
- Public API names: test_load_class_info_supports_backing_sources_contract_shape; test_wait_for_objectify_submitted_allows_dataset_primary_completed_without_commands; test_wait_for_objectify_submitted_defaults_to_dataset_primary_when_report_missing; test_wait_for_objectify_submitted_requires_commands_for_submitted_status
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=150 | code_lines=121 | risk_score=0
- API surface: public=2 | top-level functions=3 | classes=3 | methods=10
- Runtime signals: async_functions=11 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/3 (0%) | classes=0/3 (0%) | methods=0/10 (0%)
- Internal imports (2): bff.schemas.objectify_requests; bff.services
- External imports (5): __future__; fastapi; pytest; starlette; types
- Public API names: test_run_objectify_accepts_version_pinned_execution; test_run_objectify_requires_dataset_version_id_without_artifact
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=276 | code_lines=223 | risk_score=6
- API surface: public=9 | top-level functions=9 | classes=5 | methods=13
- Runtime signals: async_functions=18 | try=7 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/9 (0%) | classes=0/5 (0%) | methods=0/13 (0%)
- Internal imports (3): oms.grpc.server; shared.generated.grpc.spice.oms.v1; shared.services.grpc.oms_gateway_client
- External imports (5): __future__; fastapi; grpc; json; pytest
- Public API names: test_database_exists_returns_false_when_missing; test_database_exists_returns_true_when_found; test_dispatch_stream_emits_multiple_chunks; test_gateway_build_request_and_response_mapping_roundtrip; test_gateway_call_metadata_includes_service_and_delegated_auth; test_get_database_returns_404_when_missing; test_get_database_returns_selected_row; test_grpc_authorize_rejects_invalid_service_token; test_grpc_authorize_requires_mtls_when_enabled
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=142 | code_lines=115 | risk_score=0
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=372 | code_lines=305 | risk_score=0
- API surface: public=7 | top-level functions=7 | classes=3 | methods=7
- Runtime signals: async_functions=12 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/7 (0%) | classes=0/3 (0%) | methods=0/7 (0%)
- Internal imports (1): shared.services.pipeline.pipeline_scheduler
- External imports (5): __future__; dataclasses; datetime; pytest; typing
...
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=120 | code_lines=83 | risk_score=0
- API surface: public=5 | top-level functions=5 | classes=5 | methods=10
- Runtime signals: async_functions=12 | try=0 | raise=3 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/5 (0%) | methods=0/10 (0%)
- Internal imports (1): shared.services.registries.postgres_schema_registry
- External imports (2): __future__; pytest
- Public API names: test_ensure_schema_retries_until_lock_available; test_ensure_schema_unlocks_on_table_error; test_ensure_schema_uses_advisory_lock; test_health_check_connects_when_pool_missing; test_health_check_returns_false_on_query_failure
...
- Internal imports (1): shared.services.storage.redis_service
- External imports (2): __future__; pytest
- Public API names: test_set_json_accepts_ex_alias_for_ttl; test_set_json_prefers_ttl_over_ex_when_both_provided
...
- Module summary: Tests for sync-mode helpers in bff.services.data_connector_pipelining_service.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: service/domain orchestration
- Source footprint: total_lines=242 | code_lines=154 | risk_score=0
- API surface: public=12 | top-level functions=12 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=12/12 (100%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): bff.services.data_connector_pipelining_service
- External imports (2): hashlib; pytest
- Public API names: test_append_mode_adds_only_new_rows; test_append_mode_empty_existing; test_append_mode_no_new_rows; test_append_mode_preserves_column_names; test_append_mode_realigns_new_rows_to_existing_column_order; test_parse_csv_bytes; test_parse_csv_bytes_empty; test_row_hash_deterministic; test_update_mode_default_pk_first_column; test_update_mode_empty_existing; test_update_mode_realigns_new_rows_when_column_order_changes; test_update_mode_updates_existing_rows_by_pk
...
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): shared.config.settings; shared.security.input_sanitizer
- External imports (2): __future__; pytest
- Public API names: test_normalize_base_branch_defaults_to_main; test_ontology_protected_branches_default_excludes_master; test_pipeline_branch_defaults_are_main_only; test_validate_branch_name_rejects_master
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=27 | code_lines=21 | risk_score=0
- API surface: public=3 | top-level functions=3 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/3 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.foundry.compute_routing
- External imports (0): not documented
- Public API names: test_choose_search_around_backend_prefers_index_when_under_threshold; test_choose_search_around_backend_routes_spark_when_over_threshold; test_choose_writeback_backend_routes_spark_when_over_threshold
...
- Internal imports (1): shared.utils.object_type_backing
- External imports (0): not documented
- Public API names: test_list_backing_sources_falls_back_to_backing_source; test_list_backing_sources_prefers_backing_sources_list; test_select_primary_backing_source_returns_empty_dict_for_missing_shape; test_select_primary_backing_source_returns_first_source
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=50 | code_lines=38 | risk_score=0
- API surface: public=2 | top-level functions=2 | classes=0 | methods=0
- Runtime signals: async_functions=4 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/2 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): shared.foundry.spark_on_demand_dispatcher
- External imports (3): __future__; asyncio; pytest
- Public API names: test_dispatch_executes_job_and_returns_metrics; test_dispatch_timeout_raises
...
- External imports (0): not documented
- Public API names: test_extract_backing_dataset_id_reads_backing_sources_fallback; test_extract_backing_dataset_id_reads_object_type_spec; test_extract_backing_dataset_id_returns_none_for_missing_shape; test_policies_aligned_requires_dicts_and_exact_match
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=479 | code_lines=393 | risk_score=0
- API surface: public=8 | top-level functions=8 | classes=8 | methods=32
- Runtime signals: async_functions=26 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/8 (0%) | classes=0/8 (0%) | methods=0/32 (0%)
...
- Public API names: test_sync_worker_handle_envelope_accepts_mysql_file_import; test_sync_worker_handle_envelope_accepts_sqlserver_table_import; test_sync_worker_handle_envelope_rejects_unknown; test_sync_worker_heartbeat_loop_stops; test_sync_worker_process_connector_update_file_import_uses_file_config_key; test_sync_worker_process_connector_update_snapshot; test_sync_worker_process_connector_update_streaming_uses_cdc_extract; test_sync_worker_run_processes_message
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=307 | code_lines=242 | risk_score=0
- API surface: public=5 | top-level functions=5 | classes=6 | methods=23
- Runtime signals: async_functions=19 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/6 (0%) | methods=0/23 (0%)
...
- Public API names: test_trigger_service_file_import_uses_file_import_config_key; test_trigger_service_initialize_and_close; test_trigger_service_is_due; test_trigger_service_poll_source_uses_adapter_and_records_change; test_trigger_service_publish_outbox
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=78 | code_lines=64 | risk_score=0
- API surface: public=2 | top-level functions=4 | classes=1 | methods=2
- Runtime signals: async_functions=4 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/4 (0%) | classes=0/1 (0%) | methods=0/2 (0%)
- Internal imports (2): objectify_worker.main; shared.models.objectify_job
- External imports (2): __future__; pytest
- Public API names: test_resolve_mapping_spec_rejects_job_dataset_mismatch_with_backing_sources; test_resolve_mapping_spec_uses_backing_sources_when_backing_source_missing
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=150 | code_lines=118 | risk_score=0
- API surface: public=5 | top-level functions=5 | classes=0 | methods=0
- Runtime signals: async_functions=5 | try=0 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/5 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): pipeline_worker.main; shared.models.pipeline_job
- External imports (4): __future__; pytest; types; typing
- Public API names: test_async_domain_methods_delegate; test_execute_job_delegates_to_run_domain; test_ingest_methods_delegate_to_ingest_domain; test_pipeline_worker_initializes_domain_modules; test_validation_methods_delegate_to_validation_domain
...
- Dependencies (doc): not documented
- Inferred role: asynchronous background processing
- Source footprint: total_lines=230 | code_lines=189 | risk_score=2
- API surface: public=14 | top-level functions=14 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=2 | raise=0 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/14 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (1): pipeline_worker.main
- External imports (3): __future__; os; pytest
- Public API names: test_preview_helpers_use_foundry_defaults; test_resolve_code_version_and_sensitive_keys; test_resolve_external_read_mode_streaming_aliases; test_resolve_kafka_avro_schema_accepts_schema_registry_reference; test_resolve_kafka_avro_schema_rejects_incomplete_schema_registry_reference; test_resolve_kafka_avro_schema_rejects_latest_registry_version; test_resolve_kafka_value_format_and_checkpoint_policy; test_resolve_lakefs_repository; test_resolve_output_format_and_partitions; test_resolve_streaming_trigger_mode_and_timeout; test_sampling_strategy_defaults_to_limit_for_preview_inputs; test_streaming_external_source_requires_kafka_format (+2 more)
...
- Runtime signals: async_functions=0 | try=2 | raise=0 | broad_except=1 | bare_except=0 | finally_return=0
- Doc coverage: module=no | top-level functions=0/7 (0%) | classes=0/0 (n/a) | methods=0/0 (n/a)
- Internal imports (2): pipeline_worker.main; pipeline_worker.spark_schema_helpers
- External imports (6): __future__; importlib; os; pyspark; pytest; sys
...
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=112 | code_lines=90 | risk_score=0
- API surface: public=5 | top-level functions=6 | classes=0 | methods=0
- Runtime signals: async_functions=0 | try=0 | raise=1 | broad_except=0 | bare_except=0 | finally_return=0
...
- Module summary: QA helpers for Foundry E2E testing.
- Responsibilities: not documented
- Invariants: not documented
- Failure modes: not documented
- Extension points: not documented
- Dependencies (doc): not documented
- Inferred role: general backend module
- Source footprint: total_lines=410 | code_lines=352 | risk_score=0
- API surface: public=6 | top-level functions=3 | classes=3 | methods=16
- Runtime signals: async_functions=12 | try=2 | raise=5 | broad_except=0 | bare_except=0 | finally_return=0
- Doc coverage: module=yes | top-level functions=3/3 (100%) | classes=2/3 (66%) | methods=0/16 (0%)
- Internal imports (1): tests.utils.auth
- External imports (14): __future__; asyncio; csv; dataclasses; datetime; httpx; io; json (+6 more)
- Public API names: BugRecord; BugTracker; QAClient; fetch_frankfurter_csv; fetch_open_meteo_csv; fetch_usgs_earthquake_csv
...
- Dependencies (doc): not documented
- Inferred role: service entrypoint and lifecycle wiring
- Source footprint: total_lines=350 | code_lines=298 | risk_score=22
