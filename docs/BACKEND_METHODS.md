...
> Generated: 2026-02-21T15:14:10+09:00
...
- **Functions**
  - `async main()` (line 2588): no docstring
- **Classes**
  - `_ActionCommandPayload` (line 114): no docstring
  - `_ActionCommandParseError` (line 121): no docstring
  - `_ActionRejected` (line 125): Used to short-circuit retries when the ActionLog is already finalized with a rejection result.
  - `ActionWorker` (line 129): no docstring
    - `__init__(self)` (line 130): no docstring
    - `async initialize(self)` (line 168): no docstring
    - `async shutdown(self)` (line 213): no docstring
    - `_parse_payload(self, payload)` (line 229): no docstring
    - `_fallback_metadata(self, payload)` (line 282): no docstring
    - `_registry_key(self, payload)` (line 285): no docstring
    - `async _process_payload(self, payload)` (line 296): no docstring
    - `_span_name(self, payload)` (line 344): no docstring
    - `_span_attributes(self, msg, payload, registry_key)` (line 347): no docstring
    - `_metric_event_name(self, payload)` (line 368): no docstring
    - `async _on_parse_error(self, msg, raw_payload, error)` (line 371): no docstring
    - `async _on_retry_scheduled(self, payload, error, attempt_count, backoff_s, retryable)` (line 402): no docstring
    - `async _on_terminal_failure(self, payload, error, attempt_count, retryable)` (line 418): no docstring
    - `_is_retryable_error(exc, payload)` (line 434): no docstring
    - `async _publish_to_dlq(self, msg, stage, error, attempt_count, payload_text, payload_obj, kafka_headers, fallback_metadata)` (line 443): no docstring
    - `async _send_to_dlq(self, msg, error, attempt_count, payload, raw_payload, stage, payload_text, payload_obj, kafka_headers, fallback_metadata)` (line 471): no docstring
    - `async run(self)` (line 502): no docstring
    - `async _enforce_permission(self, db_name, submitted_by, submitted_by_type, action_spec)` (line 506): no docstring
    - `async _check_writeback_dataset_acl_alignment(self, db_name, submitted_by, submitted_by_type, actor_role, ontology_commit_id, resources, class_ids)` (line 538): no docstring
    - `async _execute_action(self, db_name, action_log_id, command, envelope)` (line 765): no docstring
    - `_audit_result(self, audit_policy, payload)` (line 898): no docstring
    - `async _prepare_pending_input(self, action_log_id, command, log_rec, spec, audit_policy)` (line 926): no docstring
    - `_is_public_identifier(value)` (line 1003): no docstring
    - `async _execute_action_pending(self, db_name, action_log_id, command, log_rec, spec, resources, action_type_id, action_type_rid, ontology_commit_id, submitted_by, submitted_by_type, actor_role, permission_profile, audit_policy, repo, branch)` (line 1007): no docstring
    - `_extract_submission_targets(self, log_rec)` (line 1121): no docstring
    - `async _build_pending_loaded_targets(self, db_name, action_log_id, audit_policy, resources, ontology_commit_id, spec, compiled_shape, implementation, input_payload, submitted_by, actor_role, base_branch, get_object_type_meta, submission_targets)` (line 1136): no docstring
    - `async _enforce_pending_target_access(self, db_name, action_log_id, audit_policy, permission_profile, submitted_by, submitted_by_type, actor_role, loaded_targets)` (line 1303): no docstring
    - `async _reject_action(self, action_log_id, audit_policy, error_key, message, extra, cause)` (line 1410): no docstring
    - `_build_target_meta(loaded_targets)` (line 1434): no docstring
    - `_build_rule_base_vars(submitted_by, actor_role, input_payload, target_docs_list, target_meta, db_name, base_branch)` (line 1445): no docstring
    - `_resolve_input_ref_target(value, loaded_targets)` (line 1466): no docstring
    - `_inject_submission_input_vars(self, criteria_vars, input_payload, loaded_targets)` (line 1486): no docstring
    - `_inject_submission_class_vars(self, criteria_vars, loaded_targets)` (line 1499): no docstring
    - `_build_submission_criteria_vars(self, submitted_by, actor_role, input_payload, loaded_targets, db_name, base_branch, target_meta)` (line 1520): no docstring
    - `async _ensure_submission_actor_for_criteria(self, action_log_id, audit_policy, submission_criteria, submitted_by, target_meta)` (line 1549): no docstring
    - `async _evaluate_submission_criteria(self, action_log_id, audit_policy, submission_criteria, criteria_vars, target_meta)` (line 1568): no docstring
    - `async _reject_submission_criteria_failed(self, action_log_id, audit_policy, submission_criteria, actor_role, target_meta)` (line 1589): no docstring
    - `async _prepare_submission_criteria_context(self, action_log_id, audit_policy, submission_criteria, submitted_by, actor_role, input_payload, loaded_targets, db_name, base_branch)` (line 1614): no docstring
    - `async _enforce_submission_criteria(self, action_log_id, audit_policy, submission_criteria, submitted_by, actor_role, input_payload, loaded_targets, db_name, base_branch)` (line 1646): no docstring
    - `async _reject_validation_rule(self, action_log_id, audit_policy, error_key, message, rule_index, scope, expr, target, cause)` (line 1691): no docstring
    - `async _parse_validation_rule(self, action_log_id, audit_policy, rule, rule_idx)` (line 1720): no docstring
    - `async _enforce_action_scope_validation_rule(self, action_log_id, audit_policy, base_vars, rule_idx, scope, expr, message)` (line 1758): no docstring
    - `async _enforce_each_target_validation_rule(self, action_log_id, audit_policy, base_vars, target_docs_list, target_meta, rule_idx, scope, expr, message)` (line 1794): no docstring
    - `async _normalize_validation_rules(self, action_log_id, audit_policy, validation_rules)` (line 1838): no docstring
    - `_build_validation_rule_context(self, submitted_by, actor_role, input_payload, loaded_targets, db_name, base_branch)` (line 1856): no docstring
    - `async _enforce_single_validation_rule(self, action_log_id, audit_policy, rule, rule_idx, base_vars, target_docs_list, target_meta)` (line 1879): no docstring
    - `async _enforce_validation_rules(self, action_log_id, audit_policy, validation_rules, submitted_by, actor_role, input_payload, loaded_targets, db_name, base_branch)` (line 1929): no docstring
    - `async _enforce_submission_and_validation_rules(self, action_log_id, audit_policy, spec, submitted_by, actor_role, input_payload, loaded_targets, db_name, base_branch)` (line 1970): no docstring
    - `async _build_and_commit_pending_patchset(self, db_name, action_log_id, action_type_id, action_type_rid, ontology_commit_id, action_conflict_policy, get_object_type_meta, loaded_targets, log_rec, audit_policy, repo, branch)` (line 2008): no docstring
    - `async _emit_action_applied_if_needed(self, db_name, action_log_id, command, writeback_target, patchset_commit_id, ontology_commit_id, branch)` (line 2157): no docstring
    - `async _mark_action_succeeded(self, action_log_id, audit_policy, patchset_commit_id, action_applied_event_id, action_applied_seq)` (line 2214): no docstring
    - `_dependency_is_satisfied(trigger_on, parent_status)` (line 2236): Returns (satisfied, impossible).
    - `async _emit_deferred_action_command(self, log_rec, triggered_by_action_log_id)` (line 2267): no docstring
    - `async _trigger_dependent_actions(self, db_name, parent_action_log_id)` (line 2326): no docstring
    - `async _ensure_branch(self, repository, branch)` (line 2417): no docstring
    - `async _write_patchset_commit(self, repository, branch, action_log_id, patchset, metadata_doc)` (line 2420): no docstring
    - `async _append_queue_entries(self, repository, branch, patchset_commit_id, action_log_id, action_applied_seq)` (line 2473): no docstring
...
- **Functions**
  ...
  - `_normalize_error_code(value)` (line 73): no docstring
  - `_extract_error_message(payload)` (line 85): no docstring
  - `_compute_tool_run_id(run_id, step_id, step_index, attempt)` (line 117): Deterministic-ish tool run id for observability.
  - `_extract_retry_after_ms(headers)` (line 131): no docstring
  - `_is_agent_proxy_path(path)` (line 156): no docstring
  - `_resolve_template_token(token, context)` (line 161): no docstring
  - `_resolve_template_string(value, context)` (line 205): no docstring
  - `_resolve_templates(obj, context)` (line 230): no docstring
  - `_artifact_value_from_response(payload)` (line 242): Choose the most useful artifact value from a tool response payload.
  - `_compact_tool_payload(payload)` (line 256): Best-effort compaction for large tool payloads.
  - `_compact_artifact_value(obj, depth)` (line 284): no docstring
  - `_walk_json_for_key(obj, wanted_keys, max_depth, max_nodes)` (line 309): no docstring
  - `_coerce_scalar(value)` (line 337): no docstring
  - `_extract_step_outputs(payload)` (line 347): no docstring
  - `_extract_scope(context)` (line 365): no docstring
  - `_normalize_status(value)` (line 385): no docstring
  - `_extract_command_id_from_url(url)` (line 392): no docstring
  - `_extract_command_id(payload)` (line 399): no docstring
  - `_extract_command_status(payload)` (line 425): no docstring
  - `_extract_pipeline_job_id(payload)` (line 444): no docstring
  - `_extract_pipeline_id(payload)` (line 460): no docstring
  - `_extract_pipeline_id_from_path(path)` (line 476): no docstring
  - `_extract_status_url(payload)` (line 483): no docstring
  - `_extract_progress(payload)` (line 497): no docstring
  - `_method_is_write(method)` (line 541): no docstring
  - `_tool_call_expects_pipeline_job(tool_id, path)` (line 545): no docstring
  - `_extract_overlay_status(payload)` (line 555): no docstring
  - `_extract_enterprise_external_code(payload)` (line 580): no docstring
  - `_iter_error_candidates(payload)` (line 592): no docstring
  - `_extract_error_key(payload)` (line 603): no docstring
  - `_extract_enterprise(payload)` (line 616): no docstring
  - `_extract_api_code(payload)` (line 624): no docstring
  - `_extract_api_category(payload)` (line 632): no docstring
  - `_extract_retryable(payload)` (line 640): no docstring
  - `_extract_action_log_signals(payload)` (line 653): no docstring
  - `_extract_action_simulation_signals(payload)` (line 674): Extract minimal, policy-relevant signals from ActionSimulation responses.
...
- **Classes**
  ...
  - `AgentRuntime` (line 802): no docstring
    ...
    - `_forward_headers(self, headers, actor)` (line 873): no docstring
    - `_resolve_status_url(self, command_id, payload)` (line 918): no docstring
    - `_resolve_ws_token(self, request_headers)` (line 928): no docstring
    - `_resolve_ws_url(self, command_id, token)` (line 944): no docstring
    - `_update_progress_context(self, context, command_id, status, progress_payload)` (line 957): no docstring
    - `async _fetch_command_status(self, status_url, actor, request_headers)` (line 976): no docstring
    - `async _wait_for_command_completion(self, run_id, actor, step_index, attempt, command_id, initial_payload, request_id, request_headers, context)` (line 998): no docstring
    - `_update_pipeline_progress_context(self, context, pipeline_id, job_id, status, run_payload)` (line 1137): no docstring
    - `async _fetch_pipeline_runs(self, pipeline_id, actor, request_headers, limit)` (line 1161): no docstring
    - `async _wait_for_pipeline_run_completion(self, run_id, actor, step_index, attempt, pipeline_id, job_id, initial_payload, request_id, request_headers, context)` (line 1188): no docstring
    - `async record_event(self, event_type, run_id, actor, status, data, request_id, step_index, resource_type, resource_id, error)` (line 1298): no docstring
    - `async execute_tool_call(self, run_id, actor, step_index, attempt, tool_call, context, dry_run, request_headers, request_id)` (line 1348): no docstring
...
- **Classes**
  ...
  - `FoundryQueryService` (line 115): OMS client wrapper for Foundry-style ontology/query operations.
    - `__init__(self, oms_client)` (line 120): Initialize with OMS client dependency
    - `async list_databases(self)` (line 130): 데이터베이스 목록 조회
    - `async create_database(self, db_name, description)` (line 141): 데이터베이스 생성
    - `async delete_database(self, db_name, expected_seq)` (line 146): 데이터베이스 삭제
    - `async get_database_info(self, db_name)` (line 151): 데이터베이스 정보 조회
...
### `backend/bff/main.py`
- **Functions**
  - `async lifespan(app)` (line 614): Modern application lifecycle management
  - `async get_oms_client()` (line 860): Get OMS client from BFF container
  - `async get_label_mapper()` (line 871): Get label mapper from BFF container
  - `async get_google_sheets_service()` (line 882): Get Google Sheets service from BFF container
  - `async get_connector_registry()` (line 893): Get ConnectorRegistry from BFF container
  - `async get_dataset_registry()` (line 904): Get DatasetRegistry from BFF container
  - `async get_dataset_profile_registry()` (line 915): Get DatasetProfileRegistry from BFF container
  - `async get_pipeline_registry()` (line 926): Get PipelineRegistry from BFF container
  - `async get_pipeline_plan_registry()` (line 944): Get PipelinePlanRegistry from BFF container
  - `async get_objectify_registry()` (line 955): no docstring
  - `async get_agent_registry()` (line 960): no docstring
  - `async get_agent_session_registry()` (line 966): no docstring
  - `async get_agent_policy_registry()` (line 972): no docstring
  - `async get_pipeline_executor()` (line 978): Get PipelineExecutor from BFF container
- **Classes**
  - `BFFServiceContainer` (line 128): BFF-specific service container to manage BFF services
    - `__init__(self, container, settings)` (line 136): no docstring
    - `async initialize_bff_services(self)` (line 141): Initialize BFF-specific services
    - `async _initialize_oms_client(self)` (line 195): Initialize OMS client with health check
    - `async _initialize_label_mapper(self)` (line 216): Initialize label mapper
    - `async _initialize_websocket_service(self)` (line 226): Initialize WebSocket notification service
    - `async _initialize_rate_limiter(self)` (line 248): Initialize rate limiting service
    - `async _initialize_connector_registry(self)` (line 252): Initialize Postgres-backed connector registry.
    - `async _initialize_dataset_registry(self)` (line 264): Initialize Postgres-backed dataset registry.
    - `async _initialize_dataset_profile_registry(self)` (line 275): Initialize Postgres-backed dataset profile registry.
    - `async _initialize_pipeline_registry(self)` (line 286): Initialize Postgres-backed pipeline registry.
    - `async _initialize_pipeline_plan_registry(self)` (line 297): Initialize Postgres-backed pipeline plan registry.
    - `async _initialize_objectify_registry(self)` (line 308): Initialize Postgres-backed objectify registry.
    - `async _initialize_agent_registry(self)` (line 319): Initialize Postgres-backed agent registry.
    - `async _initialize_agent_session_registry(self)` (line 330): Initialize Postgres-backed agent session registry.
    - `async _initialize_agent_policy_registry(self)` (line 341): Initialize Postgres-backed agent policy registry.
    - `async _initialize_agent_tool_registry(self)` (line 352): Initialize Postgres-backed agent tool registry (internal allowlist/policy).
    - `async _initialize_pipeline_executor(self)` (line 371): Initialize pipeline executor (preview/build engine).
    - `async _initialize_google_sheets_service(self)` (line 389): Initialize Google Sheets service (connector library)
    - `async shutdown_bff_services(self)` (line 408): Shutdown BFF-specific services
    - `get_oms_client(self)` (line 524): Get OMS client instance
    - `get_label_mapper(self)` (line 530): Get label mapper instance
    - `get_google_sheets_service(self)` (line 536): Get Google Sheets service instance
    - `get_connector_registry(self)` (line 542): Get connector registry instance
    - `get_dataset_registry(self)` (line 548): Get dataset registry instance
    - `get_dataset_profile_registry(self)` (line 554): Get dataset profile registry instance
    - `get_pipeline_registry(self)` (line 560): Get pipeline registry instance
    - `get_pipeline_plan_registry(self)` (line 566): Get pipeline plan registry instance
    - `get_objectify_registry(self)` (line 572): Get objectify registry instance
    - `get_agent_registry(self)` (line 578): Get agent registry instance
    - `get_agent_session_registry(self)` (line 584): Get agent session registry instance
    - `get_agent_policy_registry(self)` (line 590): Get agent policy registry instance
    - `get_agent_tool_registry(self)` (line 596): Get agent tool registry instance
    - `get_pipeline_executor(self)` (line 602): Get pipeline executor instance

### `backend/bff/middleware/__init__.py`

### `backend/bff/middleware/auth.py`
- **Functions**
  - `_attach_pytest_scoped_principal(request)` (line 66): no docstring
  - `_dev_master_auth_enabled()` (line 94): no docstring
  - `_attach_dev_master_principal(request)` (line 102): no docstring
  - `_attach_admin_token_principal(request)` (line 119): no docstring
  - `_approx_token_count(payload)` (line 136): no docstring
  - `_resolve_agent_tool_run_id(request)` (line 140): no docstring
  - `_error_response(request, status_code, message, code, category, detail, context, headers)` (line 149): no docstring
  - `_internal_error_payload(request, message, detail)` (line 181): no docstring
  - `_set_scope_header(request, name, value)` (line 203): Attach a trusted header into the ASGI scope so downstream code that still
  - `_attach_verified_principal(request, principal)` (line 218): no docstring
  - `_compile_agent_tool_path(pattern)` (line 236): no docstring
  - `_path_matches_tool_policy(policy, request_path)` (line 250): no docstring
  - `_compile_agent_tool_path_params(pattern)` (line 257): no docstring
  - `_extract_agent_tool_path_params(policy, request_path)` (line 286): no docstring
  - `_resolve_agent_tool_id(request)` (line 296): no docstring
  - `async _capture_agent_tool_request(request)` (line 301): no docstring
  - `async _maybe_start_session_tool_call(request)` (line 333): no docstring
  - `async _finalize_session_tool_call(request, response, terminal_status)` (line 420): no docstring
  - `_resolve_agent_tool_registry(request)` (line 501): no docstring
  - `_resolve_agent_session_registry(request)` (line 512): no docstring
  - `_resolve_agent_policy_registry(request)` (line 523): no docstring
  - `_resolve_agent_registry(request)` (line 534): no docstring
  - `async _get_cached_tenant_policy(request, tenant_id)` (line 545): no docstring
  - `async _enforce_internal_agent_tool_policy(request)` (line 559): no docstring
  - `async _compute_agent_tool_idempotency_digest(request, tool_id)` (line 854): no docstring
  - `async _wait_for_tool_idempotency(registry, tenant_id, idempotency_key, timeout_s, interval_s)` (line 886): no docstring
  - `async _maybe_replay_or_start_tool_idempotency(request)` (line 907): no docstring
  - `async _finalize_tool_idempotency(request, response)` (line 1019): no docstring
  - `async _finalize_tool_idempotency_error(request, exc)` (line 1088): no docstring
  - `ensure_bff_auth_configured()` (line 1113): no docstring
  - `async _bff_auth_handle_missing_token(request, call_next, ctx)` (line 1149): no docstring
  - `async _bff_auth_handle_agent_token(request, call_next, ctx)` (line 1165): no docstring
  - `async _bff_auth_handle_expected_token(request, call_next, ctx)` (line 1285): no docstring
  - `async _bff_auth_handle_user_jwt(request, call_next, ctx)` (line 1360): no docstring
  - `async _bff_auth_handle_no_token_configured(request, call_next, ctx)` (line 1383): no docstring
  - `async _bff_auth_handle_invalid_credentials(request, call_next, ctx)` (line 1397): no docstring
  - `install_bff_auth_middleware(app)` (line 1409): no docstring
  - `async enforce_bff_websocket_auth(websocket, token)` (line 1448): no docstring
- **Classes**
  - `_BffAuthContext` (line 1140): no docstring
...
- **Functions**
  ...
  - `async require_admin_strict(request)` (line 56): Strict admin guard for sensitive endpoints.
...
- **Functions**
  - `_normalize_audit_status_filter(raw_value)` (line 23): no docstring
  - `async list_audit_logs(partition_key, action, status_filter, resource_type, resource_id, event_id, command_id, actor, since, until, limit, offset, audit_store)` (line 34): no docstring
  - `async get_chain_head(partition_key, audit_store)` (line 82): no docstring
...
- **Functions**
  - `async get_google_sheets_service()` (line 27): Import here to avoid circular dependency.
  - `async get_connector_registry()` (line 34): Import here to avoid circular dependency.
  - `async get_connector_adapter_factory(google_sheets_service)` (line 41): no docstring
...
- **Functions**
  ...
  - `async _resolve_optional_access_token(connector_registry, connection_id)` (line 93): no docstring
...
- **Functions**
  - `_foundry_error(status_code, error_code, error_name, parameters)` (line 126): no docstring
  - `_connection_id_from_rid(connection_rid)` (line 141): no docstring
  - `_connection_rid(connection_id)` (line 154): no docstring
  - `_table_import_id_from_rid(table_import_rid)` (line 158): no docstring
  - `_table_import_rid(table_import_id)` (line 171): no docstring
  - `_file_import_id_from_rid(file_import_rid)` (line 175): no docstring
  - `_file_import_rid(file_import_id)` (line 188): no docstring
  - `_virtual_table_id_from_rid(virtual_table_rid)` (line 192): no docstring
  - `_virtual_table_rid(virtual_table_id)` (line 205): no docstring
  - `_dataset_id_from_rid(dataset_rid)` (line 209): no docstring
  - `_dataset_id_from_any(raw)` (line 222): no docstring
  - `_dataset_rid(dataset_id)` (line 231): no docstring
  - `_export_run_rid(run_id)` (line 235): no docstring
  - `_export_run_id_from_rid(export_run_rid)` (line 239): no docstring
  - `_coerce_bool(raw, default)` (line 252): no docstring
  - `_normalize_export_run_method(raw)` (line 265): no docstring
  - `_normalize_export_run_headers(raw)` (line 272): no docstring
  - `_normalize_export_run_timeout_seconds(raw)` (line 287): no docstring
  - `_is_valid_http_url(raw)` (line 296): no docstring
  - `_task_status_to_export_status(task_status)` (line 301): no docstring
  - `_export_run_response_from_task(connection_id, task)` (line 313): no docstring
  - `async _run_connection_export(task_id, connection_id, connection_rid, target_url, method, request_headers, payload, timeout_seconds, dry_run, actor, audit_store)` (line 351): no docstring
  - `_table_import_pipeline_id(connection_id, source_type, source_id)` (line 456): no docstring
  - `_table_import_build_job_id(pipeline_id)` (line 460): no docstring
  - `_file_import_pipeline_id(connection_id, source_type, source_id)` (line 464): no docstring
  - `_virtual_table_pipeline_id(connection_id, source_type, source_id)` (line 468): no docstring
  - `_parse_allowlist(raw)` (line 472): no docstring
  - `_is_flag_or_allowlist_enabled(global_enabled, allowlist_raw, db_name)` (line 476): no docstring
  - `_feature_flags_settings()` (line 485): no docstring
  - `_jdbc_enabled_for_db(db_name)` (line 494): no docstring
  - `_cdc_enabled_for_db(db_name)` (line 503): no docstring
  - `_requires_cdc_feature(import_mode)` (line 512): no docstring
  - `_connection_source_types()` (line 516): no docstring
  - `_table_import_source_types()` (line 520): no docstring
  - `_file_import_source_types()` (line 524): no docstring
  - `_virtual_table_source_types()` (line 528): no docstring
  - `_connection_kind_from_source(source)` (line 532): no docstring
  - `_require_preview_or_400(preview)` (line 547): no docstring
  - `_default_export_settings()` (line 558): no docstring
  - `_normalize_export_settings(value)` (line 565): no docstring
  - `_normalize_markings(value)` (line 593): no docstring
  - `_normalize_jdbc_driver_file_name(file_name)` (line 610): no docstring
  - `_upsert_custom_jdbc_driver_metadata(config_json, file_name, sha256_hex, size_bytes, repository, object_key)` (line 625): no docstring
  - `_public_custom_jdbc_driver_metadata(config)` (line 658): no docstring
  - `_extract_connection_configuration(payload)` (line 684): no docstring
  - `_display_name_from_payload(payload, fallback)` (line 692): no docstring
  - `_validate_parent_rid_matches_connection(payload, connection_id)` (line 696): no docstring
  - `_resolve_table_import_config(payload, connector_kind, sheet_url, worksheet_name)` (line 715): no docstring
  - `_resolve_file_import_config(payload, connector_kind)` (line 742): no docstring
  - `_resolve_virtual_table_config(payload, connector_kind)` (line 772): no docstring
  - `_extract_destination(payload)` (line 796): no docstring
  - `_resource_invalid_config_response(resource_kind, message)` (line 828): no docstring
  - `_resource_import_mode_from_source(source_cfg, resource_kind)` (line 841): no docstring
  - `_safe_import_mode(raw_mode)` (line 847): no docstring
  - `_resource_import_config_from_source(source_cfg, resource_kind)` (line 854): no docstring
  - `async _resolve_dataset_context(payload, dataset_registry)` (line 864): no docstring
  - `async _load_connection_source(connector_registry, connection_id)` (line 887): no docstring
  - `async _load_connection_source_or_404(connector_registry, connection_rid)` (line 899): no docstring
  - `async _load_table_import_source(connector_registry, connection_id, table_import_id)` (line 923): no docstring
  - `async _load_file_import_source(connector_registry, connection_id, file_import_id)` (line 942): no docstring
  - `async _load_virtual_table_source(connector_registry, connection_id, virtual_table_id)` (line 961): no docstring
  - `async _resolve_output_dataset_rid(source, mapping, dataset_registry)` (line 980): no docstring
  - `async _build_table_import_response(connection_id, source, mapping, dataset_registry)` (line 1010): no docstring
  - `async _build_file_import_response(connection_id, source, mapping, dataset_registry)` (line 1054): no docstring
  - `async _build_virtual_table_response(connection_id, source, mapping, dataset_registry)` (line 1098): no docstring
  - `async _connection_configuration(source, connector_adapter_factory)` (line 1138): no docstring
  - `async _connection_response(source, connector_adapter_factory)` (line 1154): no docstring
  - `_iso_timestamp(value)` (line 1200): no docstring
  - `_normalize_connection_config_for_storage(configuration, kind)` (line 1208): no docstring
  - `_extract_secrets_from_configuration(configuration, kind)` (line 1230): no docstring
  - `_extract_secrets_from_payload(payload, kind)` (line 1242): no docstring
  - `_build_execute_run_output(connection_rid, resource_rid, branch_name, requested_by, resource_field, result_payload, error_detail)` (line 1260): no docstring
  - `_validated_execute_result_payload(result_payload, resource_kind)` (line 1288): no docstring
  - `async _record_execute_failure_run(pipeline_registry, pipeline_id, job_id, connection_rid, resource_rid, branch_name, requested_by, error_detail, resource_field, started_at)` (line 1301): no docstring
  - `async _ensure_table_import_pipeline(pipeline_registry, connection_id, source, mapping)` (line 1337): no docstring
  - `async _ensure_file_import_pipeline(pipeline_registry, connection_id, source, mapping)` (line 1369): no docstring
  - `async _ensure_virtual_table_pipeline(pipeline_registry, connection_id, source, mapping)` (line 1401): no docstring
  - `async create_table_import_v2(connectionRid, payload, request, preview, google_sheets_service, connector_registry, dataset_registry, _, lineage_store)` (line 1435): no docstring
  - `async get_table_import_v2(connectionRid, tableImportRid, preview, connector_registry, dataset_registry, _)` (line 1668): no docstring
  - `async list_table_imports_v2(connectionRid, preview, pageSize, pageToken, connector_registry, dataset_registry, _)` (line 1720): no docstring
  - `async replace_table_import_v2(connectionRid, tableImportRid, payload, preview, connector_registry, dataset_registry, _)` (line 1821): no docstring
  - `async delete_table_import_v2(connectionRid, tableImportRid, preview, connector_registry, _)` (line 1969): no docstring
  - `async execute_table_import_v2(connectionRid, tableImportRid, request, preview, google_sheets_service, connector_adapter_factory, connector_registry, pipeline_registry, dataset_registry, objectify_registry, objectify_job_queue, _)` (line 2026): no docstring
  - `async create_file_import_v2(connectionRid, payload, preview, connector_registry, dataset_registry, _)` (line 2215): no docstring
  - `async get_file_import_v2(connectionRid, fileImportRid, preview, connector_registry, dataset_registry, _)` (line 2348): no docstring
  - `async list_file_imports_v2(connectionRid, preview, pageSize, pageToken, connector_registry, dataset_registry, _)` (line 2401): no docstring
  - `async replace_file_import_v2(connectionRid, fileImportRid, payload, preview, connector_registry, dataset_registry, _)` (line 2489): no docstring
  - `async delete_file_import_v2(connectionRid, fileImportRid, preview, connector_registry, _)` (line 2627): no docstring
  - `async execute_file_import_v2(connectionRid, fileImportRid, request, preview, google_sheets_service, connector_adapter_factory, connector_registry, pipeline_registry, dataset_registry, objectify_registry, objectify_job_queue, _)` (line 2680): no docstring
  - `async execute_virtual_table_v2(connectionRid, virtualTableRid, request, preview, google_sheets_service, connector_adapter_factory, connector_registry, pipeline_registry, dataset_registry, objectify_registry, objectify_job_queue, _)` (line 2871): no docstring
  - `async create_virtual_table_v2(connectionRid, payload, preview, connector_registry, dataset_registry, _)` (line 3055): no docstring
  - `async get_virtual_table_v2(connectionRid, virtualTableRid, preview, connector_registry, dataset_registry, _)` (line 3177): no docstring
  - `async list_virtual_tables_v2(connectionRid, preview, pageSize, pageToken, connector_registry, dataset_registry, _)` (line 3229): no docstring
  - `async replace_virtual_table_v2(connectionRid, virtualTableRid, payload, preview, connector_registry, dataset_registry, _)` (line 3317): no docstring
  - `async delete_virtual_table_v2(connectionRid, virtualTableRid, preview, connector_registry, _)` (line 3442): no docstring
  - `async create_connection_v2(payload, request, preview, connector_registry, connector_adapter_factory, _)` (line 3495): no docstring
  - `async get_connection_v2(connectionRid, preview, connector_registry, connector_adapter_factory, _)` (line 3592): no docstring
  - `async list_connections_v2(request, preview, pageSize, pageToken, connector_registry, connector_adapter_factory, _)` (line 3616): no docstring
  - `async delete_connection_v2(connectionRid, preview, connector_registry, _)` (line 3664): no docstring
  - `async test_connection_v2(connectionRid, preview, connector_registry, connector_adapter_factory, _)` (line 3700): no docstring
  - `async get_connection_configuration_v2(connectionRid, preview, connector_registry, connector_adapter_factory, _)` (line 3760): no docstring
  - `async get_connection_configuration_batch_v2(payload, preview, connector_registry, connector_adapter_factory, _)` (line 3793): no docstring
  - `async update_connection_secrets_v2(connectionRid, payload, preview, connector_registry, _)` (line 3844): no docstring
  - `async update_connection_export_settings_v2(connectionRid, payload, preview, connector_registry, _)` (line 3890): no docstring
  - `async create_connection_export_run_v2(connectionRid, payload, request, task_manager, audit_store, preview, connector_registry, _)` (line 3928): no docstring
  - `async get_connection_export_run_v2(connectionRid, exportRunRid, task_manager, preview, connector_registry, _)` (line 4045): no docstring
  - `async list_connection_export_runs_v2(connectionRid, task_manager, preview, pageSize, pageToken, connector_registry, _)` (line 4097): no docstring
  - `async upload_custom_jdbc_drivers_v2(connectionRid, request, driverBytes, fileName, preview, connector_registry, connector_adapter_factory, pipeline_registry, _)` (line 4157): no docstring

### `backend/bff/routers/foundry_datasets_v2.py`
- **Functions**
  - `_dataset_id_from_rid(dataset_rid)` (line 90): no docstring
  - `_dataset_rid(dataset_id)` (line 103): no docstring
  - `_folder_rid(db_name)` (line 107): no docstring
  - `_db_name_from_folder_rid(folder_rid)` (line 111): no docstring
  - `_transaction_rid(transaction_id)` (line 124): no docstring
  - `_transaction_id_from_rid(txn_rid)` (line 128): no docstring
  - `_file_rid(dataset_id, file_path)` (line 141): no docstring
  - `_dataset_response(dataset)` (line 151): no docstring
  - `_schema_response(schema_json)` (line 159): no docstring
  - `_branch_response(branch_name, dataset_rid, commit_id)` (line 173): no docstring
  - `_transaction_response(txn)` (line 187): no docstring
  - `_map_txn_status(raw)` (line 200): no docstring
  - `_dataset_object_prefix(dataset)` (line 209): no docstring
  - `_normalize_dataset_object_key(dataset, object_key)` (line 213): no docstring
  - `_artifact_s3_uri(repository, branch, object_key)` (line 235): no docstring
  - `_normalized_csv_headers(raw_headers)` (line 243): no docstring
  - `_build_csv_sample_and_schema(csv_bytes)` (line 258): no docstring
  - `_default_sample_and_schema(dataset)` (line 285): no docstring
  - `async _extract_commit_preview(dataset, branch, repository, lakefs_client, lakefs_storage_service)` (line 294): no docstring
  - `async create_dataset_v2(request, dataset_registry, _)` (line 349): POST /v2/datasets — Create a new dataset.
  - `async get_dataset_v2(datasetRid, dataset_registry, _)` (line 425): GET /v2/datasets/{datasetRid} — Get a dataset.
  - `async get_dataset_schema_v2(datasetRid, preview, branchName, endTransactionRid, versionId, dataset_registry, _)` (line 463): GET /v2/datasets/{datasetRid}/getSchema — Get dataset schema (preview).
  - `async put_dataset_schema_v2(datasetRid, request, preview, branchName, dataset_registry, _)` (line 542): PUT /v2/datasets/{datasetRid}/putSchema — Put dataset schema (preview).
  - `async get_schema_batch_v2(request, preview, dataset_registry, _)` (line 641): POST /v2/datasets/getSchemaBatch — Get dataset schemas batch (preview).
  - `async _get_lakefs_client(pipeline_registry, request)` (line 713): no docstring
  - `async _get_lakefs_storage(pipeline_registry, request)` (line 718): no docstring
  - `async list_branches_v2(datasetRid, request, pageSize, pageToken, dataset_registry, pipeline_registry, _)` (line 728): GET /v2/datasets/{datasetRid}/branches — List branches.
  - `async create_branch_v2(datasetRid, request, dataset_registry, pipeline_registry, _)` (line 807): POST /v2/datasets/{datasetRid}/branches — Create branch.
  - `async get_branch_v2(datasetRid, branchName, request, dataset_registry, pipeline_registry, _)` (line 912): GET /v2/datasets/{datasetRid}/branches/{branchName} — Get branch.
  - `async delete_branch_v2(datasetRid, branchName, request, dataset_registry, pipeline_registry, _)` (line 977): DELETE /v2/datasets/{datasetRid}/branches/{branchName} — Delete branch.
  - `async create_transaction_v2(datasetRid, request, branchName, dataset_registry, _)` (line 1057): POST /v2/datasets/{datasetRid}/transactions — Create a transaction.
  - `async list_transactions_v2(datasetRid, preview, branchName, pageSize, pageToken, dataset_registry, _)` (line 1156): GET /v2/datasets/{datasetRid}/transactions — List transactions.
  - `async get_transaction_v2(datasetRid, transactionRid, branchName, dataset_registry, _)` (line 1275): GET /v2/datasets/{datasetRid}/transactions/{transactionRid} — Get transaction.
  - `async commit_transaction_v2(datasetRid, transactionRid, request, dataset_registry, pipeline_registry, _)` (line 1375): POST /v2/datasets/{datasetRid}/transactions/{transactionRid}/commit.
  - `async abort_transaction_v2(datasetRid, transactionRid, dataset_registry, _)` (line 1581): POST /v2/datasets/{datasetRid}/transactions/{transactionRid}/abort.
  - `async list_files_v2(datasetRid, request, branchName, startTransactionRid, endTransactionRid, prefix, pageSize, pageToken, dataset_registry, pipeline_registry, _)` (line 1663): GET /v2/datasets/{datasetRid}/files — List files in dataset.
  - `async get_file_content_v2(datasetRid, filePath, request, branchName, startTransactionRid, endTransactionRid, dataset_registry, pipeline_registry, _)` (line 1803): GET /v2/datasets/{datasetRid}/files/{filePath}/content — Download file.
  - `async upload_file_v2(datasetRid, filePath, request, branchName, transactionRid, byteOffset, dataset_registry, pipeline_registry, _)` (line 1909): POST /v2/datasets/{datasetRid}/files/{filePath}/upload — Upload file.
  - `async get_file_v2(datasetRid, filePath, request, branchName, startTransactionRid, endTransactionRid, dataset_registry, pipeline_registry, _)` (line 2102): GET /v2/datasets/{datasetRid}/files/{filePath} — Get file metadata.
  - `async read_table_v2(datasetRid, request, branchName, startTransactionRid, endTransactionRid, format, columns, rowLimit, dataset_registry, pipeline_registry, _)` (line 2233): GET /v2/datasets/{datasetRid}/readTable — Read table rows.

### `backend/bff/routers/foundry_ontology_v2.py`
- **Functions**
  - `_build_pk_spec_from_v2_payload(pk_spec, primary_key, title_property)` (line 171): no docstring
  - `_build_backing_sources_from_v2_payload(backing_source, backing_sources)` (line 189): no docstring
  - `_extract_api_response_data(payload)` (line 202): no docstring
  - `_service_http_error_response(exc, ontology, object_type)` (line 214): no docstring
  - `_default_expected_head_commit(branch)` (line 245): no docstring
  - `_foundry_error(status_code, error_code, error_name, parameters)` (line 252): no docstring
  - `_passthrough_upstream_error_payload(exc)` (line 267): no docstring
  - `_named_not_found(error_name, parameters)` (line 281): no docstring
  - `_error_parameters(ontology, object_type, link_type, primary_key, linked_primary_key, parameters)` (line 290): no docstring
  - `_not_found_error(error_name, ontology, object_type, link_type, primary_key, linked_primary_key, parameters)` (line 313): no docstring
  - `_permission_denied(ontology, message, parameters)` (line 336): no docstring
  - `_preflight_error_response(exc, ontology, parameters)` (line 353): no docstring
  - `_decode_page_token(page_token, scope)` (line 404): no docstring
  - `_encode_page_token(offset, scope)` (line 412): no docstring
  - `_parse_order_by(order_by)` (line 416): no docstring
  - `_temporary_object_set_rid()` (line 449): no docstring
  - `_prune_expired_temporary_object_sets(now_epoch)` (line 453): no docstring
  - `async _store_temporary_object_set(object_set)` (line 459): no docstring
  - `async _load_temporary_object_set(rid)` (line 468): no docstring
  - `_collect_object_set_object_types(object_set)` (line 485): no docstring
  - `_resolve_object_set_object_type(object_set)` (line 514): no docstring
  - `async _resolve_object_set_definition(object_set)` (line 519): no docstring
  - `_is_search_around_object_set(object_set)` (line 527): no docstring
  - `_extract_search_around_link_type(object_set)` (line 534): no docstring
  - `_dedupe_rows_by_identity(rows)` (line 547): no docstring
  - `_normalize_sort_value(value)` (line 575): no docstring
  - `_sort_rows_by_order_by(rows, order_by)` (line 587): no docstring
  - `async _resolve_search_around_target_primary_keys(oms_client, db_name, branch, object_set)` (line 618): no docstring
  - `async _load_rows_for_search_around_object_set(oms_client, db_name, branch, object_set, payload, endpoint_scope)` (line 717): no docstring
  - `_object_set_runtime_value_error_response(exc, ontology, parameters)` (line 810): no docstring
  - `_extract_object_set_where(object_set)` (line 839): no docstring
  - `_normalize_object_set_order_by(order_by)` (line 859): no docstring
  - `_normalize_select_values(payload)` (line 869): no docstring
  - `_to_int_or_none(value)` (line 888): no docstring
  - `_build_object_set_search_payload(object_set, payload, default_page_size, require_select)` (line 895): no docstring
  - `_get_result_rows(result)` (line 936): no docstring
  - `_get_total_count(result)` (line 943): no docstring
  - `_get_next_page_token(result)` (line 951): no docstring
  - `async _search_object_type_rows(oms_client, db_name, branch, object_type, search_payload)` (line 961): no docstring
  - `_derive_page_size(search_payload)` (line 976): no docstring
  - `_project_row_with_required_fields(row, select_fields, exclude_rid)` (line 983): no docstring
  - `async _load_all_rows_for_object_type(oms_client, db_name, branch, object_type, search_payload)` (line 1009): no docstring
  - `async _load_rows_for_single_object_type(oms_client, db_name, branch, object_type, search_payload)` (line 1058): no docstring
  - `async _load_rows_for_multi_object_types(oms_client, db_name, branch, object_types, search_payload, page_token, pagination_scope)` (line 1079): no docstring
  - `_normalize_link_type_values(payload)` (line 1115): no docstring
  - `_resolve_source_object_type_from_row(row, fallback_object_type)` (line 1138): no docstring
  - `_resolve_source_primary_key_from_row(row, primary_key_field)` (line 1152): no docstring
  - `_build_object_locator(object_type, primary_key)` (line 1169): no docstring
  - `_build_linked_object_locator(link_type, target_object_type, target_primary_key)` (line 1173): no docstring
  - `_collect_load_links_rows(rows, requested_links, link_sides_by_source_type, source_primary_key_fields, default_object_type)` (line 1185): no docstring
  - `_value_by_field(row, field)` (line 1243): no docstring
  - `_pagination_scope(*parts)` (line 1265): no docstring
  - `_is_foundry_v2_strict_compat_enabled(db_name)` (line 1270): no docstring
  - `_rid_component(value, fallback)` (line 1275): no docstring
  - `_default_object_type_rid(db_name, object_type)` (line 1284): no docstring
  - `_default_property_rid(db_name, object_type, property_name)` (line 1289): no docstring
  - `_default_link_type_rid(db_name, source_object_type, link_type)` (line 1296): no docstring
  - `_default_property_contract(db_name, object_type, property_name)` (line 1303): no docstring
  - `_strictify_foundry_object_type(object_type, db_name, object_type_hint)` (line 1310): no docstring
  - `_strictify_outgoing_link_type(link_type_payload, db_name, source_object_type)` (line 1426): no docstring
  - `_strictify_object_type_full_metadata(payload, db_name, object_type_hint)` (line 1468): no docstring
  - `_log_strict_compat_summary(route, db_name, branch, fixes, dropped)` (line 1509): no docstring
  - `_full_metadata_branch_contract(branch)` (line 1529): no docstring
  - `_require_preview_true_for_strict_compat(preview, strict_compat, endpoint)` (line 1533): no docstring
  - `_linked_object_parameters(ontology, object_type, primary_key, link_type, linked_primary_key)` (line 1543): no docstring
  - `_iter_primary_key_values(value)` (line 1560): no docstring
  - `_coerce_primary_key_values(value)` (line 1581): no docstring
  - `_extract_linked_primary_keys(source_row, link_type, foreign_key_property)` (line 1585): no docstring
  - `_iter_linked_primary_keys(source_row, link_type, foreign_key_property)` (line 1605): no docstring
  - `_extract_linked_primary_keys_page(source_row, link_type, foreign_key_property, offset, page_size)` (line 1622): Extract a deduplicated page without materializing every linked PK.
  - `_linked_primary_key_exists(source_row, link_type, foreign_key_property, linked_primary_key)` (line 1662): no docstring
  - `_build_primary_key_where(primary_key_field, primary_key_values)` (line 1686): no docstring
  - `async _resolve_object_primary_key_field(db_name, object_type, branch, oms_client)` (line 1700): no docstring
  - `async _require_domain_role(request, db_name)` (line 1736): no docstring
  - `_extract_actor_forward_headers(request)` (line 1745): no docstring
  - `_validate_ontology_db_name(ontology)` (line 1754): no docstring
  - `_validate_branch(branch)` (line 1758): no docstring
  - `async _resolve_ontology_db_name(ontology, oms_client)` (line 1762): no docstring
  - `_extract_databases(payload)` (line 1793): no docstring
  - `_extract_ontology_resource_rows(payload)` (line 1809): no docstring
  - `_extract_ontology_resource(payload)` (line 1820): no docstring
  - `_localized_text(value)` (line 1830): no docstring
  - `_to_foundry_named_metadata(resource)` (line 1845): no docstring
  - `_to_foundry_named_metadata_map(resources)` (line 1883): no docstring
  - `_dict_or_none(value)` (line 1895): no docstring
  - `_list_or_none(value)` (line 1899): no docstring
  - `_first_non_none(*values)` (line 1903): no docstring
  - `_coerce_optional_bool(value, default)` (line 1910): no docstring
  - `_extract_project_policy_inheritance(permission_policy, spec)` (line 1924): no docstring
  - `_to_foundry_action_type(resource)` (line 1992): no docstring
  - `_to_foundry_action_type_map(resources)` (line 2133): no docstring
  - `_to_foundry_query_type(resource)` (line 2145): no docstring
  - `_to_foundry_query_type_map_key(resource)` (line 2175): no docstring
  - `_to_foundry_query_type_metadata_map(resources)` (line 2188): no docstring
  - `_resolve_query_placeholder_key(value)` (line 2200): no docstring
  - `_materialize_query_execution_value(value, parameters)` (line 2221): no docstring
  - `_resolve_query_execution_object_type(execution, search, spec, metadata)` (line 2246): no docstring
  - `_extract_query_execution_plan(resource)` (line 2268): no docstring
  - `_apply_query_execute_options(base_payload, options)` (line 2315): no docstring
  - `_scoped_error_parameters(ontology, parameters)` (line 2338): no docstring
  - `_normalize_non_foundry_upstream_error(exc, ontology, parameters, action_surface)` (line 2349): no docstring
  - `_upstream_status_error_response(exc, ontology, parameters, not_found_response, passthrough_payload, normalize_non_foundry_payload, action_surface)` (line 2421): no docstring
  - `_upstream_transport_error_response(ontology, parameters)` (line 2455): no docstring
  - `_internal_error_response(log_message, exc, ontology, parameters)` (line 2468): no docstring
  - `async _find_resource_by_rid(db_name, branch, resource_type, rid, oms_client, page_size)` (line 2484): no docstring
  - `_group_outgoing_link_types_by_source(resources)` (line 2510): no docstring
  - `_group_incoming_link_types_by_target(resources)` (line 2526): Group incoming link types by their *target* object type.
  - `_strip_prefix(text, prefixes)` (line 2578): no docstring
  - `_normalize_interface_ref(value)` (line 2589): no docstring
  - `_normalize_shared_property_ref(value)` (line 2596): no docstring
  - `_coerce_string_list(value)` (line 2612): no docstring
  - `_ordered_unique(values)` (line 2639): no docstring
  - `_extract_interface_implementations(resource)` (line 2651): no docstring
  - `_extract_interface_names(resource)` (line 2670): no docstring
  - `_extract_ontology_properties_payload(payload)` (line 2684): no docstring
  - `_extract_shared_property_type_mapping(resource, ontology_payload)` (line 2694): no docstring
  - `_to_foundry_object_type_full_metadata(resource, ontology_payload, link_types)` (line 2730): no docstring
  - `async _list_all_resources_for_type(db_name, branch, resource_type, oms_client, page_size)` (line 2750): no docstring
  - `_looks_like_action_type_resource(resource)` (line 2779): no docstring
  - `async _list_action_type_resources_with_fallback(db_name, branch, oms_client)` (line 2789): no docstring
  - `async _find_action_type_resource_by_id(db_name, branch, action_type, oms_client)` (line 2822): no docstring
  - `async _find_action_type_resource_by_rid(db_name, branch, action_type_rid, oms_client)` (line 2843): no docstring
  - `async _list_resources_best_effort(db_name, branch, resource_type, oms_client)` (line 2864): no docstring
  - `async _list_action_type_resources_best_effort(db_name, branch, oms_client)` (line 2889): no docstring
  - `async _get_ontology_payload_best_effort(db_name, branch, object_type, oms_client)` (line 2911): no docstring
  - `_to_foundry_ontology(row)` (line 2931): no docstring
  - `async list_ontologies_v2(request, oms_client)` (line 2953): no docstring
  - `async get_ontology_v2(ontologyRid, request, oms_client)` (line 2987): no docstring
  - `async get_full_metadata_v2(ontologyRid, request, preview, branch, oms_client)` (line 3032): no docstring
  - `async list_action_types_v2(ontologyRid, request, page_size, page_token, branch, oms_client)` (line 3215): no docstring
  - `async get_action_type_v2(ontologyRid, actionTypeApiName, request, branch, oms_client)` (line 3281): no docstring
  - `async get_action_type_by_rid_v2(ontologyRid, actionTypeRid, request, branch, oms_client)` (line 3368): no docstring
  - `_resolve_apply_action_mode(explicit_mode)` (line 3444): no docstring
  - `_default_action_parameter_results(parameters)` (line 3453): no docstring
  - `_extract_action_audit_log_id(payload, data_payload)` (line 3469): no docstring
  - `_normalize_action_writeback_status(raw_status, audit_log_id, side_effect_delivery)` (line 3485): no docstring
  - `_normalize_apply_action_response_payload(response, request_parameters)` (line 3499): no docstring
  - `async apply_action_v2(ontologyRid, actionApiName, body, request, branch, sdk_package_rid, sdk_version, transaction_id, oms_client)` (line 3571): no docstring
  - `async apply_action_batch_v2(ontologyRid, actionApiName, body, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 3655): no docstring
  - `async list_query_types_v2(ontologyRid, request, page_size, page_token, oms_client)` (line 3736): no docstring
  - `async get_query_type_v2(ontologyRid, queryApiName, request, version, sdk_package_rid, sdk_version, oms_client)` (line 3786): no docstring
  - `async execute_query_v2(ontologyRid, queryApiName, body, request, version, sdk_package_rid, sdk_version, transaction_id, oms_client)` (line 3868): no docstring
  - `async list_interface_types_v2(ontologyRid, request, preview, page_size, page_token, branch, oms_client)` (line 3995): no docstring
  - `async get_interface_type_v2(ontologyRid, interfaceTypeApiName, request, preview, branch, sdk_package_rid, sdk_version, oms_client)` (line 4059): no docstring
  - `async list_shared_property_types_v2(ontologyRid, request, preview, page_size, page_token, branch, oms_client)` (line 4142): no docstring
  - `async get_shared_property_type_v2(ontologyRid, sharedPropertyTypeApiName, request, preview, branch, oms_client)` (line 4206): no docstring
  - `async list_value_types_v2(ontologyRid, request, preview, oms_client)` (line 4286): no docstring
  - `async get_value_type_v2(ontologyRid, valueTypeApiName, request, preview, oms_client)` (line 4341): no docstring
  - `async list_object_types_v2(ontologyRid, request, page_size, page_token, branch, oms_client)` (line 4419): no docstring
  - `async create_object_type_v2(ontologyRid, body, request, branch, expected_head_commit, oms_client, dataset_registry, objectify_registry)` (line 4506): no docstring
  - `async update_object_type_v2(ontologyRid, objectTypeApiName, body, request, branch, expected_head_commit, oms_client, dataset_registry, objectify_registry)` (line 4596): no docstring
  - `async get_object_type_v2(ontologyRid, objectTypeApiName, request, branch, oms_client)` (line 4707): no docstring
  - `async get_object_type_full_metadata_v2(ontologyRid, objectTypeApiName, request, branch, preview, sdk_package_rid, sdk_version, oms_client)` (line 4781): no docstring
  - `async list_outgoing_link_types_v2(ontologyRid, objectTypeApiName, request, page_size, page_token, branch, oms_client)` (line 4899): no docstring
  - `async get_outgoing_link_type_v2(ontologyRid, objectTypeApiName, linkTypeApiName, request, branch, oms_client)` (line 5016): no docstring
  - `async list_incoming_link_types_v2(ontologyRid, objectTypeApiName, request, page_size, page_token, branch, oms_client)` (line 5122): no docstring
  - `async get_incoming_link_type_v2(ontologyRid, objectTypeApiName, linkTypeApiName, request, branch, oms_client)` (line 5239): no docstring
  - `async search_objects_v2(ontologyRid, objectTypeApiName, payload, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 5340): no docstring
  - `async count_objects_v2(ontologyRid, objectTypeApiName, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 5406): no docstring
  - `async aggregate_objects_v2(ontologyRid, objectTypeApiName, payload, request, branch, transaction_id, sdk_package_rid, sdk_version, oms_client)` (line 5469): Delegate aggregation to OMS ES-native aggregate engine.
  - `async load_object_set_objects_v2(ontologyRid, payload, request, branch, transaction_id, sdk_package_rid, sdk_version, oms_client)` (line 5533): no docstring
  - `async load_object_set_links_v2(ontologyRid, payload, request, branch, preview, sdk_package_rid, sdk_version, oms_client)` (line 5632): no docstring
  - `async load_object_set_multiple_object_types_v2(ontologyRid, payload, request, branch, preview, transaction_id, sdk_package_rid, sdk_version, oms_client)` (line 5834): no docstring
  - `async load_object_set_objects_or_interfaces_v2(ontologyRid, payload, request, branch, preview, sdk_package_rid, sdk_version, oms_client)` (line 5966): no docstring
  - `async aggregate_object_set_v2(ontologyRid, payload, request, branch, transaction_id, sdk_package_rid, sdk_version, oms_client)` (line 6091): Delegate objectSet aggregate to OMS ES-native aggregate engine.
  - `async create_temporary_object_set_v2(ontologyRid, payload, request, sdk_package_rid, sdk_version, oms_client)` (line 6173): no docstring
  - `async get_object_set_v2(ontologyRid, objectSetRid, request, oms_client)` (line 6199): no docstring
  - `async list_objects_v2(ontologyRid, objectTypeApiName, request, page_size, page_token, select, order_by, exclude_rid, snapshot, branch, sdk_package_rid, sdk_version, oms_client)` (line 6220): no docstring
  - `async get_object_v2(ontologyRid, objectTypeApiName, primaryKey, request, select, exclude_rid, branch, sdk_package_rid, sdk_version, oms_client)` (line 6304): no docstring
  - `async list_linked_objects_v2(ontologyRid, objectTypeApiName, primaryKey, linkTypeApiName, request, page_size, page_token, select, order_by, exclude_rid, snapshot, branch, sdk_package_rid, sdk_version, oms_client)` (line 6445): no docstring
  - `async get_linked_object_v2(ontologyRid, objectTypeApiName, primaryKey, linkTypeApiName, linkedObjectPrimaryKey, request, select, exclude_rid, branch, sdk_package_rid, sdk_version, oms_client)` (line 6711): no docstring
  - `async get_timeseries_first_point_v2(ontologyRid, objectTypeApiName, primaryKey, property, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 7010): Get the first (earliest) point of a time series property.
  - `async get_timeseries_last_point_v2(ontologyRid, objectTypeApiName, primaryKey, property, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 7068): Get the last (most recent) point of a time series property.
  - `async stream_timeseries_points_v2(ontologyRid, objectTypeApiName, primaryKey, property, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 7127): Stream all points of a time series property with optional range filter.
  - `async upload_attachment_v2(request, filename, sdk_package_rid, sdk_version, oms_client)` (line 7192): Upload an attachment payload (Foundry v2 shape).
  - `async list_attachment_property_v2(ontologyRid, objectTypeApiName, primaryKey, property, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 7228): List attachment metadata for a property (single or multiple).
  - `async get_attachment_by_rid_v2(ontologyRid, objectTypeApiName, primaryKey, property, attachmentRid, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 7286): Get metadata for a specific attachment by its RID.
  - `async get_attachment_content_v2(ontologyRid, objectTypeApiName, primaryKey, property, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 7348): Get the content of a single-valued attachment property.
  - `async get_attachment_content_by_rid_v2(ontologyRid, objectTypeApiName, primaryKey, property, attachmentRid, request, branch, sdk_package_rid, sdk_version, oms_client)` (line 7410): Get the content of an attachment by its RID.
- **Classes**
  - `OntologyNotFoundError` (line 90): no docstring
  - `PermissionDeniedError` (line 94): no docstring
  - `ApiFeaturePreviewUsageOnlyError` (line 98): no docstring
  - `ObjectSetNotFoundError` (line 102): no docstring
  - `ApplyActionRequestOptionsV2` (line 106): no docstring
  - `ApplyActionRequestV2` (line 111): no docstring
  - `BatchApplyActionRequestItemV2` (line 116): no docstring
  - `BatchApplyActionRequestOptionsV2` (line 120): no docstring
  - `BatchApplyActionRequestV2` (line 124): no docstring
  - `ExecuteQueryRequestV2` (line 129): no docstring
  - `ObjectTypeContractCreateRequestV2` (line 134): no docstring
  - `ObjectTypeContractUpdateRequestV2` (line 153): no docstring
...
- **Functions**
  ...
  - `_resolve_create_build_input(payload, request)` (line 225): no docstring
  - `_request_with_internal_idempotency(request)` (line 300): no docstring
  - `_build_response(job_id, run, branch_name, created_by, fallback_branches, retry_count, retry_backoff_duration, abort_on_failure, pipeline)` (line 308): no docstring
  - `async _load_build_run(build_rid, pipeline_registry)` (line 345): no docstring
  - `async create_build_v2(payload, request, audit_store, pipeline_registry, pipeline_job_queue, dataset_registry, oms_client, _)` (line 364): no docstring
  - `async get_build_v2(buildRid, pipeline_registry, _)` (line 451): no docstring
  - `async get_builds_batch_v2(payload, pipeline_registry, _)` (line 498): no docstring
  - `async list_build_jobs_v2(buildRid, pageSize, pageToken, pipeline_registry, _)` (line 549): no docstring
  - `async cancel_build_v2(buildRid, pipeline_registry, _)` (line 603): no docstring
  - `_schedule_rid(pipeline_id)` (line 660): no docstring
  - `_pipeline_id_from_schedule_rid(schedule_rid)` (line 664): no docstring
  - `_schedule_response(pipeline)` (line 677): no docstring
  - `_has_schedule(pipeline)` (line 708): no docstring
  - `async create_schedule_v2(payload, request, pipeline_registry, _)` (line 716): POST /v2/orchestration/schedules — Create a schedule.
  - `async get_schedule_v2(scheduleRid, pipeline_registry, _)` (line 760): GET /v2/orchestration/schedules/{scheduleRid} — Get a schedule.
  - `async delete_schedule_v2(scheduleRid, pipeline_registry, _)` (line 782): DELETE /v2/orchestration/schedules/{scheduleRid} — Remove schedule.
  - `async pause_schedule_v2(scheduleRid, pipeline_registry, _)` (line 811): POST /v2/orchestration/schedules/{scheduleRid}/pause — Pause schedule.
  - `async unpause_schedule_v2(scheduleRid, pipeline_registry, _)` (line 836): POST /v2/orchestration/schedules/{scheduleRid}/unpause — Unpause schedule.
  - `async list_schedule_runs_v2(scheduleRid, pageSize, pageToken, pipeline_registry, _)` (line 861): GET /v2/orchestration/schedules/{scheduleRid}/runs — List schedule runs.
- **Classes**
  - `_ResolvedCreateBuildInput` (line 213): no docstring
...
- **Functions**
  - `async execute_graph_query(db_name, query, request, lineage_store, graph_service, dataset_registry, base_branch, overlay_branch)` (line 38): no docstring
  - `async execute_simple_graph_query(db_name, query, request, graph_service, dataset_registry, base_branch, overlay_branch)` (line 62): no docstring
  - `async execute_multi_hop_query(db_name, query, request, graph_service, dataset_registry, base_branch, overlay_branch)` (line 84): no docstring
  - `async find_relationship_paths(db_name, source_class, target_class, max_depth, graph_service, branch)` (line 106): no docstring
  - `async graph_service_health(graph_service)` (line 126): no docstring
  - `async register_projection(db_name, request, graph_service)` (line 154): no docstring
  - `async query_projection(db_name, request, graph_service)` (line 184): no docstring
  - `async list_projections(db_name, graph_service)` (line 214): no docstring
- **Classes**
  - `ProjectionRegistrationRequest` (line 133): no docstring
  - `ProjectionQueryRequest` (line 141): no docstring
...
- **Functions**
  - `_unwrap_data(payload)` (line 4): no docstring
  - `_extract_resources(payload)` (line 13): no docstring
  - `_normalize_object_ref(raw)` (line 21): no docstring
  - `_localized_text(value)` (line 36): no docstring
  - `_map_cardinality(raw)` (line 51): no docstring
  - `_invert_cardinality(raw)` (line 62): Invert cardinality for the incoming side of a link type.
  - `_to_foundry_outgoing_link_type(resource, source_object_type)` (line 86): no docstring
  - `_to_foundry_incoming_link_type(resource, target_object_type)` (line 135): Map an OMS link-type resource to a Foundry ``LinkTypeSideV2`` for the
...
- **Functions**
  ...
  - `_localized_text(value)` (line 65): no docstring
  - `_extract_ontology_properties(payload)` (line 80): no docstring
  - `_normalize_foundry_data_type(value)` (line 88): no docstring
  - `_to_foundry_data_type(value)` (line 123): no docstring
  - `_to_foundry_object_type(resource, ontology_payload)` (line 130): no docstring
  - `async create_object_type_contract(db_name, body, request, branch, expected_head_commit, oms_client, dataset_registry, objectify_registry)` (line 256): no docstring
  - `async update_object_type_contract(db_name, class_id, body, request, branch, expected_head_commit, oms_client, dataset_registry, objectify_registry)` (line 284): no docstring
...
- **Functions**
  ...
  - `_default_expected_head_commit(branch)` (line 28): no docstring
  - `async list_resources(db_name, request, resource_type, branch, limit, offset, oms_client)` (line 37): no docstring
  - `async list_resources_by_type(db_name, resource_type, request, branch, limit, offset, oms_client)` (line 59): no docstring
  - `async create_resource(db_name, resource_type, payload, request, branch, expected_head_commit, oms_client)` (line 81): no docstring
  - `async get_resource(db_name, resource_type, resource_id, request, branch, oms_client)` (line 103): no docstring
  - `async update_resource(db_name, resource_type, resource_id, payload, request, branch, expected_head_commit, oms_client)` (line 123): no docstring
  - `async delete_resource(db_name, resource_type, resource_id, request, branch, expected_head_commit, oms_client)` (line 147): no docstring
  - `async record_deployment(db_name, payload, request, oms_client)` (line 169): no docstring
...
- **Functions**
  ...
  - `async get_dataset_raw_file(dataset_id, file_name, file_index, request, pipeline_registry, dataset_registry)` (line 55): no docstring
...
- **Functions**
  ...
  - `_build_tabular_analysis_payload(analysis, inferred_schema)` (line 90): no docstring
...
- **Functions**
  - `async list_pipeline_runs(pipeline_id, limit, pipeline_registry, request)` (line 28): no docstring
  - `async list_pipeline_artifacts(pipeline_id, mode, limit, pipeline_registry, request)` (line 89): no docstring
  - `async get_pipeline_artifact(pipeline_id, artifact_id, pipeline_registry, request)` (line 119): no docstring
...
- **Functions**
  - `async get_summary(db, branch, redis_service, es_service)` (line 25): Summarize context + cross-service health for UI.
...
- **Classes**
  ...
  - `ObjectTypeContractUpdate` (line 26): no docstring
...
- **Classes**
  - `TabularAnalysisData` (line 18): no docstring
  - `TabularAnalysisApiResponse` (line 25): no docstring
...
- **Functions**
  - `_normalize_dt(dt)` (line 42): no docstring
  - `_text_with_keyword_field()` (line 48): no docstring
  - `_i18n_text_mapping()` (line 57): no docstring
  - `_fallback_projection_mapping(projection)` (line 67): no docstring
  - `_load_projection_mapping(projection)` (line 159): no docstring
  - `async _ensure_es_connected(es)` (line 175): no docstring
  - `_versioning_kwargs(seq)` (line 180): no docstring
  - `_validate_recompute_projection_mode(projection)` (line 186): no docstring
  - `_normalize_localized_field(value, default_lang)` (line 202): no docstring
  - `_normalize_ontology_properties(properties, default_lang)` (line 217): no docstring
  - `_normalize_ontology_relationships(relationships, default_lang)` (line 251): no docstring
  - `_strategy_for_projection(projection)` (line 523): no docstring
  - `async start_recompute_projection(http_request, request, background_tasks, task_manager, redis_service, audit_store, lineage_store, elasticsearch_service)` (line 532): no docstring
  - `async get_recompute_projection_result(task_id, task_manager, redis_service)` (line 583): no docstring
  - `async _log_audit_safe(audit_store, action, db_name, resource_id, metadata, occurred_at)` (line 616): no docstring
  - `async _maybe_record_lineage(lineage_store, envelope, db_name, branch, index_name, doc_id, seq, event_ts, ontology_ref, ontology_commit)` (line 639): no docstring
  - `async recompute_projection_task(task_id, request, elasticsearch_service, redis_service, audit_store, lineage_store, task_manager, requested_by, request_ip)` (line 673): no docstring
- **Classes**
  - `IndexDecision` (line 297): no docstring
  - `ProjectionStrategy` (line 304): no docstring
    - `event_types(self)` (line 308): no docstring
    - `base_index(self, db_name, branch)` (line 311): no docstring
    - `new_index(self, db_name, branch, version_suffix)` (line 314): no docstring
    - `async decide(self, envelope, data, db_name, branch, new_index, ontology_ref, ontology_commit, seq, event_ts, created_at_cache, elasticsearch_service)` (line 317): no docstring
  - `InstancesProjectionStrategy` (line 335): no docstring
    - `base_index(self, db_name, branch)` (line 339): no docstring
    - `new_index(self, db_name, branch, version_suffix)` (line 342): no docstring
    - `async decide(self, envelope, data, db_name, branch, new_index, ontology_ref, ontology_commit, seq, event_ts, created_at_cache, elasticsearch_service)` (line 345): no docstring
  - `OntologiesProjectionStrategy` (line 420): no docstring
    - `base_index(self, db_name, branch)` (line 424): no docstring
    - `new_index(self, db_name, branch, version_suffix)` (line 427): no docstring
    - `async decide(self, envelope, data, db_name, branch, new_index, ontology_ref, ontology_commit, seq, event_ts, created_at_cache, elasticsearch_service)` (line 430): no docstring

### `backend/bff/services/admin_reindex_instances_service.py`
- **Functions**
  - `_extract_spec_field(spec, field)` (line 26): no docstring
  - `async reindex_all_instances(db_name, branch, objectify_registry, dataset_registry, job_queue, delete_index_first, elasticsearch_service)` (line 33): Re-index all instances for a database by re-running objectify jobs.
...
- **Functions**
  - `_trim_text(value, max_chars)` (line 57): no docstring
  - `_resolve_optional_principal(request)` (line 66): no docstring
  - `_ensure_session_owner(record, user_id)` (line 76): no docstring
  ...
  - `_now_iso()` (line 532): no docstring
  - `_cap_int(value, lo, hi)` (line 536): no docstring
  - `async _load_schema_context(db_name, oms, redis_service, cache_ttl_s, max_classes, max_properties_per_class, max_relationships_per_class)` (line 540): Build a minimal, LLM-friendly schema context.
  - `_build_plan_prompts(question, schema_context, mode, branch, limit_cap, conversation_context, dataset_inventory)` (line 637): no docstring
  - `_build_plan_repair_prompts(question, schema_context, mode, branch, limit_cap, conversation_context, dataset_inventory, prior_plan, issue)` (line 735): no docstring
  - `_build_answer_prompts(question, grounding)` (line 836): no docstring
  - `_validate_and_cap_plan(plan, limit_cap)` (line 872): Enforce server-side caps regardless of what the LLM produced.
  - `async _execute_label_query(db_name, query_dict, lang, mapper, query_service)` (line 909): Execute label query by reusing the same deterministic pipeline as /database/{db_name}/query.
  - `_ground_label_query_result(execution, max_rows)` (line 958): no docstring
  - `_ground_graph_query_result(execution, max_nodes, max_edges)` (line 970): no docstring
  - `_dataset_item_min(item)` (line 1041): no docstring
  - `_ground_dataset_list_result(datasets, total_count, max_items)` (line 1061): no docstring
  - `_build_dataset_inventory(datasets, max_items)` (line 1070): no docstring
  - `async translate_query_plan(db_name, body, request, llm, redis_service, audit_store, oms, sessions, dataset_registry)` (line 1082): Natural language → constrained query plan JSON.
  - `async ai_query(db_name, body, request, llm, redis_service, audit_store, lineage_store, oms, mapper, query_service, sessions, dataset_registry)` (line 1231): End-to-end natural language query:
...
- **Functions**
  - `_row_hash(row)` (line 53): Deterministic hash of a row for deduplication.
  - `_parse_csv_bytes(data)` (line 58): Parse CSV bytes into (columns, rows).
  - `_align_row_to_columns(row, source_columns, target_columns)` (line 72): Project a row from source column order into target column order.
  - `_align_rows_to_columns(rows, source_columns, target_columns)` (line 92): no docstring
  - `_apply_append_mode(existing_columns, existing_rows, new_columns, new_rows)` (line 104): APPEND mode: add only new rows (by hash) that don't exist in the current dataset.
  - `_apply_update_mode(existing_columns, existing_rows, new_columns, new_rows, primary_key_column)` (line 133): UPDATE mode: merge/upsert rows by primary key column.
  - `async _load_existing_csv(dataset, dataset_registry, lakefs_storage_service, repo)` (line 179): Load the latest version's CSV from lakeFS. Returns (columns, rows) or empty if none.
  - `async start_pipelining_google_sheet(sheet_id, payload, http_request, google_sheets_service, connector_registry, pipeline_registry, dataset_registry, objectify_registry, objectify_job_queue, lineage_store)` (line 215): no docstring
  - `_validate_table_import_runtime_config(connector_kind, import_mode, import_config)` (line 497): no docstring
  - `_validate_file_import_runtime_config(connector_kind, import_mode, import_config)` (line 511): no docstring
  - `_validate_virtual_table_runtime_config(connector_kind, import_mode, import_config)` (line 525): no docstring
  - `async start_pipelining_table_import(source, mapping, google_sheets_service, connector_adapter_factory, connector_registry, pipeline_registry, dataset_registry, objectify_registry, objectify_job_queue, actor_user_id)` (line 540): no docstring
  - `async start_pipelining_file_import(source, mapping, google_sheets_service, connector_adapter_factory, connector_registry, pipeline_registry, dataset_registry, objectify_registry, objectify_job_queue, actor_user_id)` (line 571): no docstring
  - `async start_pipelining_virtual_table(source, mapping, google_sheets_service, connector_adapter_factory, connector_registry, pipeline_registry, dataset_registry, objectify_registry, objectify_job_queue, actor_user_id)` (line 602): no docstring
  - `async _start_pipelining_connector_import(source, mapping, google_sheets_service, connector_adapter_factory, connector_registry, pipeline_registry, dataset_registry, objectify_registry, objectify_job_queue, actor_user_id, import_config_key, execution_label, resource_kind, config_validator)` (line 633): no docstring
...
- **Functions**
  ...
  - `async execute_simple_graph_query(db_name, query, request, graph_service, dataset_registry, base_branch, overlay_branch, branch)` (line 674): Execute simple single-class graph query.
  - `async execute_multi_hop_query(db_name, query, request, graph_service, dataset_registry, base_branch, overlay_branch, branch)` (line 798): Execute multi-hop graph query (compat dict payload).
  - `async find_relationship_paths(db_name, source_class, target_class, max_depth, graph_service, branch)` (line 944): no docstring
  - `async graph_service_health(graph_service)` (line 982): Check health of graph federation service (ES-only, no external graph DB dependency).
- **Classes**
...
- **Functions**
  ...
  - `async build_mapping_request(db_name, request, oms_client, dataset_registry, relationship_spec_id, link_type_id, source_class, target_class, predicate, cardinality, branch, source_props, target_props, source_contract, target_contract, spec_payload)` (line 598): no docstring
- **Classes**
  - `_MappingContext` (line 269): no docstring
  - `_MappingResult` (line 288): no docstring
  - `_ForeignKeyMappingStrategy` (line 295): no docstring
    - `async build(self, ctx, fk_spec, source_pk_fields, target_pk_fields)` (line 296): no docstring
  - `_JoinTableMappingStrategy` (line 418): no docstring
    - `async build(self, ctx, join_spec, source_pk_fields, target_pk_fields, spec_type, relationship_kind, relationship_object_type)` (line 419): no docstring
...
- **Functions**
  - `_extract_resource_payload(response)` (line 44): no docstring
  - `_schema_hash_from_version(sample_json, schema_json)` (line 53): no docstring
  - `_normalize_contract_status(raw_status, default)` (line 65): no docstring
  - `_is_effective_backing_source(backing)` (line 70): no docstring
  - `_extract_backing_sources(spec)` (line 80): no docstring
  - `_extract_primary_backing_source(spec)` (line 84): no docstring
  - `_build_backing_source(dataset, backing, backing_version, version, resolved_schema_hash)` (line 88): no docstring
  - `_apply_backing_hints_from_sources(payload)` (line 108): no docstring
  - `async _resolve_backing(db_name, request, dataset_registry, backing_dataset_id, backing_datasource_id, backing_datasource_version_id, dataset_version_id, schema_hash)` (line 150): no docstring
  - `_extract_ontology_property_names(payload)` (line 245): no docstring
  - `_infer_pk_spec_from_ontology(ontology_payload, class_id)` (line 261): no docstring
  - `_normalize_and_validate_pk_spec(raw_pk_spec, ontology_property_names)` (line 315): no docstring
  - `async create_object_type_contract(db_name, body, request, branch, expected_head_commit, oms_client, dataset_registry, objectify_registry)` (line 334): no docstring
  - `_normalize_field_list(raw_value)` (line 587): no docstring
  - `_normalize_field_moves(raw_value)` (line 597): no docstring
  - `_has_effective_pk_spec(spec)` (line 614): no docstring
  - `_has_effective_backing_source(spec)` (line 621): no docstring
  - `async update_object_type_contract(db_name, class_id, body, request, branch, expected_head_commit, oms_client, dataset_registry, objectify_registry)` (line 631): no docstring

### `backend/bff/services/objectify_dag_service.py`
- **Functions**
  - `async run_objectify_dag(db_name, body, request, dataset_registry, objectify_registry, job_queue, oms_client)` (line 610): Enterprise helper: enqueue multiple objectify jobs in dependency order.
- **Classes**
  - `_DagPlanItem` (line 42): no docstring
    - `to_dict(self)` (line 50): no docstring
  - `_ObjectifyDagOrchestrator` (line 61): no docstring
    - `__init__(self, db_name, body, dataset_registry, objectify_registry, job_queue, oms_client)` (line 62): no docstring
    - `async _fetch_object_type_contract(self, class_id)` (line 92): no docstring
    - `async _resolve_mapping_spec_for_object_type(self, class_id, backing_source)` (line 113): no docstring
    - `async _fetch_relationship_targets(self, class_id)` (line 156): no docstring
    - `async _load_class_info(self, class_id)` (line 174): no docstring
    - `async _build_dependency_closure(self, start)` (line 222): no docstring
    - `_toposort(self, start)` (line 271): no docstring
    - `_build_plan(self, ordered)` (line 323): no docstring
    - `async compute_plan(self, class_ids)` (line 340): no docstring
    - `async _enqueue_class_job(self, class_id, run_id, start)` (line 348): no docstring
    - `_extract_command_status(payload)` (line 414): no docstring
    - `_is_dataset_primary_mode(report)` (line 424): no docstring
    - `async _wait_for_objectify_submitted(self, job_id, timeout_seconds)` (line 431): no docstring
    - `async _wait_for_command_terminal(self, command_id, timeout_seconds)` (line 468): no docstring
    - `async _wait_for_class_ready(self, class_id)` (line 494): no docstring
    - `async _run_ready_orchestrator(self, ordered, initial_classes, start)` (line 502): no docstring
    - `async enqueue_plan(self, ordered, start)` (line 549): no docstring

### `backend/bff/services/objectify_mapping_spec_service.py`
- **Functions**
  - `async create_mapping_spec(body, request, dataset_registry, objectify_registry, oms_client)` (line 43): Create an objectify mapping spec with full validation.
...
- **Classes**
  - `OntologyRef` (line 23): Minimal ontology reference used by BFF validation flows.
  - `OMSClient` (line 30): OMS HTTP 클라이언트
    - `__init__(self, base_url)` (line 33): no docstring
    - `_get_auth_token()` (line 58): no docstring
    - `async get(self, path, **kwargs)` (line 66): Low-level GET helper (returns JSON dict).
    - `async post(self, path, **kwargs)` (line 74): Low-level POST helper (returns JSON dict).
    - `async put(self, path, **kwargs)` (line 82): Low-level PUT helper (returns JSON dict).
    - `async delete(self, path, **kwargs)` (line 90): Low-level DELETE helper (returns JSON dict when available).
    - `async check_health(self)` (line 98): OMS 서비스 상태 확인
    ...
    - `async get_ontology(self, db_name, class_id, branch)` (line 193): 온톨로지 조회
    - `async list_ontologies(self, db_name, branch)` (line 206): 온톨로지 목록 조회
    - `async get_ontologies(self, db_name, branch)` (line 219): Compatibility helper for BFF callers that need a flattened view of:
    - `async list_ontology_resources(self, db_name, resource_type, branch, limit, offset)` (line 264): 온톨로지 리소스 목록 조회
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 292): 단일 온톨로지 리소스 조회
    - `async create_ontology_resource(self, db_name, resource_type, payload, branch, expected_head_commit)` (line 312): 온톨로지 리소스 생성
    - `async record_ontology_deployment(self, db_name, target_branch, ontology_commit_id, snapshot_rid, deployed_by, metadata)` (line 337): 온톨로지 배포 레코드 기록 (actions precondition).
    - `async update_ontology_resource(self, db_name, resource_type, resource_id, payload, branch, expected_head_commit)` (line 366): 온톨로지 리소스 업데이트
    - `async delete_ontology_resource(self, db_name, resource_type, resource_id, branch, expected_head_commit)` (line 392): 온톨로지 리소스 삭제
    - `async update_ontology(self, db_name, class_id, update_data, expected_seq, branch, headers)` (line 416): 온톨로지 업데이트
    - `async delete_ontology(self, db_name, class_id, expected_seq, branch, headers)` (line 440): 온톨로지 삭제
    - `async search_objects_v2(self, db_name, object_type, where, page_size, page_token, select, order_by, order_direction, exclude_rid, snapshot, branch)` (line 467): Foundry Search Objects API v2 proxy.
    - `async aggregate_objects_v2(self, db_name, object_type, payload, branch)` (line 517): Foundry Aggregate Objects API v2 proxy — delegates to OMS ES-native engine.
    - `async get_timeseries_first_point(self, db_name, object_type, primary_key, property_name, branch, headers)` (line 542): Proxy GET firstPoint to OMS Time Series router.
    - `async get_timeseries_last_point(self, db_name, object_type, primary_key, property_name, branch, headers)` (line 565): Proxy GET lastPoint to OMS Time Series router.
    - `async stream_timeseries_points(self, db_name, object_type, primary_key, property_name, payload, branch, headers)` (line 588): Proxy POST streamPoints to OMS (returns raw response for streaming).
    - `async upload_attachment(self, filename, data, content_type, headers)` (line 617): Proxy POST attachment upload to OMS.
    - `async list_property_attachments(self, db_name, object_type, primary_key, property_name, branch, headers)` (line 643): Proxy GET list attachment property metadata.
    - `async get_attachment_by_rid(self, db_name, object_type, primary_key, property_name, attachment_rid, branch, headers)` (line 666): Proxy GET attachment metadata by RID.
    - `async get_attachment_content(self, db_name, object_type, primary_key, property_name, branch, headers)` (line 690): Proxy GET attachment content (returns raw response for binary data).
    - `async get_attachment_content_by_rid(self, db_name, object_type, primary_key, property_name, attachment_rid, branch, headers)` (line 713): Proxy GET attachment content by RID (returns raw response for binary data).
    - `async database_exists(self, db_name)` (line 737): 데이터베이스 존재 여부 확인
    - `async __aenter__(self)` (line 748): no docstring
    - `async __aexit__(self, _exc_type, _exc_val, _exc_tb)` (line 751): no docstring
...
- **Functions**
  - `async create_ontology(db_name, body, branch, mapper, oms_client)` (line 33): 온톨로지 생성

### `backend/bff/services/ontology_extensions_service.py`
- **Functions**
  - `_default_expected_head_commit(branch)` (line 30): no docstring
  - `async _call_oms(action, func)` (line 37): no docstring
  - `async list_resources(oms_client, db_name, resource_type, branch, limit, offset)` (line 54): no docstring
  - `async create_resource(oms_client, db_name, resource_type, payload, branch, expected_head_commit)` (line 76): no docstring
  - `async update_resource(oms_client, db_name, resource_type, resource_id, payload, branch, expected_head_commit)` (line 109): no docstring
  - `async get_resource(oms_client, db_name, resource_type, resource_id, branch)` (line 144): no docstring
  - `async delete_resource(oms_client, db_name, resource_type, resource_id, branch, expected_head_commit)` (line 164): no docstring
  - `async record_deployment(oms_client, db_name, target_branch, ontology_commit_id, snapshot_rid, deployed_by, metadata)` (line 197): no docstring
...
- **Functions**
  - `_normalize_ref(value)` (line 16): no docstring
  - `async fetch_branch_head_commit_id(oms_client, db_name, branch)` (line 22): no docstring
  - `async resolve_expected_head_commit(oms_client, db_name, branch, expected_head_commit, allow_none, unresolved_detail)` (line 34): no docstring
  - `async resolve_branch_head_commit_with_bootstrap(oms_client, db_name, branch, source_branch, max_attempts, initial_backoff_seconds, max_backoff_seconds, warning_logger)` (line 52): no docstring
...
- **Functions**
  - `async get_pipeline(pipeline_id, pipeline_registry, branch, preview_node_id, request)` (line 43): no docstring
  - `async get_pipeline_readiness(pipeline_id, branch, pipeline_registry, dataset_registry, request)` (line 97): no docstring
  - `async update_pipeline(pipeline_id, payload, audit_store, pipeline_registry, dataset_registry, request, event_store)` (line 278): no docstring
...
- **Functions**
  ...
  - `_parse_pipeline_run_request_payload(sanitized, allow_sampling_strategy)` (line 841): no docstring
  - `_merge_definition_contract_overrides(definition_json, expectations, schema_contract)` (line 888): no docstring
  - `async _resolve_pipeline_run_context(pipeline_registry, pipeline_id, request_payload, validate_db, clear_node_for_streaming_pipeline, archived_branch_error)` (line 902): no docstring
  - `_build_preview_job_id(pipeline_id, node_id, definition_hash)` (line 969): no docstring
  - `_build_preview_existing_run_response(pipeline_id, job_id, limit, preflight, existing_run)` (line 981): no docstring
  - `async _record_preview_run_queued(pipeline_registry, pipeline_id, job_id, node_id, limit)` (line 1020): no docstring
  - `_build_preview_definition(definition_json, branch, sampling_strategy)` (line 1046): no docstring
  - `async _publish_preview_pipeline_job(pipeline_job_queue, pipeline_registry, job, pipeline_id, node_id)` (line 1061): no docstring
  - `async _append_preview_command_event(event_store, pipeline_id, limit)` (line 1115): no docstring
  - `_assert_build_preflight_passes(preflight)` (line 1135): no docstring
  - `async _resolve_build_ontology_head_commit(oms_client, db_name, ontology_branch)` (line 1148): no docstring
  - `_build_definition_with_ontology_meta(definition_json, ontology_branch, ontology_head_commit_id)` (line 1185): no docstring
  - `async _publish_build_pipeline_job(pipeline_job_queue, pipeline_registry, job, pipeline_id, node_id)` (line 1203): no docstring
  - `async _emit_build_requested_event(emit_pipeline_control_plane_event, pipeline_id, job_id, db_name, branch, node_id, definition_hash, limit, principal_type, principal_id)` (line 1248): no docstring
  - `async _prepare_preview_execution(pipeline_id, sanitized, pipeline_registry, dataset_registry)` (line 1302): no docstring
  - `async _dispatch_preview_execution(pipeline_id, prepared, pipeline_registry, pipeline_job_queue, event_store)` (line 1349): no docstring
  - `async _prepare_build_execution(pipeline_id, sanitized, pipeline_registry, dataset_registry, oms_client)` (line 1420): no docstring
  - `async _dispatch_build_execution(pipeline_id, prepared, pipeline_registry, pipeline_job_queue, emit_pipeline_control_plane_event, request)` (line 1472): no docstring
  - `async _record_preview_validation_failure(pipeline_registry, pipeline_id, node_id, error_detail)` (line 1539): no docstring
  - `async _log_pipeline_preview_failure(audit_store, request, pipeline_id, error_detail)` (line 1575): no docstring
  - `async preview_pipeline(pipeline_id, payload, request, audit_store, pipeline_registry, pipeline_job_queue, dataset_registry, event_store)` (line 1594): no docstring
  - `async build_pipeline(pipeline_id, payload, request, audit_store, pipeline_registry, pipeline_job_queue, dataset_registry, oms_client, emit_pipeline_control_plane_event)` (line 1671): no docstring
  - `_extract_promote_outputs_list(artifact_record, output_json)` (line 1735): no docstring
  - `_select_outputs_for_promotion(outputs_list, node_id, is_streaming_promotion)` (line 1750): no docstring
  - `_resolve_build_artifact_context(selected_outputs, output_json, artifact_record)` (line 1779): no docstring
  - `_resolve_promote_output_selection(output_json, artifact_record, pipeline, node_id)` (line 1833): no docstring
  - `_coerce_optional_int(value, field_name)` (line 1874): no docstring
  - `_extract_staged_dataset_name(item)` (line 1882): no docstring
  - `_extract_artifact_path_from_output(item, staged_bucket, staged_prefix)` (line 1893): no docstring
  - `_extract_promote_output_runtime_fields(item)` (line 1949): no docstring
  - `_normalize_promote_output_item(item, staged_bucket, staged_prefix)` (line 1993): no docstring
  - `async _collect_output_breaking_changes(dataset_registry, db_name, resolved_branch, normalized_output)` (line 2029): no docstring
  - `async _normalize_promote_outputs(selected_outputs, staged_bucket, build_ref, dataset_registry, db_name, resolved_branch)` (line 2049): no docstring
  - `_collect_policy_mismatches(normalized_outputs, definition_json, execution_semantics)` (line 2086): no docstring
  - `_assert_breaking_changes_replay_policy(any_breaking_changes, replay_on_deploy, is_streaming_promotion, normalized_outputs)` (line 2155): no docstring
  - `async _prepare_promote_outputs_for_deploy(output_json, artifact_record, pipeline, node_id, dataset_registry, db_name, resolved_branch, definition_json, replay_on_deploy)` (line 2176): no docstring
  - `async _merge_promote_build_branch(request, pipeline_registry, acquire_pipeline_publish_lock, release_pipeline_publish_lock, pipeline_id, resolved_branch, promote_job_id, staged_bucket, build_ref, build_job_id, node_id, pipeline, db_name)` (line 2228): no docstring
  - `_build_dataset_sample_json(columns, rows, row_count, delta_row_count, write_mode_requested, write_mode_resolved, runtime_write_mode, pk_columns, post_filtering_column, write_policy_hash)` (line 2297): no docstring
  - `async _ensure_dataset_key_spec_alignment(dataset_registry, dataset_id, pk_columns, node_id)` (line 2328): no docstring
  - `_resolve_mapping_spec_from_bundle(proposal_bundle, dataset_id, dataset_branch)` (line 2380): no docstring
  - `async _resolve_mapping_spec_reference(objectify_registry, proposal_bundle, dataset_id, dataset_branch, staged_dataset_name, schema_hash)` (line 2405): no docstring
  - `async _upsert_promoted_dataset_version(dataset_registry, db_name, resolved_branch, staged_dataset_name, schema_columns, sample_rows, row_count, delta_row_count, write_mode_requested, write_mode_resolved, runtime_write_mode, pk_columns, post_filtering_column, write_policy_hash, source_ref, merge_commit_id, promoted_artifact_key, promoted_from_artifact_id)` (line 2432): no docstring
  - `_extract_materialization_fields(item, staged_bucket, merge_commit_id)` (line 2493): no docstring
  - `async _record_promoted_output_manifest(pipeline_registry, pipeline_id, db_name, build_job_id, artifact_id, definition_hash, staged_bucket, merge_commit_id, build_ontology_commit, mapping_spec_id, mapping_spec_version, mapping_spec_target_class_id, dataset_version_id, staged_dataset_name, resolved_branch, principal_id, item)` (line 2517): no docstring
  - `async _finalize_promoted_output_registration(dataset_registry, objectify_registry, pipeline_registry, proposal_bundle, definition_json, item, dataset, schema_hash, pipeline_id, db_name, build_job_id, artifact_id, definition_hash, staged_bucket, merge_commit_id, build_ontology_commit, resolved_branch, principal_id, staged_dataset_name, dataset_version_id)` (line 2566): no docstring
  - `_build_promoted_output_payload(item, staged_dataset_name, dataset_id, dataset_version_id, promoted_artifact_key, artifact_path, merge_commit_id, replay_on_deploy, artifact_id)` (line 2629): no docstring
  - `async _materialize_single_promoted_output(item, context, dataset_registry, objectify_registry, proposal_bundle, pipeline_registry)` (line 2665): no docstring
  - `async _materialize_promoted_build_outputs(normalized_outputs, merge_commit_id, staged_bucket, dataset_registry, objectify_registry, proposal_bundle, db_name, resolved_branch, pipeline_registry, pipeline_id, build_job_id, definition_hash, build_ontology_commit, principal_id, replay_on_deploy, artifact_id, definition_json, build_ref)` (line 2743): no docstring
  - `_build_promoted_run_output_json(build_outputs, build_ontology, build_job_id, artifact_id, staged_bucket, build_ref, resolved_branch, merge_commit_id, promote_job_id)` (line 2795): no docstring
  - `async _record_deploy_build_and_run(pipeline_registry, pipeline_id, build_outputs, build_ontology, build_job_id, artifact_id, staged_bucket, build_ref, resolved_branch, merge_commit_id, promote_job_id, node_id, definition_hash, definition_commit_id)` (line 2824): no docstring
  - `async _emit_pipeline_deploy_promoted_event(emit_pipeline_control_plane_event, pipeline_id, promote_job_id, principal_id, build_job_id, artifact_id, db_name, resolved_branch, node_id, merge_commit_id, definition_hash, replay_on_deploy, principal_type)` (line 2881): no docstring
  - `async _record_promoted_build_output_lineage(lineage_store, build_outputs, db_name, resolved_branch, pipeline_id, build_job_id, artifact_id)` (line 2919): no docstring
  - `async _apply_deploy_pipeline_updates(pipeline_registry, pipeline_id, schedule_interval_seconds, schedule_cron, branch, proposal_status, proposal_title, proposal_description, dependencies)` (line 2959): no docstring
  - `async _prepare_deploy_execution(pipeline_id, sanitized, pipeline_registry)` (line 3019): no docstring
  - `async _resolve_deploy_promotion_payload(prepared, pipeline_id, pipeline_registry, dataset_registry, objectify_registry)` (line 3064): no docstring
  - `async _emit_pipeline_deploy_requested_event(emit_pipeline_control_plane_event, pipeline_id, promote_job_id, principal_id, build_job_id, artifact_id, db_name, resolved_branch, node_id, definition_hash, replay_on_deploy, principal_type)` (line 3108): no docstring
  - `async _merge_and_materialize_deploy_outputs(prepared, promotion_payload, request_input, pipeline_context, pipeline_id, request, pipeline_registry, dataset_registry, objectify_registry, acquire_pipeline_publish_lock, release_pipeline_publish_lock, principal_id, promote_job_id)` (line 3144): no docstring
  - `async _record_deploy_execution_side_effects(prepared, promotion_payload, pipeline_context, pipeline_id, request_input, build_outputs, merge_commit_id, promote_job_id, principal_id, principal_type, pipeline_registry, lineage_store, emit_pipeline_control_plane_event)` (line 3198): no docstring
  - `async _dispatch_deploy_execution(prepared, pipeline_id, request, pipeline_registry, dataset_registry, objectify_registry, lineage_store, emit_pipeline_control_plane_event, acquire_pipeline_publish_lock, release_pipeline_publish_lock)` (line 3267): no docstring
  - `_build_deploy_audit_metadata(result)` (line 3348): no docstring
  - `_build_deploy_success_response(pipeline_id, result)` (line 3360): no docstring
  - `async deploy_pipeline(pipeline_id, payload, request, pipeline_registry, dataset_registry, objectify_registry, oms_client, lineage_store, audit_store, emit_pipeline_control_plane_event, _acquire_pipeline_publish_lock, _release_pipeline_publish_lock)` (line 3378): no docstring
- **Classes**
  ...
  - `_PreparedPreviewExecution` (line 1281): no docstring
  - `_PreparedBuildExecution` (line 1291): no docstring
  - `_PreparedDeployExecution` (line 2986): no docstring
  - `_DeployPromotionPayload` (line 2996): no docstring
  - `_DeployExecutionResult` (line 3007): no docstring
...
- **Functions**
  - `_normalize_ontology_bundle(ontology_meta, build_branch)` (line 31): no docstring
  - `normalize_mapping_spec_ids(raw)` (line 42): no docstring
  - `async _build_proposal_bundle(pipeline, build_job_id, mapping_spec_ids, pipeline_registry, dataset_registry, objectify_registry)` (line 69): no docstring
  - `async list_pipeline_proposals(db_name, branch, status_filter, pipeline_registry, request)` (line 236): no docstring
  - `async submit_pipeline_proposal(pipeline_id, payload, audit_store, pipeline_registry, dataset_registry, objectify_registry, request)` (line 264): no docstring
  - `async approve_pipeline_proposal(pipeline_id, payload, audit_store, pipeline_registry, request)` (line 341): no docstring
  - `async reject_pipeline_proposal(pipeline_id, payload, audit_store, pipeline_registry, request)` (line 421): no docstring

### `backend/bff/services/pipeline_tabular_upload_facade.py`
- **Functions**
  - `async finalize_tabular_upload(ctx, dataset_name, description, source_type, source_ref, request_fingerprint_payload, schema_json, sample_json, row_count, source_metadata, artifact_fileobj, artifact_basename, artifact_content_type, content_sha256, commit_message, commit_metadata_extra, lineage_label, dataset_registry, objectify_registry, objectify_job_queue, lineage_store, preview_payload, tabular_analysis, success_message)` (line 13): no docstring

### `backend/bff/services/pipeline_udf_service.py`
- **Functions**
  - `_parse_uuid_or_404(value, detail)` (line 21): no docstring
  - `async create_udf(db_name, name, code, description, pipeline_registry)` (line 29): no docstring
  - `async list_udfs(db_name, pipeline_registry)` (line 73): no docstring
  - `async get_udf(udf_id, pipeline_registry)` (line 106): no docstring
  - `async create_udf_version(udf_id, code, pipeline_registry)` (line 139): no docstring
  - `async get_udf_version(udf_id, version, pipeline_registry)` (line 181): no docstring
...
### `backend/bff/tests/test_actions_apply_batch_proxy.py`
- **Functions**
...
- **Functions**
  - `test_action_submit_batch_forwards_actor_identity_from_headers()` (line 9): no docstring

### `backend/bff/tests/test_ai_query_router.py`
- **Functions**
  - `client()` (line 85): no docstring
  - `_install_common_overrides(llm_gateway)` (line 89): no docstring
  - `test_translate_query_plan_returns_plan(client)` (line 116): no docstring
  - `test_translate_query_plan_returns_graph_query_with_paths(client)` (line 139): no docstring
  - `test_ai_query_unsupported_returns_guidance_templates(client)` (line 175): no docstring
  - `test_ai_query_label_query_executes_and_answers(client)` (line 199): no docstring
  - `test_ai_query_label_query_propagates_http_errors(client)` (line 255): no docstring
  - `test_ai_query_label_query_maps_upstream_5xx_to_503(client)` (line 307): no docstring
  - `test_ai_query_dataset_list_executes_and_answers(client, monkeypatch)` (line 365): no docstring
  - `test_ai_intent_passes_through_llm_response(client)` (line 427): no docstring
  - `test_ai_intent_does_not_override_greeting_route(client)` (line 447): no docstring
- **Classes**
  - `_FakeOMSClient` (line 25): no docstring
    - `async list_ontologies(self, db_name)` (line 26): no docstring
  - `_FakeGateway` (line 44): no docstring
    - `__init__(self, plan, answer, intent)` (line 45): no docstring
    - `async complete_json(self, task, response_model, **kwargs)` (line 56): no docstring
...
- **Functions**
  - `async _noop_require_domain_role(request, db_name)` (line 799): no docstring
  - `_request_with_body(body, method, path, headers)` (line 804): no docstring
  - `async test_list_object_types_v2_returns_foundry_raw_shape()` (line 821): no docstring
  - `async test_list_ontologies_v2_returns_foundry_raw_shape()` (line 845): no docstring
  - `async test_create_object_type_v2_routes_to_contract_service_with_backing_sources()` (line 859): no docstring
  - `async test_update_object_type_v2_routes_to_contract_service()` (line 912): no docstring
  - `async test_list_ontologies_v2_accepts_apiname_source_rows()` (line 968): no docstring
  - `async test_get_ontology_v2_returns_foundry_raw_shape()` (line 980): no docstring
  - `async test_get_ontology_v2_resolves_rid_identifier()` (line 1000): no docstring
  - `async test_get_ontology_v2_unknown_returns_ontology_not_found()` (line 1018): no docstring
  - `async test_get_ontology_v2_permission_denied_returns_foundry_403()` (line 1039): no docstring
  - `async test_get_ontology_v2_non_permission_role_error_returns_invalid_argument()` (line 1065): no docstring
  - `async test_get_ontology_v2_preflight_upstream_error_returns_upstream_contract()` (line 1091): no docstring
  - `async test_get_full_metadata_v2_returns_foundry_full_metadata_shape()` (line 1107): no docstring
  - `async test_get_full_metadata_v2_requires_preview_true()` (line 1145): no docstring
  - `async test_get_full_metadata_v2_omits_partial_entities_when_upstream_unavailable()` (line 1168): no docstring
  - `async test_list_action_types_v2_returns_foundry_raw_shape()` (line 1190): no docstring
  - `async test_list_action_types_v2_falls_back_to_legacy_action_rows()` (line 1216): no docstring
  - `async test_get_action_type_v2_returns_foundry_raw_shape()` (line 1238): no docstring
  - `async test_get_action_type_v2_falls_back_to_legacy_action_rows()` (line 1262): no docstring
  - `async test_get_action_type_by_rid_v2_returns_foundry_raw_shape()` (line 1283): no docstring
  - `async test_get_action_type_by_rid_v2_falls_back_to_legacy_action_rows()` (line 1304): no docstring
  - `async test_apply_action_v2_forwards_to_oms_v2_apply_with_foundry_path()` (line 1324): no docstring
  - `async test_apply_action_v2_validate_only_maps_to_oms_v2_apply()` (line 1373): no docstring
  - `async test_apply_action_v2_emits_standardized_action_evidence_fields()` (line 1420): no docstring
  - `async test_apply_action_batch_v2_forwards_requests_to_submit_batch()` (line 1455): no docstring
  - `async test_apply_action_batch_v2_forwards_return_edits_option()` (line 1500): no docstring
  - `async test_count_objects_v2_forwards_to_oms_count_path()` (line 1536): no docstring
  - `async test_apply_action_v2_normalizes_non_foundry_validation_error()` (line 1561): no docstring
  - `async test_apply_action_batch_v2_normalizes_non_foundry_validation_error()` (line 1605): no docstring
  - `async test_list_query_types_v2_returns_foundry_raw_shape()` (line 1650): no docstring
  - `async test_get_query_type_v2_returns_foundry_raw_shape()` (line 1672): no docstring
  - `async test_get_query_type_v2_mismatched_version_returns_not_found()` (line 1694): no docstring
  - `async test_execute_query_v2_runs_function_query_and_returns_value_envelope()` (line 1717): no docstring
  - `async test_execute_query_v2_missing_required_parameter_returns_invalid_argument()` (line 1746): no docstring
  - `async test_execute_query_v2_without_execution_spec_returns_invalid_argument()` (line 1773): no docstring
  - `async test_execute_query_v2_prefers_canonical_object_type_field_over_fallback()` (line 1800): no docstring
  - `async test_list_interface_types_v2_requires_preview_true()` (line 1827): no docstring
  - `async test_list_interface_types_v2_returns_foundry_raw_shape_with_preview()` (line 1852): no docstring
  - `async test_list_shared_property_types_v2_requires_preview_true()` (line 1875): no docstring
  - `async test_list_shared_property_types_v2_returns_foundry_raw_shape_with_preview()` (line 1900): no docstring
  - `async test_get_shared_property_type_v2_returns_foundry_raw_shape_with_preview()` (line 1924): no docstring
  - `async test_get_shared_property_type_v2_missing_returns_not_found()` (line 1946): no docstring
  - `async test_list_value_types_v2_requires_preview_true()` (line 1970): no docstring
  - `async test_get_value_type_v2_returns_foundry_raw_shape_with_preview()` (line 1992): no docstring
  - `async test_list_value_types_v2_returns_foundry_raw_shape_without_pagination_token()` (line 2013): no docstring
  - `async test_get_object_type_v2_returns_foundry_raw_shape()` (line 2033): no docstring
  - `async test_get_object_type_full_metadata_v2_returns_foundry_shape()` (line 2055): no docstring
  - `async test_get_object_type_full_metadata_v2_missing_returns_object_type_not_found()` (line 2080): no docstring
  - `async test_get_object_type_v2_missing_returns_object_type_not_found()` (line 2104): no docstring
  - `async test_list_outgoing_link_types_v2_returns_foundry_raw_shape()` (line 2127): no docstring
  - `async test_list_outgoing_link_types_v2_filters_before_pagination()` (line 2151): no docstring
  - `async test_list_outgoing_link_types_v2_rejects_page_token_when_page_size_changes()` (line 2185): no docstring
  - `async test_get_outgoing_link_type_v2_returns_foundry_raw_shape()` (line 2219): no docstring
  - `async test_get_outgoing_link_type_v2_missing_returns_link_type_not_found()` (line 2242): no docstring
  - `async test_list_incoming_link_types_v2_returns_foundry_shape()` (line 2271): ``User`` is the *target* of ``owned_by`` (Account→User).
  - `async test_list_incoming_link_types_v2_excludes_non_matching()` (line 2300): ``Account`` is not a *target* of any link, so incoming should be empty.
  - `async test_list_incoming_link_types_v2_filters_before_pagination()` (line 2323): ``User`` is the target of 3 link types in _PagedLinkTypesOMSClient
  - `async test_get_incoming_link_type_v2_returns_foundry_shape()` (line 2359): no docstring
  - `async test_get_incoming_link_type_v2_wrong_target_returns_not_found()` (line 2383): ``Account`` is not a *target* of ``owned_by``, so this should be 404.
  - `async test_get_incoming_link_type_v2_unknown_link_returns_not_found()` (line 2408): no docstring
  - `async test_search_objects_v2_passthrough_foundry_shape()` (line 2432): no docstring
  - `async test_list_objects_v2_passthrough_foundry_shape_and_orderby_parse()` (line 2454): no docstring
  - `async test_get_object_v2_returns_foundry_raw_shape()` (line 2497): no docstring
  - `async test_get_object_v2_not_found_returns_foundry_error()` (line 2521): no docstring
  - `async test_list_linked_objects_v2_returns_foundry_raw_shape()` (line 2548): no docstring
  - `async test_list_linked_objects_v2_paginates_after_dedup_link_filter()` (line 2581): no docstring
  - `async test_list_linked_objects_v2_rejects_page_token_when_page_size_changes()` (line 2644): no docstring
  - `async test_list_linked_objects_v2_missing_link_type_returns_link_type_not_found()` (line 2690): no docstring
  - `async test_get_linked_object_v2_returns_foundry_raw_shape()` (line 2721): no docstring
  - `async test_get_linked_object_v2_not_found_returns_foundry_error()` (line 2747): no docstring
  - `async test_load_object_set_objects_v2_supports_search_around()` (line 2779): no docstring
  - `async test_load_object_set_objects_or_interfaces_v2_search_around_invalid_link_returns_not_found()` (line 2815): no docstring
  - `async test_v2_invalid_ontology_returns_foundry_error_envelope()` (line 2849): no docstring
  - `async test_list_objects_v2_rejects_invalid_orderby_expression()` (line 2870): no docstring
  - `async test_list_objects_v2_rejects_invalid_branch()` (line 2898): no docstring
  - `async test_list_object_types_v2_rejects_expired_page_token()` (line 2928): no docstring
  - `async test_list_object_types_v2_rejects_page_token_scope_mismatch()` (line 2949): no docstring
  - `async test_list_object_types_v2_rejects_page_token_when_page_size_changes()` (line 2969): no docstring
  - `async test_timeseries_first_point_v2_requires_domain_role_and_returns_payload()` (line 3000): no docstring
  - `async test_timeseries_first_point_v2_forwards_actor_headers_to_oms()` (line 3032): no docstring
  - `async test_upload_attachment_v2_proxies_binary_payload_to_oms()` (line 3068): no docstring
  - `async test_upload_attachment_v2_forwards_actor_headers_to_oms()` (line 3084): no docstring
  - `async test_attachment_property_v2_requires_domain_role_and_returns_payload()` (line 3110): no docstring
- **Classes**
  - `_FakeOMSClient` (line 16): no docstring
    - `__init__(self)` (line 17): no docstring
    - `async list_databases(self)` (line 21): no docstring
    - `async get_database(self, db_name)` (line 31): no docstring
    - `async post(self, path, **kwargs)` (line 36): no docstring
    - `async list_ontology_resources(self, db_name, resource_type, branch, limit, offset)` (line 88): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 232): no docstring
    - `async get_ontology(self, db_name, class_id, branch)` (line 354): no docstring
    - `async get_timeseries_first_point(self, db_name, object_type, primary_key, property_name, branch, headers)` (line 389): no docstring
    - `async get_timeseries_last_point(self, db_name, object_type, primary_key, property_name, branch, headers)` (line 396): no docstring
    - `async stream_timeseries_points(self, db_name, object_type, primary_key, property_name, payload, branch, headers)` (line 403): no docstring
    - `async upload_attachment(self, filename, data, content_type, headers)` (line 416): no docstring
    - `async list_property_attachments(self, db_name, object_type, primary_key, property_name, branch, headers)` (line 428): no docstring
    - `async get_attachment_by_rid(self, db_name, object_type, primary_key, property_name, attachment_rid, branch, headers)` (line 441): no docstring
    - `async get_attachment_content(self, db_name, object_type, primary_key, property_name, branch, headers)` (line 453): no docstring
    - `async get_attachment_content_by_rid(self, db_name, object_type, primary_key, property_name, attachment_rid, branch, headers)` (line 461): no docstring
  - `_ApiNameOnlyOMSClient` (line 470): no docstring
    - `async list_databases(self)` (line 471): no docstring
  - `_MissingObjectTypeOMSClient` (line 475): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 476): no docstring
  - `_MissingSharedPropertyOMSClient` (line 495): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 496): no docstring
  - `_MissingQueryExecutionSpecOMSClient` (line 515): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 516): no docstring
  - `_CanonicalQueryObjectTypeOMSClient` (line 547): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 548): no docstring
  - `_ListDatabasesStatusErrorOMSClient` (line 596): no docstring
    - `async list_databases(self)` (line 597): no docstring
  - `_FullMetadataPartialFailureOMSClient` (line 607): no docstring
    - `async list_ontology_resources(self, db_name, resource_type, branch, limit, offset)` (line 608): no docstring
  - `_LegacyActionResourceOnlyOMSClient` (line 629): no docstring
    - `async list_ontology_resources(self, db_name, resource_type, branch, limit, offset)` (line 630): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 668): no docstring
  - `_ActionEvidenceOMSClient` (line 689): no docstring
    - `async post(self, path, **kwargs)` (line 690): no docstring
  - `_PagedLinkTypesOMSClient` (line 701): no docstring
    - `__init__(self)` (line 702): no docstring
    - `async list_ontology_resources(self, db_name, resource_type, branch, limit, offset)` (line 730): no docstring
  - `_LinkedPaginationOMSClient` (line 752): no docstring
    - `async post(self, path, **kwargs)` (line 753): no docstring
...
- **Functions**
  ...
  - `test_foundry_v2_error_envelope_stable_with_lang_param()` (line 29): no docstring
...
- **Functions**
  - `async _noop_require_domain_role(request, db_name)` (line 42): no docstring
  - `_client_with_overrides()` (line 47): no docstring
  - `test_v2_list_objects_returns_foundry_shape()` (line 55): no docstring
  - `test_v2_get_object_not_found_uses_foundry_error_envelope()` (line 69): no docstring
- **Classes**
  - `_FakeOMSClient` (line 10): no docstring
    - `async list_databases(self)` (line 11): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 14): no docstring
    - `async get_ontology(self, db_name, class_id, branch)` (line 25): no docstring
    - `async post(self, path, **kwargs)` (line 29): no docstring

### `backend/bff/tests/test_legacy_ontology_suggest_import_routes_removed.py`
- **Functions**
  - `test_legacy_suggest_and_import_routes_not_registered()` (line 20): no docstring
...
- **Functions**
  - `async test_join_table_missing_target_column_is_rejected()` (line 67): no docstring
  - `async test_join_table_source_type_mismatch_is_rejected()` (line 124): no docstring
- **Classes**
  - `_FakeDatasetRegistry` (line 10): no docstring
    - `__init__(self, dataset, version)` (line 11): no docstring
    - `async get_dataset(self, dataset_id)` (line 35): no docstring
    - `async get_version(self, version_id)` (line 40): no docstring
    - `async get_latest_version(self, dataset_id)` (line 45): no docstring
    - `async get_or_create_backing_datasource(self, dataset, source_type, source_ref)` (line 50): no docstring
    - `async get_or_create_backing_datasource_version(self, backing_id, dataset_version_id, schema_hash, metadata)` (line 54): no docstring

### `backend/bff/tests/test_link_types_retrieval.py`
- **Functions**
  - `test_extract_resources_unwraps_nested_data()` (line 11): no docstring
  - `test_to_foundry_outgoing_link_type_maps_link_type_fields()` (line 28): no docstring
  - `test_to_foundry_outgoing_link_type_filters_non_matching_source()` (line 53): no docstring
  - `test_invert_cardinality(raw, expected)` (line 87): no docstring
  - `test_to_foundry_incoming_link_type_maps_fields()` (line 97): ``owned_by`` goes from Account → User (n:1).
  - `test_to_foundry_incoming_link_type_filters_non_matching_target()` (line 127): no docstring
  - `test_to_foundry_incoming_link_type_one_to_many_inverts_to_one()` (line 141): ``contains`` goes from Order → Product (1:n).
  - `test_to_foundry_incoming_link_type_no_foreign_key()` (line 165): Incoming link types should not expose foreignKeyPropertyApiName.
...
- **Functions**
  ...
  - `async test_object_type_requires_title_key()` (line 167): no docstring
  - `async test_object_type_draft_allows_no_backing_context()` (line 207): no docstring
  - `async test_object_type_active_requires_backing_context()` (line 244): no docstring
  - `async test_object_type_accepts_backing_sources_hint()` (line 282): no docstring
- **Classes**
  - `_FakeDatasetRegistry` (line 10): no docstring
...
- **Functions**
  - `_build_context(status_value, existing_spec_override)` (line 103): no docstring
  - `async test_object_type_migration_requires_approval()` (line 143): no docstring
  - `async test_object_type_migration_plan_is_recorded()` (line 173): no docstring
  - `async test_object_type_bootstrap_seed_update_skips_migration_gate()` (line 202): no docstring
- **Classes**
  - `_FakeDatasetRegistry` (line 10): no docstring
...
- **Functions**
  - `test_localized_to_string()` (line 7): no docstring
  - `test_transform_properties_for_oms()` (line 13): no docstring
  - `test_build_source_schema_and_samples()` (line 31): no docstring
  - `test_normalize_mapping_type_and_import_target()` (line 49): no docstring

### `backend/bff/tests/test_ontology_validate_proxy.py`
- **Functions**
  - `test_ontology_validate_endpoints_removed()` (line 6): no docstring
...
### `backend/bff/tests/test_pipeline_datasets_raw_file_version_metadata.py`
- **Functions**
  - `async test_get_dataset_raw_file_includes_version_metadata()` (line 50): no docstring
- **Classes**
  - `_FakeStorage` (line 12): no docstring
    - `async load_bytes(self, bucket, key)` (line 13): no docstring
  - `_FakePipelineRegistry` (line 18): no docstring
    - `async get_lakefs_storage(self, user_id)` (line 19): no docstring
  - `_FakeDatasetRegistry` (line 24): no docstring
    - `async get_dataset(self, dataset_id)` (line 25): no docstring
    - `async get_latest_version(self, dataset_id)` (line 36): no docstring
...
- **Functions**
  ...
  - `async test_promote_build_merges_build_branch_to_main_and_registers_version(lakefs_merge_stub, monkeypatch)` (line 432): no docstring
  - `async test_promote_build_rejects_non_staged_artifact_key()` (line 504): no docstring
  - `async test_promote_build_surfaces_build_errors_when_build_failed()` (line 556): no docstring
  - `async test_promote_build_blocks_deploy_when_expectations_failed()` (line 594): no docstring
  - `async test_promote_build_requires_replay_for_breaking_schema_changes(lakefs_merge_stub)` (line 631): no docstring
  - `async test_promote_build_allows_breaking_schema_changes_with_replay_flag(lakefs_merge_stub, monkeypatch)` (line 694): no docstring
- **Classes**
...
- **Functions**
  - `async test_query_database_adapts_to_foundry_where_and_page_token()` (line 12): no docstring
...
- **Functions**
  ...
  - `_client(fail_search)` (line 62): no docstring
  - `test_v2_get_object_success_no_source_leak()` (line 70): no docstring
  - `test_v2_list_objects_success_no_source_leak()` (line 86): no docstring
  - `test_v2_not_found_error_uses_foundry_envelope_without_internal_leak()` (line 103): no docstring
  - `test_v2_upstream_error_does_not_leak_backend_source_details()` (line 119): no docstring
- **Classes**
  - `_FakeOMSClient` (line 13): no docstring
    - `__init__(self, fail_search)` (line 14): no docstring
    - `async list_databases(self)` (line 17): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 20): no docstring
    - `async get_ontology(self, db_name, class_id, branch)` (line 26): no docstring
...
- **Functions**
  - `async test_get_database_info_uses_oms_get_database()` (line 11): no docstring
...
- **Classes**
  - `ConnectorSyncWorker` (line 60): no docstring
    - `__init__(self)` (line 61): no docstring
    - `async initialize(self)` (line 106): no docstring
    - `async close(self)` (line 168): no docstring
    - `async _send_to_dlq(self, msg, payload, raw_payload, error, attempt_count)` (line 208): no docstring
    - `async _process_payload(self, payload)` (line 228): no docstring
    - `_span_name(self, payload)` (line 231): no docstring
    - `_is_retryable_error(self, exc, payload)` (line 234): no docstring
    - `_in_progress_sleep_seconds(self, claim, payload)` (line 237): no docstring
    - `_should_seek_on_in_progress(self, claim, payload)` (line 240): no docstring
    - `_should_seek_on_retry(self, attempt_count, payload)` (line 243): no docstring
    - `_should_mark_done_after_dlq(self, payload, error)` (line 246): no docstring
    - `async _on_success(self, payload, result, duration_s)` (line 249): no docstring
    - `async _on_retry_scheduled(self, payload, error, attempt_count, backoff_s, retryable)` (line 262): no docstring
    - `async _on_terminal_failure(self, payload, error, attempt_count, retryable)` (line 284): no docstring
    - `async _process_connector_update(self, envelope)` (line 306): no docstring
    - `async _handle_envelope(self, envelope)` (line 450): no docstring
    - `async run(self)` (line 466): no docstring
...
- **Classes**
  - `ConnectorTriggerService` (line 53): no docstring
    ...
    - `async run(self)` (line 318): no docstring
...
- **Classes**
  - `ConnectorConnectionTestResult` (line 9): no docstring
  - `ConnectorExtractResult` (line 16): no docstring
  - `ConnectorAdapter` (line 22): Common adapter contract for connectivity connectors.
    - `async test_connection(self, config, secrets)` (line 28): no docstring
    - `async get_public_configuration(self, config)` (line 32): no docstring
    - `async snapshot_extract(self, config, secrets, import_config)` (line 36): no docstring
    - `async incremental_extract(self, config, secrets, import_config, sync_state)` (line 46): no docstring
    - `async cdc_extract(self, config, secrets, import_config, sync_state)` (line 57): no docstring
    - `async peek_change_token(self, config, secrets, import_config)` (line 68): no docstring

### `backend/data_connector/adapters/blocking_query.py`
- **Functions**
  - `async run_blocking_query(fn, adapter_name, operation, timeout_seconds)` (line 9): no docstring
...
- **Functions**
  - `async resolve_source_runtime_credentials(connector_registry, source_type, source_config)` (line 9): Resolve runtime connector config + secrets via parent connection link.

### `backend/data_connector/adapters/sql_query_guard.py`
- **Functions**
  - `normalize_sql_query(query, field_name)` (line 4): Normalize and validate externally provided SQL query text.
...
- **Functions**
  - `_safe_columns(rows)` (line 14): no docstring
  - `_parse_mysql_dsn(dsn)` (line 20): no docstring
  - `_sanitize_identifier(value, field_name)` (line 40): no docstring
  - `_row_value(row, key)` (line 49): no docstring
- **Classes**
  - `MySQLConnectorService` (line 59): no docstring
    - `_connect_kwargs(self, config, secrets)` (line 62): no docstring
    - `_require_driver(self)` (line 83): no docstring
    - `async get_public_configuration(self, config)` (line 94): no docstring
    - `async test_connection(self, config, secrets)` (line 102): no docstring
    - `async _fetch(self, query, config, secrets, params)` (line 127): no docstring
    - `async snapshot_extract(self, config, secrets, import_config)` (line 168): no docstring
    - `async incremental_extract(self, config, secrets, import_config, sync_state)` (line 178): no docstring
    - `async cdc_extract(self, config, secrets, import_config, sync_state)` (line 226): no docstring
    - `async peek_change_token(self, config, secrets, import_config)` (line 285): no docstring

### `backend/data_connector/oracle/__init__.py`

### `backend/data_connector/oracle/service.py`
- **Functions**
  - `_safe_columns(rows)` (line 15): no docstring
  - `_sanitize_identifier(value, field_name)` (line 21): no docstring
  - `_row_value(row, key)` (line 30): no docstring
- **Classes**
  - `OracleConnectorService` (line 40): no docstring
    - `async get_public_configuration(self, config)` (line 43): no docstring
    - `_require_driver(self)` (line 57): no docstring
    - `_connect_kwargs(self, config, secrets)` (line 68): no docstring
    - `async test_connection(self, config, secrets)` (line 84): no docstring
    - `async _fetch(self, query, config, secrets, params)` (line 105): no docstring
    - `async snapshot_extract(self, config, secrets, import_config)` (line 141): no docstring
    - `async incremental_extract(self, config, secrets, import_config, sync_state)` (line 151): no docstring
    - `async cdc_extract(self, config, secrets, import_config, sync_state)` (line 197): no docstring
    - `async peek_change_token(self, config, secrets, import_config)` (line 255): no docstring

### `backend/data_connector/postgresql/__init__.py`

### `backend/data_connector/postgresql/service.py`
- **Functions**
  - `_rows_to_dict_rows(rows)` (line 14): no docstring
  - `_safe_columns(rows)` (line 21): no docstring
  - `_sanitize_identifier(value, field_name)` (line 27): no docstring
  - `_row_value(row, key)` (line 36): no docstring
- **Classes**
  - `PostgreSQLConnectorService` (line 46): no docstring
    - `_dsn(self, config, secrets)` (line 49): no docstring
    - `async get_public_configuration(self, config)` (line 62): no docstring
    - `async test_connection(self, config, secrets)` (line 70): no docstring
    - `async _fetch(self, query, config, secrets, params)` (line 81): no docstring
    - `async snapshot_extract(self, config, secrets, import_config)` (line 99): no docstring
    - `async incremental_extract(self, config, secrets, import_config, sync_state)` (line 109): no docstring
    - `async cdc_extract(self, config, secrets, import_config, sync_state)` (line 158): no docstring
    - `async peek_change_token(self, config, secrets, import_config)` (line 218): no docstring

### `backend/data_connector/snowflake/__init__.py`

### `backend/data_connector/snowflake/service.py`
- **Functions**
  - `_safe_columns(rows)` (line 13): no docstring
  - `_sanitize_identifier(value, field_name)` (line 19): no docstring
  - `_row_value(row, key)` (line 28): no docstring
- **Classes**
  - `SnowflakeConnectorService` (line 38): no docstring
    - `async get_public_configuration(self, config)` (line 41): no docstring
    - `_require_driver(self)` (line 49): no docstring
    - `_connect_kwargs(self, config, secrets)` (line 60): no docstring
    - `async test_connection(self, config, secrets)` (line 71): no docstring
    - `async _fetch(self, query, config, secrets, params)` (line 92): no docstring
    - `async snapshot_extract(self, config, secrets, import_config)` (line 128): no docstring
    - `async incremental_extract(self, config, secrets, import_config, sync_state)` (line 138): no docstring
    - `async cdc_extract(self, config, secrets, import_config, sync_state)` (line 186): no docstring
    - `async peek_change_token(self, config, secrets, import_config)` (line 248): no docstring
...
- **Functions**
  ...
  - `_row_value(row, key)` (line 28): no docstring
- **Classes**
  - `SqlServerConnectorService` (line 38): no docstring
    - `_connection_string(self, config, secrets)` (line 41): no docstring
    - `_require_driver(self)` (line 71): no docstring
    - `async get_public_configuration(self, config)` (line 82): no docstring
    - `async test_connection(self, config, secrets)` (line 90): no docstring
    - `async _fetch(self, query, config, secrets, params)` (line 111): no docstring
    - `async snapshot_extract(self, config, secrets, import_config)` (line 147): no docstring
    - `async incremental_extract(self, config, secrets, import_config, sync_state)` (line 157): no docstring
    - `async cdc_extract(self, config, secrets, import_config, sync_state)` (line 206): no docstring
    - `async peek_change_token(self, config, secrets, import_config)` (line 267): no docstring
...
- **Functions**
  - `async main()` (line 2671): Main entry point
- **Classes**
  - `_InstanceCommandPayload` (line 90): no docstring
  - `_InstanceCommandParseError` (line 95): no docstring
  - `StrictInstanceWorker` (line 99): STRICT Lightweight Instance Worker
    - `__init__(self)` (line 111): no docstring
    - `_is_ingest_metadata(metadata)` (line 179): no docstring
    - `_writeback_guard_blocks(cls, command)` (line 185): no docstring
    - `async initialize(self)` (line 206): Initialize all connections
    - `async _ensure_instances_index(self, db_name, branch)` (line 389): Ensure the ES instances index exists (create if needed, update mapping if exists).
    - `async _fetch_class_schema_via_oms(self, db_name, class_id, branch)` (line 421): Fetch ontology schema from OMS HTTP API.
    - `async _resolve_ontology_version_via_oms(self, db_name, branch)` (line 440): Resolve ontology version stamp in Foundry-style ref form.
    - `_build_es_document(db_name, branch, class_id, instance_id, payload, ontology_version, event_sequence, relationships, now_iso, created_at_override, command_id)` (line 449): Build ES document in canonical format matching objectify_worker write_paths._build_document.
    - `async _s3_call(self, func, *args, **kwargs)` (line 509): no docstring
    - `async _s3_read_body(self, body)` (line 512): no docstring
    - `_extract_payload_from_message(self, message)` (line 515): Unwrap a command from the canonical EventEnvelope message.
    - `async extract_payload_from_message(self, message)` (line 544): no docstring
    - `async _stamp_ontology_version(self, command, db_name, branch)` (line 547): Ensure commands carry an ontology ref/commit stamp for reproducibility.
    - `get_primary_key_value(self, class_id, payload, allow_generate)` (line 582): Extract primary key value dynamically based on class naming convention
    - `_is_objectify_command(command)` (line 613): no docstring
    - `async extract_relationships(self, db_name, class_id, payload, branch, allow_pattern_fallback, strict_schema)` (line 622): Extract ONLY relationship fields from payload via shared library.
    - `async _apply_create_instance_side_effects(self, command_id, db_name, class_id, branch, payload, instance_id, command_log, ontology_version, created_by, allow_pattern_fallback)` (line 668): Apply the create-instance side-effects without touching command status.
    - `async process_create_instance(self, command)` (line 894): Process CREATE_INSTANCE command - strict lightweight mode.
    - `async process_bulk_create_instances(self, command)` (line 1011): Process BULK_CREATE_INSTANCES command (idempotent per event_id; no sequence-guard).
    - `async process_bulk_update_instances(self, command)` (line 1195): Process BULK_UPDATE_INSTANCES command (updates multiple instances).
    - `async process_update_instance(self, command, skip_status)` (line 1288): Process UPDATE_INSTANCE command (idempotent + ordered via registry claim).
    - `async process_delete_instance(self, command)` (line 1778): Process DELETE_INSTANCE command (idempotent delete).
    - `async _record_instance_edit(self, db_name, class_id, instance_id, edit_type, fields, metadata)` (line 2034): no docstring
    - `async _resolve_instance_payload(self, db_name, branch, class_id, instance_id)` (line 2058): no docstring
    - `async _enqueue_link_reindex(self, db_name, link_type_id)` (line 2128): no docstring
    - `async _apply_relationship_object_link_edits(self, db_name, branch, class_id, instance_id, current_payload, previous_payload)` (line 2158): no docstring
    - `async set_command_status(self, command_id, status, result)` (line 2232): Set command status using CommandStatusService (preserves history + pubsub).
    - `_is_retryable_error_impl(exc)` (line 2301): no docstring
    - `_is_elasticsearch_outage_error_message(message)` (line 2312): no docstring
    - `async _publish_to_dlq(self, msg, stage, error, attempt_count, payload_text, payload_obj, kafka_headers, fallback_metadata)` (line 2328): no docstring
    - `_parse_payload(self, payload)` (line 2357): no docstring
    - `_fallback_metadata(self, payload)` (line 2406): no docstring
    - `_registry_key(self, payload)` (line 2409): no docstring
    - `async _process_payload(self, payload)` (line 2437): no docstring
    - `_span_name(self, payload)` (line 2488): no docstring
    - `_span_attributes(self, msg, payload, registry_key)` (line 2491): no docstring
    - `_metric_event_name(self, payload)` (line 2514): no docstring
    - `_is_retryable_error(exc, payload)` (line 2521): no docstring
    - `_max_retries_for_error(self, exc, payload, error, retryable)` (line 2526): no docstring
    - `_backoff_seconds_for_error(self, exc, payload, error, attempt_count, retryable)` (line 2538): no docstring
    - `async _on_retry_scheduled(self, payload, error, attempt_count, backoff_s, retryable)` (line 2556): no docstring
    - `async _on_terminal_failure(self, payload, error, attempt_count, retryable)` (line 2589): no docstring
    - `async run(self)` (line 2616): Main processing loop
    - `async shutdown(self)` (line 2628): Graceful shutdown
...
- **Functions**
  ...
  - `async main()` (line 1535): no docstring
- **Classes**
  ...
  - `PipelineMCPServer` (line 159): no docstring
    ...
    - `async run(self)` (line 1524): no docstring
...
- **Functions**
  ...
  - `async _objectify_list_mapping_specs(server, arguments)` (line 268): no docstring
  - `async _objectify_run(server, arguments)` (line 297): no docstring
  - `async _objectify_get_status(server, arguments)` (line 465): no docstring
  - `async _objectify_wait(server, arguments)` (line 501): no docstring
  - `async _trigger_incremental_objectify(server, arguments)` (line 562): no docstring
  - `async _get_objectify_watermark(server, arguments)` (line 630): no docstring
  - `build_objectify_tool_handlers()` (line 673): no docstring
...
- **Functions**
  ...
  - `async _ontology_query_instances(_server, arguments)` (line 155): no docstring
  - `async _detect_foreign_keys(server, arguments)` (line 224): no docstring
  - `async _create_link_type_from_fk(_server, arguments)` (line 325): no docstring
  - `build_ontology_tool_handlers()` (line 409): no docstring
...
- **Classes**
  ...
  - `ObjectifyWritePath` (line 39): Port for objectify write-side strategies.
    - `async write_instances(self, job, instances, ontology_version, objectify_pk_fields, objectify_instance_id_field, instance_relationships, target_field_types)` (line 42): no docstring
    - `async finalize_job(self, job, execution_mode, indexed_instance_ids)` (line 56): no docstring
  - `DatasetPrimaryIndexWritePath` (line 66): Foundry-style path: dataset rows are indexed directly into Elasticsearch.
    - `__init__(self, elasticsearch_service, storage_service, instance_bucket, chunk_size, refresh, prune_stale_on_full)` (line 75): no docstring
    ...
    - `async _find_stale_instance_ids(self, index_name, class_id, active_instance_ids)` (line 315): no docstring
    - `_build_document(job, instance, instance_id, branch, ontology_version, now_iso, event_sequence, relationships, target_field_types)` (line 372): no docstring
...
- **Functions**
  - `ValidatedDatabaseName(db_name)` (line 165): 데이터베이스 이름 검증 의존성 - Modernized version
  - `ValidatedClassId(class_id)` (line 177): 클래스 ID 검증 의존성 - Modernized version
  - `async ensure_database_exists(db_name)` (line 190): 데이터베이스 존재 확인 및 검증된 이름 반환 - Modernized version
  - `async check_oms_dependencies_health(container)` (line 212): Check health of all OMS dependencies
- **Classes**
  - `OMSDependencyProvider` (line 53): Modern dependency provider for OMS services
    - `async get_event_store(container)` (line 62): Get S3/MinIO Event Store - The Single Source of Truth.
    - `async get_command_status_service(container)` (line 72): Get command status service from container
    - `async get_processed_event_registry(container)` (line 133): no docstring
...
- **Classes**
  ...
  - `BackupCreationError` (line 70): Raised when backup creation fails
  - `BackupRestoreError` (line 76): Raised when backup restore fails
  - `CriticalDataLossRisk` (line 82): Raised when there's a critical risk of data loss
  - `RelationshipError` (line 89): Base exception for relationship operations
  - `CircularReferenceError` (line 95): Raised when circular reference is detected
  - `InvalidRelationshipError` (line 101): Raised when relationship is invalid
  - `RelationshipValidationError` (line 107): Raised when relationship validation fails

### `backend/oms/main.py`
- **Functions**
  - `_resource_storage_backend()` (line 82): no docstring
  - `async lifespan(app)` (line 278): Modern application lifecycle management
  - `async _oms_domain_exception_handler(request, exc)` (line 395): Map OMS domain exceptions to enterprise error envelope responses.
  - `async root()` (line 428): 루트 엔드포인트 - Modernized version
  - `async health_check()` (line 451): 헬스 체크 - Modernized version
  - `async container_health_check()` (line 511): Health check for the modernized container system
- **Classes**
  - `OMSServiceContainer` (line 86): OMS-specific service container to manage OMS services
    - `__init__(self, container, settings)` (line 94): no docstring
    - `async initialize_oms_services(self)` (line 99): Initialize OMS-specific services
    - `async _initialize_event_store(self)` (line 126): Initialize S3/MinIO Event Store - The Single Source of Truth.
    - `async _initialize_postgres(self)` (line 146): Initialize Postgres MVCC pool for OMS relational runtime state.
    - `async _initialize_jsonld_converter(self)` (line 156): Initialize JSON-LD converter
    - `async _initialize_label_mapper(self)` (line 162): Initialize label mapper
    - `async _initialize_redis_and_command_status(self)` (line 168): Initialize Redis service and Command Status service
    - `async _initialize_elasticsearch(self)` (line 193): Initialize Elasticsearch service
    - `async _initialize_rate_limiter(self)` (line 201): Initialize rate limiting service
    - `async shutdown_oms_services(self)` (line 205): Shutdown OMS-specific services
    - `get_jsonld_converter(self)` (line 248): Get JSON-LD converter instance
    - `get_label_mapper(self)` (line 254): Get label mapper instance
    - `get_redis_service(self)` (line 260): Get Redis service instance (can be None)
    - `get_command_status_service(self)` (line 264): Get command status service instance (can be None)
    - `get_elasticsearch_service(self)` (line 268): Get Elasticsearch service instance (can be None)
...
- **Functions**
  - `async _ensure_ontology_database_exists(ontology)` (line 219): no docstring
  - `_resolve_v2_apply_mode(explicit_mode)` (line 230): no docstring
  - `_default_action_parameter_results(parameters)` (line 243): no docstring
  - `_foundry_valid_action_validation_payload_for_parameters(parameters, action_log_id, writeback_status, side_effect_delivery)` (line 259): no docstring
  - `_resolve_writeback_target(db_name, raw_target)` (line 285): no docstring
  - `_normalize_batch_dependency_entries(item)` (line 301): no docstring
  - `_validate_batch_dependency_graph(request_ids, dependencies_by_request_id)` (line 311): no docstring
  - `async submit_action_async(db_name, action_type_id, request, base_branch, event_store)` (line 361): Internal helper that submits one Action for async execution.
  - `async submit_action_batch_async(db_name, action_type_id, request, event_store)` (line 396): no docstring
  - `async simulate_action_async(db_name, action_type_id, request)` (line 550): Simulate an Action writeback (dry-run).
  - `async apply_action_v2_oms(ontology, action, body, branch, sdk_package_rid, sdk_version, transaction_id, event_store)` (line 954): no docstring
  - `async apply_action_batch_v2_oms(ontology, action, body, branch, sdk_package_rid, sdk_version, event_store)` (line 1031): no docstring
- **Classes**
  - `ActionSubmitRequest` (line 58): no docstring
  - `ActionSubmitResponse` (line 69): no docstring
  - `ActionSubmitBatchDependencyRequest` (line 80): no docstring
    - `_normalize_trigger_on(cls, value)` (line 86): no docstring
  - `ActionSubmitBatchItemRequest` (line 93): no docstring
  - `ActionSubmitBatchRequest` (line 108): no docstring
  - `ActionSubmitBatchItemResponse` (line 114): no docstring
  - `ActionSubmitBatchResponse` (line 122): no docstring
  - `ActionSimulateScenarioRequest` (line 129): no docstring
  - `ActionSimulateStatePatch` (line 137): Patch-like state override for decision simulation (what-if).
  - `ActionSimulateObservedBaseOverrides` (line 148): Override observed_base snapshot fields/links to simulate stale reads.
  - `ActionSimulateTargetAssumption` (line 155): no docstring
  - `ActionSimulateAssumptions` (line 162): no docstring
  - `ActionSimulateRequest` (line 169): no docstring
  - `ApplyActionRequestOptionsV2` (line 193): no docstring
  - `ApplyActionRequestV2` (line 197): no docstring
  - `ApplyActionBatchRequestItemV2` (line 204): no docstring
  - `ApplyActionBatchRequestOptionsV2` (line 208): no docstring
  - `ApplyActionBatchRequestV2` (line 212): no docstring

### `backend/oms/routers/attachments.py`
- **Functions**
  - `_foundry_error(status_code, error_code, error_name, parameters)` (line 56): no docstring
  - `_generate_attachment_rid()` (line 77): no docstring
  - `_detect_media_type(filename)` (line 81): Guess MIME type from filename extension.
  - `_attachment_s3_key(attachment_rid, filename)` (line 87): Build S3 key for an attachment file.
  - `_attachments_bucket(storage)` (line 92): no docstring
  - `_has_actor_headers(request)` (line 99): no docstring
  - `async _require_domain_role_if_actor(request, db_name)` (line 103): no docstring
  - `_parse_attachment_metadata(value)` (line 114): Parse attachment metadata from an ES property value.
  - `_find_attachment_by_rid(attachments, rid)` (line 139): Find an attachment by its RID.
...
- **Functions**
  - `_enforce_ingest_only_if_writeback_enabled(class_id, metadata)` (line 43): no docstring
  - `async _fallback_from_registry(command_uuid, registry)` (line 69): no docstring
...
- **Classes**
  ...
  - `InstanceDeleteRequest` (line 193): 인스턴스 삭제 요청 (optional body for metadata/ingest marker).
  - `BulkInstanceCreateRequest` (line 199): 대량 인스턴스 생성 요청
  - `BulkInstanceUpdateRequest` (line 205): 대량 인스턴스 수정 요청

### `backend/oms/routers/ontology.py`
- **Functions**
  - `_is_protected_branch(branch)` (line 78): no docstring
  - `_require_proposal_for_branch(branch)` (line 82): no docstring
  - `_reject_direct_write_if_required(branch)` (line 88): no docstring
  - `_admin_authorized(request)` (line 100): no docstring
  - `_extract_change_reason(request)` (line 110): no docstring
  - `_extract_actor(request)` (line 115): no docstring
  - `async _collect_interface_issues(db_name, branch, ontology_id, metadata, properties, relationships, resource_service)` (line 120): no docstring
  - `_extract_shared_property_refs(metadata)` (line 158): no docstring
  - `_extract_group_refs(metadata)` (line 184): no docstring
  - `async _validate_group_refs(db_name, branch, metadata, resource_service)` (line 211): no docstring
  - `async _apply_shared_properties(db_name, branch, properties, metadata, resource_service)` (line 235): no docstring
  - `async _validate_value_type_refs(db_name, branch, properties, resource_service)` (line 302): no docstring
  - `_is_internal_ontology(ontology)` (line 358): no docstring
  - `_ontology_from_resource_payload(payload, class_id_hint)` (line 372): no docstring
  - `_coerce_property_models(items)` (line 411): no docstring
  - `_coerce_relationship_models(items)` (line 432): no docstring
...
- **Functions**
  - `_foundry_error(status_code, error_code, error_name, parameters)` (line 48): no docstring
  - `_ts_s3_key(db_name, branch, class_id, instance_id, property_name)` (line 69): Build canonical S3 key for a time series property.
  - `_timeseries_bucket(storage)` (line 80): no docstring
  - `_resolve_timeseries_location(db_name, branch, object_type, primary_key, property_name, ts_ref, default_bucket)` (line 87): no docstring
  - `_has_actor_headers(request)` (line 114): no docstring
  - `async _require_domain_role_if_actor(request, db_name)` (line 118): no docstring
  - `async _find_instance_by_pk(es, db_name, branch, object_type, primary_key)` (line 129): Resolve a single instance by its primary key via ES term search.
  - `_extract_ts_property(source, property_name)` (line 157): Extract time series S3 reference from an instance ES document.
  - `async _load_ts_points(storage, bucket, key)` (line 180): Load time series points from S3 JSON file.
  - `_filter_points_by_range(points, range_spec)` (line 199): Apply optional time range filter to points list.
  - `_filter_absolute(points, start_time, end_time)` (line 220): no docstring
  - `_duration_to_timedelta(duration)` (line 246): no docstring
  - `_filter_relative(points, range_spec)` (line 257): no docstring
  - `async get_first_point(ontology, objectType, primaryKey, property, request, branch, es, storage)` (line 298): Get the first (earliest) point of a time series property.
  - `async get_last_point(ontology, objectType, primaryKey, property, request, branch, es, storage)` (line 380): Get the last (most recent) point of a time series property.
  - `async stream_points(ontology, objectType, primaryKey, property, request, payload, branch, es, storage)` (line 462): Stream all points of a time series property with optional range filter.

### `backend/oms/services/__init__.py`

### `backend/oms/services/action_simulation_service.py`
- **Functions**
  - `_enterprise_payload_for_error(error_key)` (line 68): no docstring
  - `_attach_enterprise(payload)` (line 93): no docstring
  - `_assumption_is_forbidden_field(field)` (line 117): no docstring
  - `_extract_link_fields(ops)` (line 126): no docstring
  - `_extract_patch_field_lists(patch)` (line 146): no docstring
  - `_apply_assumption_patch(scope, base_state, patch)` (line 169): no docstring
  - `_apply_observed_base_overrides(observed_base, overrides)` (line 222): no docstring
  - `_coerce_overlay_branch(db_name, writeback_target, overlay_branch)` (line 345): no docstring
  - `_first_defined(*values)` (line 354): no docstring
  - `_coerce_optional_bool(value, default)` (line 361): no docstring
  - `_resolve_project_policy_contract(action_spec)` (line 375): no docstring
...
- **Classes**
  ...
  - `ActionSimulationScenario` (line 305): no docstring
  - `TargetPreflight` (line 311): no docstring
  - `ActionPreflight` (line 329): no docstring

### `backend/oms/services/action_submit_service.py`
- **Functions**
  - `_resolve_writeback_target(db_name, raw_target)` (line 61): no docstring
  - `async submit_action_request(db_name, action_type_id, request_payload, base_branch_alias, event_store, deployments_factory, resources_factory, settings_getter, storage_factory, dataset_registry_factory, compile_action_change_shape_fn, evaluate_action_target_data_access_fn)` (line 77): Submit an async action command and return ActionSubmitResponse-compatible dict.
...
- **Functions**
  ...
  - `async find_missing_references(db_name, resource_type, payload, branch)` (line 170): no docstring
  - `_canonicalize_ref(raw)` (line 204): no docstring
  - `_is_primitive_reference(value)` (line 214): no docstring
  - `_strip_object_ref(raw)` (line 228): no docstring
  - `_collect_link_type_issues(spec)` (line 243): no docstring
  - `_collect_relationship_spec_issues(spec)` (line 266): no docstring
  - `async _find_missing_link_type_refs(resources, db_name, branch, spec)` (line 338): no docstring
  - `_validate_required_fields(resource_type, spec)` (line 366): no docstring
  - `_collect_required_field_issues(resource_type, spec)` (line 372): no docstring
  - `_collect_required_items_issues(items, item_name, name_keys)` (line 871): no docstring
  - `_collect_permission_policy_issues(policy)` (line 909): no docstring
  - `_validate_string_list(value, field_name)` (line 1065): no docstring
  - `_append_spec_issue(issues, message, missing_fields, invalid_fields)` (line 1075): no docstring
  - `async _reference_exists(resources, db_name, branch, ref_type, ref)` (line 1094): no docstring
  - `async validate_resource(db_name, resource_type, payload, branch, expected_head_commit, strict)` (line 1139): no docstring
- **Classes**
  - `ResourceSpecError` (line 26): Raised when resource spec is invalid or missing required fields.
  - `ResourceReferenceError` (line 30): Raised when resource spec references missing entities.

### `backend/oms/services/ontology_resources.py`
- **Functions**
  - `normalize_resource_type(value)` (line 57): no docstring
  - `_resource_doc_id(resource_type, resource_id)` (line 67): no docstring
  - `_strip_branch_ref(branch)` (line 72): no docstring
  - `_localized_to_string(value)` (line 82): no docstring
  - `_json_like_to_dict(value, default)` (line 107): no docstring
  - `_to_iso(value)` (line 130): no docstring
  - `_to_datetime(value)` (line 139): no docstring
- **Classes**
  - `OntologyResourceService` (line 157): CRUD for ontology resources on PostgreSQL canonical backend.
    - `__init__(self, postgres_url, pool_min, pool_max)` (line 163): no docstring
    - `async _get_pool(cls, postgres_url, pool_min, pool_max)` (line 177): no docstring
    - `async _ensure_pool(self)` (line 204): no docstring
    - `async _ensure_postgres_schema(self)` (line 213): no docstring
    - `async ensure_resource_schema(self, db_name, branch)` (line 277): no docstring
    - `_normalize_branch_for_write(branch)` (line 282): no docstring
    - `async _resolve_deployed_target_branch(self, db_name, ontology_commit_id)` (line 286): no docstring
    - `async _resolve_read_branches(self, db_name, branch)` (line 318): no docstring
    - `async create_resource(self, db_name, branch, resource_type, resource_id, payload)` (line 338): no docstring
    - `async update_resource(self, db_name, branch, resource_type, resource_id, payload)` (line 369): no docstring
    - `async delete_resource(self, db_name, branch, resource_type, resource_id)` (line 407): no docstring
    - `async get_resource(self, db_name, branch, resource_type, resource_id)` (line 426): no docstring
    - `async list_resources(self, db_name, branch, resource_type, limit, offset)` (line 450): no docstring
    - `async promote_branch_resources(self, db_name, source_branch, target_branch)` (line 475): no docstring
    - `async materialize_commit_snapshot(self, db_name, source_branch, ontology_commit_id)` (line 544): no docstring
    - `async _insert_resource_document_postgres(self, db_name, branch, doc)` (line 560): no docstring
    - `async _upsert_resource_document_postgres(self, db_name, branch, doc)` (line 632): no docstring
    - `async _append_resource_version_postgres(self, conn, db_name, branch, resource_type, resource_id, version, operation, snapshot, created_at)` (line 708): no docstring
    - `async _delete_resource_postgres(self, db_name, branch, resource_type, resource_id)` (line 746): no docstring
    - `async _get_resource_document_postgres(self, db_name, branch, resource_type, resource_id)` (line 793): no docstring
    - `async _list_resource_documents_postgres(self, db_name, branch, resource_type, limit, offset)` (line 823): no docstring
    - `_payload_to_document(self, resource_type, resource_id, payload, doc_id, is_create, existing)` (line 872): no docstring
    - `_document_to_payload(self, doc)` (line 946): no docstring
    - `_row_to_document(self, row)` (line 967): no docstring
...
- **Functions**
  - `_append_doc(fn, extra)` (line 12): no docstring
  - `deprecated(reason, version, alternative, removal_version)` (line 21): Decorator to mark a function as deprecated.
  - `legacy_api(reason)` (line 71): Decorator to mark a callable as a legacy API.
  - `experimental(feature)` (line 86): Decorator to mark a callable as experimental.
...
- **Classes**
  - `_OntologyCommandPayload` (line 78): no docstring
  - `_OntologyCommandParseError` (line 83): no docstring
  - `OntologyWorker` (line 87): 온톨로지 Command를 처리하는 워커
    - `__init__(self)` (line 94): no docstring
    - `_extract_key_spec_from_payload(payload)` (line 145): Extract ordered primary/title keys from an ontology payload.
    - `_uses_resource_registry_for_ontology(self)` (line 183): no docstring
    - `_ontology_resource_service(self)` (line 186): no docstring
    - `_ontology_resource_payload(payload, class_id)` (line 190): no docstring
    - `_ontology_from_resource(resource, class_id)` (line 214): no docstring
    - `async initialize(self)` (line 230): 워커 초기화
    - `async _publish_to_dlq(self, msg, stage, error, attempt_count, payload_text, payload_obj, kafka_headers, fallback_metadata)` (line 301): no docstring
    - `async process_command(self, command_data)` (line 329): Command 처리
    - `async handle_create_ontology(self, command_data)` (line 374): 온톨로지 생성 처리
    - `async handle_update_ontology(self, command_data)` (line 559): 온톨로지 업데이트 처리
    - `async handle_delete_ontology(self, command_data)` (line 762): 온톨로지 삭제 처리
    - `async handle_create_database(self, command_data)` (line 950): 데이터베이스 생성 처리
    - `async handle_delete_database(self, command_data)` (line 1004): 데이터베이스 삭제 처리
    - `_to_domain_envelope(self, event, kafka_topic)` (line 1051): no docstring
    - `async publish_event(self, event)` (line 1099): 이벤트 발행 (Event Sourcing: S3/MinIO -> EventPublisher -> Kafka).
    - `async publish_failure_event(self, command_data, error)` (line 1111): 실패 이벤트 발행
    - `_parse_payload(self, payload)` (line 1133): no docstring
    - `_fallback_metadata(self, payload)` (line 1209): no docstring
    - `_registry_key(self, payload)` (line 1212): no docstring
    - `async _process_payload(self, payload)` (line 1233): no docstring
    - `_span_name(self, payload)` (line 1237): no docstring
    - `_span_attributes(self, msg, payload, registry_key)` (line 1240): no docstring
    - `_is_retryable_error(exc, payload)` (line 1263): no docstring
    - `async _on_retry_scheduled(self, payload, error, attempt_count, backoff_s, retryable)` (line 1266): no docstring
    - `async _on_terminal_failure(self, payload, error, attempt_count, retryable)` (line 1300): no docstring
    - `async run(self)` (line 1328): 메인 실행 루프
    - `async shutdown(self)` (line 1341): 워커 종료
...
- **Functions**
  - `_schema_column_names(columns)` (line 169): no docstring
  - `_resolve_declared_output_kind(declared_outputs, output_node_id, output_name)` (line 228): no docstring
  - `_validate_output_kind_metadata(output_kind, output_metadata, node_id)` (line 283): no docstring
  - `async main()` (line 6758): no docstring
- **Classes**
  - `_PipelinePayloadParseError` (line 181): no docstring
    - `__init__(self, stage, payload_text, payload_obj, cause)` (line 182): no docstring
  - `_OutputNodeValidationError` (line 197): no docstring
    - `__init__(self, stage, node_id, errors, row_count, payload)` (line 198): no docstring
  - `_DatasetInputLoadContext` (line 216): no docstring
  - `PipelineWorker` (line 295): no docstring
    - `__init__(self)` (line 296): no docstring
    - `_build_error_payload(self, message, errors, code, category, status_code, external_code, stage, job, pipeline_id, node_id, mode, context)` (line 379): no docstring
    - `async initialize(self)` (line 425): no docstring
    ...
    - `async _run_preview_mode(self, job, definition, nodes, target_node_ids, tables, input_snapshots, input_sampling, temp_dirs, preview_limit, execution_semantics, declared_outputs, pipeline_spec_hash, pipeline_spec_commit_id, code_version, spark_conf, input_commit_payload, inputs_payload, record_preview, record_run, record_artifact)` (line 1210): no docstring
    - `_build_output_validation_payload(self, stage, errors, job, node_id, execution_semantics, output_name)` (line 1425): no docstring
    - `async _prepare_output_work_item(self, mode_label, job, definition, declared_outputs, output_nodes, node_id, output_df, pipeline_ref, output_write_mode, execution_semantics, has_incremental_input, incremental_inputs_have_additive_updates, preview_limit, temp_dirs, persist_output, persisted_dfs)` (line 1469): no docstring
    - `_log_output_validation_failure(self, mode_label, failure)` (line 1701): no docstring
    - `async _record_build_output_failure(self, job, failure, input_commit_payload, inputs_payload, record_run, record_artifact, emit_job_event)` (line 1720): no docstring
    - `async _record_deploy_output_failure(self, job, failure, input_commit_payload, inputs_payload, record_build, record_run, record_artifact, emit_job_event)` (line 1749): no docstring
    - `async _prepare_build_output_work(self, job, lock, tables, target_node_ids, output_nodes, definition, declared_outputs, pipeline_ref, output_write_mode, execution_semantics, has_incremental_input, incremental_inputs_have_additive_updates, preview_limit, temp_dirs, persisted_dfs, input_commit_payload, inputs_payload, record_run, record_artifact, emit_job_event)` (line 1783): no docstring
    - `async _create_build_branch(self, artifact_repo, pipeline_ref, run_ref, base_branch)` (line 1848): no docstring
    - `async _materialize_build_outputs(self, job, artifact_repo, build_branch, base_branch, output_work, output_write_mode, execution_semantics, incremental_inputs_have_additive_updates)` (line 1872): no docstring
    - `async _run_build_mode(self, job, lock, tables, target_node_ids, output_nodes, definition, declared_outputs, pipeline_ref, run_ref, execution_semantics, diff_empty_inputs, has_incremental_input, incremental_inputs_have_additive_updates, preview_limit, temp_dirs, persisted_dfs, input_snapshots, input_commit_payload, inputs_payload, pipeline_spec_hash, pipeline_spec_commit_id, code_version, spark_conf, record_build, record_run, record_artifact, emit_job_event)` (line 1974): no docstring
    - `async _prepare_deploy_output_work(self, job, lock, tables, target_node_ids, output_nodes, definition, declared_outputs, pipeline_ref, output_write_mode, execution_semantics, has_incremental_input, incremental_inputs_have_additive_updates, preview_limit, temp_dirs, persisted_dfs, input_commit_payload, inputs_payload, record_build, record_run, record_artifact, emit_job_event)` (line 2167): no docstring
    - `async _create_deploy_run_branch(self, artifact_repo, base_branch, pipeline_ref, run_ref)` (line 2234): no docstring
    - `async _materialize_deploy_staged_outputs(self, job, run_branch, artifact_repo, base_branch, output_work, output_write_mode, execution_semantics, incremental_inputs_have_additive_updates)` (line 2258): no docstring
    - `async _commit_and_merge_deploy_branch(self, job, lock, pipeline_ref, artifact_repo, run_branch, base_branch)` (line 2335): no docstring
    - `async _stage_deploy_outputs(self, job, lock, pipeline_ref, run_ref, artifact_repo, base_branch, output_work, output_write_mode, execution_semantics, incremental_inputs_have_additive_updates)` (line 2381): no docstring
    - `_build_deploy_version_sample_payload(self, item, schema_columns, output_sample, total_row_count, delta_row_count, resolved_runtime_write_mode)` (line 2421): no docstring
    - `async _resolve_deploy_output_publication(self, job, pipeline_ref, artifact_repo, base_branch, merge_commit_id, output_write_mode, item)` (line 2447): no docstring
    - `_build_deploy_output_record(self, item, publication, merge_commit_id, base_branch)` (line 2513): no docstring
    - `async _record_deploy_output_lineage(self, job, pipeline_ref, artifact_key, dataset_name, node_id, merge_commit_id, base_branch)` (line 2548): no docstring
    - `async _publish_deploy_outputs(self, job, pipeline_ref, artifact_repo, base_branch, merge_commit_id, output_write_mode, staged_outputs)` (line 2598): no docstring
    - `_merge_watermark_keys(self, next_watermark, previous_watermark, previous_watermark_keys, next_watermark_keys)` (line 2639): no docstring
    - `async _persist_deploy_watermarks(self, resolved_pipeline_id, branch, execution_semantics, input_snapshots, watermark_column, previous_watermark, previous_watermark_keys)` (line 2670): no docstring
    - `async _run_deploy_mode(self, job, lock, tables, target_node_ids, output_nodes, definition, declared_outputs, pipeline_ref, run_ref, execution_semantics, diff_empty_inputs, has_incremental_input, incremental_inputs_have_additive_updates, preview_limit, temp_dirs, persisted_dfs, input_snapshots, input_commit_payload, inputs_payload, pipeline_spec_hash, pipeline_spec_commit_id, code_version, spark_conf, resolved_pipeline_id, previous_watermark, previous_watermark_keys, watermark_column, record_build, record_run, record_artifact, emit_job_event)` (line 2740): no docstring
    - `async _resolve_execution_node_dataframe(self, job, node_id, node, tables, incoming, parameters, preview_meta, preview_sampling_seed, input_snapshots, input_sampling, temp_dirs, previous_input_commits, use_lakefs_diff, execution_semantics, watermark_column, previous_watermark, previous_watermark_keys, is_preview)` (line 2932): no docstring
    - `async _record_schema_check_failure(self, job, node_id, schema_errors, execution_semantics, is_preview, is_build, run_mode, input_commit_payload, record_preview, record_build, record_run, record_artifact, emit_job_event)` (line 3005): no docstring
    - `async _record_validation_failure(self, job, validation_errors, execution_semantics, pipeline_spec_hash, pipeline_spec_commit_id, is_preview, is_build, run_mode, record_preview, record_build, record_run, record_artifact, emit_job_event)` (line 3060): no docstring
    - `_derive_post_node_execution_state(self, input_snapshots, execution_semantics, preview_limit)` (line 3118): no docstring
    - `_validate_execution_prerequisites(self)` (line 3158): no docstring
    - `_build_execution_graph(self, definition)` (line 3166): no docstring
    - `async _resolve_execution_pipeline_context(self, job, definition, execution_semantics)` (line 3191): no docstring
    - `_resolve_run_mode(self, job)` (line 3252): no docstring
    - `_build_run_record_callbacks(self, resolved_pipeline_id, pipeline_spec_hash, pipeline_spec_commit_id, spark_conf, code_version)` (line 3259): no docstring
    - `_build_artifact_recorder_callback(self, job, resolved_pipeline_id, run_mode, declared_outputs, pipeline_spec_hash, pipeline_spec_commit_id)` (line 3296): no docstring
    - `_build_job_event_callback(self, job, pipeline_ref, run_mode, execution_semantics)` (line 3352): no docstring
    - `_build_artifact_event_callbacks(self, job, resolved_pipeline_id, pipeline_ref, run_mode, execution_semantics, declared_outputs, pipeline_spec_hash, pipeline_spec_commit_id)` (line 3396): no docstring
    - `_build_execution_recorders(self, job, resolved_pipeline_id, pipeline_ref, run_mode, execution_semantics, declared_outputs, pipeline_spec_hash, pipeline_spec_commit_id, spark_conf, code_version)` (line 3428): no docstring
    - `async _start_execution_tracking(self, job, resolved_pipeline_id, run_mode, is_preview, is_build, artifact_state, record_preview, record_build, record_run, record_artifact)` (line 3468): no docstring
    - `async _execute_ordered_nodes(self, job, order_run, nodes, tables, incoming, parameters, preview_meta, preview_sampling_seed, input_snapshots, input_sampling, temp_dirs, previous_input_commits, use_lakefs_diff, execution_semantics, watermark_column, previous_watermark, previous_watermark_keys, is_preview, is_build, run_mode, input_commit_payload, record_preview, record_build, record_run, record_artifact, emit_job_event)` (line 3517): no docstring
    - `async _record_execution_failure(self, job, exc, is_preview, is_build, run_mode, input_commit_payload, record_preview, record_build, record_run, emit_job_event)` (line 3596): no docstring
    - `async _cleanup_execution_resources(self, lock, temp_dirs, persisted_dfs, prev_spark_conf, prev_cast_mode)` (line 3647): no docstring
    - `async _execute_job(self, job)` (line 3682): no docstring
    - `async _maybe_enqueue_objectify_job(self, dataset, version)` (line 3977): no docstring
    - `async _maybe_enqueue_relationship_jobs(self, dataset, version)` (line 4110): no docstring
    - `async _materialize_output_by_kind(self, output_kind, output_metadata, df, artifact_bucket, prefix, db_name, branch, dataset_name, execution_semantics, incremental_inputs_have_additive_updates, write_mode, file_prefix, file_format, partition_cols, base_row_count)` (line 4224): no docstring
    - `async _materialize_dataset_output(self, output_metadata, df, artifact_bucket, prefix, db_name, branch, dataset_name, execution_semantics, incremental_inputs_have_additive_updates, write_mode, file_prefix, file_format, partition_cols, base_row_count)` (line 4322): no docstring
    - `async _materialize_geotemporal_output(self, output_metadata, df, artifact_bucket, prefix, write_mode, file_prefix, file_format, partition_cols)` (line 4491): no docstring
    - `async _materialize_media_output(self, output_metadata, df, artifact_bucket, prefix, write_mode, file_prefix, file_format, partition_cols)` (line 4525): no docstring
    - `async _materialize_virtual_output(self, output_metadata, df, artifact_bucket, prefix, write_mode, file_prefix, file_format, partition_cols, row_count_hint)` (line 4558): no docstring
    - `async _materialize_ontology_output(self, output_metadata, df, artifact_bucket, prefix, write_mode, file_prefix, file_format, partition_cols)` (line 4625): no docstring
    - `_ensure_output_columns_present(self, df, required_columns, output_kind)` (line 4655): no docstring
    - `async _load_existing_output_dataset(self, db_name, branch, dataset_name)` (line 4671): no docstring
    - `_align_columns(self, df, columns)` (line 4707): no docstring
    - `_select_new_or_changed_rows(self, input_df, existing_df, pk_columns, dedupe_input)` (line 4717): no docstring
    - `_post_filter_false_expr(self, post_filtering_column)` (line 4745): no docstring
    - `async _materialize_output_dataframe(self, df, artifact_bucket, prefix, write_mode, file_prefix, file_format, partition_cols)` (line 4749): no docstring
    - `_row_hash_expr(self, df)` (line 4861): no docstring
    - `_apply_watermark_filter(self, df, watermark_column, watermark_after, watermark_keys)` (line 4874): no docstring
    - `_collect_watermark_keys(self, df, watermark_column, watermark_value)` (line 4897): no docstring
    - `_build_dataset_input_snapshot(self, node_id, context, lakefs_commit_id)` (line 4924): no docstring
    - `_annotate_diff_snapshot(self, snapshot, previous_commit_id, diff_ok, diff_paths_count)` (line 4943): no docstring
    - `_append_input_snapshot(self, input_snapshots, snapshot)` (line 4961): no docstring
    - `async _load_external_input_dataframe_with_snapshot(self, read_config, node_id, temp_dirs, input_snapshots)` (line 4970): no docstring
    - `async _resolve_dataset_input_load_context(self, db_name, node_id, selection, input_snapshots)` (line 5022): no docstring
    - `async _load_full_dataset_input_dataframe(self, context, metadata, temp_dirs, node_id)` (line 5092): no docstring
    - `async _apply_input_watermark_and_snapshot(self, df, node_id, snapshot, watermark_column, watermark_after, watermark_keys, label_scope, tolerate_max_errors, always_compute_watermark_max)` (line 5113): no docstring
    - `async _try_load_diff_input_dataframe(self, context, node_id, temp_dirs, input_snapshots, base_snapshot, previous_commit_id, use_lakefs_diff, watermark_column, watermark_after, watermark_keys)` (line 5184): no docstring
    - `async _load_input_dataframe(self, db_name, metadata, temp_dirs, branch, node_id, input_snapshots, previous_commit_id, use_lakefs_diff, watermark_column, watermark_after, watermark_keys)` (line 5257): no docstring
    - `_preview_sampling_seed(self, job_id)` (line 5326): no docstring
    - `_resolve_sampling_strategy(self, metadata, preview_meta)` (line 5330): no docstring
    - `_attach_sampling_snapshot(self, input_snapshots, node_id, sampling_strategy)` (line 5346): no docstring
    - `_normalize_sampling_fraction(self, value, field)` (line 5358): no docstring
    - `_apply_sampling_strategy(self, df, sampling_strategy, node_id, seed)` (line 5367): no docstring
    - `_strip_commit_prefix(self, key, commit_id)` (line 5412): no docstring
    - `async _list_lakefs_diff_paths(self, repository, ref, since, prefix, node_id)` (line 5418): no docstring
    - `async _load_parquet_keys_dataframe(self, bucket, keys, temp_dirs, prefix)` (line 5464): no docstring
    - `async _load_media_prefix_dataframe(self, bucket, key, node_id)` (line 5498): Treat the artifact_key as an unstructured/media prefix.
    - `async _resolve_pipeline_id(self, job)` (line 5549): no docstring
    - `_collect_spark_conf(self)` (line 5568): no docstring
    - `_build_input_commit_payload(self, input_snapshots)` (line 5584): no docstring
    - `async _acquire_pipeline_lock(self, job)` (line 5608): no docstring
    - `_validate_required_subgraph(self, nodes, incoming, required_node_ids)` (line 5639): no docstring
    - `_validate_definition(self, definition, require_output)` (line 5655): no docstring
    - `_build_table_ops(self, df)` (line 5733): no docstring
    - `_sql_ident(self, name)` (line 5804): no docstring
    - `_clean_string_column(self, column)` (line 5807): no docstring
    - `_try_cast_column(self, column, spark_type)` (line 5811): no docstring
    - `_safe_cast_column(self, column, target_type)` (line 5837): no docstring
    - `_apply_casts(self, df, casts)` (line 5848): no docstring
    - `_apply_schema_casts(self, df, dataset, version)` (line 5860): no docstring
    - `_parse_fk_expectation(self, expectation, default_branch)` (line 5869): no docstring
    - `async _load_fk_reference_dataframe(self, db_name, dataset_id, dataset_name, branch, temp_dirs)` (line 5917): no docstring
    - `async _evaluate_fk_expectations(self, expectations, output_df, db_name, branch, temp_dirs)` (line 5948): no docstring
    - `_normalize_read_options(self, read_config)` (line 6017): no docstring
    - `_mask_sensitive_options(self, options)` (line 6053): no docstring
    - `_schema_ddl_from_read_config(self, read_config)` (line 6074): no docstring
    - `_resolve_read_format(self, path, read_config)` (line 6097): no docstring
    - `_resolve_streaming_checkpoint_location(self, read_config, node_id)` (line 6116): no docstring
    - `_resolve_kafka_value_format(self, read_config)` (line 6131): no docstring
    - `_resolve_kafka_schema_registry_headers(self, read_config)` (line 6146): no docstring
    - `_resolve_kafka_avro_schema(self, read_config, node_id)` (line 6192): no docstring
    - `_apply_kafka_value_parsing(self, df, read_config, node_id)` (line 6224): no docstring
    - `_load_external_streaming_dataframe(self, read_config, node_id, fmt, temp_dirs)` (line 6275): no docstring
    - `_load_external_input_dataframe(self, read_config, node_id, temp_dirs)` (line 6376): Load an input DataFrame directly from Spark using metadata.read (no DatasetRegistry artifact).
    - `async _load_artifact_dataframe(self, bucket, key, temp_dirs, read_config)` (line 6476): no docstring
    - `async _collect_prefix_local_paths(self, bucket, prefix, temp_dirs)` (line 6498): no docstring
    - `async _read_prefix_dataframe_from_local_paths(self, temp_dir, local_paths, read_config, bucket, prefix)` (line 6531): no docstring
    - `async _load_prefix_dataframe(self, bucket, prefix, temp_dirs, read_config)` (line 6596): no docstring
    - `async _download_object_to_path(self, bucket, key, local_path)` (line 6620): no docstring
    - `async _download_object(self, bucket, key, temp_dirs, temp_dir)` (line 6633): no docstring
    - `_read_local_file(self, path, read_config)` (line 6649): no docstring
    - `_strip_bom_headers(self, df)` (line 6676): Normalize UTF-8 BOM artifacts in CSV headers.
    - `_load_excel_path(self, path)` (line 6716): no docstring
    - `_load_json_path(self, path, reader)` (line 6722): no docstring
    - `_empty_dataframe(self)` (line 6739): no docstring
    - `_apply_transform(self, metadata, inputs, parameters)` (line 6742): no docstring
...
- **Classes**
  - `ProjectionWorker` (line 66): Instance와 Ontology 이벤트를 Elasticsearch에 프로젝션하는 워커
    ...
    - `_normalize_localized_field(value, default_lang)` (line 158): no docstring
    - `_normalize_ontology_properties(self, properties, default_lang)` (line 168): no docstring
    - `_normalize_ontology_relationships(self, relationships, default_lang)` (line 205): no docstring
    - `_extract_envelope_metadata(event_data)` (line 254): no docstring
    - `async _record_es_side_effect(self, event_id, event_data, db_name, index_name, doc_id, operation, status, record_lineage, skip_reason, error, extra_metadata)` (line 272): Record projection side-effects for provenance (lineage) + audit.
    - `async initialize(self)` (line 374): 워커 초기화
    - `async _setup_indices(self)` (line 444): 매핑 파일 로드 (인덱스는 DB별로 동적 생성)
    - `async _ensure_index_exists(self, db_name, index_type, branch)` (line 456): 특정 데이터베이스의 인덱스가 존재하는지 확인하고 없으면 생성
    - `async _load_mapping(self, filename)` (line 553): 매핑 파일 로드
    - `async run(self)` (line 567): 메인 실행 루프
    - `_span_name(self, payload)` (line 579): no docstring
    - `_registry_handler(self, msg, payload)` (line 582): no docstring
    - `_registry_key(self, payload)` (line 585): no docstring
    - `_is_retryable_error(self, exc, payload)` (line 592): no docstring
    - `_max_retries_for_error(self, exc, payload, error, retryable)` (line 597): no docstring
    - `_backoff_seconds_for_error(self, exc, payload, error, attempt_count, retryable)` (line 609): no docstring
    - `_in_progress_sleep_seconds(self, claim, payload)` (line 621): no docstring
    - `async _on_retry_scheduled(self, payload, error, attempt_count, backoff_s, retryable)` (line 632): no docstring
    - `async _on_terminal_failure(self, payload, error, attempt_count, retryable)` (line 662): no docstring
    - `async _on_parse_error(self, msg, raw_payload, error)` (line 676): no docstring
    - `async _commit(self, msg)` (line 708): no docstring
    - `async _publish_to_dlq(self, msg, error, attempt_count, payload_text, kafka_headers, fallback_metadata)` (line 714): no docstring
    - `async _send_to_dlq(self, msg, payload, raw_payload, error, attempt_count)` (line 750): no docstring
    - `async _process_payload(self, payload)` (line 780): no docstring
    - `async _handle_ontology_event(self, event_data)` (line 808): 온톨로지 이벤트 처리
    - `async _handle_action_event(self, event_data)` (line 832): Action writeback events -> overlay projection.
    - `async _handle_action_applied(self, action_data, event_id, event_data)` (line 847): no docstring
    - `async _handle_ontology_class_created(self, ontology_data, event_id, event_data)` (line 1005): 온톨로지 클래스 생성 이벤트 처리
    - `async _handle_ontology_class_updated(self, ontology_data, event_id, event_data)` (line 1188): 온톨로지 클래스 업데이트 이벤트 처리
    - `async _handle_ontology_class_deleted(self, ontology_data, event_id, event_data)` (line 1387): 온톨로지 클래스 삭제 이벤트 처리
    - `async _handle_database_created(self, db_data, event_id, event_data)` (line 1642): 데이터베이스 생성 이벤트 처리
    - `async _handle_database_deleted(self, db_data, event_id, event_data)` (line 1698): 데이터베이스 삭제 이벤트 처리
    - `async _get_class_label(self, class_id, db_name, branch)` (line 1778): Redis에서 클래스 라벨 조회 (Cache Stampede 방지)
    - `async _get_class_label_fallback(self, class_id, db_name, branch)` (line 1884): 락 획득 실패 시 fallback 조회 (성능보다 안정성 우선)
    - `get_cache_efficiency_metrics(self)` (line 1920): 캐시 효율성 및 락 경합 메트릭 반환
    - `log_cache_metrics(self)` (line 1973): 캐시 메트릭을 로그로 출력
    - `async _cache_class_label(self, class_id, label, db_name, branch)` (line 1992): 클래스 라벨을 Redis에 캐싱
    - `_normalize_properties(self, properties)` (line 2007): 속성을 검색 최적화된 형태로 정규화
    - `_is_transient_infra_error(error)` (line 2019): Return True for errors that are expected to recover via retry (e.g. ES outage).
    - `async _shutdown(self)` (line 2043): 워커 종료
...
- **Functions**
  - `check_service_imports(service_dir)` (line 20): Check what external libraries a service actually imports
  - `audit_service(service_name, service_dir)` (line 48): Comprehensive audit of a single service
  - `main()` (line 102): Main audit execution
...
- **Functions**
  - `fix_datetime_in_file(filepath)` (line 10): Fix datetime deprecation in a single file
  - `main()` (line 52): Fix all Python files with datetime deprecation

### `backend/scripts/migrations/migrate_lineage_es_aliases_to_canonical.py`
- **Functions**
  - `_build_parser()` (line 17): no docstring
  - `async _run(dsn, schema)` (line 24): no docstring
  - `main()` (line 106): no docstring

### `backend/scripts/migrations/migrate_lineage_s3_edge_alias_to_canonical.py`
- **Functions**
  - `_build_parser()` (line 17): no docstring
  - `async _run(dsn, schema)` (line 24): no docstring
  - `main()` (line 40): no docstring
...
- **Functions**
  ...
  - `check_single_source_compliance()` (line 104): Verify that all services use only -e ../shared in requirements.txt
  - `main()` (line 140): Main audit execution
...
- **Functions**
  - `_redact_url(url)` (line 29): no docstring
  - `async main()` (line 306): no docstring
- **Classes**
  - `EnvironmentValidator` (line 48): no docstring
    - `__init__(self)` (line 49): no docstring
    - `print_header(self, title)` (line 54): no docstring
    - `check_result(self, name, success, message)` (line 59): no docstring
    - `validate_effective_settings(self)` (line 68): no docstring
    - `async check_postgresql(self)` (line 94): no docstring
    - `async check_redis(self)` (line 139): no docstring
    - `async check_elasticsearch(self)` (line 155): no docstring
    - `check_kafka(self)` (line 178): no docstring
    - `async check_services(self)` (line 210): no docstring
    - `check_docker_config(self)` (line 232): no docstring
    - `async check_workers(self)` (line 251): no docstring
    - `async run_all_checks(self)` (line 275): no docstring
...
- **Functions**
  - `_parse_ts(value)` (line 35): no docstring
  - `_to_iso(value)` (line 45): no docstring
  - `async _collect_instance_events(event_store, from_ts, to_ts, max_events)` (line 49): no docstring
  - `async _run(args)` (line 70): no docstring
  - `_build_arg_parser()` (line 202): no docstring
  - `main()` (line 230): no docstring
...
- **Functions**
  - `__getattr__(name)` (line 170): Lazy, drift-free compatibility exports.
- **Classes**
  - `Config` (line 34): 통합 설정 클래스
    ...
    - `get_minio_url()` (line 66): MinIO 연결 URL
    - `get_instances_index_name(db_name, version)` (line 75): 인스턴스 Elasticsearch 인덱스 이름
    - `get_ontologies_index_name(db_name, version)` (line 80): 온톨로지 Elasticsearch 인덱스 이름
    - `sanitize_index_name(name)` (line 85): Elasticsearch 인덱스 이름 정제
    - `get_default_index_settings()` (line 90): 기본 인덱스 설정
    - `validate_all_config(cls)` (line 99): 모든 설정의 유효성 검증
    - `get_full_config_summary(cls)` (line 128): 전체 시스템 설정 요약 반환
...
- **Classes**
  ...
  - `AppConfig` (line 25): SPICE HARVESTER 애플리케이션 전체 설정 중앙 관리 클래스
    ...
    - `_normalize_object_type_id(value)` (line 182): no docstring
    - `get_writeback_enabled_object_types(cls)` (line 196): no docstring
    - `is_writeback_enabled_object_type(cls, class_id)` (line 205): no docstring
    - `get_ontology_writeback_branch(cls, db_name)` (line 215): Return a lakeFS-compatible writeback branch id.
    - `sanitize_lakefs_branch_id(value)` (line 230): no docstring
    - `validate_config(cls)` (line 284): 설정값들의 유효성 검증
    - `get_all_topics(cls)` (line 313): 모든 Kafka 토픽 목록 반환
    - `get_config_summary(cls)` (line 346): 현재 설정 요약 반환 (디버깅용)

### `backend/shared/config/instances_index_mapping.py`
...
- **Functions**
  - `get_oms_url()` (line 453): Get OMS URL - convenience function.
  - `get_bff_url()` (line 458): Get BFF URL - convenience function.
  - `get_agent_url()` (line 463): Get Agent URL - convenience function.
- **Classes**
  ...
  - `ServiceConfig` (line 36): Centralized service configuration management.
    - `get_oms_port()` (line 52): Get OMS (Ontology Management Service) port from environment or default.
    - `get_bff_port()` (line 57): Get BFF (Backend for Frontend) port from environment or default.
    - `get_agent_port()` (line 62): Get Agent service port from environment or default.
    - `get_oms_host()` (line 67): Get OMS host from environment or default.
    - `get_bff_host()` (line 72): Get BFF host from environment or default.
    - `get_agent_host()` (line 77): Get Agent host from environment or default.
    - `get_oms_url()` (line 82): Get complete OMS URL from environment or construct from host/port.
    - `get_bff_url()` (line 94): Get complete BFF URL from environment or construct from host/port.
    - `get_agent_url()` (line 106): Get complete Agent URL from environment or construct from host/port.
    - `get_postgres_url()` (line 118): Get PostgreSQL connection URL from environment or default.
    - `get_kafka_bootstrap_servers()` (line 123): Get Kafka bootstrap servers from environment or default.
    - `get_redis_host()` (line 128): Get Redis host from environment or default.
    - `get_redis_port()` (line 133): Get Redis port from environment or default.
    - `get_redis_url()` (line 138): Get Redis connection URL from environment or construct from host/port.
    - `get_elasticsearch_host()` (line 143): Get Elasticsearch host from environment or default.
    - `get_elasticsearch_port()` (line 148): Get Elasticsearch port from environment or default.
    - `get_elasticsearch_url()` (line 153): Get Elasticsearch base URL from environment or construct from host/port.
    - `is_docker_environment()` (line 158): Check if running in Docker environment.
    - `get_minio_endpoint()` (line 167): Get MinIO/S3 endpoint URL.
    - `get_minio_access_key()` (line 172): Get MinIO/S3 access key.
    - `get_minio_secret_key()` (line 177): Get MinIO/S3 secret key.
    - `get_event_store_bucket()` (line 182): Get S3/MinIO bucket name for immutable event store.
    - `get_lakefs_api_url()` (line 187): Get lakeFS API base URL.
    - `get_lakefs_s3_endpoint()` (line 198): Get lakeFS S3 Gateway endpoint URL.
    - `get_service_url(service_name)` (line 207): Get URL for a specific service by name.
    - `get_all_service_urls()` (line 232): Get all service URLs as a dictionary.
    - `validate_configuration()` (line 241): Validate that all required configuration is present.
    - `use_https()` (line 258): Check if HTTPS should be used for service communication.
    - `is_production()` (line 268): Check if running in production environment.
    - `is_debug_endpoints_enabled()` (line 273): Enable opt-in debug endpoints (never on by default).
    - `get_ssl_cert_path()` (line 278): Get SSL certificate path from environment.
    - `get_ssl_key_path()` (line 290): Get SSL key path from environment.
    - `get_ssl_ca_path()` (line 302): Get SSL CA certificate path from environment.
    - `verify_ssl()` (line 314): Check if SSL certificate verification should be enabled.
    - `get_protocol()` (line 329): Get the protocol to use for service communication.
    - `get_ssl_config()` (line 339): Get complete SSL configuration as a dictionary.
    - `get_client_ssl_config()` (line 349): Get SSL configuration for HTTP clients (requests, httpx).
    - `get_cors_origins()` (line 361): Get CORS allowed origins from environment variables.
    - `_get_environment_default_origins()` (line 376): Get environment-based default CORS origins.
    - `_get_dev_cors_origins()` (line 395): Get development CORS origins for common frontend ports.
    - `get_cors_config()` (line 422): Get complete CORS configuration for FastAPI middleware.
    - `is_cors_enabled()` (line 432): Check if CORS should be enabled.
    - `get_cors_debug_info()` (line 442): Get CORS configuration debug information.
...
- **Functions**
  ...
  - `get_settings()` (line 4236): Get the global settings instance
  - `reload_settings()` (line 4250): Reload settings from environment (useful for testing)
  - `build_client_ssl_config(settings)` (line 4262): SSL config for HTTP clients (httpx/requests/etc).
  - `build_server_ssl_config(settings)` (line 4283): SSL config for uvicorn (server-side TLS).
  - `_get_dev_cors_origins()` (line 4313): no docstring
  - `_get_environment_default_origins(settings)` (line 4329): no docstring
  - `resolve_cors_origins(settings)` (line 4339): Resolve CORS origins with production safety.
  - `build_cors_middleware_config(settings)` (line 4381): no docstring
  - `get_cors_debug_info(settings)` (line 4411): no docstring
- **Classes**
  - `Environment` (line 107): Application environment types
  - `DatabaseSettings` (line 114): Database configuration settings
    - `clamp_elasticsearch_default_shards(cls, v)` (line 221): no docstring
    - `clamp_elasticsearch_default_replicas(cls, v)` (line 226): no docstring
    - `postgres_url(self)` (line 235): Construct PostgreSQL connection URL
    - `kafka_servers(self)` (line 242): Get Kafka bootstrap servers
    - `elasticsearch_url(self)` (line 249): Construct Elasticsearch URL with authentication
    - `redis_url(self)` (line 258): Construct Redis URL
  - `ServiceSettings` (line 267): Service configuration settings
    - `get_oms_base_url_override(cls, v)` (line 361): no docstring
    - `get_bff_base_url_override(cls, v)` (line 369): no docstring
    - `get_agent_base_url_override(cls, v)` (line 377): no docstring
    - `resolve_funnel_excel_timeout(cls, v)` (line 385): no docstring
    - `clamp_funnel_excel_timeout(cls, v)` (line 393): no docstring
    - `resolve_funnel_infer_timeout(cls, v)` (line 402): no docstring
    - `clamp_funnel_infer_timeout(cls, v)` (line 410): no docstring
    - `oms_base_url(self)` (line 418): Construct OMS base URL
    - `bff_base_url(self)` (line 426): Construct BFF base URL
    - `agent_base_url(self)` (line 434): Construct Agent base URL
    - `cors_origins_list(self)` (line 442): Parse CORS origins from JSON string
  - `LLMSettings` (line 454): LLM gateway settings (shared across services).
    - `fallback_anthropic_api_key(cls, v)` (line 541): no docstring
    - `fallback_google_api_key(cls, v)` (line 549): no docstring
    - `fallback_openai_api_key(cls, v)` (line 557): no docstring
    - `fallback_openai_base_url(cls, v)` (line 571): no docstring
    - `fallback_openai_model(cls, v)` (line 585): no docstring
    - `anthropic_api_key_effective(self)` (line 598): no docstring
    - `google_api_key_effective(self)` (line 602): no docstring
    - `mock_json_for_task(self, task)` (line 605): Resolve the mock provider JSON payload for a task.
  - `ObservabilitySettings` (line 648): Logging/observability settings (shared across services/workers).
    - `normalize_log_level(cls, v)` (line 762): no docstring
    - `fallback_run_id(cls, v)` (line 779): no docstring
    - `fallback_code_sha(cls, v)` (line 790): no docstring
    - `normalize_otel_service_version(cls, v)` (line 801): no docstring
    - `normalize_jaeger_endpoint(cls, v)` (line 807): no docstring
    - `clamp_trace_sample_rate(cls, v)` (line 813): no docstring
    - `parse_otel_export_otlp(cls, v)` (line 826): no docstring
    - `clamp_metric_export_interval_seconds(cls, v)` (line 831): no docstring
    - `service_name_effective(self)` (line 839): no docstring
    - `lineage_required_effective(self)` (line 847): no docstring
    - `enterprise_catalog_ref_effective(self)` (line 855): no docstring
    - `otel_export_otlp_effective(self)` (line 865): no docstring
  - `GraphQuerySettings` (line 871): Graph query guardrails (graph federation).
    - `clamp_max_hops(cls, v)` (line 889): no docstring
    - `clamp_max_limit(cls, v)` (line 894): no docstring
    - `clamp_max_paths(cls, v)` (line 899): no docstring
  - `FeatureFlagsSettings` (line 903): Feature flags / opt-in endpoints.
  - `PipelineSettings` (line 954): Pipeline Builder + pipeline worker settings.
    - `fallback_publish_lock_timeout(cls, v)` (line 1145): no docstring
    - `clamp_jobs_max_retries(cls, v)` (line 1154): no docstring
    - `clamp_job_queue_flush_timeout_seconds(cls, v)` (line 1159): no docstring
    - `clamp_jobs_backoff_base_seconds(cls, v)` (line 1168): no docstring
    - `clamp_jobs_backoff_max_seconds(cls, v)` (line 1173): no docstring
    - `clamp_spark_executor_threads(cls, v)` (line 1178): no docstring
    - `clamp_spark_shuffle_partitions(cls, v)` (line 1183): no docstring
    - `clamp_spark_streaming_await_timeout_seconds(cls, v)` (line 1188): no docstring
    - `clamp_kafka_schema_registry_timeout_seconds(cls, v)` (line 1193): no docstring
    - `normalize_spark_streaming_default_trigger(cls, v)` (line 1198): no docstring
    - `clamp_lock_ttl_seconds(cls, v)` (line 1208): no docstring
    - `clamp_lock_renew_seconds(cls, v)` (line 1213): no docstring
    - `clamp_lock_retry_seconds(cls, v)` (line 1218): no docstring
    - `clamp_lock_acquire_timeout_seconds(cls, v)` (line 1223): no docstring
    - `clamp_publish_lock_acquire_timeout_seconds(cls, v)` (line 1228): no docstring
    - `clamp_scheduler_poll_seconds(cls, v)` (line 1233): no docstring
    - `protected_branches_set(self)` (line 1237): no docstring
    - `fallback_branches_list(self)` (line 1244): no docstring
  - `OntologySettings` (line 1252): Ontology API + linter governance settings.
    - `strip_protected_branches(cls, v)` (line 1325): no docstring
    - `parse_optional_bool(cls, v)` (line 1330): no docstring
    - `normalize_resource_storage_backend(cls, v)` (line 1335): no docstring
    - `protected_branches_set(self)` (line 1345): no docstring
    - `allow_implicit_primary_key_effective(self, is_production, branch)` (line 1350): no docstring
    - `allow_implicit_title_key_effective(self, is_production, branch)` (line 1359): no docstring
  - `AgentRuntimeSettings` (line 1369): Agent runtime settings (agent service tool runner).
    - `clamp_context_upload_max_bytes(cls, v)` (line 1495): no docstring
    - `clamp_context_upload_max_text_chars(cls, v)` (line 1500): no docstring
    - `clamp_context_upload_clamav_port(cls, v)` (line 1510): no docstring
    - `fallback_bff_token(cls, v)` (line 1515): no docstring
    - `fallback_command_timeout(cls, v)` (line 1523): no docstring
  - `AgentPlanSettings` (line 1533): LLM-native control plane settings (planner + allowlist bootstrap).
  - `PipelinePlanSettings` (line 1563): Pipeline plan planner settings (LLM-backed pipeline definition proposals).
  - `ClientSettings` (line 1580): Internal service-to-service client settings (BFF/OMS/etc).
    - `clamp_agent_proxy_timeout(cls, v)` (line 1613): no docstring
    - `fallback_oms_client_token(cls, v)` (line 1622): no docstring
    - `fallback_bff_admin_token(cls, v)` (line 1633): no docstring
  - `MCPSettings` (line 1643): MCP integration settings (BFF/agent).
  - `AuthSettings` (line 1665): Service auth configuration (BFF/OMS).
    - `bff_auth_disable_allowed(self)` (line 1820): no docstring
    - `oms_auth_disable_allowed(self)` (line 1824): no docstring
    - `_split_tokens(raw)` (line 1828): no docstring
    - `_tokens_from_values(cls, *values)` (line 1835): no docstring
    - `bff_expected_tokens(self)` (line 1842): no docstring
    - `bff_agent_tokens(self)` (line 1846): no docstring
    - `oms_expected_tokens(self)` (line 1850): no docstring
    - `bff_expected_token(self)` (line 1854): no docstring
    - `bff_admin_only_token(self)` (line 1864): no docstring
    - `oms_expected_token(self)` (line 1869): no docstring
    - `admin_bypass_tokens(self)` (line 1874): no docstring
    - `is_bff_auth_required(self, allow_pytest, default_required)` (line 1885): no docstring
    - `is_oms_auth_required(self, default_required)` (line 1894): no docstring
    - `_parse_exempt_paths(raw, defaults)` (line 1902): no docstring
    - `resolve_bff_exempt_paths(self, defaults)` (line 1909): no docstring
    - `resolve_oms_exempt_paths(self, defaults)` (line 1912): no docstring
    - `dev_master_role_set(self)` (line 1916): no docstring
  - `RateLimitSettings` (line 1920): Rate limiter runtime configuration.
    - `clamp_local_max_entries(cls, v)` (line 1942): no docstring
  - `MessagingSettings` (line 1946): Kafka topic/group configuration settings
  - `StorageSettings` (line 2062): Storage configuration settings
    - `normalize_minio_endpoint_url(cls, v)` (line 2117): no docstring
    - `clamp_lakefs_client_timeout(cls, v)` (line 2195): no docstring
    - `normalize_lakefs_credentials_source(cls, v)` (line 2203): no docstring
    - `use_ssl(self)` (line 2214): Determine if SSL should be used based on endpoint URL
    - `lakefs_api_url_effective(self)` (line 2219): Return lakeFS API base URL (without /api/v1).
    - `lakefs_s3_endpoint_effective(self)` (line 2227): Return lakeFS S3 Gateway endpoint URL.
  - `CacheSettings` (line 2234): Cache and TTL configuration settings
    - `clamp_command_status_ttl_seconds(cls, v)` (line 2272): no docstring
  - `SecuritySettings` (line 2276): Security configuration settings
  - `PerformanceSettings` (line 2350): Performance and optimization settings
    - `clamp_pg_pool_min(cls, v)` (line 2478): no docstring
    - `clamp_pg_pool_max(cls, v)` (line 2493): no docstring
    - `clamp_pg_command_timeout_seconds(cls, v)` (line 2508): no docstring
    - `clamp_lineage_latest_edges_max_ids(cls, v)` (line 2513): no docstring
  - `EventSourcingSettings` (line 2517): Event sourcing / CQRS tuning settings
    - `normalize_event_store_strings(cls, v)` (line 2619): no docstring
  - `BranchVirtualizationSettings` (line 2625): Branch virtualization defaults (OCC seeding).
  - `InstanceWorkerSettings` (line 2643): Instance worker runtime settings.
    - `fallback_allow_pk_generation(cls, v)` (line 2681): no docstring
    - `fallback_relationship_strict(cls, v)` (line 2687): no docstring
    - `clamp_max_retry_attempts(cls, v)` (line 2693): no docstring
    - `clamp_untyped_ref_max_retry_attempts(cls, v)` (line 2698): no docstring
    - `clamp_untyped_ref_backoff_max_seconds(cls, v)` (line 2703): no docstring
  - `OntologyWorkerSettings` (line 2711): Ontology worker runtime settings.
    - `clamp_max_retry_attempts(cls, v)` (line 2737): no docstring
  - `ProjectionWorkerSettings` (line 2741): Projection worker runtime settings.
    - `clamp_max_retries(cls, v)` (line 2763): no docstring
  - `ActionWorkerSettings` (line 2767): Action worker runtime settings.
    - `clamp_dlq_retries(cls, v)` (line 2793): no docstring
    - `clamp_max_retry_attempts(cls, v)` (line 2798): no docstring
  - `ActionOutboxSettings` (line 2802): Action outbox worker settings.
    - `clamp_batch_size(cls, v)` (line 2824): no docstring
  - `OntologyDeployOutboxSettings` (line 2828): Ontology deployment outbox worker settings (OMS embedded worker).
    - `clamp_poll_seconds(cls, v)` (line 2896): no docstring
    - `clamp_batch_size(cls, v)` (line 2901): no docstring
    - `clamp_claim_timeout_seconds(cls, v)` (line 2906): no docstring
    - `clamp_backoff_base_seconds(cls, v)` (line 2911): no docstring
    - `clamp_backoff_max_seconds(cls, v)` (line 2916): no docstring
    - `clamp_retention_days(cls, v)` (line 2921): no docstring
    - `clamp_purge_interval_seconds(cls, v)` (line 2926): no docstring
    - `clamp_purge_limit(cls, v)` (line 2931): no docstring
  - `ConnectorSyncSettings` (line 2935): Connector sync worker settings.
    - `clamp_max_retries(cls, v)` (line 2975): no docstring
    - `clamp_backoff_base_seconds(cls, v)` (line 2980): no docstring
    - `clamp_backoff_max_seconds(cls, v)` (line 2985): no docstring
  - `ConnectorTriggerSettings` (line 2989): Connector trigger service settings.
    - `strip_source_type(cls, v)` (line 3019): no docstring
    - `clamp_tick_seconds(cls, v)` (line 3024): no docstring
    - `clamp_poll_concurrency(cls, v)` (line 3029): no docstring
    - `clamp_outbox_batch(cls, v)` (line 3034): no docstring
  - `ObjectifySettings` (line 3038): Objectify worker settings.
    - `strip_worker_handler(cls, v)` (line 3114): no docstring
    - `clamp_batch_size(cls, v)` (line 3119): no docstring
    - `clamp_row_batch_size(cls, v)` (line 3124): no docstring
    - `clamp_bulk_update_batch_size(cls, v)` (line 3129): no docstring
    - `clamp_list_page_size(cls, v)` (line 3136): no docstring
    - `clamp_max_rows(cls, v)` (line 3141): no docstring
    - `clamp_lineage_max_links(cls, v)` (line 3146): no docstring
    - `clamp_max_retries(cls, v)` (line 3151): no docstring
    - `clamp_backoff_base_seconds(cls, v)` (line 3156): no docstring
    - `clamp_backoff_max_seconds(cls, v)` (line 3161): no docstring
    - `normalize_ontology_pk_validation_mode(cls, v)` (line 3166): no docstring
    - `clamp_dataset_primary_index_chunk_size(cls, v)` (line 3180): no docstring
    - `bulk_update_batch_size_effective(self)` (line 3184): no docstring
  - `IngestReconcilerSettings` (line 3188): Dataset ingest reconciler worker settings.
    - `fallback_alert_webhook_url(cls, v)` (line 3251): no docstring
    - `clamp_poll_seconds(cls, v)` (line 3260): no docstring
    - `clamp_stale_seconds(cls, v)` (line 3265): no docstring
    - `clamp_limit(cls, v)` (line 3270): no docstring
    - `clamp_lock_key(cls, v)` (line 3275): no docstring
    - `clamp_alert_published_threshold(cls, v)` (line 3280): no docstring
    - `clamp_alert_aborted_threshold(cls, v)` (line 3285): no docstring
    - `clamp_alert_cooldown_seconds(cls, v)` (line 3290): no docstring
  - `DatasetIngestOutboxSettings` (line 3294): Dataset ingest outbox worker settings (BFF embedded worker).
    - `clamp_poll_seconds(cls, v)` (line 3387): no docstring
    - `clamp_backoff_base_seconds(cls, v)` (line 3397): no docstring
    - `clamp_backoff_max_seconds(cls, v)` (line 3402): no docstring
    - `clamp_max_retries(cls, v)` (line 3407): no docstring
    - `clamp_claim_timeout_seconds(cls, v)` (line 3412): no docstring
    - `clamp_purge_interval_seconds(cls, v)` (line 3417): no docstring
    - `clamp_retention_days(cls, v)` (line 3422): no docstring
    - `clamp_purge_limit(cls, v)` (line 3427): no docstring
    - `clamp_dlq_max_in_flight(cls, v)` (line 3432): no docstring
    - `clamp_dlq_delivery_timeout_ms(cls, v)` (line 3437): no docstring
    - `clamp_dlq_request_timeout_ms(cls, v)` (line 3442): no docstring
    - `clamp_dlq_retries(cls, v)` (line 3447): no docstring
  - `ObjectifyOutboxWorkerSettings` (line 3451): Objectify outbox worker settings (BFF embedded worker).
    - `clamp_poll_seconds(cls, v)` (line 3539): no docstring
    - `clamp_batch_size(cls, v)` (line 3544): no docstring
    - `clamp_backoff_base_seconds(cls, v)` (line 3554): no docstring
    - `clamp_backoff_max_seconds(cls, v)` (line 3559): no docstring
    - `clamp_claim_timeout_seconds(cls, v)` (line 3564): no docstring
    - `clamp_purge_interval_seconds(cls, v)` (line 3569): no docstring
    - `clamp_retention_days(cls, v)` (line 3574): no docstring
    - `clamp_purge_limit(cls, v)` (line 3579): no docstring
    - `clamp_producer_max_in_flight(cls, v)` (line 3584): no docstring
    - `clamp_producer_delivery_timeout_ms(cls, v)` (line 3589): no docstring
    - `clamp_producer_request_timeout_ms(cls, v)` (line 3594): no docstring
    - `clamp_producer_retries(cls, v)` (line 3599): no docstring
  - `ObjectifyReconcilerSettings` (line 3603): Objectify reconciler worker settings (BFF embedded worker).
    - `clamp_poll_seconds(cls, v)` (line 3641): no docstring
    - `clamp_stale_after_seconds(cls, v)` (line 3646): no docstring
    - `clamp_enqueued_stale_seconds(cls, v)` (line 3651): no docstring
    - `clamp_lock_key(cls, v)` (line 3656): no docstring
    - `enqueued_stale_seconds_effective(self)` (line 3660): no docstring
  - `WritebackMaterializerSettings` (line 3665): Writeback materializer worker settings.
    - `db_names_list(self)` (line 3697): no docstring
  - `EventPublisherSettings` (line 3704): Event publisher (message relay) settings.
    - `fallback_poll_interval(cls, v)` (line 3766): no docstring
    - `fallback_batch_size(cls, v)` (line 3774): no docstring
    - `fallback_topic_bootstrap_timeout(cls, v)` (line 3782): no docstring
    - `clamp_poll_interval_seconds(cls, v)` (line 3788): no docstring
    - `clamp_batch_size(cls, v)` (line 3793): no docstring
    - `clamp_kafka_flush_batch_size(cls, v)` (line 3798): no docstring
    - `clamp_metrics_log_interval_seconds(cls, v)` (line 3805): no docstring
    - `clamp_lookback_seconds(cls, v)` (line 3810): no docstring
    - `clamp_lookback_max_keys(cls, v)` (line 3815): no docstring
    - `clamp_dedup_max_events(cls, v)` (line 3820): no docstring
    - `clamp_dedup_checkpoint_max_events(cls, v)` (line 3825): no docstring
    - `clamp_topic_bootstrap_timeout_seconds(cls, v)` (line 3830): no docstring
    - `kafka_flush_batch_size_effective(self)` (line 3834): no docstring
  - `AgentRetentionWorkerSettings` (line 3838): Agent session retention worker settings (SEC-005).
    - `clamp_poll_seconds(cls, v)` (line 3860): no docstring
    - `clamp_retention_days(cls, v)` (line 3865): no docstring
    - `normalize_action(cls, v)` (line 3870): no docstring
  - `SchemaChangeMonitorSettings` (line 3881): Schema change monitor settings for proactive drift detection.
    - `clamp_check_interval(cls, v)` (line 3907): no docstring
    - `clamp_cooldown(cls, v)` (line 3912): no docstring
  - `ChaosSettings` (line 3916): Chaos/fault injection settings (test-only).
    - `coerce_enabled(cls, v)` (line 3947): no docstring
    - `coerce_crash_once(cls, v)` (line 3958): no docstring
    - `clamp_crash_exit_code(cls, v)` (line 3969): no docstring
  - `WorkersSettings` (line 3973): Workers/services runtime settings.
  - `WritebackSettings` (line 4003): Ontology writeback + read overlay settings
  - `TestSettings` (line 4073): Test environment configuration
  - `GoogleSheetsSettings` (line 4097): Google Sheets integration settings
    - `fallback_google_api_key(cls, v)` (line 4133): no docstring
  - `ApplicationSettings` (line 4140): Main application settings - aggregates all other settings
    - `normalize_environment(cls, v)` (line 4192): no docstring
    - `is_development(self)` (line 4213): Check if running in development mode
    - `is_production(self)` (line 4218): Check if running in production mode
    - `is_test(self)` (line 4223): Check if running in test mode
    - `is_pytest(self)` (line 4228): Check if running under pytest (PYTEST_CURRENT_TEST set).
...
- **Functions**
  ...
  - `is_external_code(value)` (line 2407): no docstring
  - `_resolve_http_status(spec, status_code, prefer_status_code)` (line 2413): no docstring
  - `_resolve_retryable(spec, retryable_hint)` (line 2426): no docstring
  - `_resolve_http_status_hint(spec, status_code)` (line 2438): no docstring
  - `_resolve_default_retry_policy(spec)` (line 2444): no docstring
  - `_resolve_human_required(spec)` (line 2450): no docstring
  - `_resolve_max_attempts(spec, retry_policy)` (line 2456): no docstring
  - `_resolve_base_delay_ms(spec, retry_policy)` (line 2465): no docstring
  - `_resolve_max_delay_ms(spec, retry_policy)` (line 2474): no docstring
  ...
  - `resolve_objectify_error(error)` (line 2648): no docstring
  - `_normalize_objectify_error_key(error)` (line 2701): no docstring
- **Classes**
...
- **Functions**
  - `classified_http_exception(status_code, detail, code, category, external_code, extra, headers)` (line 100): Create an HTTPException that carries enterprise error classification.
- **Classes**
...
### `backend/shared/foundry/__init__.py`

### `backend/shared/foundry/auth.py`
- **Functions**
  - `_principal_scopes(principal)` (line 17): no docstring
  - `require_scopes(required)` (line 24): no docstring

### `backend/shared/foundry/errors.py`
- **Functions**
  - `foundry_error(status, error_code, error_name, parameters)` (line 11): no docstring
  - `async foundry_exception_handler(request, exc)` (line 37): no docstring
- **Classes**
  - `FoundryAPIError` (line 30): no docstring

### `backend/shared/foundry/rids.py`
- **Functions**
  - `build_rid(kind, id)` (line 29): no docstring
  - `parse_rid(rid, allowed_prefixes)` (line 39): no docstring
...
- **Functions**
  - `_default_risk_policy()` (line 10): no docstring
- **Classes**
  - `TypeInferenceResult` (line 14): Type inference result with confidence and reasoning
  - `TabularRiskItem` (line 23): Risk signal emitted by tabular inference runtime (suggestion-only).
  - `ColumnProfile` (line 38): Lightweight column profiling summary (sample-based).
  - `ColumnAnalysisResult` (line 46): Analysis result for a single column
  - `TabularAnalysisPayload` (line 90): Tabular analysis payload (suggestion-only).
  - `DatasetAnalysisRequest` (line 98): Request for dataset type analysis
  - `DatasetAnalysisResponse` (line 107): Response for dataset type analysis
  - `SchemaGenerationRequest` (line 121): Request for schema generation based on analysis
  - `SchemaGenerationResponse` (line 131): Generated schema based on type analysis
  - `TabularPreviewRequest` (line 140): Request for data preview with type inference
  - `TabularPreviewResponse` (line 149): Preview response with inferred types
  - `TypeMappingRequest` (line 166): Request for mapping inferred types to target schema
  - `TypeMappingResponse` (line 174): Response with mapped types for target system
...
- **Classes**
  ...
  - `ConfigurationMonitor` (line 118): Monitors configuration changes and provides observability
    ...
    - `add_validation_rule(self, rule)` (line 202): Add custom validation rule
    - `add_change_callback(self, callback)` (line 207): Add callback for configuration changes
    - `get_config_snapshot(self)` (line 211): Get current configuration snapshot
    - `calculate_config_hash(self, config_dict)` (line 248): Calculate hash of configuration for change detection
    - `detect_changes(self)` (line 253): Detect configuration changes since last check
    - `_compare_snapshots(self, old_snapshot, new_snapshot)` (line 284): Compare two configuration snapshots and return changes
    - `_analyze_change_impact(self, change)` (line 344): Analyze the impact of a configuration change
    - `validate_configuration(self)` (line 377): Validate current configuration against rules
    - `perform_security_audit(self)` (line 403): Perform comprehensive security audit of configuration
    - `_check_debug_mode_in_production(self, config)` (line 441): Check if debug mode is enabled in production
    - `_check_default_passwords(self, config)` (line 460): Check for default or weak passwords
    - `_check_insecure_connections(self, config)` (line 484): Check for insecure connection configurations
    - `_check_exposed_sensitive_data(self, config)` (line 507): Check for potentially exposed sensitive data
    - `_check_weak_authentication(self, config)` (line 518): Check for weak authentication configurations
    - `_get_nested_value(self, data, key_path)` (line 540): Get nested value from dictionary using dot notation
    - `_sanitize_sensitive_value(self, key_path, value)` (line 553): Sanitize sensitive values for display
    - `_count_total_settings(self, config)` (line 560): Count total number of configuration settings
    - `get_change_history(self, limit)` (line 570): Get recent configuration change history
    - `get_configuration_report(self)` (line 575): Get comprehensive configuration report
...
- **Functions**
  ...
  - `get_tracing_service(service_name)` (line 577): no docstring
  - `trace_endpoint(name)` (line 586): Lazily create a tracing decorator for request handlers.
  - `trace_db_operation(name)` (line 599): no docstring
  - `trace_external_call(name)` (line 605): no docstring
  - `trace_storage_operation(name, system)` (line 610): Trace storage operations (S3/MinIO, Elasticsearch, Redis, etc.).
  - `trace_kafka_operation(name)` (line 617): Trace Kafka produce/consume operations.
  - `_lazy_trace(name, kind, attributes)` (line 624): no docstring
- **Classes**
  - `_SettingsValue` (line 179): no docstring
    - `__init__(self, getter)` (line 180): no docstring
    - `__get__(self, instance, owner)` (line 183): no docstring
  - `OpenTelemetryConfig` (line 187): no docstring
  - `TracingService` (line 212): Distributed tracing facade.
    - `__init__(self, service_name)` (line 220): no docstring
    - `_log_no_op_once(self, reason)` (line 234): no docstring
    - `initialize(self)` (line 241): no docstring
    - `instrument_fastapi(self, app)` (line 347): no docstring
    - `instrument_clients(self)` (line 364): no docstring
    - `runtime_status(self)` (line 457): no docstring
    - `span(self, name, kind, attributes)` (line 475): no docstring
    - `trace(self, name, kind, attributes)` (line 497): no docstring
    - `get_current_span(self)` (line 517): no docstring
    - `record_exception(self, exception)` (line 522): no docstring
    - `set_span_attribute(self, key, value)` (line 529): no docstring
    - `get_trace_id(self)` (line 535): no docstring
    - `get_span_id(self)` (line 544): no docstring
    - `inject_trace_context(self, headers)` (line 553): no docstring
    - `extract_trace_context(self, headers)` (line 563): no docstring
...
- **Functions**
  - `get_expected_token(env_keys)` (line 24): no docstring
  - `extract_presented_token(headers)` (line 48): no docstring
  - `auth_disable_allowed(allow_disable_env_keys)` (line 58): no docstring
  - `auth_required(require_env_key, token_env_keys, default_required, allow_pytest, pytest_env_key)` (line 71): no docstring
  - `get_exempt_paths(env_key, defaults)` (line 94): no docstring
  - `is_exempt_path(path, exempt_paths)` (line 109): no docstring
  - `get_db_scope(headers)` (line 113): no docstring
  - `enforce_db_scope(headers, db_name, require_env_key)` (line 121): no docstring
...
- **Functions**
  - `sanitize_input(data)` (line 816): 전역 입력 정화 함수
  - `sanitize_label_input(data)` (line 828): Sanitize a label-keyed payload (BFF).
  - `validate_db_name(db_name)` (line 847): 데이터베이스 이름 검증 함수
  - `validate_class_id(class_id)` (line 852): 클래스 ID 검증 함수
  - `validate_branch_name(branch_name)` (line 857): 브랜치 이름 검증 함수
  - `validate_instance_id(instance_id)` (line 862): 인스턴스 ID 검증 함수
  - `sanitize_es_query(query)` (line 867): Elasticsearch 쿼리 문자열 정제
- **Classes**
  ...
  - `InputSanitizer` (line 22): 포괄적인 입력 데이터 보안 검증 및 정화 클래스
    ...
    - `validate_branch_name(self, branch_name)` (line 773): 브랜치 이름/RID 검증
    - `validate_instance_id(self, instance_id)` (line 793): 인스턴스 ID 검증
...
- **Functions**
  - `extract_bearer_token(value)` (line 43): no docstring
  - `_parse_algorithms(raw)` (line 52): no docstring
  - `_claim_str(claims, keys)` (line 60): no docstring
  - `_claim_list_str(claims, keys)` (line 71): no docstring
  - `_claim_scopes(claims, keys)` (line 88): Parse OAuth scopes from OIDC claims.
  - `async _fetch_jwks(url)` (line 145): no docstring
  - `_select_jwk(jwks, kid)` (line 162): no docstring
  - `_decode_user_claims(token, key, algorithms, issuer, audience)` (line 179): no docstring
  - `async verify_user_token(token, jwt_enabled, jwt_issuer, jwt_audience, jwt_jwks_url, jwt_public_key, jwt_hs256_secret, jwt_algorithms)` (line 201): Verify a user JWT and return a structured principal.
- **Classes**
  ...
  - `UserPrincipal` (line 17): Verified (or explicitly unverified) principal extracted from an auth token.
    - `scopes(self)` (line 34): no docstring
...
- **Functions**
  - `create_audit_log_store(settings)` (line 420): no docstring
- **Classes**
  - `AuditLogStore` (line 25): no docstring
    - `__init__(self, dsn, schema, pool_min, pool_max)` (line 26): no docstring
    - `async _ensure_tables(self, conn)` (line 45): no docstring
    - `_canonical_json(value)` (line 100): no docstring
    - `_compute_hash(cls, prev_hash, payload)` (line 104): no docstring
    - `_coerce_metadata(value)` (line 110): no docstring
    - `async append(self, entry, partition_key)` (line 127): no docstring
    - `async log(self, partition_key, actor, action, status, resource_type, resource_id, event_id, command_id, trace_id, correlation_id, metadata, error, occurred_at)` (line 230): no docstring
    - `async list_logs(self, partition_key, action, status, resource_type, resource_id, event_id, command_id, actor, since, until, limit, offset)` (line 263): no docstring
    - `async count_logs(self, partition_key, action, status, resource_type, resource_id, event_id, command_id, actor, since, until)` (line 346): no docstring
    - `async get_chain_head(self, partition_key)` (line 395): no docstring

### `backend/shared/services/core/background_task_manager.py`
- **Functions**
  - `create_background_task_manager(redis_service, websocket_service)` (line 676): Create a BackgroundTaskManager instance.
- **Classes**
  ...
  - `BackgroundTaskManager` (line 48): Centralized background task management service.
    ...
    - `async update_progress(self, task_id, current, total, message, metadata)` (line 332): Update task progress for long-running operations.
    - `async get_task_status(self, task_id)` (line 381): Get current task status and details.
    - `async get_all_tasks(self, status, task_type, limit)` (line 385): Get all tasks matching the criteria.
    - `async cancel_task(self, task_id)` (line 425): Cancel a running task.
    - `async add_task_callback(self, task_id, callback)` (line 459): Add a callback to be called when task completes.
    - `async get_task_metrics(self)` (line 477): Get overall task execution metrics.
    - `async _save_task(self, task)` (line 497): Save task to Redis.
    - `async _get_task(self, task_id)` (line 511): Get task from Redis.
    - `async _handle_task_done(self, task_id, asyncio_task)` (line 519): Handle task completion callback.
    - `_handle_cleanup_task_done(self, task)` (line 537): Handle cleanup task completion.
    - `async _cleanup_dead_tasks(self)` (line 551): Periodically clean up dead tasks.
    - `_calculate_average_duration(self, tasks)` (line 583): Calculate average task duration in seconds.
    - `_calculate_success_rate(self, tasks)` (line 593): Calculate task success rate as percentage.
    - `async _notify_task_created(self, task)` (line 607): Notify about task creation.
    - `async _notify_task_status_changed(self, task)` (line 618): Notify about task status change.
    - `async _notify_task_progress(self, task)` (line 627): Notify about task progress update.
    - `async _notify_task_completed(self, task)` (line 636): Notify about task completion.
    - `async _notify_task_failed(self, task)` (line 645): Notify about task failure.
    - `async _notify_task_cancelled(self, task)` (line 655): Notify about task cancellation.
    - `async _notify_task_retrying(self, task)` (line 663): Notify about task retry.
...
- **Functions**
  - `_row_hash(row)` (line 26): no docstring
  - `_dataset_artifact_prefix(db_name, dataset_id, dataset_name)` (line 30): no docstring
  - `_rows_to_csv_bytes(columns, rows)` (line 35): no docstring
  - `_parse_csv_bytes(data)` (line 45): no docstring
  - `_align_row_to_columns(row, source_columns, target_columns)` (line 58): no docstring
  - `_align_rows_to_columns(rows, source_columns, target_columns)` (line 74): no docstring
  - `_apply_append_mode(existing_columns, existing_rows, new_columns, new_rows)` (line 86): no docstring
  - `_apply_update_mode(existing_columns, existing_rows, new_columns, new_rows, primary_key_column)` (line 110): no docstring
  - `_resolve_raw_repo()` (line 148): no docstring
- **Classes**
  - `ConnectorIngestService` (line 153): no docstring
    - `__init__(self, dataset_registry, pipeline_registry, objectify_registry, objectify_job_queue)` (line 154): no docstring
    - `async _ensure_branch_exists(self, repository, branch, source_branch)` (line 167): no docstring
    - `async _commit(self, repository, branch, message, metadata, object_key)` (line 177): no docstring
    - `async _load_existing_csv(self, dataset, repository)` (line 194): no docstring
    - `async _maybe_enqueue_objectify_job(self, dataset, version, actor_user_id)` (line 217): no docstring
    - `async ingest_rows(self, db_name, source_type, source_id, columns, rows, branch, dataset_name, import_mode, primary_key_column, actor_user_id, source_ref)` (line 283): no docstring
...
- **Functions**
  - `async build_link_index_objectify_job(db_name, link_type_id, dataset_registry, objectify_registry, job_id)` (line 25): no docstring
- **Classes**
  - `LinkIndexObjectifyJobBuildResult` (line 19): no docstring
...
- **Functions**
  - `_normalize_branch(value)` (line 49): no docstring
  - `_normalize_dt(value)` (line 54): no docstring
  - `parse_instance_aggregate_id(aggregate_id)` (line 60): Parse aggregate_id in the canonical Instance format:
  - `key_from_instance_event(event)` (line 85): Build an instance projection key from an EventEnvelope.
  - `_event_order_key(event)` (line 111): no docstring
  - `build_instance_expectations(events, db_name, branch)` (line 118): Reduce instance events to one expected projection state per instance.
  - `evaluate_projection_document(expectation, document)` (line 168): Compare expected state against an ES projection document.
- **Classes**
  - `InstanceProjectionKey` (line 26): no docstring
  - `InstanceProjectionExpectation` (line 34): no docstring
  - `ExpectationBuildResult` (line 44): no docstring
...
- **Functions**
  ...
  - `_configure_cors(app)` (line 214): Configure CORS middleware based on environment variables
  - `_add_logging_middleware(app)` (line 229): Add request logging middleware
  - `_add_health_check(app, service_info)` (line 272): Add standardized health check endpoints
  - `_add_debug_endpoints(app)` (line 296): Add debug endpoints for development environment
  - `_install_observability(app, service_info)` (line 305): Install tracing + metrics in a way that is:
  - `create_uvicorn_config(service_info, reload)` (line 429): Create standardized uvicorn configuration.
  - `_get_logging_config(service_name)` (line 462): Get standardized logging configuration for uvicorn
  - `run_service(app, service_info, app_module_path, reload)` (line 507): Run the service with standardized uvicorn configuration.
  - `get_bff_service_info()` (line 526): no docstring
  - `get_oms_service_info()` (line 558): no docstring
  - `get_funnel_service_info()` (line 576): no docstring
  - `get_agent_service_info()` (line 591): no docstring
- **Classes**
...
- **Functions**
  - `_coerce_occurred_at(value)` (line 35): no docstring
  - `async flush_dataset_ingest_outbox(dataset_registry, lineage_store, batch_size)` (line 274): no docstring
  - `async run_dataset_ingest_outbox_worker(dataset_registry, lineage_store, poll_interval_seconds, batch_size, stop_event)` (line 291): no docstring
  - `build_dataset_event_payload(event_id, event_type, aggregate_type, aggregate_id, command_type, actor, data)` (line 313): no docstring
- **Classes**
  - `DatasetIngestOutboxPublisher` (line 53): no docstring
    - `__init__(self, dataset_registry, lineage_store, batch_size)` (line 54): no docstring
    - `async close(self)` (line 114): no docstring
    - `async _send_to_dlq(self, item, error, attempts)` (line 123): no docstring
    - `async _handle_failure(self, item, error)` (line 165): no docstring
    - `async _publish_item(self, item)` (line 192): no docstring
    - `async flush_once(self)` (line 243): no docstring
    - `async maybe_purge(self)` (line 260): no docstring
...
- **Functions**
  ...
  - `classify_retryable_by_error_code(code)` (line 226): Classify retryability based on a structured ErrorCode.
- **Classes**
...
### `backend/shared/services/mcp_client.py`
- **Functions**
  - `get_mcp_manager()` (line 401): Get or create MCP manager singleton
  - `get_context7_client()` (line 409): Get Context7 client
- **Classes**
  ...
  - `MCPClientManager` (line 40): Manager for multiple MCP client connections
    ...
    - `_load_config(self)` (line 76): Load MCP configuration from file
    - `async connect_server(self, server_name)` (line 104): Connect to a specific MCP server
    - `async disconnect_server(self, server_name)` (line 154): Disconnect from a specific MCP server.
    - `async reconnect_server(self, server_name)` (line 172): Reconnect to a server to refresh the tool list cache.
    - `async call_tool(self, server_name, tool_name, arguments, _retries)` (line 183): Call a tool on a specific MCP server.
    - `async list_tools(self, server_name)` (line 237): List available tools from a server.
  - `Context7Client` (line 266): Specialized client for Context7 MCP server
    - `__init__(self, mcp_manager)` (line 272): no docstring
    - `async search(self, query, limit, filters)` (line 276): Search Context7 knowledge base
    - `async get_context(self, entity_id)` (line 304): Get context for a specific entity
    - `async add_knowledge(self, title, content, metadata)` (line 320): Add knowledge to Context7
    - `async link_entities(self, source_id, target_id, relationship, properties)` (line 347): Create relationship between entities
    - `async analyze_ontology(self, ontology_data)` (line 380): Analyze ontology with Context7
...
- **Functions**
  ...
  - `async compute_schema_by_node(definition, db_name, dataset_registry, branch)` (line 1695): no docstring
- **Classes**
...
- **Functions**
  ...
  - `_compute_histogram(values, bins)` (line 47): no docstring
  - `_normalize_columns(columns)` (line 80): no docstring
  - `compute_column_stats(rows, columns, max_top_values)` (line 94): Returns a dict payload that is safe to JSON serialize:
...
- **Functions**
  ...
  - `normalize_cast_target(target)` (line 392): no docstring
  - `normalize_cast_mode(value)` (line 396): no docstring
  - `xsd_to_spark_type(value)` (line 403): no docstring
  - `spark_type_to_xsd(data_type)` (line 408): no docstring
- **Classes**
...
- **Functions**
  - `_normalize_oms_response(payload)` (line 55): OMS responses may be wrapped in {"data": {...}} or {"response": {...}}.
  - `async get_mapping_from_oms(http_client, oms_base_url, db_name, target_class_id, branch, admin_token)` (line 65): Fetch an object_type resource from OMS and extract backing_source mapping spec.
  - `async find_class_id_by_dataset(http_client, oms_base_url, db_name, dataset_id, branch, admin_token)` (line 129): Reverse lookup: find the object_type whose backing_source.dataset_id matches.
  - `is_oms_mapping_spec(mapping_spec_id)` (line 314): Check if a mapping_spec_id originates from OMS backing_source.
  - `extract_class_id_from_oms_spec_id(mapping_spec_id)` (line 319): Extract class_id from an OMS mapping_spec_id like 'oms:Customer'.
- **Classes**
  - `BackingSourceMappingSpec` (line 34): OMS backing_source에서 추출된 mapping spec (PostgreSQL MappingSpecRecord과 호환).
  - `MappingSpecResolver` (line 178): OMS-first, PostgreSQL-fallback mapping spec resolver.
    - `__init__(self, http_client, oms_base_url, admin_token, objectify_registry)` (line 193): no docstring
    - `async resolve(self, db_name, dataset_id, branch, schema_hash, target_class_id, artifact_output_name)` (line 206): Resolve mapping spec with OMS priority:
    - `async resolve_by_class_id(self, db_name, target_class_id, branch)` (line 296): Convenience: resolve directly by class_id (OMS-only, no PG fallback).
...
- **Functions**
  - `_parse_json_list_of_dicts(value)` (line 32): no docstring
- **Classes**
  - `ConnectorSource` (line 38): no docstring
  - `ConnectorMapping` (line 48): no docstring
  - `SyncState` (line 63): no docstring
  - `OutboxItem` (line 81): no docstring
  - `ConnectorRegistry` (line 95): no docstring
    - `__init__(self, dsn, schema, pool_min, pool_max)` (line 98): no docstring
    - `_secret_aad(source_type, source_id)` (line 123): no docstring
    - `_assert_connector_secret_encryption_ready(self, operation)` (line 126): no docstring
    - `_encrypt_secrets_payload(self, source_type, source_id, secrets_json)` (line 137): no docstring
...
- **Classes**
  ...
  - `DatasetRegistry` (line 304): no docstring
    ...
    - `async list_all_datasets(self, branch, limit, offset, order_by)` (line 1298): no docstring
    - `async count_datasets_by_db_names(self, db_names, branch)` (line 1359): no docstring
    - `async get_dataset(self, dataset_id)` (line 1391): no docstring
    - `async get_dataset_by_name(self, db_name, name, branch)` (line 1419): no docstring
    - `async update_schema(self, dataset_id, schema_json)` (line 1455): Update the schema_json of an existing dataset.
    - `async get_dataset_by_source_ref(self, db_name, source_type, source_ref, branch)` (line 1477): no docstring
    - `async add_version(self, dataset_id, lakefs_commit_id, artifact_key, row_count, sample_json, schema_json, version_id, ingest_request_id, promoted_from_artifact_id)` (line 1515): no docstring
    - `async get_latest_version(self, dataset_id)` (line 1609): no docstring
    - `async get_version(self, version_id)` (line 1640): no docstring
    - `async get_version_by_ingest_request(self, ingest_request_id)` (line 1669): no docstring
    - `async create_backing_datasource(self, dataset_id, db_name, name, branch, description, source_type, source_ref, backing_id)` (line 1702): no docstring
    - `async get_backing_datasource(self, backing_id)` (line 1740): no docstring
    - `async get_backing_datasource_by_dataset(self, dataset_id, branch)` (line 1757): no docstring
    - `async list_backing_datasources(self, db_name, branch, limit)` (line 1783): no docstring
    - `async get_or_create_backing_datasource(self, dataset, source_type, source_ref)` (line 1809): no docstring
    - `async create_backing_datasource_version(self, backing_id, dataset_version_id, schema_hash, metadata)` (line 1832): no docstring
    - `async get_backing_datasource_version(self, version_id)` (line 1878): no docstring
    - `async get_backing_datasource_version_by_dataset_version(self, dataset_version_id)` (line 1899): no docstring
    - `async list_backing_datasource_versions(self, backing_id, limit)` (line 1922): no docstring
    - `async get_or_create_backing_datasource_version(self, backing_id, dataset_version_id, schema_hash, metadata)` (line 1945): no docstring
    - `async create_key_spec(self, dataset_id, spec, dataset_version_id, status, key_spec_id)` (line 1965): no docstring
    - `async get_key_spec(self, key_spec_id)` (line 1996): no docstring
    - `async get_key_spec_for_dataset(self, dataset_id, dataset_version_id)` (line 2012): no docstring
    - `async list_key_specs(self, dataset_id, limit)` (line 2053): no docstring
    - `async upsert_gate_policy(self, scope, name, description, rules, status)` (line 2075): no docstring
    - `async get_gate_policy(self, scope, name)` (line 2111): no docstring
    - `async list_gate_policies(self, scope, limit)` (line 2133): no docstring
    - `async record_gate_result(self, scope, subject_type, subject_id, status, details, policy_name)` (line 2155): no docstring
    - `async list_gate_results(self, scope, subject_type, subject_id, limit)` (line 2197): no docstring
    - `async upsert_access_policy(self, db_name, scope, subject_type, subject_id, policy, status)` (line 2225): no docstring
    - `async get_access_policy(self, db_name, scope, subject_type, subject_id, status)` (line 2262): no docstring
    - `async list_access_policies(self, db_name, scope, subject_type, subject_id, status, limit)` (line 2291): no docstring
    - `async record_instance_edit(self, db_name, class_id, instance_id, edit_type, metadata, status, fields)` (line 2325): no docstring
    - `async count_instance_edits(self, db_name, class_id, status)` (line 2365): no docstring
    - `async list_instance_edits(self, db_name, class_id, instance_id, status, limit)` (line 2388): no docstring
    - `async clear_instance_edits(self, db_name, class_id)` (line 2419): no docstring
    - `async remap_instance_edits(self, db_name, class_id, id_map, status)` (line 2442): no docstring
    - `async get_instance_edit_field_stats(self, db_name, class_id, fields, status)` (line 2480): no docstring
    - `async apply_instance_edit_field_moves(self, db_name, class_id, field_moves, status)` (line 2554): no docstring
    - `async update_instance_edit_status_by_fields(self, db_name, class_id, fields, new_status, status, metadata_note)` (line 2618): no docstring
    - `async create_relationship_spec(self, link_type_id, db_name, source_object_type, target_object_type, predicate, spec_type, dataset_id, mapping_spec_id, mapping_spec_version, spec, dataset_version_id, status, auto_sync, relationship_spec_id)` (line 2675): no docstring
    - `async update_relationship_spec(self, relationship_spec_id, status, spec, auto_sync, dataset_id, dataset_version_id, mapping_spec_id, mapping_spec_version)` (line 2730): no docstring
    - `async record_relationship_index_result(self, relationship_spec_id, status, stats, errors, dataset_version_id, mapping_spec_version, lineage, indexed_at)` (line 2788): no docstring
    - `async get_relationship_spec(self, relationship_spec_id, link_type_id)` (line 2872): no docstring
    - `async list_relationship_specs(self, db_name, dataset_id, status, limit)` (line 2903): no docstring
    - `async list_relationship_specs_by_relationship_object_type(self, db_name, relationship_object_type, status, limit)` (line 2935): no docstring
    - `async list_relationship_index_results(self, relationship_spec_id, link_type_id, db_name, status, limit)` (line 2968): no docstring
    - `async record_link_edit(self, db_name, link_type_id, branch, source_object_type, target_object_type, predicate, source_instance_id, target_instance_id, edit_type, status, metadata, edit_id)` (line 3000): no docstring
    - `async list_link_edits(self, db_name, link_type_id, branch, status, source_instance_id, target_instance_id, limit)` (line 3050): no docstring
    - `async clear_link_edits(self, db_name, link_type_id, branch)` (line 3088): no docstring
    - `async create_schema_migration_plan(self, db_name, subject_type, subject_id, plan, status, plan_id)` (line 3114): no docstring
    - `async list_schema_migration_plans(self, db_name, subject_type, subject_id, status, limit)` (line 3147): no docstring
    - `async get_ingest_request_by_key(self, idempotency_key)` (line 3178): no docstring
    - `async get_ingest_request(self, ingest_request_id)` (line 3222): no docstring
    - `async create_ingest_request(self, dataset_id, db_name, branch, idempotency_key, request_fingerprint, schema_json, sample_json, row_count, source_metadata)` (line 3266): no docstring
    - `async get_ingest_transaction(self, ingest_request_id)` (line 3341): no docstring
    - `async get_ingest_transaction_by_id(self, transaction_id)` (line 3373): no docstring
    - `async list_ingest_transactions_for_dataset(self, dataset_id, branch, limit, offset)` (line 3405): no docstring
    - `async create_ingest_transaction(self, ingest_request_id, status)` (line 3456): no docstring
    - `async mark_ingest_transaction_committed(self, ingest_request_id, lakefs_commit_id, artifact_key)` (line 3495): no docstring
    - `async mark_ingest_transaction_aborted(self, ingest_request_id, error)` (line 3536): no docstring
    - `async mark_ingest_committed(self, ingest_request_id, lakefs_commit_id, artifact_key)` (line 3574): no docstring
    - `async mark_ingest_failed(self, ingest_request_id, error)` (line 3639): no docstring
    - `async update_ingest_request_payload(self, ingest_request_id, schema_json, sample_json, row_count, source_metadata)` (line 3672): no docstring
    - `async approve_ingest_schema(self, ingest_request_id, schema_json, approved_by)` (line 3704): no docstring
    - `async publish_ingest_request(self, ingest_request_id, dataset_id, lakefs_commit_id, artifact_key, row_count, sample_json, schema_json, apply_schema, outbox_entries)` (line 3814): no docstring
    - `async claim_ingest_outbox_batch(self, limit, claimed_by, claim_timeout_seconds)` (line 4083): no docstring
    - `async mark_ingest_outbox_published(self, outbox_id)` (line 4160): no docstring
    - `async mark_ingest_outbox_failed(self, outbox_id, error, next_attempt_at)` (line 4179): no docstring
    - `async mark_ingest_outbox_dead(self, outbox_id, error)` (line 4206): no docstring
    - `async purge_ingest_outbox(self, retention_days, limit)` (line 4226): no docstring
    - `async get_ingest_outbox_metrics(self)` (line 4256): no docstring
    - `async reconcile_ingest_state(self, stale_after_seconds, limit, use_lock, lock_key)` (line 4298): Best-effort reconciliation for ingest atomicity.
...
- **Classes**
  - `PostgresSchemaRegistry` (line 24): no docstring
    - `__init__(self, dsn, schema, pool_min, pool_max, command_timeout)` (line 25): no docstring
    - `async initialize(self)` (line 45): no docstring
    - `async connect(self)` (line 48): no docstring
    - `async close(self)` (line 59): no docstring
    - `async shutdown(self)` (line 64): no docstring
    - `async health_check(self)` (line 67): no docstring
    - `async ensure_schema(self)` (line 78): no docstring
    - `async _acquire_schema_lock(self, conn, lock_key)` (line 93): no docstring
    - `async _ensure_tables(self, conn)` (line 107): no docstring
...
- **Functions**
  ...
  - `create_elasticsearch_service(settings)` (line 701): Elasticsearch 서비스 팩토리 함수 (Anti-pattern 13 해결)
  - `async promote_alias_to_index(elasticsearch_service, base_index, new_index, allow_delete_base_index)` (line 732): Atomically promote *new_index* behind the *base_index* alias.
- **Classes**
  - `ElasticsearchService` (line 70): Async Elasticsearch client service with connection pooling and error handling.
    ...
    - `async connect(self)` (line 132): Initialize Elasticsearch connection.
    - `async initialize(self)` (line 170): ServiceContainer lifecycle hook — delegates to ``connect()``.
    - `async disconnect(self)` (line 181): Close Elasticsearch connection.
    - `client(self)` (line 193): Get Elasticsearch client instance.
    - `async get_cluster_health(self)` (line 200): Get Elasticsearch cluster health status.
    - `async create_index(self, index, mappings, settings, aliases)` (line 213): Create an index with optional mappings, settings, and aliases.
    - `async delete_index(self, index)` (line 252): Delete an index.
    - `async index_exists(self, index)` (line 274): Check if index exists.
    - `async update_mapping(self, index, properties)` (line 283): Update index mapping.
    - `async index_document(self, index, document, doc_id, refresh, version, version_type, op_type)` (line 312): Index a single document.
    - `async get_document(self, index, doc_id, source_includes, source_excludes)` (line 356): Get a document by ID.
    - `async update_document(self, index, doc_id, doc, script, upsert, refresh)` (line 390): Update a document.
    - `async delete_document(self, index, doc_id, refresh, version, version_type)` (line 439): Delete a document.
    - `async bulk_index(self, index, documents, chunk_size, refresh)` (line 477): Bulk index documents.
    - `async search(self, index, query, size, from_, sort, source_includes, source_excludes, aggregations)` (line 527): Search documents.
    - `async count(self, index, query)` (line 581): Count documents matching query.
    - `async create_alias(self, index, alias, filter)` (line 610): Create an alias for an index with optional filter.
    - `async delete_alias(self, index, alias)` (line 644): Delete an alias.
    - `async update_aliases(self, actions)` (line 667): Perform multiple alias operations atomically.
    - `async refresh_index(self, index)` (line 691): Force refresh an index to make changes searchable.

### `backend/shared/services/storage/event_store.py`
- **Functions**
  - `async get_event_store()` (line 1267): Dependency to get the Event Store instance
- **Classes**
  - `EventStore` (line 54): The REAL Event Store using S3/MinIO as Single Source of Truth.
    - `__init__(self)` (line 69): no docstring
    - `attach_observability_stores(self, lineage_store, audit_store)` (line 82): Reuse already-initialized stores to avoid duplicate schema bootstrap.
    - `_sequence_mode(self)` (line 95): no docstring
    - `_lineage_enabled(self)` (line 100): no docstring
    - `_audit_enabled(self)` (line 104): no docstring
    - `_s3_client_kwargs(self)` (line 107): no docstring
    - `async connect(self)` (line 135): Initialize S3/MinIO connection
    - `async _initialize_lineage_and_audit(self)` (line 179): no docstring
    - `_partition_key_for_envelope(envelope)` (line 208): no docstring
    - `async _record_lineage_and_audit(self, envelope, s3_key, audit_action)` (line 217): no docstring
    - `async _record_audit_failure(self, envelope, error)` (line 336): no docstring
    - `async _get_sequence_allocator(self)` (line 373): no docstring
    - `async _ensure_sequence_number(self, event)` (line 386): Ensure `event.sequence_number` is set using an atomic write-side allocator.
    - `async append_event(self, event)` (line 530): Append an immutable event to S3/MinIO.
    - `_enforce_idempotency_contract(self, existing, incoming, source)` (line 711): Detect event_id reuse with conflicting contents.
    - `_is_command_envelope(env)` (line 746): no docstring
    - `_normalize_for_idempotency_compare(env)` (line 752): no docstring
    - `_stable_hash(payload)` (line 767): no docstring
    - `async _get_existing_key_by_event_id(self, s3, event_id)` (line 771): no docstring
    - `async _get_existing_key_by_aggregate_index(self, s3, aggregate_type, aggregate_id, event_id)` (line 784): no docstring
    - `async _read_event_object(self, s3, key)` (line 806): no docstring
    - `async get_event_object_key(self, event_id)` (line 812): Resolve an event_id to its S3 object key using the by-event-id index.
    - `async read_event_by_key(self, key)` (line 825): Read an event envelope from S3/MinIO by object key.
    - `async get_events(self, aggregate_type, aggregate_id, from_version, to_version)` (line 834): Retrieve all events for an aggregate from S3/MinIO.
    - `_dedup_events(events)` (line 924): Best-effort dedup to hide historical duplicates during migration.
    - `_dedup_key(event)` (line 937): no docstring
    - `async replay_events(self, from_timestamp, to_timestamp, event_types)` (line 949): Replay events from S3/MinIO for a time range.
    - `async get_aggregate_version(self, aggregate_type, aggregate_id, allow_full_scan)` (line 1042): Get the current version of an aggregate (max sequence_number).
    - `async _update_indexes(self, event, key, s3)` (line 1086): Update various indexes for efficient querying.
    - `async _write_index_entries(self, s3, aggregate_index_key, date_index_key, event_id_index_key, payload)` (line 1154): no docstring
    - `async get_snapshot(self, aggregate_type, aggregate_id, version)` (line 1184): Get a snapshot of an aggregate at a specific version.
    - `async save_snapshot(self, aggregate_type, aggregate_id, version, state)` (line 1213): Save a snapshot for performance optimization.
...
- **Functions**
  - `create_redis_service(settings)` (line 460): Redis 서비스 팩토리 함수 (Anti-pattern 13 해결)
- **Classes**
  - `RedisService` (line 27): Async Redis client service with connection pooling and error handling.
    ...
    - `async set_json(self, key, value, ttl, ex)` (line 358): Set JSON value with optional TTL.
    - `async get_json(self, key)` (line 377): Get JSON value.
    - `async set(self, key, value, ttl)` (line 385): Set key-value pair with optional TTL.
    - `async get(self, key)` (line 392): Get value for key.
    - `async delete(self, key)` (line 397): Delete key.
    - `async exists(self, key)` (line 402): Check if key exists.
    - `async expire(self, key, seconds)` (line 407): Set expiration on key.
    - `async keys(self, pattern)` (line 412): Get keys matching pattern.
    - `async cleanup_listeners(self)` (line 417): Clean up all active pub/sub listeners.
    - `async scan_keys(self, pattern, count)` (line 436): Scan keys matching pattern without blocking.
...
- **Functions**
  - `create_mock_storage_service()` (line 183): Create mock storage service for testing
  - `create_mock_redis_service()` (line 193): Create mock Redis service for testing
  - `create_mock_elasticsearch_service()` (line 205): Create mock Elasticsearch service for testing
  - `create_mock_label_mapper()` (line 216): Create mock label mapper for testing
  - `create_mock_jsonld_converter()` (line 224): Create mock JSON-LD converter for testing
  - `test_settings()` (line 233): Pytest fixture for test application settings
  - `test_settings_with_overrides()` (line 239): Pytest fixture factory for test settings with custom overrides
  - `async mock_container(test_settings)` (line 247): Pytest fixture for mock service container
  - `mock_command_status_service()` (line 265): Pytest fixture for mock command status service
  - `async isolated_test_environment(**config_overrides)` (line 304): Async context manager for completely isolated test environment
  - `setup_test_database_config(**overrides)` (line 332): Create test settings with database configuration
  - `setup_test_service_config(**overrides)` (line 346): Create test settings with service configuration
- **Classes**
  ...
  - `ConfigOverride` (line 274): Context manager for temporary configuration overrides
    - `__init__(self, **overrides)` (line 282): no docstring
    - `__enter__(self)` (line 286): no docstring
    - `__exit__(self, _exc_type, _exc_val, _exc_tb)` (line 294): no docstring
...
- **Functions**
  ...
  - `_pick_properties_from_record(record)` (line 110): no docstring
  - `_pick_interface_metadata_from_record(record)` (line 135): no docstring
  - `_build_contract_from_record(record)` (line 163): no docstring
  - `async load_action_target_runtime_contract(db_name, class_id, branch, resources)` (line 172): no docstring
- **Classes**
...
- **Functions**
  - `encode_offset_page_token(offset, issued_at, scope)` (line 19): Encode a pagination offset into an opaque page token.
  - `decode_offset_page_token(page_token, ttl_seconds, now, expected_scope)` (line 37): Decode an opaque page token and return its offset.
...
### `backend/shared/utils/object_type_backing.py`
- **Functions**
  - `list_backing_sources(spec)` (line 6): no docstring
  - `select_primary_backing_source(spec)` (line 21): no docstring
...
- **Functions**
  - `normalize_ontology_version(value)` (line 14): Normalize an ontology version payload.
  - `build_ontology_version(branch, commit)` (line 44): Build a minimal ontology stamp for audit + replay.
  - `extract_ontology_version(envelope_metadata, envelope_data)` (line 58): Extract ontology_version stamp from either:
  - `split_ref_commit(value)` (line 77): no docstring
  - `async resolve_ontology_version(source, db_name, branch, logger)` (line 84): Resolve ontology semantic contract stamp in Foundry-style branch-ref form.
...
- **Functions**
  - `build_principal_tags(principal_type, principal_id, role)` (line 13): no docstring
  - `policy_allows(policy, principal_tags)` (line 30): Evaluate a minimal principal policy:
- **Classes**
...
- **Functions**
  - `extract_backing_dataset_id(object_type_spec)` (line 8): no docstring
  - `policies_aligned(backing_policy, writeback_policy)` (line 20): no docstring
  - `format_acl_alignment_result(scope, writeback_dataset_id, backing_dataset_id, backing_policy, writeback_policy)` (line 26): no docstring
...
- **Functions**
  - `_load_repo_dotenv()` (line 41): no docstring
  - `_ensure_lakefs_credentials()` (line 62): no docstring
  - `_lakefs_admin_credentials()` (line 86): no docstring
  - `async _ensure_lakefs_repository(repository, branch)` (line 100): no docstring
  - `async _release_stale_processing_events(max_age_seconds)` (line 140): no docstring
  - `async _cleanup_stale_processing_events()` (line 162): no docstring
  - `async _wait_for_db_exists(session, db_name, expected, timeout_seconds, poll_interval_seconds)` (line 166): no docstring
  - `async _wait_for_command_completed(session, command_id, timeout_seconds, poll_interval_seconds)` (line 186): no docstring
  - `async _wait_for_ontology_present(session, db_name, ontology_id, branch, timeout_seconds, poll_interval_seconds)` (line 211): no docstring
  - `async _get_head_commit(session, db_name, branch)` (line 238): no docstring
  - `async _create_db(session, db_name)` (line 243): no docstring
  - `async _create_ontology(session, db_name, ontology, branch)` (line 256): no docstring
  - `async _upsert_object_type_contract(oms_session, db_name, class_id, contract_payload, branch)` (line 281): no docstring
  - `async _upsert_link_type_contract(oms_session, dataset_registry, objectify_registry, db_name, branch, link_type_id, source_class, target_class, predicate, cardinality, join_dataset_id, join_dataset_version_id, source_key_column, target_key_column)` (line 363): no docstring
  - `async _enqueue_link_index_job(dataset_registry, objectify_registry, link_type_id, db_name)` (line 487): no docstring
  - `async _wait_for_instance_count(session, db_name, class_id, expected_count, timeout_seconds, poll_interval_seconds)` (line 508): no docstring
  - `async _create_instance(session, db_name, class_id, payload, branch)` (line 533): no docstring
  - `_render_csv(headers, rows)` (line 553): no docstring
  - `async _create_dataset_with_artifact(dataset_registry, db_name, name, columns, rows, branch)` (line 563): no docstring
  - `async _wait_for_link_index_status(dataset_registry, link_type_id, expected_status, timeout_seconds, poll_interval_seconds)` (line 607): no docstring
  - `async _wait_for_relationship(session, db_name, class_id, pk_field, pk_value, predicate, branch, timeout_seconds, poll_interval_seconds)` (line 629): no docstring
  - `async _wait_for_instance_edits(dataset_registry, db_name, class_id, min_count, timeout_seconds, poll_interval_seconds)` (line 665): no docstring
  - `async _get_write_side_last_sequence(aggregate_type, aggregate_id)` (line 683): no docstring
  - `async _delete_db_best_effort(session, db_name)` (line 738): no docstring
  - `async test_access_policy_filters_and_masks_query_results()` (line 758): no docstring
  - `async test_link_indexing_updates_relationships_and_status()` (line 854): no docstring
  - `async test_object_type_migration_requires_edit_reset()` (line 1059): no docstring
...
- **Functions**
  ...
  - `async _record_deployed_commit(db_name, target_branch, ontology_commit_id)` (line 149): no docstring
  - `async _wait_for_action_log(session, db_name, action_log_id, headers, timeout_seconds, poll_interval_seconds)` (line 175): no docstring
  - `async _wait_for_action_log_ids_by_correlation(db_name, action_type_id, correlation_id, expected_count, timeout_seconds, poll_interval_seconds)` (line 207): no docstring
  - `async _submit_action_apply_v2(session, db_name, action_type_id, base_branch, input_payload, headers, metadata, correlation_id)` (line 254): no docstring
  - `_pick_first_lifecycle_id(action_log_payload)` (line 288): no docstring
  - `async _wait_for_es_overlay_doc(es_base_url, index_name, doc_id, timeout_seconds, poll_interval_seconds)` (line 302): no docstring
  - `async _wait_for_es_overlay_doc_by_action_log(es_base_url, index_name, doc_id, action_log_id, timeout_seconds, poll_interval_seconds)` (line 338): no docstring
  - `async _start_action_worker(env, backend_dir)` (line 375): no docstring
  - `async _run_subprocess(*args, cwd, env, timeout_seconds)` (line 392): no docstring
  - `async _docker_container_running(container_name)` (line 416): no docstring
  - `_smoke_worker_mode()` (line 428): no docstring
  - `async _ensure_action_worker_docker_running(repo_root, build)` (line 438): Ensure action-worker is running in Docker and return whether the test started it.
  - `async _docker_container_health(container_name)` (line 466): no docstring
  - `async _wait_for_container_healthy(container_name, timeout_seconds, poll_interval_seconds)` (line 481): no docstring
  - `async _ensure_kafka_docker_running(repo_root)` (line 497): Ensure Kafka is running before submitting commands.
  - `async _stop_action_worker_docker(repo_root)` (line 534): no docstring
  - `async _stop_process(proc, timeout_seconds)` (line 551): no docstring
  - `_es_base_url_from_dotenv(env)` (line 569): no docstring
  - `_action_worker_env_from_dotenv(dotenv)` (line 575): no docstring
  - `_apply_postgres_env_for_registry(dotenv)` (line 605): no docstring
  - `_apply_event_store_env(dotenv)` (line 614): no docstring
  - `_apply_lakefs_env(dotenv)` (line 621): no docstring
  - `_pick_first_lifecycle_id_any(action_log_payload)` (line 631): no docstring
  - `async _update_instance_ingest(session, db_name, base_branch, class_id, instance_id, expected_seq, patch, headers)` (line 657): no docstring
  - `async _assert_action_applied_event_in_event_store(action_applied_event_id)` (line 689): no docstring
  - `async test_action_writeback_e2e_smoke()` (line 703): no docstring
  - `async test_action_writeback_e2e_verification_suite()` (line 950): Verification suite for Action writeback behavior (ACTION_WRITEBACK_DESIGN.md):
  - `async test_action_batch_dependency_e2e()` (line 1461): End-to-end verification for:
...
- **Functions**
  - `_kafka_admin()` (line 63): no docstring
  - `_auth_headers()` (line 67): Get auth headers for BFF requests.
  - `_extract_constant_dict(node)` (line 72): Extract a best-effort {str: constant} mapping from an ast.Dict node.
  - `_extract_constant_kwargs(node)` (line 85): Extract a best-effort {str: constant} mapping from an ast.Call keyword list.
- **Classes**
  - `TestSafeKafkaConsumerConfiguration` (line 103): Verify SafeKafkaConsumer enforces critical settings.
    - `test_enforced_isolation_level(self)` (line 106): SafeKafkaConsumer should always use read_committed.
    - `test_enforced_auto_commit_disabled(self)` (line 113): SafeKafkaConsumer should disable auto-commit.
    - `test_workers_use_safe_consumer(self)` (line 120): Verify all Kafka-consuming workers use SafeKafkaConsumer (no raw Consumer).
    - `test_no_raw_consumer_in_worker_tree(self)` (line 171): Hard-fail if any *_worker module imports raw Consumer (regression guard).
  - `TestKafkaProducerConfiguration` (line 236): Verify critical producer-side idempotence settings are present where required.
    - `test_pipeline_job_queue_producer_is_idempotent(self)` (line 239): no docstring
    - `test_connector_trigger_producer_is_idempotent(self)` (line 285): no docstring
  - `TestKafkaConnectivity` (line 337): Verify Kafka connectivity and topic access.
    - `test_kafka_topics_exist(self)` (line 341): Verify all declared Kafka topics exist (SSoT: AppConfig.get_all_topics).
  ...
  - `TestMSAServiceHealth` (line 540): Verify all first-class services are reachable (full stack).
    ...
    - `async test_agent_health_endpoint(self)` (line 553): no docstring
    - `async test_ingest_reconciler_health_endpoint(self)` (line 560): no docstring
  - `TestDatabaseConnectivity` (line 571): Verify database connectivity.
    - `async test_postgres_connection(self)` (line 576): PostgreSQL should be connectable.
    - `async test_redis_connection(self)` (line 593): Redis should be connectable and require authentication (prod safety).
  - `TestInfraConnectivity` (line 648): Verify non-DB infra dependencies (S3/MinIO, lakeFS, Elasticsearch).
    - `async test_minio_health(self)` (line 653): no docstring
    - `async test_lakefs_health(self)` (line 660): no docstring
    - `async test_elasticsearch_health(self)` (line 669): no docstring
  - `TestSystemWiring` (line 678): Verify producer/consumer wiring between key MSAs (no mocks).
    - `async test_message_relay_publishes_event_store_appends(self)` (line 688): Message relay must publish newly appended Event Store events to Kafka.
    - `async test_connector_trigger_publishes_outbox(self)` (line 762): Connector trigger service must publish pending outbox items to Kafka.
    - `async test_pipeline_scheduler_enqueues_scheduled_pipeline(self)` (line 816): Pipeline scheduler must enqueue due scheduled pipelines to Kafka.
    - `async test_action_outbox_emits_action_applied_event(self)` (line 897): Action outbox worker must emit ActionApplied into the event store, and the relay must publish it to Kafka.
  - `TestOutboxPatternVerification` (line 1020): Verify outbox pattern implementation.
    - `test_objectify_outbox_uses_aggregate_key(self)` (line 1023): Objectify outbox should scope ordering by run_id when present.
    - `test_objectify_outbox_tracks_delivery(self)` (line 1038): Objectify outbox should track individual delivery status.
    - `test_message_relay_prefers_ordering_key(self)` (line 1051): Message relay should prefer ordering_key for Kafka partitioning when present.
  - `TestProcessedEventRegistryIdempotency` (line 1066): Verify ProcessedEventRegistry provides idempotency.
    - `async test_claim_idempotency(self)` (line 1071): ProcessedEventRegistry.claim should be idempotent.
    - `async test_sequence_ordering(self)` (line 1105): ProcessedEventRegistry should enforce sequence ordering.
  - `TestPipelineJobQueue` (line 1159): Verify PipelineJobQueue implementation.
    - `test_pipeline_job_has_dedupe_key(self)` (line 1162): PipelineJob should auto-generate dedupe_key.
    - `test_pipeline_job_queue_uses_pipeline_id_key(self)` (line 1176): PipelineJobQueue should use pipeline_id as partition key.
  - `TestEndToEndFlowSimulation` (line 1190): Simulate E2E flows without actually processing jobs.
    - `async test_objectify_job_creation_flow(self)` (line 1194): Test creating an objectify job payload.
    - `async test_pipeline_job_creation_flow(self)` (line 1222): Test creating a pipeline job payload.
  - `TestWorkerModuleImports` (line 1257): Verify workers can be imported without errors.
    - `test_objectify_worker_import(self)` (line 1260): Objectify worker should be importable.
    - `test_pipeline_worker_import(self)` (line 1265): Pipeline worker should be importable.
    - `test_action_worker_import(self)` (line 1270): Action worker should be importable.
    - `test_connector_sync_worker_import(self)` (line 1275): Connector sync worker should be importable.
    - `test_ontology_worker_import(self)` (line 1280): Ontology worker should be importable.
    - `test_instance_worker_import(self)` (line 1285): Instance worker should be importable.
    - `test_projection_worker_import(self)` (line 1290): Projection worker should be importable.
    - `test_action_outbox_worker_import(self)` (line 1295): Action outbox worker should be importable.
    - `test_ingest_reconciler_worker_import(self)` (line 1300): Ingest reconciler worker should be importable.
    - `test_writeback_materializer_worker_import(self)` (line 1305): Writeback materializer worker should be importable.
    - `test_connector_trigger_service_import(self)` (line 1310): Connector trigger service should be importable.
    - `test_pipeline_scheduler_import(self)` (line 1315): Pipeline scheduler should be importable.
    - `test_message_relay_import(self)` (line 1320): Message relay should be importable.
  - `TestConsistencySummary` (line 1331): Summary tests for all consistency features.
    - `test_all_critical_settings_enforced(self)` (line 1334): All critical Kafka settings should be enforced.
    - `test_idempotency_patterns_present(self)` (line 1346): Idempotency patterns should be present.
    - `test_occ_support_present(self)` (line 1364): OCC support should be present in PipelineRegistry.

### `backend/tests/test_core_functionality.py`
- **Functions**
  - `_get_postgres_url_candidates()` (line 28): Return Postgres DSN candidates (env override first, then common local ports).
  - `async _resolve_bff_path(session, candidates)` (line 53): no docstring
  - `async _get_write_side_last_sequence(aggregate_type, aggregate_id)` (line 72): Fetch the current write-side sequence for an aggregate from Postgres.
  - `async _wait_for_db_exists(session, db_name, expected, timeout_seconds, poll_interval_seconds)` (line 136): no docstring
  - `async _wait_for_command_terminal_state(session, command_id, timeout_seconds, poll_interval_seconds)` (line 157): Wait until an async (202 Accepted) command reaches a terminal state.
  - `async _wait_for_ontology_present(session, db_name, ontology_id, branch, timeout_seconds, poll_interval_seconds)` (line 192): no docstring
  - `async _wait_for_es_doc(session, index_name, doc_id, timeout_seconds, poll_interval_seconds)` (line 218): no docstring
- **Classes**
  - `TestCoreOntologyManagement` (line 245): Test suite for Ontology Management Service
    - `async test_database_lifecycle(self)` (line 250): Test complete database lifecycle with Event Sourcing
    - `async test_ontology_creation(self)` (line 291): Test ontology creation with complex types
    - `async test_ontology_i18n_label_projection(self)` (line 370): Ensure i18n labels are normalized for ES and preserved in label_i18n.
    - `async test_ontology_creation_advanced_relationships(self)` (line 496): Test ontology creation with relationships is event-sourced and functional.
  - `TestBFFGraphFederation` (line 597): Test suite for BFF Graph Federation capabilities
    - `async test_foundry_v2_ontology_full_metadata_surface(self)` (line 602): Foundry v2 full metadata surface should be available.
    - `async test_graph_query_federation(self)` (line 612): Test federated graph queries with Elasticsearch
  - `TestEventSourcingInfrastructure` (line 625): Test Event Sourcing and CQRS infrastructure
    - `async test_s3_event_storage(self)` (line 633): Verify S3/MinIO event storage is working
    - `async test_postgresql_processed_event_registry(self)` (line 680): Verify Postgres processed_events registry is available (idempotency contract)
    - `async test_kafka_message_flow(self)` (line 744): Verify Kafka message flow is operational
  - `TestComplexTypes` (line 767): Test complex type validation and handling
    - `test_email_validation(self)` (line 771): Test email type validation
    - `test_phone_validation(self)` (line 787): Test phone number validation
    - `test_json_validation(self)` (line 798): Test JSON type validation
  - `TestHealthEndpoints` (line 815): Test all service health endpoints
    - `async test_oms_health(self)` (line 820): Test OMS health endpoint
    - `async test_bff_health(self)` (line 830): Test BFF health endpoint
...
- **Functions**
  ...
  - `async _upsert_object_type_contract(client, db_name, class_id, branch, contract_payload)` (line 166): no docstring
...
- **Functions**
  - `_build_smoke_user_jwt()` (line 57): Build a deterministic HS256 user JWT for integration smoke tests.
  - `_load_repo_dotenv()` (line 89): Best-effort loader for the repo root `.env` used by docker-compose port overrides.
  - `_get_postgres_url_candidates()` (line 118): no docstring
  - `async _get_write_side_last_sequence(aggregate_type, aggregate_id)` (line 148): Fetch current write-side aggregate sequence (OCC expected_seq) from Postgres.
  - `async _get_ontology_head_commit(session, db_name, branch)` (line 199): no docstring
  - `async _record_deployed_commit(db_name, target_branch, ontology_commit_id)` (line 209): no docstring
  - `_extract_command_lifecycle_status(payload)` (line 247): Resolve command lifecycle status from either direct or envelope-style responses.
  - `async _wait_for_command_completed(session, command_id, timeout_seconds, poll_interval_seconds)` (line 275): no docstring
  - `async _wait_for_ontology_schema_ready(session, schema_url, branch, class_id, include_preview, timeout_seconds, poll_interval_seconds)` (line 305): Wait until ontology schema is readable on the target branch.
  - `async _wait_for_action_type_ready(session, db_name, action_type_id, branch, timeout_seconds, poll_interval_seconds)` (line 349): Wait until action-type resource becomes readable on the target branch.
  - `_xlsx_bytes(header, rows)` (line 385): no docstring
  - `_csv_bytes(header, rows)` (line 403): no docstring
  - `_collect_reintroduced_removed_ops(spec_paths_map)` (line 626): no docstring
  - `_local_source_reintroduced_removed_ops()` (line 635): no docstring
  - `_is_wip(op)` (line 647): no docstring
  - `_is_ops_only(op)` (line 657): no docstring
...
- **Classes**
  ...
  - `SmokeContext` (line 672): no docstring
    - `instance_aggregate_id(self)` (line 700): no docstring
    - `pipeline_name(self)` (line 705): no docstring
    - `dataset_name(self)` (line 709): no docstring
  - `RequestPlan` (line 713): no docstring
...
- **Functions**
  ...
  - `async _upsert_object_type_contract(client, db_name, class_id, branch, contract_payload)` (line 331): no docstring
  - `async test_pipeline_objectify_es_projection()` (line 412): Full flow: raw ingest -> pipeline build -> objectify -> ES projection.
...
- **Functions**
  ...
  - `test_no_foundry_strict_opt_out_env_keys_reintroduced()` (line 132): no docstring
  - `test_no_external_funnel_address_env_keys_reintroduced()` (line 156): no docstring

### `backend/tests/unit/config/test_foundry_surface_topology_guard.py`
- **Functions**
  - `_repo_root()` (line 7): no docstring
  - `_extract_service_block(compose_yaml, service_name)` (line 11): no docstring
  - `test_gateway_does_not_expose_funnel_public_routes()` (line 19): no docstring
  - `test_default_compose_does_not_publish_funnel_host_port()` (line 32): no docstring
  - `test_default_compose_includes_pipeline_scheduler_runtime()` (line 40): no docstring
  - `test_full_compose_bff_does_not_depend_on_funnel_service()` (line 47): no docstring
  - `test_full_compose_does_not_enable_legacy_pull_request_surface()` (line 56): no docstring
  - `test_settings_do_not_expose_legacy_pull_request_feature_flag()` (line 62): no docstring
  - `test_funnel_service_absent_in_compose_variants()` (line 69): no docstring
  - `test_prometheus_default_targets_do_not_assume_funnel_service()` (line 76): no docstring
  - `test_debug_ports_overlay_does_not_expose_funnel_port()` (line 82): no docstring
  - `test_deploy_scripts_do_not_reference_external_funnel_health()` (line 89): no docstring
  - `test_ssl_cert_generator_does_not_assume_external_funnel_service()` (line 102): no docstring
  - `test_local_start_script_does_not_start_funnel_process()` (line 111): no docstring
  - `test_env_templates_do_not_expose_external_funnel_toggles()` (line 119): no docstring
...
- **Functions**
  - `test_ontology_settings_backend_normalization_forces_postgres()` (line 6): no docstring

### `backend/tests/unit/config/test_settings_ssot.py`
- **Functions**
  - `_disable_env_file(monkeypatch)` (line 17): no docstring
  - `test_pipeline_publish_lock_timeout_fallback(monkeypatch)` (line 23): no docstring
  - `test_agent_bff_token_and_command_timeout_fallback(monkeypatch)` (line 40): no docstring
  - `test_client_token_fallbacks(monkeypatch)` (line 58): no docstring
  - `test_lakefs_repository_defaults(monkeypatch)` (line 78): no docstring
  - `test_local_port_host_aliases(monkeypatch)` (line 85): no docstring
  - `test_objectify_dataset_primary_chunk_size_defaults(monkeypatch)` (line 106): no docstring
...
- **Functions**
  - `test_normalize_sql_query_allows_single_statement()` (line 9): no docstring
  - `test_normalize_sql_query_rejects_empty()` (line 15): no docstring
  - `test_normalize_sql_query_rejects_multi_statement()` (line 21): no docstring
...
- **Functions**
  - `test_error_taxonomy_audit_guard()` (line 52): no docstring
...
- **Functions**
  - `_iter_runtime_python_files(backend_dir)` (line 53): no docstring
  - `test_runtime_has_no_return_in_finally()` (line 74): no docstring
  - `test_runtime_scope_disallows_silent_failures()` (line 97): no docstring
- **Classes**
  - `_ReturnInFinallyVisitor` (line 61): no docstring
    - `__init__(self)` (line 62): no docstring
    - `visit_Try(self, node)` (line 65): no docstring
...
### `backend/tests/unit/oms/test_action_async_apply_batch.py`
- **Functions**
  - `app_with_router()` (line 22): no docstring
  - `async test_submit_batch_registers_dependencies_and_defers_children(app_with_router, monkeypatch)` (line 42): no docstring
  - `async test_foundry_apply_batch_v2_uses_submit_batch_pipeline(app_with_router, monkeypatch)` (line 112): no docstring
  - `async test_foundry_apply_v2_validate_only_returns_validation_payload(app_with_router, monkeypatch)` (line 160): no docstring
  - `async test_foundry_apply_v2_validate_and_execute_returns_validation_payload(app_with_router, monkeypatch)` (line 204): no docstring
- **Classes**
  - `_FakeEventStore` (line 13): no docstring
    - `__init__(self)` (line 14): no docstring
    - `async append_event(self, event)` (line 17): no docstring
...
- **Functions**
  ...
  - `async test_submit_batch_returns_403_for_datasource_derived_without_data_engineer_role(action_async_app, monkeypatch)` (line 94): no docstring
  - `async test_simulate_returns_503_when_datasource_derived_data_access_is_unverifiable(action_async_app, monkeypatch)` (line 126): no docstring
  - `async test_submit_batch_returns_403_when_target_class_misses_required_interface(action_async_app, monkeypatch)` (line 176): no docstring
  - `async test_submit_batch_returns_503_when_target_edit_access_is_unverifiable(action_async_app, monkeypatch)` (line 222): no docstring
  - `async test_simulate_use_branch_head_no_longer_requires_terminus(action_async_app, monkeypatch)` (line 282): no docstring
- **Classes**
...
- **Functions**
  - `mock_es()` (line 69): no docstring
  - `mock_storage()` (line 76): no docstring
  - `override_deps(mock_es, mock_storage)` (line 84): no docstring
  - `async test_upload_attachment_stores_to_s3_and_returns_metadata(mock_storage)` (line 103): no docstring
  - `async test_upload_attachment_rejects_empty_body(mock_storage)` (line 122): no docstring
  - `async test_list_property_attachments_single(mock_es)` (line 141): no docstring
  - `async test_list_property_attachments_multiple(mock_es)` (line 156): no docstring
  - `async test_list_property_attachments_404_not_found(mock_es)` (line 174): no docstring
  - `async test_get_attachment_by_rid_returns_metadata(mock_es)` (line 193): no docstring
  - `async test_get_attachment_by_rid_not_found(mock_es)` (line 207): no docstring
  - `async test_get_attachment_content_returns_binary(mock_es, mock_storage)` (line 224): no docstring
  - `async test_get_attachment_content_by_rid_returns_binary(mock_es, mock_storage)` (line 237): no docstring
  - `async test_get_attachment_content_404_when_s3_missing(mock_es, mock_storage)` (line 249): no docstring
  - `async test_attachments_skip_role_enforcement_without_actor_headers(monkeypatch)` (line 263): no docstring
  - `async test_attachments_return_permission_denied_when_actor_header_present_and_role_check_fails(monkeypatch)` (line 278): no docstring

### `backend/tests/unit/oms/test_database_router_backend_profile.py`
- **Functions**
  - `test_oms_database_routes_are_foundry_style_without_profile_gates()` (line 6): no docstring

### `backend/tests/unit/oms/test_dependencies_database_exists.py`
- **Functions**
  - `async test_ensure_database_exists_uses_postgres_registry_when_terminus_missing(monkeypatch)` (line 11): no docstring
  - `async test_ensure_database_exists_returns_name_when_present(monkeypatch)` (line 27): no docstring
  - `async test_ensure_database_exists_raises_404_when_missing_in_postgres_registry(monkeypatch)` (line 40): no docstring
  - `async test_ensure_database_exists_raises_404_when_missing()` (line 54): no docstring

### `backend/tests/unit/oms/test_dependencies_terminus_profile_gate.py`
- **Functions**
  - `test_legacy_terminus_dependency_accessors_are_removed()` (line 6): no docstring

### `backend/tests/unit/oms/test_instance_async_permission_profile.py`
- **Functions**
  - `async test_create_instance_async_allows_missing_terminus_in_postgres_profile(monkeypatch)` (line 11): no docstring
...
- **Functions**
  ...
  - `async test_sparql_endpoint_removed_returns_404()` (line 132): no docstring

### `backend/tests/unit/oms/test_main_backend_profile.py`
- **Functions**
  - `async test_root_reports_postgres_profile_features(monkeypatch)` (line 11): no docstring
  - `async test_root_forces_postgres_backend_when_legacy_profile_is_configured(monkeypatch)` (line 25): no docstring
...
- **Functions**
  ...
  - `async test_search_objects_v2_retries_with_properties_when_data_query_misses(mock_es)` (line 76): no docstring
  - `async test_search_objects_v2_collapses_duplicate_overlay_rows(mock_es)` (line 122): no docstring
  - `async test_search_objects_v2_hides_overlay_tombstoned_rows(mock_es)` (line 158): no docstring
  - `async test_search_objects_v2_allows_missing_where_with_match_all_fallback(mock_es)` (line 193): no docstring
  - `async test_search_objects_v2_supports_select_and_order_by_pushdown(mock_es)` (line 208): no docstring
  - `async test_search_objects_v2_preserves_existing_properties_object(mock_es)` (line 236): no docstring
  - `async test_search_objects_v2_rejects_select_and_select_v2_together()` (line 272): no docstring
  - `async test_search_objects_v2_invalid_page_token_returns_foundry_error()` (line 288): no docstring
  - `async test_search_objects_v2_expired_page_token_returns_foundry_error()` (line 306): no docstring
  - `async test_search_objects_v2_rejects_page_token_scope_mismatch()` (line 322): no docstring
  - `async test_search_objects_v2_accepts_scope_matched_page_token(mock_es)` (line 338): no docstring
  - `async test_search_objects_v2_rejects_page_token_when_page_size_changes()` (line 360): no docstring
  - `async test_search_objects_v2_accepts_deprecated_startswith_alias(mock_es)` (line 386): no docstring
  - `async test_search_objects_v2_accepts_contains_any_term_operator(mock_es)` (line 403): no docstring
  - `async test_search_objects_v2_in_operator_valid_list_accepted(mock_es)` (line 427): ``in`` operator with a non-empty list should be accepted (previously rejected).
  - `async test_search_objects_v2_is_null_false_maps_to_exists_clause(mock_es)` (line 441): no docstring
  - `async test_search_objects_v2_rejects_is_null_with_non_boolean_value()` (line 458): no docstring
  - `async test_search_objects_v2_accepts_non_deprecated_operator(mock_es)` (line 472): no docstring
  - `async test_search_objects_v2_rejects_non_foundry_anyterm_alias()` (line 493): no docstring
  - `async test_search_objects_v2_rejects_excessive_nesting_depth()` (line 508): no docstring
  - `async test_search_objects_v2_accepts_foundry_branch_rid(mock_es)` (line 540): no docstring
  - `async test_search_v2_in_operator_generates_terms_query(mock_es)` (line 565): no docstring
  - `async test_search_v2_in_operator_rejects_empty_list()` (line 583): no docstring
  - `async test_search_v2_interval_operator_generates_intervals_query(mock_es)` (line 601): no docstring
  - `async test_search_v2_within_distance_of_generates_nested_geo_query(mock_es)` (line 631): no docstring
  - `async test_search_v2_within_bounding_box_generates_nested_geo_query(mock_es)` (line 663): no docstring
  - `async test_search_v2_within_polygon_generates_nested_geo_query(mock_es)` (line 689): no docstring
  - `async test_search_v2_intersects_bounding_box_generates_geo_shape_query(mock_es)` (line 714): no docstring
  - `async test_search_v2_does_not_intersect_polygon_generates_disjoint_query(mock_es)` (line 742): no docstring
  - `async test_search_v2_geo_operator_rejects_non_dict_value()` (line 768): no docstring

### `backend/tests/unit/oms/test_ontology_extensions_occ.py`
- **Functions**
  - `async test_assert_expected_head_commit_skips_when_unset()` (line 11): no docstring
  - `async test_assert_expected_head_commit_skips_when_blank()` (line 23): no docstring
  - `async test_assert_expected_head_commit_returns_trimmed_token_when_allowed_by_branch()` (line 35): no docstring
  - `async test_assert_expected_head_commit_strict_mode_rejects_blank()` (line 47): no docstring
  - `async test_assert_expected_head_commit_strict_mode_accepts_latest_deployed_commit(monkeypatch)` (line 60): no docstring
  - `async test_assert_expected_head_commit_strict_mode_rejects_mismatch(monkeypatch)` (line 81): no docstring

### `backend/tests/unit/oms/test_ontology_router_resource_helpers.py`
- **Functions**
  - `test_ontology_from_resource_payload_maps_object_type_contract()` (line 14): no docstring
  - `test_is_internal_ontology_detects_internal_dict_payload()` (line 38): no docstring
  - `test_coerce_property_models_backfills_label_for_resource_payload()` (line 45): no docstring
  - `test_coerce_relationship_models_backfills_label_for_resource_payload()` (line 59): no docstring

### `backend/tests/unit/oms/test_ontology_router_write_backend.py`
- **Functions**
  - `async test_load_existing_ontology_for_write_reads_from_resource_registry_without_terminus(monkeypatch)` (line 37): no docstring
- **Classes**
  - `_ResourceServiceStub` (line 8): no docstring
    - `async get_resource(self, db_name, branch, resource_type, resource_id)` (line 9): no docstring
...
- **Functions**
  - `mock_es()` (line 42): no docstring
  - `mock_storage()` (line 49): no docstring
  - `override_deps(mock_es, mock_storage)` (line 57): no docstring
  - `async test_get_first_point_returns_earliest_point(mock_es, mock_storage)` (line 76): no docstring
  - `async test_get_first_point_404_when_instance_not_found(mock_es)` (line 90): no docstring
  - `async test_get_first_point_404_when_property_not_timeseries(mock_es)` (line 104): no docstring
  - `async test_get_last_point_returns_latest_point(mock_es, mock_storage)` (line 130): no docstring
  - `async test_stream_points_returns_all_points(mock_es, mock_storage)` (line 149): no docstring
  - `async test_stream_points_with_absolute_range(mock_es, mock_storage)` (line 165): no docstring
  - `async test_stream_points_404_when_no_ts_data(mock_es, mock_storage)` (line 188): no docstring
  - `async test_timeseries_skips_role_enforcement_without_actor_headers(monkeypatch)` (line 204): no docstring
  - `async test_timeseries_returns_permission_denied_when_actor_header_present_and_role_check_fails(monkeypatch)` (line 219): no docstring

### `backend/tests/unit/openapi/test_architecture_quality_docs_guard.py`
- **Functions**
...
- **Functions**
  - `_load_manifest()` (line 18): no docstring
  - `_openapi_operation_parameters(openapi, path, method)` (line 25): no docstring
  - `_split_params(params)` (line 47): no docstring
  - `_route_index(app_routes)` (line 61): no docstring
  - `_route_required_scopes(route)` (line 74): no docstring
  - `test_foundry_contract_manifest_matches_openapi_and_scopes()` (line 85): no docstring

### `backend/tests/unit/openapi/test_foundry_datasets_v2_contract.py`
- **Functions**
  - `_build_test_app()` (line 32): no docstring
  - `_override_deps(app, dataset_registry, pipeline_registry)` (line 388): no docstring
  - `test_foundry_datasets_v2_paths_exist_in_openapi()` (line 405): no docstring
  - `async test_foundry_datasets_create_and_get(monkeypatch)` (line 449): no docstring
  - `async test_foundry_datasets_schema_get_and_update(monkeypatch)` (line 498): no docstring
  - `async test_foundry_datasets_branch_operations(monkeypatch)` (line 562): no docstring
  - `async test_foundry_datasets_transaction_lifecycle(monkeypatch)` (line 637): no docstring
  - `async test_foundry_datasets_transaction_commit_materializes_uploaded_csv_version(monkeypatch)` (line 709): no docstring
  - `async test_foundry_datasets_transaction_commit_materializes_non_source_csv_when_list_objects_fails(monkeypatch)` (line 778): no docstring
  - `async test_foundry_datasets_transaction_commit_lakefs_failure_keeps_open(monkeypatch)` (line 847): no docstring
  - `async test_foundry_datasets_file_operations(monkeypatch)` (line 895): no docstring
  - `async test_foundry_datasets_list_files_returns_503_when_lakefs_unavailable(monkeypatch)` (line 963): no docstring
  - `async test_foundry_datasets_read_table(monkeypatch)` (line 1000): no docstring
  - `async test_foundry_datasets_read_table_with_column_selection(monkeypatch)` (line 1055): readTable respects the ``columns`` request field to project columns.
  - `async test_foundry_datasets_read_table_uses_version_artifact_key_fallback(monkeypatch)` (line 1106): no docstring
  - `async test_foundry_datasets_read_table_no_version_returns_empty(monkeypatch)` (line 1149): readTable returns empty result when no version exists and lakeFS fallback fails.
  - `async test_foundry_datasets_read_table_lakefs_error_returns_unavailable(monkeypatch)` (line 1185): no docstring
- **Classes**
  - `_DatasetRegistry` (line 57): no docstring
    - `__init__(self)` (line 58): no docstring
    - `async create_dataset(self, **kwargs)` (line 66): no docstring
    - `async get_dataset(self, dataset_id)` (line 83): no docstring
    - `async list_datasets(self, db_name, **kwargs)` (line 86): no docstring
    - `async list_all_datasets(self, branch, limit, offset, order_by)` (line 106): no docstring
    - `async update_schema(self, dataset_id, schema_json)` (line 136): no docstring
    - `async get_latest_version(self, dataset_id)` (line 141): no docstring
    - `async create_ingest_request(self, dataset_id, db_name, branch, idempotency_key, request_fingerprint, **kwargs)` (line 146): no docstring
    - `async get_ingest_request(self, ingest_request_id)` (line 179): no docstring
    - `async mark_ingest_committed(self, ingest_request_id, lakefs_commit_id, artifact_key)` (line 182): no docstring
    - `async create_ingest_transaction(self, ingest_request_id, status)` (line 197): no docstring
    - `async get_ingest_transaction(self, ingest_request_id)` (line 221): no docstring
    - `async get_ingest_transaction_by_id(self, transaction_id)` (line 227): no docstring
    - `async mark_ingest_transaction_committed(self, ingest_request_id, lakefs_commit_id, artifact_key)` (line 230): no docstring
    - `async mark_ingest_transaction_aborted(self, ingest_request_id, error)` (line 245): no docstring
    - `async publish_ingest_request(self, ingest_request_id, dataset_id, lakefs_commit_id, artifact_key, row_count, sample_json, schema_json, apply_schema, outbox_entries)` (line 258): no docstring
  - `_MockLakeFSClient` (line 311): no docstring
    - `async list_branches(self, repository, **kwargs)` (line 312): no docstring
    - `async create_branch(self, repository, name, source)` (line 318): no docstring
    - `async get_branch_head_commit_id(self, repository, branch)` (line 321): no docstring
    - `async delete_branch(self, repository, name)` (line 324): no docstring
    - `async list_objects(self, repository, ref, prefix, amount)` (line 327): no docstring
    - `async commit(self, repository, branch, message, metadata)` (line 332): no docstring
  - `_FailingLakeFSClient` (line 336): no docstring
    - `async commit(self, repository, branch, message, metadata)` (line 337): no docstring
  - `_FailingLakeFSListClient` (line 341): no docstring
    - `async list_objects(self, repository, ref, prefix, amount)` (line 342): no docstring
  - `_MockLakeFSStorage` (line 346): no docstring
    - `__init__(self)` (line 347): no docstring
    - `async load_bytes(self, repo, path)` (line 350): no docstring
    - `async save_bytes(self, repo, path, data, content_type)` (line 355): no docstring
    - `async get_object_metadata(self, repo, path)` (line 358): no docstring
  - `_PipelineRegistry` (line 369): no docstring
    - `__init__(self, lakefs_client, lakefs_storage)` (line 370): no docstring
    - `async get_pipeline(self, pipeline_id)` (line 378): no docstring
    - `async get_lakefs_client(self, user_id)` (line 381): no docstring
    - `async get_lakefs_storage(self, user_id)` (line 384): no docstring

### `backend/tests/unit/openapi/test_foundry_ontology_v2_contract.py`
- **Functions**
  - `_param_names(schema, path, method)` (line 12): no docstring
  - `_build_router_test_app(oms_client)` (line 17): no docstring
  - `test_foundry_v2_ontology_list_has_no_pagination_params()` (line 39): no docstring
  - `test_foundry_v2_object_type_list_keeps_pagination_and_branch_params()` (line 51): no docstring
  - `test_foundry_v2_ontology_read_paths_include_branch_when_supported()` (line 64): no docstring
  - `test_foundry_v2_load_object_set_objects_keeps_foundry_query_params()` (line 137): no docstring
  - `test_foundry_v2_object_set_preview_endpoints_keep_preview_query_param()` (line 159): no docstring
  - `test_foundry_v2_object_set_aggregate_and_temporary_query_params()` (line 188): no docstring
  - `test_foundry_v2_execute_query_keeps_foundry_query_params()` (line 209): no docstring
  - `test_foundry_v2_list_objects_includes_foundry_query_params()` (line 226): no docstring
  - `test_foundry_v2_count_objects_includes_foundry_query_params()` (line 248): no docstring
  - `test_foundry_v2_list_linked_objects_includes_foundry_query_params()` (line 268): no docstring
  - `test_foundry_v2_aggregate_objects_keeps_foundry_query_params()` (line 290): no docstring
  - `test_foundry_v2_timeseries_and_attachment_query_params()` (line 305): no docstring
  - `test_foundry_v2_attachment_upload_query_params()` (line 326): no docstring
  - `test_foundry_v2_strict_compat_env_gate(monkeypatch)` (line 341): no docstring
  - `test_foundry_v2_full_metadata_branch_contract()` (line 349): no docstring
  - `test_foundry_v2_strict_object_type_normalization_adds_required_fields()` (line 354): no docstring
  - `test_foundry_v2_strict_link_type_normalization_and_resolution()` (line 377): no docstring
  - `test_foundry_v2_strict_full_metadata_drops_unresolved_links()` (line 401): no docstring
  - `async test_foundry_v2_route_full_metadata_applies_required_fields(monkeypatch)` (line 422): no docstring
  - `async test_foundry_v2_load_object_set_objects_routes_to_object_search(monkeypatch)` (line 482): no docstring
  - `async test_foundry_v2_load_object_set_objects_requires_object_set(monkeypatch)` (line 526): no docstring
  - `async test_foundry_v2_count_objects_routes_to_oms_count(monkeypatch)` (line 558): no docstring
  - `async test_foundry_v2_load_object_set_multiple_object_types_requires_preview(monkeypatch)` (line 593): no docstring
  - `async test_foundry_v2_load_object_set_links_requires_preview(monkeypatch)` (line 628): no docstring
  - `async test_foundry_v2_load_object_set_links_returns_locator_payload(monkeypatch)` (line 663): no docstring
  - `async test_foundry_v2_aggregate_object_set_returns_metrics(monkeypatch)` (line 733): objectSets/aggregate now delegates to OMS aggregate_objects_v2.
  - `async test_foundry_v2_aggregate_object_set_delegates_to_oms(monkeypatch)` (line 808): Verify objectSets/aggregate delegates to OMS (not multi-page Python loop).
  - `async test_foundry_v2_aggregate_objects_route_returns_metrics(monkeypatch)` (line 867): per-objectType aggregate now delegates to OMS aggregate_objects_v2.
  - `async test_foundry_v2_create_temporary_and_get_object_set_roundtrip(monkeypatch)` (line 922): no docstring
  - `async test_foundry_v2_route_full_metadata_keeps_branch_rid_contract(monkeypatch)` (line 958): no docstring
  - `async test_foundry_v2_route_full_metadata_requires_preview_flag(monkeypatch)` (line 1018): no docstring
  - `async test_foundry_v2_preview_routes_require_preview_flag(monkeypatch, path)` (line 1065): no docstring
  - `async test_foundry_v2_route_list_object_types_strict_on_applies_required_fields(monkeypatch)` (line 1095): no docstring
  - `async test_foundry_v2_route_get_object_type_applies_required_fields(monkeypatch)` (line 1141): no docstring
  - `async test_foundry_v2_route_get_object_type_strict_on_applies_required_fields(monkeypatch)` (line 1184): no docstring
  - `async test_foundry_v2_route_get_outgoing_link_type_strict_on_unresolved_returns_not_found(monkeypatch)` (line 1227): no docstring
  - `async test_foundry_v2_route_get_outgoing_link_type_unresolved_returns_not_found(monkeypatch)` (line 1264): no docstring
  - `async test_foundry_v2_route_list_outgoing_link_types_strict_on_drops_unresolved(monkeypatch)` (line 1301): no docstring

### `backend/tests/unit/openapi/test_foundry_platform_v2_contract.py`
- **Functions**
  - `_param_names(schema, path, method)` (line 35): no docstring
  - `_build_test_app()` (line 40): no docstring
  - `test_foundry_platform_v2_paths_exist_in_openapi()` (line 71): no docstring
  - `async test_foundry_orchestration_create_build_returns_foundry_build_shape(monkeypatch)` (line 132): no docstring
  - `async test_foundry_orchestration_get_batch_jobs_and_cancel_flow()` (line 189): no docstring
  - `async test_foundry_connectivity_connection_scoped_table_import_create(monkeypatch)` (line 253): no docstring
  - `async test_foundry_connectivity_table_import_create_accepts_streaming_mode_when_cdc_enabled(monkeypatch)` (line 383): no docstring
  - `async test_foundry_connectivity_get_list_execute_and_delete_table_import(monkeypatch)` (line 490): no docstring
  - `async test_foundry_connectivity_export_runs_create_get_and_list()` (line 647): no docstring
  - `async test_foundry_connectivity_export_run_requires_markings_when_enforced()` (line 760): no docstring
  - `test_foundry_schedule_paths_exist_in_openapi()` (line 827): no docstring
  - `async test_foundry_schedule_create_get_pause_unpause_delete()` (line 843): no docstring
  - `async test_foundry_schedule_not_found_for_missing_pipeline()` (line 934): no docstring
  - `async test_foundry_schedule_runs_pagination_and_invalid_token()` (line 951): no docstring
  - `test_foundry_connection_crud_paths_exist_in_openapi()` (line 1012): no docstring
  - `async test_foundry_connection_create_get_list_delete()` (line 1037): no docstring
  - `async test_foundry_connection_get_not_found()` (line 1139): no docstring
  - `async test_foundry_connection_test_endpoint()` (line 1161): no docstring
  - `async test_foundry_connection_update_secrets_keeps_response_non_secret()` (line 1202): no docstring
  - `async test_foundry_connection_update_export_settings_v2()` (line 1262): no docstring
  - `async test_foundry_connection_upload_custom_jdbc_drivers_v2()` (line 1332): no docstring
  - `async test_foundry_file_import_requires_preview_and_supports_create(monkeypatch)` (line 1431): no docstring
  - `async test_foundry_virtual_table_supports_foundry_name_and_parent_rid(monkeypatch)` (line 1547): no docstring
  - `async test_foundry_virtual_table_execute_records_build_run(monkeypatch)` (line 1656): no docstring
  - `async test_foundry_virtual_table_create_rejects_non_snapshot_mode(monkeypatch)` (line 1773): no docstring
  - `async test_foundry_file_import_create_rejects_missing_selector_for_google_sheets()` (line 1838): no docstring
  - `async test_foundry_file_import_execute_rejects_invalid_runtime_config_before_pipeline(monkeypatch)` (line 1890): no docstring
...
- **Functions**
  - `test_extract_command_lifecycle_status_prefers_nested_command_status()` (line 9): no docstring
  - `test_extract_command_lifecycle_status_handles_nested_state_alias()` (line 21): no docstring
  - `test_extract_command_lifecycle_status_uses_top_level_when_not_generic()` (line 32): no docstring
  - `test_extract_command_lifecycle_status_ignores_generic_envelope_status_without_data_status()` (line 40): no docstring

### `backend/tests/unit/openapi/test_openapi_smoke_recipe_guard.py`
- **Functions**
  - `_iter_values(value)` (line 48): no docstring
  - `async test_openapi_smoke_recipes_exist_and_query_params_are_aiohttp_safe(method, path)` (line 62): no docstring
  - `async test_openapi_smoke_preview_recipes_use_string_preview_true(method, path)` (line 89): no docstring

### `backend/tests/unit/openapi/test_removed_v1_compat_guard.py`
- **Functions**
  - `_build_schema()` (line 157): no docstring
  - `_param_names(paths, path, method)` (line 163): no docstring
  - `test_removed_v1_compat_operations_absent_from_openapi()` (line 179): no docstring
  - `test_removed_v1_compat_operations_absent_from_full_bff_openapi()` (line 187): no docstring
  - `test_foundry_v2_openapi_parameter_surface_matches_official_docs_contract()` (line 200): no docstring
  - `test_removed_v1_query_path_not_allowlisted_for_agent_tools()` (line 367): no docstring
  - `test_removed_v1_query_path_not_present_in_seed_allowlist_script()` (line 417): no docstring
  - `test_removed_v1_compat_path_literals_absent_from_runtime_code()` (line 425): no docstring
  - `test_architecture_guard_covers_legacy_action_and_funnel_path_literals()` (line 546): no docstring
  - `test_removed_bff_legacy_branch_and_merge_path_literals_absent_from_runtime_code()` (line 575): no docstring
  - `test_funnel_runtime_does_not_call_bff_google_sheets_v1_paths()` (line 601): no docstring
  - `test_action_worker_direct_undo_literal_absent_from_runtime()` (line 625): no docstring
  - `test_oms_action_apply_runtime_not_coupled_to_internal_simulation_registry()` (line 643): no docstring
  - `test_migration_docs_synced_to_code_deleted_status()` (line 654): no docstring
  - `test_legacy_link_types_router_composition_shim_deleted()` (line 664): no docstring
  - `test_legacy_link_type_and_objectify_helper_shims_deleted()` (line 674): no docstring
  - `test_legacy_actions_and_query_router_shims_deleted()` (line 685): no docstring
  - `test_legacy_data_connector_sheet_tools_router_deleted()` (line 704): no docstring
  - `test_legacy_ontology_suggest_and_import_router_shims_deleted()` (line 716): no docstring
  - `test_legacy_ontology_metadata_router_shim_deleted()` (line 733): no docstring
  - `test_legacy_instances_sample_values_router_deleted()` (line 743): no docstring
  - `test_legacy_pipeline_compile_and_simulation_router_shims_deleted()` (line 756): no docstring
  - `test_external_funnel_service_artifacts_deleted()` (line 781): no docstring
  - `test_legacy_oms_pull_request_modules_deleted()` (line 806): no docstring
  - `test_legacy_action_simulation_registry_module_deleted()` (line 822): no docstring
  - `test_migration_docs_do_not_reintroduce_fullmetadata_preview_contradiction()` (line 829): no docstring
  - `test_foundry_reference_docs_use_current_urls()` (line 837): no docstring
  - `test_legacy_version_head_endpoint_literal_is_only_in_visibility_guard()` (line 851): no docstring
  - `test_legacy_branch_endpoint_literals_are_only_in_visibility_guard()` (line 872): no docstring
  - `test_legacy_version_history_diff_literals_are_only_in_visibility_guard(needle)` (line 900): no docstring
  - `test_removed_v1_paths_absent_from_generated_api_docs()` (line 924): no docstring
  - `test_tabular_ingest_response_schema_uses_tabular_analysis_key_only()` (line 988): no docstring
...
### `backend/tests/unit/routers/test_admin_reindex_instances_router.py`
- **Functions**
  - `async test_reindex_instances_endpoint_invokes_service(monkeypatch)` (line 10): no docstring
  - `async test_reindex_instances_endpoint_validates_db_name()` (line 46): no docstring

### `backend/tests/unit/routers/test_audit_router.py`
- **Functions**
  - `async test_list_audit_logs_normalizes_status_filter()` (line 26): no docstring
  - `async test_list_audit_logs_rejects_invalid_status_filter()` (line 45): no docstring
  - `async test_list_audit_logs_rejects_invalid_time_window()` (line 62): no docstring
  - `async test_list_audit_logs_treats_store_value_error_as_internal_error()` (line 78): no docstring
- **Classes**
  - `_RecordingAuditStore` (line 11): no docstring
    - `__init__(self)` (line 12): no docstring
    - `async list_logs(self, **kwargs)` (line 15): no docstring
  - `_ValueErrorAuditStore` (line 20): no docstring
    - `async list_logs(self, **_kwargs)` (line 21): no docstring

### `backend/tests/unit/routers/test_database_router_openapi_visibility.py`
- **Functions**
  - `test_removed_legacy_routes_not_exposed_in_openapi()` (line 6): no docstring
...
- **Functions**
  - `test_suggest_remediation_actions_uses_graph_target_kind()` (line 6): no docstring

### `backend/tests/unit/routers/test_lineage_router_out_of_date.py`
- **Functions**
  - `test_freshness_status_healthy_warning_critical()` (line 31): no docstring
  - `test_freshness_status_no_data()` (line 58): no docstring
  - `test_status_rank_orders_for_triage()` (line 67): no docstring
  - `test_normalize_window_defaults_and_order()` (line 73): no docstring
  - `test_extract_impacted_artifacts_from_edges_keeps_latest_per_artifact()` (line 80): no docstring
  - `test_summarize_run_rows_assigns_status_counts()` (line 105): no docstring
  - `test_edge_cause_payload_extracts_latest_writer_context()` (line 134): no docstring
  - `test_edge_cause_payload_returns_none_for_invalid_input()` (line 158): no docstring
  - `test_upstream_gap_minutes()` (line 163): no docstring
  - `test_chunked_helper()` (line 173): no docstring
  - `async test_batched_latest_edges_helpers_chunk_large_inputs(monkeypatch)` (line 203): no docstring
  - `async test_enrich_artifacts_with_latest_writer(monkeypatch)` (line 236): no docstring
  - `test_artifact_latest_writer_state()` (line 256): no docstring
  - `test_event_node_id_from_latest_writer()` (line 263): no docstring
  - `test_projection_and_writer_fields_from_latest_writer()` (line 270): no docstring
  - `test_out_of_date_scope_resolution()` (line 281): no docstring
  - `test_staleness_reason_with_scope_resolution()` (line 324): no docstring
  - `test_update_type_resolution()` (line 332): no docstring
- **Classes**
  - `_FakeLineageStoreForBatch` (line 178): no docstring
    - `__init__(self)` (line 179): no docstring
    - `async get_latest_edges_to(self, to_node_ids, **kwargs)` (line 184): no docstring
    - `async get_latest_edges_from(self, from_node_ids, **kwargs)` (line 188): no docstring
    - `async get_latest_edges_for_projections(self, projection_names, **kwargs)` (line 192): no docstring

### `backend/tests/unit/routers/test_lineage_router_path_diff.py`
- **Functions**
  - `test_find_shortest_path_downstream()` (line 8): no docstring
  - `test_find_shortest_path_upstream_uses_reverse_traversal()` (line 39): no docstring
  - `test_edge_signature_uses_projection_name_metadata()` (line 68): no docstring
  - `test_count_artifact_kinds()` (line 82): no docstring

### `backend/tests/unit/routers/test_lineage_router_timeline.py`
- **Functions**
  - `test_bucket_start_floors_to_interval()` (line 8): no docstring
  - `test_build_timeline_summary_counts_and_spikes()` (line 16): no docstring
  - `test_compact_edge_metadata_whitelists_keys()` (line 53): no docstring
...
- **Functions**
  - `async test_summary_skips_branch_info_in_postgres_profile(monkeypatch)` (line 28): no docstring
  - `async test_summary_keeps_branch_info_disabled_in_hybrid_profile(monkeypatch)` (line 45): no docstring
- **Classes**
  - `_FakeRedis` (line 8): no docstring
    - `async ping(self)` (line 9): no docstring
  - `_FakeEs` (line 13): no docstring
    - `async connect(self)` (line 14): no docstring
    - `async ping(self)` (line 17): no docstring
    - `async get_cluster_health(self)` (line 20): no docstring
    - `async disconnect(self)` (line 23): no docstring
...
- **Functions**
  - `test_validate_branch_name_accepts_foundry_branch_rid()` (line 8): no docstring
  - `test_validate_branch_name_rejects_reserved_head()` (line 13): no docstring
...
- **Functions**
  - `async test_enforce_action_permission_allows_ontology_roles_model(monkeypatch)` (line 13): no docstring
  - `async test_enforce_action_permission_rejects_policy_mismatch(monkeypatch)` (line 33): no docstring
  - `async test_enforce_action_permission_allows_datasource_derived_without_policy(monkeypatch)` (line 55): no docstring
  - `async test_enforce_action_permission_rejects_datasource_derived_for_non_engineer_role(monkeypatch)` (line 74): no docstring
  - `async test_enforce_action_permission_rejects_edits_beyond_actions_without_engineer_role(monkeypatch)` (line 95): no docstring
  - `async test_enforce_action_permission_rejects_invalid_permission_profile(monkeypatch)` (line 120): no docstring
  - `async test_enforce_action_permission_allows_when_project_policy_inheritance_matches(monkeypatch)` (line 139): no docstring
  - `async test_enforce_action_permission_rejects_when_required_project_policy_is_missing(monkeypatch)` (line 176): no docstring
  - `async test_enforce_action_permission_rejects_when_inherited_project_policy_denies(monkeypatch)` (line 214): no docstring
...
- **Functions**
  - `_request_payload(projection)` (line 39): no docstring
  - `_http_request_stub()` (line 50): no docstring
  - `async test_start_recompute_projection_blocks_instances_in_dataset_primary_mode()` (line 58): no docstring
  - `async test_start_recompute_projection_allows_ontologies_in_dataset_primary_mode()` (line 80): no docstring
  - `async test_recompute_projection_task_blocks_instances_in_dataset_primary_mode()` (line 99): no docstring
  - `async test_get_recompute_projection_result_returns_processing_for_running_task()` (line 115): no docstring
  - `async test_ontologies_projection_strategy_normalizes_localized_fields_for_es()` (line 146): no docstring
  - `test_load_projection_mapping_falls_back_when_file_missing_for_ontologies(monkeypatch)` (line 205): no docstring
  - `test_load_projection_mapping_falls_back_when_file_missing_for_instances(monkeypatch)` (line 217): no docstring
  - `async test_recompute_projection_task_updates_progress_for_long_running_work(monkeypatch)` (line 317): no docstring
- **Classes**
  - `_TaskManagerStub` (line 20): no docstring
    - `__init__(self)` (line 21): no docstring
    - `async create_task(self, *args, **kwargs)` (line 24): no docstring
  - `_TaskStatusManagerStub` (line 31): no docstring
    - `__init__(self, task)` (line 32): no docstring
    - `async get_task_status(self, task_id)` (line 35): no docstring
  - `_EsStub` (line 140): no docstring
    - `async get_document(self, index, doc_id)` (line 141): no docstring
  - `_ProgressTaskManagerStub` (line 229): no docstring
    - `__init__(self)` (line 230): no docstring
    - `async update_progress(self, task_id, current, total, message, metadata)` (line 233): no docstring
  - `_RedisResultStub` (line 252): no docstring
    - `__init__(self)` (line 253): no docstring
    - `async set_json(self, key, value, ttl)` (line 256): no docstring
  - `_AuditStoreStub` (line 260): no docstring
    - `async log(self, **kwargs)` (line 261): no docstring
  - `_LineageStoreStub` (line 265): no docstring
    - `async record_link(self, **kwargs)` (line 266): no docstring
    - `node_event(event_id)` (line 270): no docstring
    - `node_artifact(kind, index_name, doc_id)` (line 274): no docstring
  - `_ElasticsearchRecomputeStub` (line 278): no docstring
    - `__init__(self)` (line 279): no docstring
    - `async connect(self)` (line 284): no docstring
    - `async index_exists(self, index_name)` (line 287): no docstring
    - `async delete_index(self, index_name)` (line 290): no docstring
    - `async create_index(self, index_name, mappings, settings)` (line 293): no docstring
    - `async index_document(self, index_name, document, doc_id, refresh, version, version_type)` (line 296): no docstring
    - `async delete_document(self, index_name, doc_id, **kwargs)` (line 309): no docstring
    - `async refresh_index(self, index_name)` (line 312): no docstring

### `backend/tests/unit/services/test_admin_reindex_instances.py`
- **Functions**
  - `async test_reindex_no_mapping_specs()` (line 24): no docstring
  - `async test_reindex_submits_jobs()` (line 41): no docstring
  - `async test_reindex_handles_missing_dataset_version()` (line 77): no docstring
  - `async test_reindex_with_multiple_specs()` (line 108): no docstring
  - `async test_reindex_filters_legacy_specs_by_dataset_db_name()` (line 137): no docstring
- **Classes**
  - `_FakeSpec` (line 12): no docstring
    - `__init__(self, **kwargs)` (line 13): no docstring
  - `_FakeDataset` (line 18): no docstring
    - `__init__(self, db_name)` (line 19): no docstring
...
- **Functions**
  ...
  - `test_extract_action_simulation_rejection_returns_enterprise()` (line 37): no docstring
  - `test_extract_action_simulation_rejection_returns_none_when_accepted()` (line 64): no docstring
...
- **Functions**
  - `_response_with_provenance(provenance)` (line 7): no docstring
  - `test_ground_graph_query_result_prefers_graph_provenance()` (line 27): no docstring
  - `test_ground_graph_query_result_ignores_legacy_terminus_key()` (line 42): no docstring

### `backend/tests/unit/services/test_audit_log_store_metadata_coercion.py`
- **Functions**
  - `test_coerce_metadata_accepts_dict()` (line 6): no docstring
  - `test_coerce_metadata_parses_json_string()` (line 10): no docstring
  - `test_coerce_metadata_returns_empty_for_invalid_string()` (line 17): no docstring
  - `test_coerce_metadata_returns_empty_for_broken_mapping()` (line 21): no docstring

### `backend/tests/unit/services/test_background_task_manager.py`
- **Functions**
  - `async _wait_until_complete(manager, task_id, timeout_seconds)` (line 33): no docstring
  - `async test_retry_attempt_clears_terminal_fields_before_reexecution()` (line 50): no docstring
  - `async test_task_stays_terminal_failed_after_retry_exhaustion()` (line 83): no docstring
- **Classes**
  - `_RedisStub` (line 12): no docstring
    - `__init__(self)` (line 13): no docstring
    - `async set_json(self, key, value, ttl)` (line 16): no docstring
    - `async get_json(self, key)` (line 21): no docstring
    - `async scan_keys(self, pattern)` (line 27): no docstring
...
- **Functions**
  - `_parse_saved_csv(data)` (line 13): no docstring
  - `async test_connector_ingest_service_snapshot_creates_dataset_and_version(monkeypatch)` (line 84): no docstring
  - `async test_connector_ingest_service_append_deduplicates_rows(monkeypatch)` (line 129): no docstring
  - `async test_connector_ingest_service_incremental_cdc_streaming_use_append_merge(monkeypatch, mode, incoming_rows, expected_rows)` (line 200): no docstring
  - `async test_connector_ingest_service_update_upserts_by_primary_key(monkeypatch)` (line 256): no docstring
  - `async test_connector_ingest_service_rejects_invalid_import_mode()` (line 308): no docstring
- **Classes**
  - `_Storage` (line 20): no docstring
    - `__init__(self)` (line 21): no docstring
    - `async save_bytes(self, repository, key, payload, content_type)` (line 24): no docstring
  - `_DatasetRegistry` (line 41): no docstring
    - `__init__(self, existing_dataset)` (line 42): no docstring
    - `async get_dataset_by_source_ref(self, **kwargs)` (line 47): no docstring
    - `async create_dataset(self, **kwargs)` (line 51): no docstring
    - `async add_version(self, **kwargs)` (line 62): no docstring
  - `_PipelineRegistry` (line 73): no docstring
    - `__init__(self, storage)` (line 74): no docstring
    - `async get_lakefs_storage(self, user_id)` (line 77): no docstring
...
### `backend/tests/unit/services/test_elasticsearch_service_compat.py`
- **Functions**
  - `test_resolve_compat_version_uses_explicit_env(monkeypatch)` (line 13): no docstring
  - `test_resolve_compat_version_defaults_to_8_for_v9_client(monkeypatch)` (line 20): no docstring
  - `test_service_injects_compat_headers_for_v9_client(monkeypatch)` (line 28): no docstring
...
- **Functions**
  ...
  - `async test_event_store_connect_skips_store_bootstrap_when_pre_attached(monkeypatch)` (line 79): no docstring
  - `async test_event_store_connect_fails_when_lineage_required_and_store_unavailable(monkeypatch)` (line 107): no docstring
  - `async test_event_store_lineage_record_failure_propagates_when_required(monkeypatch)` (line 130): no docstring
- **Classes**
...
- **Functions**
  - `test_normalize_paths_converts_list_paths_to_object_shape()` (line 6): no docstring
  - `test_normalize_paths_preserves_existing_object_paths()` (line 28): no docstring
  - `test_normalize_es_doc_id_strips_class_prefix()` (line 33): no docstring
...
- **Functions**
  - `test_parse_node_id_rejects_deprecated_es_artifact_kind()` (line 25): no docstring
  - `test_canonicalize_edge_type_keeps_canonical_value()` (line 30): no docstring
  - `test_canonicalize_edge_type_rejects_deprecated_alias()` (line 35): no docstring
  - `test_canonicalize_edge_type_rejects_deprecated_s3_alias()` (line 40): no docstring
  - `test_infer_branch_from_es_node_id()` (line 45): no docstring
  - `async test_record_link_rejects_deprecated_es_ids_and_edge_type()` (line 51): no docstring
  - `async test_record_link_accepts_canonical_es_ids_and_edge_type()` (line 84): no docstring
- **Classes**
  - `_CaptureLineageStore` (line 11): no docstring
    - `__init__(self)` (line 12): no docstring
    - `async upsert_node(self, **kwargs)` (line 17): no docstring
    - `async insert_edge(self, **kwargs)` (line 20): no docstring

### `backend/tests/unit/services/test_lineage_store_latest_projection_edges.py`
- **Functions**
  - `async test_get_latest_edges_for_projections_returns_latest_writer_context()` (line 41): no docstring
  - `async test_get_latest_edges_for_projections_returns_empty_for_blank_names()` (line 83): no docstring
  - `async test_get_latest_edges_from_returns_latest_per_parent_node()` (line 95): no docstring
- **Classes**
  - `_AcquireCtx` (line 11): no docstring
    - `__init__(self, conn)` (line 12): no docstring
    - `async __aenter__(self)` (line 15): no docstring
    - `async __aexit__(self, exc_type, exc, tb)` (line 18): no docstring
  - `_FakeConn` (line 22): no docstring
    - `__init__(self, rows)` (line 23): no docstring
    - `async fetch(self, query, *params)` (line 27): no docstring
  - `_FakePool` (line 32): no docstring
    - `__init__(self, conn)` (line 33): no docstring
    - `acquire(self)` (line 36): no docstring
...
- **Functions**
  - `_make_orchestrator(record)` (line 63): no docstring
  - `async test_wait_for_objectify_submitted_allows_dataset_primary_completed_without_commands()` (line 75): no docstring
  - `async test_wait_for_objectify_submitted_defaults_to_dataset_primary_when_report_missing()` (line 89): no docstring
  - `async test_wait_for_objectify_submitted_requires_commands_for_submitted_status()` (line 103): no docstring
  - `async test_load_class_info_supports_backing_sources_contract_shape()` (line 117): no docstring
- **Classes**
  - `_FakeObjectifyRegistry` (line 14): no docstring
    - `async get_objectify_job(self, job_id)` (line 17): no docstring
    - `async get_active_mapping_spec(self, **kwargs)` (line 20): no docstring
  - `_FakeDatasetRegistry` (line 31): no docstring
    - `async get_latest_version(self, **kwargs)` (line 32): no docstring
    - `async get_version(self, **kwargs)` (line 40): no docstring
  - `_FakeOMSClient` (line 45): no docstring
    - `async get_ontology_resource(self, db_name, resource_type, resource_id, branch)` (line 46): no docstring
    - `async get_ontology(self, db_name, class_id, branch)` (line 58): no docstring
...
- **Functions**
  - `_request()` (line 73): no docstring
  - `async test_run_objectify_requires_dataset_version_id_without_artifact(monkeypatch)` (line 87): no docstring
  - `async test_run_objectify_accepts_version_pinned_execution(monkeypatch)` (line 113): no docstring
- **Classes**
  - `_FakeDatasetRegistry` (line 13): no docstring
    - `__init__(self, version)` (line 14): no docstring
    - `async get_dataset(self, dataset_id)` (line 17): no docstring
    - `async get_version(self, version_id)` (line 28): no docstring
    - `async get_latest_version(self, dataset_id)` (line 33): no docstring
  - `_FakeObjectifyRegistry` (line 38): no docstring
    - `async get_mapping_spec(self, mapping_spec_id)` (line 39): no docstring
    - `async get_active_mapping_spec(self, **kwargs)` (line 53): no docstring
    - `build_dedupe_key(self, **kwargs)` (line 57): no docstring
    - `async get_objectify_job_by_dedupe_key(self, dedupe_key)` (line 60): no docstring
  - `_FakeJobQueue` (line 65): no docstring
    - `__init__(self)` (line 66): no docstring
    - `async publish(self, job, require_delivery)` (line 69): no docstring
...
- **Functions**
  - `async test_resolve_expected_head_commit_prefers_explicit_value()` (line 28): no docstring
  - `async test_resolve_expected_head_commit_returns_none_without_legacy_lookup()` (line 43): no docstring
  - `async test_fetch_branch_head_commit_id_is_disabled_in_foundry_profile()` (line 58): no docstring
  - `async test_resolve_branch_head_commit_with_bootstrap_is_disabled()` (line 72): no docstring
- **Classes**
  - `_UnusedOMSClient` (line 12): no docstring
    - `__init__(self)` (line 13): no docstring
    - `async get_version_head(self, db_name, branch)` (line 16): no docstring
    - `async create_branch(self, db_name, branch_data)` (line 21): no docstring

### `backend/tests/unit/services/test_ontology_resource_service_versioning.py`
- **Functions**
  - `test_payload_to_document_sets_initial_version_and_rev()` (line 9): no docstring
  - `test_payload_to_document_increments_version_and_rev_from_existing()` (line 24): no docstring
  - `test_normalize_branch_for_write_strips_branch_prefix()` (line 50): no docstring
  - `async test_get_resource_falls_back_to_deployed_target_branch(monkeypatch)` (line 60): no docstring
  - `async test_materialize_commit_snapshot_delegates_to_promote(monkeypatch)` (line 117): no docstring

### `backend/tests/unit/services/test_ontology_resource_validator.py`
- **Functions**
  - `test_action_type_requires_input_schema_and_policy()` (line 23): no docstring
  - `test_object_type_requires_pk_spec_and_backing_source()` (line 32): no docstring
  - `test_object_type_draft_allows_missing_pk_and_backing()` (line 41): no docstring
  - `test_object_type_supports_backing_sources_list()` (line 50): no docstring
  - `test_shared_property_requires_properties_list()` (line 62): no docstring
  - `test_function_requires_expression_and_return_type_ref()` (line 68): no docstring
  - `test_action_type_rejects_unsafe_submission_criteria_expression()` (line 75): no docstring
  - `test_action_type_rejects_invalid_validation_rules()` (line 91): no docstring
  - `test_action_type_accepts_template_v2_implementation()` (line 107): no docstring
  - `test_link_type_invalid_predicate_is_reported()` (line 131): no docstring
  - `test_relationship_spec_missing_is_reported()` (line 138): no docstring
  - `test_relationship_spec_invalid_type_is_reported()` (line 144): no docstring
  - `test_relationship_spec_object_backed_requires_object_type()` (line 150): no docstring
  - `test_relationship_spec_join_table_requires_dataset_or_auto_create()` (line 165): no docstring
  - `async test_link_type_missing_refs_are_reported()` (line 182): no docstring
  - `test_permission_policy_rejects_legacy_roles_alias()` (line 194): no docstring
  - `test_permission_policy_rejects_legacy_users_alias()` (line 206): no docstring
  - `test_permission_policy_rejects_unsupported_legacy_fields()` (line 218): no docstring
  - `test_action_type_datasource_derived_allows_missing_permission_policy()` (line 231): no docstring
  - `test_action_type_rejects_invalid_permission_model()` (line 247): no docstring
  - `test_action_type_rejects_non_boolean_edits_beyond_actions()` (line 263): no docstring
  - `test_permission_policy_accepts_project_inheritance_fields()` (line 281): no docstring
  - `test_permission_policy_rejects_invalid_project_inheritance_field_types()` (line 298): no docstring
- **Classes**
  - `_FakeResourceService` (line 12): no docstring
    - `__init__(self, existing)` (line 13): no docstring
    - `async get_resource(self, db_name, branch, resource_type, resource_id)` (line 16): no docstring

### `backend/tests/unit/services/test_ontology_router_helpers.py`
- **Functions**
  - `test_extract_group_refs_dedupes()` (line 21): no docstring
  - `async test_validate_group_refs_reports_missing()` (line 33): no docstring
  - `async test_apply_shared_properties_merges_and_tracks_duplicates()` (line 46): no docstring
  - `async test_validate_value_type_refs_detects_base_type_mismatch()` (line 74): no docstring
  - `async test_collect_interface_issues_reports_missing_property()` (line 100): no docstring
- **Classes**
  - `_FakeResourceService` (line 13): no docstring
    - `__init__(self, resources)` (line 14): no docstring
    - `async get_resource(self, db_name, branch, resource_type, resource_id)` (line 17): no docstring
...
- **Functions**
  - `async test_build_proposal_bundle_adds_ontology_ref_fallback_when_commit_missing()` (line 53): no docstring
  - `async test_build_proposal_bundle_preserves_ontology_ref_when_present()` (line 77): no docstring
- **Classes**
  - `_Pipeline` (line 12): no docstring
  - `_PipelineRegistry` (line 18): no docstring
    - `__init__(self, output_json)` (line 19): no docstring
    - `async get_run(self, pipeline_id, job_id)` (line 22): no docstring
    - `async get_artifact_by_job(self, pipeline_id, job_id, mode)` (line 31): no docstring
  - `_DatasetRegistry` (line 36): no docstring
    - `async get_dataset_by_name(self, db_name, name, branch)` (line 37): no docstring
  - `_ObjectifyRegistry` (line 42): no docstring
    - `async get_active_mapping_spec(self, **kwargs)` (line 43): no docstring
    - `async get_mapping_spec(self, mapping_spec_id)` (line 47): no docstring
...
- **Functions**
  - `async test_pipeline_scheduler_main_bootstraps_and_runs(monkeypatch)` (line 12): no docstring
...
- **Functions**
  - `async test_health_check_connects_when_pool_missing()` (line 55): no docstring
  - `async test_health_check_returns_false_on_query_failure()` (line 72): no docstring
  - `async test_ensure_schema_uses_advisory_lock()` (line 80): no docstring
  - `async test_ensure_schema_unlocks_on_table_error()` (line 98): no docstring
  - `async test_ensure_schema_retries_until_lock_available()` (line 111): no docstring
- **Classes**
  ...
  - `_Conn` (line 19): no docstring
    - `__init__(self, fail, lock_sequence)` (line 20): no docstring
    - `async execute(self, sql, *_args)` (line 25): no docstring
    - `async fetchval(self, sql, *_args)` (line 30): no docstring
  - `_Pool` (line 41): no docstring
    - `__init__(self, conn)` (line 42): no docstring
    - `acquire(self)` (line 45): no docstring
  - `_Registry` (line 49): no docstring
    - `async _ensure_tables(self, conn)` (line 50): no docstring
  - `_FailingRegistry` (line 92): no docstring
    - `async _ensure_tables(self, conn)` (line 93): no docstring

### `backend/tests/unit/services/test_projection_consistency.py`
- **Functions**
  - `_env(event_id, event_type, aggregate_id, sequence_number, occurred_at, data)` (line 13): no docstring
  - `test_parse_instance_aggregate_id_handles_instance_id_with_colon()` (line 35): no docstring
  - `test_build_instance_expectations_prefers_higher_sequence_number()` (line 44): no docstring
  - `test_build_instance_expectations_uses_aggregate_id_fallback()` (line 72): no docstring
  - `test_evaluate_projection_document_reports_missing_document()` (line 92): no docstring
  - `test_evaluate_projection_document_detects_deleted_document_present()` (line 107): no docstring
...
### `backend/tests/unit/services/test_redis_service_set_json_compat.py`
- **Functions**
  - `async test_set_json_accepts_ex_alias_for_ttl()` (line 22): no docstring
  - `async test_set_json_prefers_ttl_over_ex_when_both_provided()` (line 36): no docstring
- **Classes**
  - `_FakeRedisClient` (line 8): no docstring
    - `__init__(self)` (line 9): no docstring
    - `async setex(self, key, ttl, value)` (line 12): no docstring
    - `async set(self, key, value)` (line 16): no docstring
...
- **Classes**
  ...
  - `TestExtractRelationshipsWithOntologyData` (line 60): Test extraction using raw ontology data (instance_worker path).
    ...
    - `test_legacy_graph_schema_format(self)` (line 73): no docstring
...
- **Functions**
  ...
  - `async test_load_action_target_runtime_contract_extracts_metadata_and_properties()` (line 70): no docstring
  - `async test_load_action_target_runtime_contract_reads_object_type_resource_first()` (line 103): no docstring
  - `async test_load_action_target_runtime_contract_returns_none_when_resource_missing()` (line 136): no docstring
...
- **Functions**
  - `test_foundry_page_token_round_trip()` (line 10): no docstring
  - `test_foundry_page_token_rejects_expired_token()` (line 16): no docstring
  - `test_foundry_page_token_empty_defaults_to_zero_offset()` (line 23): no docstring
  - `test_foundry_page_token_scope_mismatch_rejected()` (line 28): no docstring
...
### `backend/tests/unit/utils/test_object_type_backing.py`
- **Functions**
  - `test_list_backing_sources_prefers_backing_sources_list()` (line 4): no docstring
  - `test_list_backing_sources_falls_back_to_backing_source()` (line 13): no docstring
  - `test_select_primary_backing_source_returns_first_source()` (line 20): no docstring
  - `test_select_primary_backing_source_returns_empty_dict_for_missing_shape()` (line 26): no docstring
...
- **Functions**
  - `async test_resolve_ontology_version_without_source_returns_ref_only()` (line 40): no docstring
  - `async test_resolve_ontology_version_ignores_legacy_like_source()` (line 51): no docstring
  - `async test_resolve_ontology_version_ignores_branch_list_source()` (line 62): no docstring
  - `async test_resolve_ontology_version_ignores_branch_info_source()` (line 73): no docstring
  - `async test_resolve_ontology_version_falls_back_to_ref_on_source_failures()` (line 84): no docstring
- **Classes**
  - `_LegacyLikeSource` (line 8): no docstring
    - `async list_branches(self, db_name)` (line 9): no docstring
  - `_BranchInfoLikeSource` (line 17): no docstring
    - `async get_branch_info(self, db_name, branch_name)` (line 18): no docstring
  - `_FailingSource` (line 29): no docstring
    - `async list_branches(self, db_name)` (line 30): no docstring
    - `async get_branch_info(self, db_name, branch_name)` (line 34): no docstring

### `backend/tests/unit/utils/test_principal_policy.py`
- **Functions**
  - `test_build_principal_tags_defaults_to_user_prefix()` (line 4): no docstring
  ...
  - `test_policy_rejects_legacy_roles_alias()` (line 20): no docstring
  - `test_policy_rejects_legacy_roles_alias_even_for_deny_effect()` (line 26): no docstring
...
- **Functions**
  ...
  - `test_extract_backing_dataset_id_reads_backing_sources_fallback()` (line 15): no docstring
  - `test_policies_aligned_requires_dicts_and_exact_match()` (line 20): no docstring
...
- **Functions**
  - `async test_sync_worker_process_connector_update_snapshot()` (line 188): no docstring
  - `async test_sync_worker_process_connector_update_file_import_uses_file_config_key()` (line 261): no docstring
  - `async test_sync_worker_process_connector_update_streaming_uses_cdc_extract()` (line 320): no docstring
  - `async test_sync_worker_handle_envelope_rejects_unknown()` (line 384): no docstring
  - `async test_sync_worker_handle_envelope_accepts_sqlserver_table_import(monkeypatch)` (line 398): no docstring
  - `async test_sync_worker_handle_envelope_accepts_mysql_file_import(monkeypatch)` (line 419): no docstring
  - `async test_sync_worker_run_processes_message(monkeypatch)` (line 440): no docstring
  - `async test_sync_worker_heartbeat_loop_stops(monkeypatch)` (line 469): no docstring
- **Classes**
  - `_FakeTracing` (line 16): no docstring
    - `span(self, *args, **kwargs)` (line 17): no docstring
  - `_FakeAdapter` (line 21): no docstring
    - `__init__(self)` (line 22): no docstring
    - `async snapshot_extract(self, config, secrets, import_config)` (line 28): no docstring
    - `async incremental_extract(self, config, secrets, import_config, sync_state)` (line 40): no docstring
    - `async cdc_extract(self, config, secrets, import_config, sync_state)` (line 44): no docstring
  - `_FakeAdapterFactory` (line 49): no docstring
    - `__init__(self)` (line 50): no docstring
    - `get_adapter(self, connector_kind)` (line 53): no docstring
  - `_FakeRegistry` (line 58): no docstring
    - `__init__(self)` (line 59): no docstring
    - `async get_source(self, source_type, source_id)` (line 67): no docstring
    - `async get_mapping(self, source_type, source_id)` (line 74): no docstring
    - `async get_sync_state(self, source_type, source_id)` (line 78): no docstring
    - `async get_connection_secrets(self, source_type, source_id)` (line 82): no docstring
    - `async upsert_sync_state_json(self, source_type, source_id, sync_state_json, merge)` (line 86): no docstring
    - `async record_sync_outcome(self, **kwargs)` (line 96): no docstring
  - `_FakeIngestService` (line 100): no docstring
    - `__init__(self)` (line 101): no docstring
    - `async ingest_rows(self, **kwargs)` (line 104): no docstring
  - `_FakeProcessed` (line 122): no docstring
    - `__init__(self)` (line 123): no docstring
    - `async claim(self, **kwargs)` (line 129): no docstring
    - `async mark_done(self, **kwargs)` (line 133): no docstring
    - `async mark_failed(self, **kwargs)` (line 136): no docstring
    - `async heartbeat(self, **kwargs)` (line 139): no docstring
  - `_FakeMessage` (line 144): no docstring
    - `__init__(self, payload)` (line 145): no docstring
    - `error(self)` (line 148): no docstring
    - `value(self)` (line 151): no docstring
    - `headers(self)` (line 154): no docstring
    - `topic(self)` (line 157): no docstring
    - `partition(self)` (line 160): no docstring
    - `offset(self)` (line 163): no docstring
  - `_FakeConsumer` (line 167): no docstring
    - `__init__(self, worker)` (line 168): no docstring
    - `poll(self, timeout)` (line 173): no docstring
    - `commit(self, msg, asynchronous)` (line 178): no docstring
    - `commit_sync(self, msg)` (line 182): no docstring
...
- **Classes**
  ...
  - `_FakeRegistry` (line 20): no docstring
    - `__init__(self)` (line 21): no docstring
    - `async initialize(self)` (line 34): no docstring
    - `async close(self)` (line 37): no docstring
    - `async get_sync_state(self, source_type, source_id)` (line 40): no docstring
    - `async list_sources(self, source_type, enabled, limit)` (line 43): no docstring
    - `async get_source(self, source_type, source_id)` (line 47): no docstring
    - `async get_connection_secrets(self, source_type, source_id)` (line 53): no docstring
    - `async record_poll_result(self, **kwargs)` (line 56): no docstring
    - `async claim_outbox_batch(self, limit)` (line 59): no docstring
    - `async mark_outbox_published(self, outbox_id)` (line 66): no docstring
    - `async mark_outbox_failed(self, outbox_id, error)` (line 69): no docstring
    - `async upsert_source(self, source_type, source_id, enabled, config_json)` (line 72): no docstring
  - `_FakeSheets` (line 76): no docstring
    - `__init__(self, api_key)` (line 77): no docstring
...
- **Functions**
  - `async test_extract_payload_from_message_success()` (line 14): no docstring
  - `async test_extract_payload_from_message_rejects_non_command()` (line 30): no docstring
  - `test_primary_key_and_objectify_helpers()` (line 44): no docstring
  - `test_retryable_error_detection()` (line 60): no docstring
  - `test_es_outage_errors_expand_retry_budget()` (line 67): no docstring
  - `async test_process_create_instance_does_not_mark_failed_before_terminal_retry()` (line 90): no docstring
  - `async test_shutdown_uses_disconnect_for_elasticsearch_service(monkeypatch)` (line 122): no docstring
  - `async test_enqueue_link_reindex_uses_registry_job_enqueue()` (line 150): no docstring
  - `async test_enqueue_link_reindex_skips_when_dedupe_exists()` (line 213): no docstring
...
- **Functions**
  - `_resolve_execution_mode(options, job_mode)` (line 9): no docstring
  - `test_default_execution_mode_is_full()` (line 16): Default execution mode should be 'full'.
  - `test_explicit_full_mode()` (line 30): no docstring
  - `test_explicit_delta_mode()` (line 44): no docstring
  - `test_watermark_fields()` (line 60): no docstring
  - `test_execution_mode_prefers_options_over_job_mode()` (line 77): no docstring
  - `test_execution_mode_falls_back_to_full_for_invalid_values()` (line 82): no docstring
  - `test_auto_detect_watermark_column()` (line 87): Test the auto-detect helper function from objectify_worker.

### `backend/tests/unit/workers/test_objectify_worker_backing_sources.py`
- **Functions**
  - `_build_job(dataset_id)` (line 19): no docstring
  - `async _fail_job(error)` (line 34): no docstring
  - `async test_resolve_mapping_spec_uses_backing_sources_when_backing_source_missing()` (line 39): no docstring
  - `async test_resolve_mapping_spec_rejects_job_dataset_mismatch_with_backing_sources()` (line 61): no docstring
- **Classes**
  - `_OmsMappingWorker` (line 9): no docstring
    - `__init__(self, object_type_spec)` (line 10): no docstring
    - `async _fetch_object_type_contract(self, job)` (line 14): no docstring
...
- **Functions**
  - `_build_worker()` (line 71): no docstring
  - `async test_create_ontology_records_graph_lineage_and_audit_naming()` (line 87): no docstring
  - `async test_delete_ontology_records_graph_lineage_and_audit_naming()` (line 123): no docstring
- **Classes**
  - `_InMemoryOntologyResourceService` (line 11): no docstring
    - `__init__(self)` (line 12): no docstring
    - `async create_resource(self, db_name, branch, resource_type, resource_id, payload)` (line 15): no docstring
    - `async delete_resource(self, db_name, branch, resource_type, resource_id)` (line 33): no docstring
    - `async get_resource(self, db_name, branch, resource_type, resource_id)` (line 43): no docstring
  - `_ObservabilityStub` (line 55): no docstring
    - `__init__(self)` (line 56): no docstring
    - `async record_link(self, **kwargs)` (line 59): no docstring
  - `_AuditStoreStub` (line 63): no docstring
    - `__init__(self)` (line 64): no docstring
    - `async log(self, **kwargs)` (line 67): no docstring

### `backend/tests/unit/workers/test_ontology_worker_helpers.py`
- **Functions**
  - `async test_resource_registry_mode_is_default_and_active()` (line 12): no docstring
  - `async test_consumer_ops_defaults_to_inline()` (line 18): no docstring
  - `async test_heartbeat_loop_no_registry()` (line 32): no docstring

### `backend/tests/unit/workers/test_ontology_worker_legacy_backend.py`
- **Functions**
  - `async test_process_command_allows_database_command_without_adapter_in_postgres_profile()` (line 12): no docstring
  - `async test_process_command_allows_ontology_command_without_adapter_in_postgres_profile()` (line 28): no docstring

### `backend/tests/unit/workers/test_ontology_worker_resource_registry.py`
- **Functions**
  - `_build_worker_with_resource_store(service)` (line 89): no docstring
  - `async test_create_ontology_uses_object_type_resource_registry_in_postgres_profile()` (line 106): no docstring
  - `async test_update_ontology_uses_object_type_resource_registry_in_postgres_profile()` (line 143): no docstring
  - `async test_delete_ontology_uses_object_type_resource_registry_in_postgres_profile()` (line 194): no docstring
- **Classes**
  - `_InMemoryOntologyResourceService` (line 11): no docstring
    - `__init__(self)` (line 12): no docstring
    - `async create_resource(self, db_name, branch, resource_type, resource_id, payload)` (line 15): no docstring
    - `async update_resource(self, db_name, branch, resource_type, resource_id, payload)` (line 33): no docstring
    - `async delete_resource(self, db_name, branch, resource_type, resource_id)` (line 51): no docstring
    - `async get_resource(self, db_name, branch, resource_type, resource_id)` (line 61): no docstring
  - `_ObservabilityStub` (line 73): no docstring
    - `__init__(self)` (line 74): no docstring
    - `async record_link(self, **kwargs)` (line 77): no docstring
  - `_AuditStoreStub` (line 81): no docstring
    - `__init__(self)` (line 82): no docstring
    - `async log(self, **kwargs)` (line 85): no docstring
