...
/* ═══════════════════════════════════════════════════════════════════════════
   Legacy Ontology Manager (Palantir-style 3-pane with actions/links/objects)
   ═══════════════════════════════════════════════════════════════════════════ */
...
export const OntologyManagerPage = () => {
  const pipelineContext = useAppStoreLegacy((state) => state.pipelineContext)
  const selectedActionTypeId = useAppStoreLegacy((state) => state.selectedActionTypeId)
  const setSelectedActionTypeId = useAppStoreLegacy((state) => state.setSelectedActionTypeId)
  const actionSimulationResult = useAppStoreLegacy((state) => state.actionSimulationResult)
  const setActionSimulationResult = useAppStoreLegacy((state) => state.setActionSimulationResult)
