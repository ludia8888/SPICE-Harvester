...
class TokenResponse(BaseModel):
    ...
    admin_token: Optional[StrictStr] = None
    expires_in: StrictInt
    refresh_token: StrictStr
    token_type: Optional[StrictStr] = 'bearer'
    __properties: ClassVar[List[str]] = ["access_token", "admin_token", "expires_in", "refresh_token", "token_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "admin_token": obj.get("admin_token"),
