...
class AccessPolicyRequest(BaseModel):
    ...
    scope: Optional[StrictStr] = 'data_access'
    status: Optional[Status] = None
    subject_id: StrictStr
    subject_type: StrictStr
    __properties: ClassVar[List[str]] = ["db_name", "policy", "scope", "status", "subject_id", "subject_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scope": obj.get("scope") if obj.get("scope") is not None else 'data_access',
