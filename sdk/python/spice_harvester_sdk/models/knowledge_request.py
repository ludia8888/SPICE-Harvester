...
class KnowledgeRequest(BaseModel):
    ...
    """ # noqa: E501
    content: StrictStr = Field(description="Knowledge content")
    metadata: Optional[Dict[str, Any]] = None
    tags: Optional[List[StrictStr]] = None
    title: StrictStr = Field(description="Knowledge title")
    __properties: ClassVar[List[str]] = ["content", "metadata", "tags", "title"]
