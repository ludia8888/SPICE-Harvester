...
class ReplayInstanceStateResponse(BaseModel):
    ...
    status_url: StrictStr = Field(description="URL to check task status")
    task_id: StrictStr = Field(description="Background task ID")
    __properties: ClassVar[List[str]] = ["message", "status", "status_url", "task_id"]
