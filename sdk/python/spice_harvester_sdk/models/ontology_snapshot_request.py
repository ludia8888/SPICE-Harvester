...
class OntologySnapshotRequest(BaseModel):
    ...
    """ # noqa: E501
    branch: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=200)]] = 'main'
    db_name: Annotated[str, Field(min_length=1, strict=True, max_length=200)]
    ontology_id: Annotated[str, Field(min_length=1, strict=True, max_length=200)]
    __properties: ClassVar[List[str]] = ["branch", "db_name", "ontology_id"]
