...
This page presents the key domain model classes in Spice OS. These diagrams reflect the core entities and their relationships as implemented in the ontology management layer.
