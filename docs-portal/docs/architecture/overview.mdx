...
Spice OS is a CQRS/Event Sourcing platform designed for enterprise ontology management. This page describes the high-level architecture, service layers, and key design decisions.
...
The client layer includes all consumers of the Spice OS API:
...
The v2 API surface follows the Palantir Foundry API contract. This ensures that clients built for Foundry can migrate to Spice OS with minimal changes. Key compatibility points:
